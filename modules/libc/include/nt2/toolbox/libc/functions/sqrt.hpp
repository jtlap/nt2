 ...
 * \file
**/
#ifndef NT2_TOOLBOX_LIBC_FUNCTIONS_SQRT_HPP_INCLUDED
#define NT2_TOOLBOX_LIBC_FUNCTIONS_SQRT_HPP_INCLUDED
...
// #include <nt2/toolbox/libc/functions/simd/all/sqrt.hpp> 
