...
//==============================================================================
#ifndef BOOST_SIMD_TOOLBOX_IEEE_FUNCTION_SCALAR_FAST_FREXP_HPP_INCLUDED
#define BOOST_SIMD_TOOLBOX_IEEE_FUNCTION_SCALAR_FAST_FREXP_HPP_INCLUDED
...
{
  BOOST_SIMD_FUNCTOR_IMPLEMENTATION( tag::fast_frexp_, tag::cpu_, (A0)(A1)(A2)
                            , (scalar_< double_<A0> >)
                              (scalar_< double_<A1> >)
			      (scalar_< int32_<A2> >)
                            )
  ...
  BOOST_SIMD_FUNCTOR_IMPLEMENTATION( tag::fast_frexp_, tag::cpu_, (A0)(A2)
                            , (scalar_< double_<A0> >)
			      (scalar_< int32_<A2> >)
                            )
  {
  ...
  BOOST_SIMD_FUNCTOR_IMPLEMENTATION(tag::fast_frexp_, tag::cpu_,
                            (A0),
                            (scalar_ < double_<A0> > )
                           )
  {
