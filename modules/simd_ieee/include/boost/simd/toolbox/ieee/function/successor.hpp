...
{
  BOOST_DISPATCH_FUNCTION_IMPLEMENTATION(boost::dispatch::tag::successor_, successor, 1)
  BOOST_DISPATCH_FUNCTION_IMPLEMENTATION(boost::dispatch::tag::successor_, successor, 2)
} }
