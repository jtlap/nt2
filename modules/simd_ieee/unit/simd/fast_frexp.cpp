...
//////////////////////////////////////////////////////////////////////////////
#define BOOST_SIMD_UNIT_MODULE "nt2 ieee toolbox - fast_frexp/simd Mode"
...
BOOST_SIMD_TEST_CASE_TPL ( fast_frexp_real__1_0,  BOOST_SIMD_REAL_TYPES)
{
  ...
  typedef typename boost::simd::meta::call<fast_frexp_(vT)>::type r_t;
  typedef typename boost::simd::meta::call<fast_frexp_(T)>::type sr_t;
