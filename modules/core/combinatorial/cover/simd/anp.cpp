...
//==============================================================================
// cover for functor anp in simd mode
...
NT2_TEST_CASE_TPL(anp_0,  NT2_SIMD_REAL_TYPES)
{
  ...
  for(std::size_t i=0; i!=NR; ++i)
  {
    ...
    a1[i] = nt2::round(a1[i]);
    a0[i] += a1[i];
    ref[i] = nt2::anp(a0[i], a1[i]);
  }

  NT2_COVER_ULP_EQUAL(nt2::tag::anp_, ((vT, a0))((vT, a1)), ref, ulpd);
