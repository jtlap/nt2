...
//==============================================================================
// cover for functor nthroot in simd mode
...
NT2_TEST_CASE_TPL(nthroot_0,  NT2_SIMD_REAL_TYPES)
{
  ...
  typedef typename nt2::meta::scalar_of<ivT>::type iT;
  ...
  for(std::size_t i=0; i!=NR; ++i)
    ref[i] = T(nt2::nthroot(a0[i],a1[i]));

  NT2_COVER_ULP_EQUAL(nt2::tag::nthroot_, ((vT, a0))((ivT, a1)), ref, ulpd);
