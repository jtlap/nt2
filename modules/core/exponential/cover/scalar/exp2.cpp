...
//==============================================================================
// cover for functor exp2 in scalar mode
...
NT2_TEST_CASE_TPL(exp2_0,  NT2_SIMD_REAL_TYPES)
{
  using nt2::unit::args;
  const std::size_t NR = args("samples", NT2_NB_RANDOM_TEST);
  const double ulpd = args("ulpd", 7);
  ...
  for(std::size_t i=0; i!=NR; ++i)
    ref[i] = cephes_exp2l(a0[i]);

  NT2_COVER_ULP_EQUAL(nt2::tag::exp2_, ((T, a0)), ref, ulpd);
