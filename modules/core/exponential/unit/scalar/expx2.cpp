...
NT2_TEST_CASE_TPL ( expx2_real,  NT2_REAL_TYPES)
{
  using nt2::expx2;
...
NT2_TEST_CASE_TPL ( expx2_unsigned_int,  NT2_UNSIGNED_TYPES)
{
  using nt2::expx2;
  using nt2::tag::expx2_;
...
NT2_TEST_CASE_TPL ( expx2_signed_int,  NT2_INTEGRAL_SIGNED_TYPES)
{
  using nt2::expx2;
  using nt2::tag::expx2_;
