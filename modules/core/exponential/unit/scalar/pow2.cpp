...
NT2_TEST_CASE_TPL ( pow2,  BOOST_SIMD_REAL_TYPES)
{
  using nt2::pow2;
  using nt2::tag::pow2_;
  ...
  NT2_TEST_ASSERT(pow2(nt2::Inf<T>()));
  NT2_TEST_ASSERT(pow2(nt2::Minf<T>()));
  NT2_TEST_ASSERT(pow2(nt2::Nan<T>()));
  NT2_TEST_ASSERT(pow2(T(1), nt2::Inf<T>()));
  NT2_TEST_ASSERT(pow2(T(1), nt2::Minf<T>()));
  NT2_TEST_ASSERT(pow2(T(1), nt2::Nan<T>()));
#endif
