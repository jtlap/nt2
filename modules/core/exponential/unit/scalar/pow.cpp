...
NT2_TEST_CASE_TPL ( pow_unsigned_int,  NT2_UNSIGNED_TYPES)
{
  using nt2::pow;
  using nt2::tag::pow_;
...
NT2_TEST_CASE_TPL ( pow_signed_int,  NT2_INTEGRAL_SIGNED_TYPES)
{
  using nt2::pow;
  using nt2::tag::pow_;
...
NT2_TEST_CASE_TPL ( powi_real,  NT2_REAL_TYPES)
{
  using nt2::pow;
  using nt2::tag::pow_;
  typedef typename nt2::meta::as_integer<T>::type          iT;
