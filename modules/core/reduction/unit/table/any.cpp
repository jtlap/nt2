...
{
  nt2::logical<T> x = nt2::any(nt2::True< nt2::logical<T> >());
  NT2_TEST_EQUAL( x, (nt2::True< nt2::logical<T> >()) );

  x = nt2::any(nt2::True< nt2::logical<T> >(),1);
  NT2_TEST_EQUAL( x, nt2::True< nt2::logical<T> >() );

  x = nt2::any(nt2::True< nt2::logical<T> >(),2);
  NT2_TEST_EQUAL( x, (nt2::True< nt2::logical<T> >()) );
...
NT2_TEST_CASE_TPL( any_expr, NT2_TYPES )
{
  ...
  for(int j=1;j<=3;j++)
    {
      nt2::logical<T> z = nt2::False< nt2::logical<T> >();
...
//   sy = nt2::any(y(_));
//   display("sy", sy);
//   NT2_TEST_EQUAL(nt2::True< nt2::logical<T> >(), sy(1));
