...
namespace nt2
{
  ...
  {
    template<class Site>
    BOOST_FORCEINLINE generic_dispatcher<tag::globalzero_crossing_rate_, Site> dispatching_globalzero_crossing_rate_(adl_helper, boost::dispatch::meta::unknown_<Site>, ...)
    {
