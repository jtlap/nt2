 ...
 ******************************************************************************/
#ifndef NT2_TOOLBOX_SIGNAL_FUNCTIONS_GENERIC_MAG2DB_HPP_INCLUDED
#define NT2_TOOLBOX_SIGNAL_FUNCTIONS_GENERIC_MAG2DB_HPP_INCLUDED
...
namespace nt2 { namespace ext
{
    ...
    )
  {
    ...
    NT2_FUNCTOR_CALL(2)
    {
      return nt2::Twenty<result_type>()*nt2::log10(a0/a1);
    }
  };
    ...
    )
  {
    ...
    NT2_FUNCTOR_CALL(2)
    {
      return nt2::Twenty<result_type>()*nt2::log10(a0);
    }
  };
