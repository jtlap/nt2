...
NT2_TEST_CASE_TPL ( compare_greater_equal_real__2_0,  NT2_REAL_TYPES)
{
  ...
  NT2_TEST_EQUAL(compare_greater_equal(nt2::Inf<T>(), nt2::Inf<T>()), ssr_t(true));
  NT2_TEST_EQUAL(compare_greater_equal(nt2::Minf<T>(), nt2::Minf<T>()), ssr_t(true));
  NT2_TEST_EQUAL(compare_greater_equal(nt2::Nan<T>(), nt2::Nan<T>()), ssr_t(true));
  NT2_TEST_EQUAL(compare_greater_equal(nt2::One<T>(),nt2::Zero<T>()), ssr_t(true));
  NT2_TEST_EQUAL(compare_greater_equal(nt2::Zero<T>(), nt2::Zero<T>()), ssr_t(true));
...
NT2_TEST_CASE_TPL ( compare_greater_equal_signed_int__2_0,  NT2_INTEGRAL_SIGNED_TYPES)
{
  ...
  // specific values tests
  NT2_TEST_EQUAL(compare_greater_equal(nt2::Mone<T>(),nt2::Zero<T>()), ssr_t(false));
  NT2_TEST_EQUAL(compare_greater_equal(nt2::One<T>(), nt2::One<T>()), ssr_t(true));
  NT2_TEST_EQUAL(compare_greater_equal(nt2::One<T>(),nt2::Zero<T>()), ssr_t(true));
  NT2_TEST_EQUAL(compare_greater_equal(nt2::Zero<T>(), nt2::Zero<T>()), ssr_t(true));
