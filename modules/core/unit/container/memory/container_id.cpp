...
NT2_TEST_CASE_TPL( container_values, NT2_TYPES )
{
  ...
  NT2_TEST_EXPR_TYPE( (container <table_, id_<1337>, T, settings()>())
                    , value_of<_>
                    , T
                    );
}
...
NT2_TEST_CASE_TPL( container_models, NT2_TYPES )
{
  ...
  NT2_TEST_EXPR_TYPE
  ( (container<table_, id_<1337>, int, settings()>())
  , (apply_model<_,T>)
  , (container<table_, id_<1337>, T, settings()>)
  );
}
...
NT2_TEST_CASE_TPL( container_static_default_ctor, NT2_TYPES)
{
  ...
  container<table_,id_<5>,T,settings(of_size_<32,7>)> b;
...
NT2_TEST_CASE_TPL( container_automatic_static_default_ctor, NT2_TYPES)
{
  ...
  container<table_,id_<99>,T,settings(of_size_<32,7>, automatic_)> b;
...
NT2_TEST_CASE_TPL( container_size_ctor, NT2_TYPES)
{
  ...
  container<table_,id_<10>,T,settings()> b( of_size(3,3) );
