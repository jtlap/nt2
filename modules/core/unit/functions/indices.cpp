...
NT2_TEST_CASE( indices_size )
{
  ...
  NT2_TEST_EQUAL( nt2::size( nt2::indices(4, along_, 1), 1 ), 4 );
  NT2_TEST_EQUAL( nt2::size( nt2::indices(4, along_, 1), 2 ), 4 );
  NT2_TEST_EQUAL( nt2::extent( nt2::indices(4, 5, along_, 1) ), nt2::of_size(4,5 ));
  NT2_TEST_EQUAL( nt2::size( nt2::indices(4, 5, along_, 1), 1 ), 4 );
  NT2_TEST_EQUAL( nt2::size( nt2::indices(4, 5, along_, 1), 2 ), 5 );
...
//   NT2_TEST_EQUAL( nt2::size( nt2::indices(nt2::of_size(1,4), along_, 1), 2 ), 4 );
  ...
  NT2_TEST_EQUAL( nt2::size( nt2::indices(nt2::of_size(4,5), 1), 1 ), 4 );
  NT2_TEST_EQUAL( nt2::size( nt2::indices(nt2::of_size(4,5), 1), 2 ), 5 );
  NT2_TEST_EQUAL( nt2::extent( nt2::indices(nt2::of_size(4,1), 1) ), nt2::of_size(4,1 ) );
  NT2_TEST_EQUAL( nt2::size( nt2::indices(nt2::of_size(4,1), 1), 1 ), 4 );
  NT2_TEST_EQUAL( nt2::size( nt2::indices(nt2::of_size(4,1), 1), 2 ), 1 );
  NT2_TEST_EQUAL( nt2::extent( nt2::indices(nt2::of_size(1,4), 1) ), nt2::of_size(1,4 ) );
  NT2_TEST_EQUAL( nt2::size( nt2::indices(nt2::of_size(1,4), 1), 1 ), 1 );
  NT2_TEST_EQUAL( nt2::size( nt2::indices(nt2::of_size(1,4), 1), 2 ), 4 );

  NT2_TEST_EQUAL( nt2::extent( nt2::indices(nt2::of_size(4,5,2), 1) ), nt2::of_size(4,5,2) );
  NT2_TEST_EQUAL( nt2::size( nt2::indices(nt2::of_size(4,5,2), 1), 1 ), 4 );
  NT2_TEST_EQUAL( nt2::size( nt2::indices(nt2::of_size(4,5,2), 1), 2 ), 5 );
  NT2_TEST_EQUAL( nt2::size( nt2::indices(nt2::of_size(4,5,2), 1), 3 ), 2 );
