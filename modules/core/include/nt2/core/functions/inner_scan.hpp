...
/*!
 * \file
 * \brief Defines and implements the nt2::inner_scan function
 */
...
namespace nt2
{
  namespace tag { struct inner_scan_ : boost::dispatch::tag::formal_ { typedef boost::dispatch::tag::formal_ parent; }; }
