 ...
 * {
 *   template <class A0>
 *     bool havesamesize(const A0 & a0);
 * }
 * \endcode
 *
 * \param a0 the first parameter of havesamesize
 * 
 * \return a bool value
 *  
**/
...
namespace nt2
{
  namespace tag
  {
    struct havesamesize_ : ext::unspecified_<havesamesize_>
    {
      typedef ext::unspecified_<havesamesize_> parent;
    };
  }
