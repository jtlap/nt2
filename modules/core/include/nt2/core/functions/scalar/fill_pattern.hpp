...
#define M0(z,n,t)                                                       \
  ...
  {                                                                     \
    typedef typename meta::call<nt2::tag::repnum_(A0,size_t,size_t) >::type type_t; \
    ...
    BOOST_FORCEINLINE result_type                                       \
      operator()(BOOST_PP_ENUM_BINARY_PARAMS(BOOST_PP_INC(n),A,         \
                                             const& a)) const           \
    {                                                                   \
      ...
      return  boost::proto::                                            \
        ...
        , container::domain                                             \
        > ( boost::cref(nt2::repnum(a0, 1u, n)), boxify(sizee) );       \
    }                                                                   \
  };                                                                    \
