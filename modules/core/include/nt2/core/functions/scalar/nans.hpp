...
//==============================================================================
#ifndef NT2_CORE_FUNCTIONS_SCALAR_NANS_HPP_INCLUDED
#define NT2_CORE_FUNCTIONS_SCALAR_NANS_HPP_INCLUDED
...
namespace nt2 { namespace ext
{
  ...
  BOOST_PP_REPEAT_FROM_TO ( 2
                          ...
                          , (nt2::tag::nans_,nt2::tag::Nan)
                          )

  NT2_PP_GENERATIVE_MAKE_FROM_SINGLE( (nt2::tag::nans_,nt2::tag::Nan) )

  //============================================================================
  // Generates nans from fusion sequence (support of_size calls)
  //============================================================================
  NT2_FUNCTOR_IMPLEMENTATION( nt2::tag::nans_, tag::cpu_
                            , (Seq)
                            ...
                            )
  {
    ...
    typedef typename  boost::proto::
                      result_of::make_expr< nt2::tag::nans_
                                          , container::domain
                                          , box<seq_t>
