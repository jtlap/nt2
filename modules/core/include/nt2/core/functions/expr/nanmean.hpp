...
namespace nt2 { namespace ext
{
                              ...
                              (ast_<A0>) )
  {
    ...
    typedef typename meta::call < nt2::tag::nansum_(A0 const &)>::type T1;
    ...
    {
      return nt2::multiplies(nt2::rec(nt2::max(nt2::nbtrue(nt2::is_not_nan(a0)), One<value_type>())), nt2::nansum(a0));
    }
  };
  NT2_FUNCTOR_IMPLEMENTATION( nt2::tag::nanmean_, tag::cpu_,
                              (A0)(A1),
