...
//==============================================================================
#ifndef NT2_CORE_FUNCTIONS_EXPR_INFS_HPP_INCLUDED
#define NT2_CORE_FUNCTIONS_EXPR_INFS_HPP_INCLUDED
...
{
  //============================================================================
  // Generates inf from expression (support size(a) + type calls)
  //============================================================================
                            ...
                            )
  {
    ...
    BOOST_FORCEINLINE result_type operator()(A0 const& a0) const
    {
      ...
      BOOST_ASSERT_MSG
      ( nt2::isrow(a0)
      , "Error using inf: Size vector must be a row vector."
      );
      ...
      return boost::proto::make_expr< nt2::tag::infs_
                                    , container::domain
                                    > ( boxify(sizee)
