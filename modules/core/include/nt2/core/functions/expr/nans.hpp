...
//==============================================================================
#ifndef NT2_CORE_FUNCTIONS_EXPR_NANS_HPP_INCLUDED
#define NT2_CORE_FUNCTIONS_EXPR_NANS_HPP_INCLUDED
...
namespace nt2 { namespace ext
{
                            ...
                            )
  {
    ...
    BOOST_FORCEINLINE result_type operator()(A0 const& a0) const
    {
      ...
      BOOST_ASSERT_MSG
      ( nt2::isrow(a0)
      , "Error using nan: Size vector must be a row vector."
      );
      ...
      return boost::proto::make_expr< nt2::tag::nans_
                                    , container::domain
                                    > ( boxify(sizee)
