...
namespace nt2 { namespace ext
{
                            ...
                            )
  {
    ...
    operator()(A0 const& a0, State const& p, Data const& t) const
    {
      ...
      ext_t       ex2 = boost::proto::child_c<2>(a0).extent();
      std::size_t s2  = nt2::numel(boost::fusion::pop_front(ex1));
      ...
      base1_t v2  = (ex2[0] == 1 )  ? expand_singleton<base2_t,2>(a0,p,s2)
                                    : gather_values<base2_t,2>(a0,p,ex2);
      // Apply the function
