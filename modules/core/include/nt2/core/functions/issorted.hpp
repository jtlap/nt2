...
//==============================================================================
#ifndef NT2_CORE_FUNCTIONS_ISSORTED_HPP_INCLUDED
#define NT2_CORE_FUNCTIONS_ISSORTED_HPP_INCLUDED
 ...
 * {
 *   template <class A0>
 *     bool issorted(const A0 & a0);
 * }
 * \endcode
 *
 * \param a0 the first parameter of issorted
 * 
 * \return a bool value
 *  
**/
...
namespace nt2
{
  namespace tag
  {
    struct issorted_ : ext::unspecified_<issorted_>
    {
      typedef ext::unspecified_<issorted_> parent;
    };
  }
