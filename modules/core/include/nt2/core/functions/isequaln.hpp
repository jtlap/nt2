 ...
 * {
 *   template <class A0>
 *     bool isequaln(const A0 & a0);
 * }
 * \endcode
 *
 * \param a0 the first parameter of isequaln
 * 
 * \return a bool value
 *  
**/
...
namespace nt2
{
  namespace tag
  {
    struct isequaln_ : ext::unspecified_<isequaln_>
    {
      typedef ext::unspecified_<isequaln_> parent;
    };
  }

  NT2_FUNCTION_IMPLEMENTATION(nt2::tag::isequaln_, isequaln, 2)
  NT2_FUNCTION_IMPLEMENTATION(nt2::tag::isequaln_, areequal, 2)      
}
