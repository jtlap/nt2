...
//==============================================================================
#ifndef NT2_INTERPOL_FUNCTIONS_GENERIC_BILINEAR_HPP_INCLUDED
#define NT2_INTERPOL_FUNCTIONS_GENERIC_BILINEAR_HPP_INCLUDED

#include <nt2/interpol/functions/bilinear.hpp>
...
{
  BOOST_DISPATCH_IMPLEMENT  ( bilinear_, tag::cpu_
                            , (A0)(A1)(A2)(A3)
  ...
  BOOST_DISPATCH_IMPLEMENT  ( run_assign_, tag::cpu_
                            ...
                            , ((ast_<A0, nt2::container::domain>))
                              ((node_<A1,nt2::tag::bilinear_,boost::mpl::long_<1>,nt2::container::domain>))
                            )
  {
  ...
  BOOST_DISPATCH_IMPLEMENT  ( run_assign_, tag::cpu_
                            , (A0)(A1)
                            , ((ast_<A0, nt2::container::domain>))
                              ((node_<A1,nt2::tag::bilinear_,boost::mpl::long_<2>,nt2::container::domain>))
                            )
  {
    typedef typename boost::proto::result_of::child_c<A1&,0>::value_type  child0;
  ...
  BOOST_DISPATCH_IMPLEMENT  ( run_assign_, tag::cpu_
                            , (A0)(A1)
                            , ((ast_<A0, nt2::container::domain>))
                              ((node_<A1,nt2::tag::bilinear_,boost::mpl::long_<4>,nt2::container::domain>))
                            )
  {
    typedef typename boost::proto::result_of::child_c<A1&,0>::value_type  child0;
    typedef typename boost::proto::result_of::child_c<A1&,1>::value_type  child1;
    ...
    result_type operator()(const A0 & zi, A1& inputs) const
    {
      ...
      using value_type = typename child0::value_type;
      using x_type = typename meta::as_real<value_type>::type;
      zi = bilinear(_(One<x_type>(), width(z)), _(One<x_type>(), height(z)),
                     z,
  ...
  BOOST_DISPATCH_IMPLEMENT  ( run_assign_, tag::cpu_
                            , (A0)(A1)
                            , ((ast_<A0, nt2::container::domain>))
                              ((node_<A1,nt2::tag::bilinear_,boost::mpl::long_<3>,nt2::container::domain>))
                            )
  {
    typedef typename boost::proto::result_of::child_c<A1&,0>::value_type  child0;
    typedef typename boost::proto::result_of::child_c<A1&,1>::value_type  child1;
  ...
  BOOST_DISPATCH_IMPLEMENT  ( run_assign_, tag::cpu_
                            , (A0)(A1)(N1)
                            , ((ast_<A0, nt2::container::domain>))
                              ((node_<A1,nt2::tag::bilinear_,N1,nt2::container::domain>))
                            )
  {
    typedef typename boost::proto::result_of::child_c<A1&,0>::value_type  child0;//x
    typedef typename boost::proto::result_of::child_c<A1&,1>::value_type  child1;//y
    typedef typename boost::proto::result_of::child_c<A1&,2>::value_type  child2;//z
    typedef typename boost::proto::result_of::child_c<A1&,3>::value_type  child3;//xi
    typedef typename boost::proto::result_of::child_c<A1&,4>::value_type  child4;//yi
    ...
    result_type operator()(A0& zi, A1& inputs) const
    {
       ...
       else
       {
         ...
         auto hi = _(1, height(z)-1);
         auto li = _(1, width(z)-1);
         auto a = z(hi, li);
         auto b = z(hi, inc(li)) - a;
         auto c = z(inc(hi), li) - a;
         auto d = z(inc(hi), inc(li)) - a - b - c;
         auto xsc = (xi - rowvect(x(indx)))/rowvect(diff(x)(indx));
         auto ysc = (yi - rowvect(y(indy)))/rowvect(diff(y)(indy));
         auto indz = sub2ind (size(a),indy,indx);
         zi =  fma(fma(d(indz), xsc, c(indz)), ysc, fma(b(indz), xsc, a(indz)));
         if (!extrap)
         {
