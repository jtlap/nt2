...
NT2_TEST_CASE_TPL( nearest5, NT2_REAL_TYPES )
{
  using nt2::_;
  nt2::table<T> x =  nt2::linspace(T(1),  T(4), 4);
  nt2::table<T> y =  repmat(nt2::trans(nt2::linspace(T(2),  T(8), 4)), 1, 3);
  nt2::table<T> xi =  nt2::linspace(T(1),  T(4), 12);
  nt2::table<T> y0= repmat(nt2::nearest(x, y(_, 1), xi), 1, 3);
  nt2::table<T> yi = nt2::nearest(x, y, xi);
  NT2_TEST_EQUAL(y0, yi);
  xi =  reshape(nt2::linspace(T(1),  T(4), 12), 3, 4);
  yi = nt2::nearest(x, y, xi);
  y0= reshape(y0, 3, 4, 3);
  NT2_TEST_EQUAL(y0, yi);
}
