...
//==============================================================================
#include <nt2/include/functions/blas_gemv.hpp>
...
NT2_TEST_CASE_TPL(blas_gemv, NT2_REAL_TYPES )
{
  using nt2::blas_gemv;
  using nt2::mtimes;
  using nt2::reshape;
  ...
  using nt2::linspace;
  {
    ...
    blas_gemv('N', alpha, boost::proto::value(a), boost::proto::value(v), 1, beta, boost::proto::value(y), 1);
...
NT2_TEST_CASE_TPL(blas_gemv2, NT2_REAL_TYPES )
{
  using nt2::blas_gemv;
  using nt2::mtimes;
  using nt2::reshape;
  ...
  using nt2::end_;
  {
    ...
    blas_gemv('N', alpha, boost::proto::value(a), boost::proto::value(v), 2, beta, boost::proto::value(y), 2);
    NT2_TEST_ULP_EQUAL(y(_(1, 2, end_), _), z, 1);

    nt2::table<T> tz= y(_(1, 2, end_), _)*beta+alpha*mtimes(trans(a), v(_(1, 2, end_), _));
    blas_gemv('T', alpha, boost::proto::value(a), boost::proto::value(v), 2, beta, boost::proto::value(y), 2);
    NT2_TEST_ULP_EQUAL(y(_(1, 2, end_), _), tz, 1);

    nt2::table<T> ctz= y(_(1, 2, end_), _)*beta+alpha*mtimes(ctrans(a), v(_(1, 2, end_), _));
    blas_gemv('C', alpha, boost::proto::value(a), boost::proto::value(v), 2, beta, boost::proto::value(y), 2);
  ...
  }
  {
    ...
    blas_gemv('N', alpha, boost::proto::value(a), boost::proto::value(v), 2, beta, boost::proto::value(y), 2);
    NT2_TEST_ULP_EQUAL(y(_(1, 2, end_), _), z, 12);
