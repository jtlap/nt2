...
//==============================================================================
#include <nt2/include/functions/blas_her.hpp>
...
NT2_TEST_CASE_TPL(blas_her, NT2_REAL_TYPES )
{
  using nt2::blas_her;
  using nt2::reshape;
  using nt2::_;
  ...
  using nt2::average;
  {
    ...
    blas_her('U', alpha, boost::proto::value(x), 1, boost::proto::value(a));
    NT2_TEST_ULP_EQUAL(triu(a), triu(z), 0.5);
    a = a1;
    z = alpha*mtimes(x, trans(x))+a;
    blas_her('L', alpha, boost::proto::value(x), 1, boost::proto::value(a));
