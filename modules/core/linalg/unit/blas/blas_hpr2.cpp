...
//==============================================================================
#include <nt2/include/functions/blas_hpr2.hpp>
...
NT2_TEST_CASE_TPL(blas_hpr2, NT2_REAL_TYPES )
{
  using nt2::blas_hpr2;
  using nt2::reshape;
  using nt2::_;
  ...
  using nt2::conj;
  {
    ...
    blas_hpr2('U',  alpha, boost::proto::value(x), 1, boost::proto::value(y), 1, boost::proto::value(pa));
    nt2::table<T> zz = nt2::blas_pack('U',z);
    NT2_TEST_ULP_EQUAL(zz, pa, 0.5);
    pa =  nt2::blas_pack('L', a1);
    z = alpha*mtimes(x, trans(y))+alpha*mtimes(y, trans(x))+a;
    blas_hpr2('L', alpha, boost::proto::value(x), 1, boost::proto::value(y), 1, boost::proto::value(pa));
    zz = nt2::blas_pack('L',z);
...

  {
    ...
    NT2_TEST_ULP_EQUAL(zz, pa, 5);
    a = a1;
    pa = nt2::blas_pack('L', a);
    z = alpha*mtimes(x, ctrans(y))+conj(alpha)*mtimes(y, ctrans(x))+a;
    blas_hpr2('L', alpha, boost::proto::value(x), 1, boost::proto::value(y), 1, boost::proto::value(pa));
    zz = nt2::blas_pack('L',z);
    NT2_TEST_ULP_EQUAL(pa, zz, 5);
