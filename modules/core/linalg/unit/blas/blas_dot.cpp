...
//==============================================================================
#include <nt2/include/functions/blas_dot.hpp>
...
NT2_TEST_CASE_TPL(blas_dot, NT2_REAL_TYPES )
{
  using nt2::blas_dot;
  {
  ...
  }
  {
    ...
    NT2_DISPLAY(x);
    NT2_DISPLAY(y);
    cT p =blas_dot(numel(x), boost::proto::value(x), 1,  boost::proto::value(y), 1);
    NT2_TEST_ULP_EQUAL(p, nt2::dot(x, y), 2);
  }
}

NT2_TEST_CASE_TPL(blas_dot2, NT2_REAL_TYPES )
{
  using nt2::blas_dot;
  using nt2::_;
  using nt2::end_;
