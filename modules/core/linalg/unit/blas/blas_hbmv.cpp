...
//==============================================================================
#include <nt2/include/functions/blas_hbmv.hpp>
...
NT2_TEST_CASE_TPL(blas_hbmvu, NT2_REAL_TYPES )
{
  using nt2::blas_hbmv;
  using nt2::mtimes;
  using nt2::reshape;
  ...
  using nt2::linspace;
  {
    ...
    blas_hbmv('U', alpha, boost::proto::value(pa), boost::proto::value(v), 1, beta, boost::proto::value(y), 1);
    NT2_TEST_ULP_EQUAL(y, z, 1);
  }
  {
    typedef std::complex<T> cT;
    nt2::table<cT> b = reshape(linspace(cT(1, 1), cT(4, 0), 25), 5, 5);
    nt2::table<cT> a =  nt2::band(nt2::average(b, ctrans(b)), -2, 2);;
    nt2::table<cT> pa = nt2::blas_band_h('U', a, 2);
    nt2::table<cT> v = reshape(linspace(cT(0, 1), cT(5, 5), 5), 5, 1);
...
NT2_TEST_CASE_TPL(blas_hbmvl, NT2_REAL_TYPES )
{
  using nt2::blas_hbmv;
  using nt2::mtimes;
  using nt2::reshape;
  ...
  using nt2::linspace;
  {
    ...
    blas_hbmv('L', alpha, boost::proto::value(pa), boost::proto::value(v), 1, beta, boost::proto::value(y), 1);
  ...
  }
  {
    ...
    nt2::table<cT> b = reshape(linspace(cT(1, 1), cT(4, 0), 25), 5, 5);
    nt2::table<cT> a =  nt2::band(nt2::average(b, ctrans(b)), -2, 2);;
    nt2::table<cT> pa = nt2::blas_band_h('L', a, 2);
    NT2_DISPLAY(a);
    nt2::table<cT> v = reshape(linspace(cT(0, 1), cT(5, 5), 5), 5, 1);
    nt2::table<cT> y = reshape(linspace(cT(0, 1), cT(1, 0), 5), 5, 1);
    cT alpha =  cT(5, 1);
...
NT2_TEST_CASE_TPL(blas_hbmvu2, NT2_REAL_TYPES )
{
  using nt2::blas_hbmv;
  using nt2::mtimes;
  using nt2::reshape;
  ...
  using nt2::end_;
  {
    ...
    blas_hbmv('U', alpha, boost::proto::value(pa), boost::proto::value(v), 2, beta, boost::proto::value(y), 2);
  ...
  }
  {
    ...
    nt2::table<cT> a = nt2::band(nt2::average(b, ctrans(b)), -2, 2);;
    nt2::table<cT> pa = nt2::blas_band_h('U', a, 2);
    nt2::table<cT> v = reshape(linspace(cT(0, 1), cT(5), 10), 10, 1);
...
NT2_TEST_CASE_TPL(blas_hbmvl2, NT2_REAL_TYPES )
{
  using nt2::blas_hbmv;
  using nt2::mtimes;
  using nt2::reshape;
  ...
  using nt2::end_;
  {
    ...
    blas_hbmv('L', alpha, boost::proto::value(pa), boost::proto::value(v), 2, beta, boost::proto::value(y), 2);
