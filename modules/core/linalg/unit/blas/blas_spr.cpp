...
//==============================================================================
#include <nt2/include/functions/blas_spr.hpp>
...
NT2_TEST_CASE_TPL(blas_spr, NT2_REAL_TYPES )
{
  using nt2::blas_spr;
  using nt2::reshape;
  using nt2::_;
  ...
  using nt2::average;
  {
    ...
    blas_spr('U', alpha, boost::proto::value(x), 1, boost::proto::value(pa));
  ...
  }
  {
    ...
    T alpha = T(2);
    nt2::table<T> z = alpha*mtimes(x, trans(x))+a;
    blas_spr('L', alpha, boost::proto::value(x), 1, boost::proto::value(pa));
