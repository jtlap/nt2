...
//==============================================================================
#include <nt2/include/functions/blas_hpmv.hpp>
...
NT2_TEST_CASE_TPL(blas_hpmvu, NT2_REAL_TYPES )
{
  using nt2::blas_hpmv;
  using nt2::mtimes;
  using nt2::reshape;
  ...
  using nt2::linspace;
  {
    ...
    blas_hpmv('U', alpha, boost::proto::value(pa), boost::proto::value(v), 1, beta, boost::proto::value(y), 1);
...
NT2_TEST_CASE_TPL(blas_hpmvl, NT2_REAL_TYPES )
{
  using nt2::blas_hpmv;
  using nt2::mtimes;
  using nt2::reshape;
  ...
  using nt2::linspace;
  {
    ...
    blas_hpmv('L', alpha, boost::proto::value(pa), boost::proto::value(v), 1, beta, boost::proto::value(y), 1);
...
NT2_TEST_CASE_TPL(blas_hpmvu2, NT2_REAL_TYPES )
{
  using nt2::blas_hpmv;
  using nt2::mtimes;
  using nt2::reshape;
  ...
  using nt2::end_;
  {
    ...
    blas_hpmv('U', alpha, boost::proto::value(pa), boost::proto::value(v), 2, beta, boost::proto::value(y), 2);
...
NT2_TEST_CASE_TPL(blas_hpmvl2, NT2_REAL_TYPES )
{
  using nt2::blas_hpmv;
  using nt2::mtimes;
  using nt2::reshape;
  ...
  using nt2::end_;
  {
    ...
    blas_hpmv('L', alpha, boost::proto::value(pa), boost::proto::value(v), 2, beta, boost::proto::value(y), 2);
