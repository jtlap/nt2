...
//==============================================================================
#include <nt2/include/functions/blas_hemm.hpp>
...
NT2_TEST_CASE_TPL(blas_hemm, NT2_REAL_TYPES )
{
  using nt2::blas_hemm;
  using nt2::mtimes;
  using nt2::reshape;
  ...
  using nt2::of_size;
  {
    ...
    nt2::table<T> a =  average(a1, ctrans(a1));
    nt2::table<T> b = reshape(_(T(1), T(6)), 3, 2);
    nt2::table<T> c = reshape(_(T(0), T(5)), 3, 2);
    T alpha = T(2);
    T beta =  T(3);
    nt2::table<T> z = c*beta+alpha*mtimes(a, b);
    blas_hemm('L', 'U', alpha, boost::proto::value(a), boost::proto::value(b), beta, boost::proto::value(c));
  ...
  }
  {
    ...
    T beta =  T(3);
    nt2::table<T> z = c*beta+alpha*mtimes(a, b);
    blas_hemm('L', 'L', alpha, boost::proto::value(a), boost::proto::value(b), beta, boost::proto::value(c));
    NT2_TEST_ULP_EQUAL(c, z, 1);
  }

  {
    ...
    blas_hemm('R', 'U', alpha, boost::proto::value(a), boost::proto::value(b), beta, boost::proto::value(c));
    NT2_TEST_ULP_EQUAL(c, z, 1);
  }
  {
    nt2::table<T> a1 = reshape(_(T(1), T(9)), 3, 3);
    ...
    T beta =  T(3);
    nt2::table<T> z = c*beta+alpha*mtimes(b, a);
    blas_hemm('R', 'L', alpha, boost::proto::value(a), boost::proto::value(b), beta, boost::proto::value(c));
    NT2_TEST_ULP_EQUAL(c, z, 1);
  }
}


NT2_TEST_CASE_TPL(blas_hemmc, NT2_REAL_TYPES )
{
  using nt2::blas_hemm;
  using nt2::mtimes;
  using nt2::reshape;
...

  {
    ...
    nt2::table<cT> a =  average(a1, ctrans(a1));
