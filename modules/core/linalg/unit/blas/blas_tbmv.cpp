...
//==============================================================================
#include <nt2/include/functions/blas_tbmv.hpp>
...
NT2_TEST_CASE_TPL(blas_tbmv, NT2_REAL_TYPES )
{
  using nt2::blas_tbmv;
  using nt2::mtimes;
  using nt2::reshape;
  ...
  using nt2::linspace;
  {
    ...
    blas_tbmv('U', 'N', 'N', boost::proto::value(ta), boost::proto::value(x), 1);
    NT2_TEST_ULP_EQUAL(x, z, 1);

    x = x1;
    z = mtimes(tri1u(a), x1);
    blas_tbmv('U', 'N', 'U', boost::proto::value(ta), boost::proto::value(x), 1);
    NT2_TEST_ULP_EQUAL(x, z, 1);

    x = x1;
    z = mtimes(trans(triu(a)), x1);
    blas_tbmv('U', 'T', 'N', boost::proto::value(ta), boost::proto::value(x), 1);
    NT2_TEST_ULP_EQUAL(x, z, 1);

    x = x1;
    z = mtimes(trans(tri1u(a)), x1);
    blas_tbmv('U', 'T', 'U', boost::proto::value(ta), boost::proto::value(x), 1);
    NT2_TEST_ULP_EQUAL(x, z, 1);
    ...
    x1 = x;
    z = mtimes(tril(a), x1);
    blas_tbmv('L', 'N', 'N', boost::proto::value(ta), boost::proto::value(x), 1);
    NT2_TEST_ULP_EQUAL(x, z, 1);

    x = x1;
    z = mtimes(tri1l(a), x1);
    blas_tbmv('L', 'N', 'U', boost::proto::value(ta), boost::proto::value(x), 1);
    NT2_TEST_ULP_EQUAL(x, z, 1);

    x = x1;
    z = mtimes(trans(tril(a)), x1);
    blas_tbmv('L', 'T', 'N', boost::proto::value(ta), boost::proto::value(x), 1);
    NT2_TEST_ULP_EQUAL(x, z, 1);

    x = x1;
    z = mtimes(trans(tri1l(a)), x1);
    blas_tbmv('L', 'T', 'U', boost::proto::value(ta), boost::proto::value(x), 1);
    NT2_TEST_ULP_EQUAL(x, z, 1);
  }
