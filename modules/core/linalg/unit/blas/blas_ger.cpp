...
//==============================================================================
#include <nt2/include/functions/blas_ger.hpp>
...
NT2_TEST_CASE_TPL(blas_ger, NT2_REAL_TYPES )
{
  using nt2::blas_ger;
  using nt2::reshape;
  using nt2::_;
  ...
  using nt2::dot;
  {
    ...
    blas_ger( alpha, boost::proto::value(x), 1, boost::proto::value(y), 1, boost::proto::value(a));
...

  {
    ...
    cT alpha = cT(2, 2);
    nt2::table<cT> z = alpha*mtimes(x, ctrans(y))+a;
    blas_ger( alpha, boost::proto::value(x), 1, boost::proto::value(y), 1, boost::proto::value(a));
    NT2_TEST_ULP_EQUAL(a, z, 0.5);
   }
}
