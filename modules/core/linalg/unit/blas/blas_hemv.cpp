...
//==============================================================================
#include <nt2/include/functions/blas_hemv.hpp>
...
NT2_TEST_CASE_TPL(blas_hemvu, NT2_REAL_TYPES )
{
  using nt2::blas_hemv;
  using nt2::mtimes;
  using nt2::reshape;
  ...
  using nt2::linspace;
  {
    ...
    blas_hemv('U', alpha, boost::proto::value(a), boost::proto::value(v), 1, beta, boost::proto::value(y), 1);
...
NT2_TEST_CASE_TPL(blas_hemvl, NT2_REAL_TYPES )
{
  using nt2::blas_hemv;
  using nt2::mtimes;
  using nt2::reshape;
  ...
  using nt2::linspace;
  {
    ...
    blas_hemv('L', alpha, boost::proto::value(a), boost::proto::value(v), 1, beta, boost::proto::value(y), 1);
...
NT2_TEST_CASE_TPL(blas_hemvu2, NT2_REAL_TYPES )
{
  using nt2::blas_hemv;
  using nt2::mtimes;
  using nt2::reshape;
  ...
  using nt2::end_;
  {
    ...
    blas_hemv('U', alpha, boost::proto::value(a), boost::proto::value(v), 2, beta, boost::proto::value(y), 2);
...
NT2_TEST_CASE_TPL(blas_hemvl2, NT2_REAL_TYPES )
{
  using nt2::blas_hemv;
  using nt2::mtimes;
  using nt2::reshape;
  ...
  using nt2::end_;
  {
    ...
    blas_hemv('L', alpha, boost::proto::value(a), boost::proto::value(v), 2, beta, boost::proto::value(y), 2);
