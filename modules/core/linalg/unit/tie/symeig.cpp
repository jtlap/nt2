...
NT2_TEST_CASE_TPL ( symeig_no_1i, NT2_REAL_TYPES)
{
  ...
  NT2_TEST_ULP_EQUAL(b, nt2::mtimes(v, nt2::mtimes(d, nt2::trans(v))), 15.0);

  std::cout << "12 w = nt2::symeig(b);" << std::endl;
  w = nt2::symeig(b);
  NT2_TEST_ULP_EQUAL(w, nt2::diag_of(d), 15.0);
}
...
NT2_TEST_CASE_TPL ( symeig_no_2i, NT2_REAL_TYPES)
{
  ...
  NT2_TEST_ULP_EQUAL(w, d, 15.0);

  std::cout << "27 nt2::tie(d, v) = nt2::symeig(b, nt2::vector_);" << std::endl;
  nt2::tie(d, v) = nt2::symeig(b, nt2::vector_);
  NT2_TEST_ULP_EQUAL(b, nt2::mtimes(v, nt2::mtimes(nt2::from_diag(d), nt2::trans(v))), 15.0);
...
NT2_TEST_CASE_TPL ( symeig_no_1i_sub, NT2_REAL_TYPES)
{
  ...
  NT2_TEST_ULP_EQUAL(b, nt2::mtimes(v(_(1, 2, 8), _), nt2::mtimes(d(_(1, 2, 8), _), nt2::trans(v(_(1, 2, 8), _)))), 15.0);

  std::cout << "sub12 w(_(1, 2, 8)) = nt2::symeig(b);" << std::endl;
  w(_(1, 2, 8)) = nt2::symeig(b);
  NT2_TEST_ULP_EQUAL(w(_(1, 2, 8)), nt2::diag_of(d(_(1, 2, 8), _)), 15.0);
}
...
NT2_TEST_CASE_TPL ( symeig_no_2i_sub, NT2_REAL_TYPES)
{
  ...
  NT2_TEST_ULP_EQUAL(b, nt2::mtimes(v(_(1, 2, 8), _), nt2::mtimes(nt2::from_diag(dd(_(1, 2, 8))), nt2::trans(v(_(1, 2, 8), _)))), 15.0);

  std::cout << "sub28 w(_(1, 2, 8)) = nt2::symeig(b, nt2::vector_);" << std::endl;
  w(_(1, 2, 8)) = nt2::symeig(b, nt2::vector_);
  NT2_DISPLAY(w);
  NT2_DISPLAY(dd);
  NT2_TEST_ULP_EQUAL(w(_(1, 2, 8)), dd(_(1, 2, 8)), 15.0);
...
NT2_TEST_CASE_TPL ( symeig_no_3i_sub, NT2_REAL_TYPES)
{
  ...
  NT2_TEST_ULP_EQUAL(ww(_(1, 2, 8), _), d(_(1, 2, 8), _), 15.0);
