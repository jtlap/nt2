...
{
  using nt2::mnorminf;
  using nt2::tag::mnorminf_;
  NT2_TEST_ULP_EQUAL(mnorminf(T(-3)),  nt2::Three<T>(), 0);
  nt2::table<T> n = nt2::ones(1, 10, nt2::meta::as_<T>());
  NT2_TEST_ULP_EQUAL(mnorminf(n),  nt2::Ten<T>(), 0);
  nt2::table<T> n1 = nt2::ones(10, 1, nt2::meta::as_<T>());
  NT2_TEST_ULP_EQUAL(mnorminf(n1),  nt2::One<T>(), 0);
  nt2::table<T> a = nt2::ones(10, 10, nt2::meta::as_<T>());
  NT2_TEST_ULP_EQUAL(mnorminf(a), nt2::Ten<T>(), 0);
  nt2::table<T, nt2::of_size_<1,10> > ns=  n;
  NT2_TEST_ULP_EQUAL(mnorminf(ns),  nt2::Ten<T>(), 0);
  nt2::table<T, nt2::of_size_<10,1> > ns1 = n1;
  NT2_TEST_ULP_EQUAL(mnorminf(ns1),  nt2::One<T>(), 0);
  nt2::table<T, nt2::of_size_<10,10> > as = a;
  NT2_TEST_ULP_EQUAL(mnorminf(as), nt2::Ten<T>(), 0);
...
NT2_TEST_CASE_TPL(norm_c, NT2_REAL_TYPES)
{
  ...
  NT2_TEST_ULP_EQUAL(mnorminf(cT(-3)),  nt2::Three<T>(), 0);
