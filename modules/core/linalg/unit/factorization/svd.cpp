...
NT2_TEST_CASE_TPL(svdc, NT2_REAL_TYPES )
{
  ...
  // [U,S,V] = SVD(A,0)
  a0 = nt2::cons<cT>(nt2::of_size(4,2),cT(1,0),cT(2,1),cT(5,0),cT(7,0),cT(2,0),cT(4,0),cT(6,0),cT(8,0));

  nt2::tie(u,s1,v) = svd(a0,0);
  NT2_TEST_ULP_EQUAL(nt2::mtimes(nt2::mtimes(u,s1),nt2::trans(v)), a0,T(20));

  // [U,S,V] = SVD(A,econ)
  a0 = nt2::cons<cT>(nt2::of_size(2,4),cT(1,0),cT(2,1),cT(5,0),cT(7,0),cT(2,0),cT(4,0),cT(6,0),cT(8,0));
