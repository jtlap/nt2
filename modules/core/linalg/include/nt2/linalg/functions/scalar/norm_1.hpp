...
//==============================================================================
#ifndef NT2_LINALG_FUNCTIONS_SCALAR_NORM_1_HPP_INCLUDED
#define NT2_LINALG_FUNCTIONS_SCALAR_NORM_1_HPP_INCLUDED
#include <nt2/linalg/functions/norm_1.hpp>
...
{
  NT2_FUNCTOR_IMPLEMENTATION( nt2::tag::norm_1_, tag::cpu_,
                              (A0),
                            ...
                            )
  {
    ...
    {
      return nt2::asum1(a0(nt2::_));
    }

    template < class T >
    BOOST_FORCEINLINE result_type eval(const A0 & a0, const T &)
    {
      BOOST_MPL_ASSERT_MSG((false), UNKNOWN_OPTION_TO_NORM_1, (T));
