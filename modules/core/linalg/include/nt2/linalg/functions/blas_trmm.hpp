...
//==============================================================================
#ifndef NT2_LINALG_FUNCTIONS_BLAS_TRMM_HPP_INCLUDED
#define NT2_LINALG_FUNCTIONS_BLAS_TRMM_HPP_INCLUDED
...
namespace nt2
{
  namespace tag
  {
    ...
    struct blas_trmm_ : ext::abstract_<blas_trmm_>
    {
      /// INTERNAL ONLY
      typedef ext::abstract_<blas_trmm_> parent;
      template<class... Args>
      static BOOST_FORCEINLINE BOOST_AUTO_DECLTYPE dispatch(Args&&... args)
      BOOST_AUTO_DECLTYPE_BODY( dispatching_blas_trmm_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site>
    BOOST_FORCEINLINE generic_dispatcher<tag::blas_trmm_, Site> dispatching_blas_trmm_(adl_helper, boost::dispatch::meta::unknown_<Site>, ...)
    {
      return generic_dispatcher<tag::blas_trmm_, Site>();
    }
    template<class... Args>
    struct impl_blas_trmm_;
  }

  /*!
    @brief  trmm  - perform one of the matrix-matrix operations
  ...
  **/
  NT2_FUNCTION_IMPLEMENTATION_TPL (tag::blas_trmm_, blas_trmm
