...
//==============================================================================
#ifndef NT2_LINALG_FUNCTIONS_BLAS_HBMV_HPP_INCLUDED
#define NT2_LINALG_FUNCTIONS_BLAS_HBMV_HPP_INCLUDED

/*!
  @file
  @brief Defines and implements blas_hbmv function
**/
...
namespace nt2
{
  namespace tag
  {
    /// @brief Defines blas_hbmv function tag
    struct blas_hbmv_ : ext::abstract_<blas_hbmv_>
    {
      /// INTERNAL ONLY
      typedef ext::abstract_<blas_hbmv_> parent;
      template<class... Args>
      static BOOST_FORCEINLINE BOOST_AUTO_DECLTYPE dispatch(Args&&... args)
      BOOST_AUTO_DECLTYPE_BODY( dispatching_blas_hbmv_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site>
    BOOST_FORCEINLINE generic_dispatcher<tag::blas_hbmv_, Site> dispatching_blas_hbmv_(adl_helper, boost::dispatch::meta::unknown_<Site>, ...)
    {
      return generic_dispatcher<tag::blas_hbmv_, Site>();
    }
    template<class... Args>
    struct impl_blas_hbmv_;
  }
  ...
  **/
  NT2_FUNCTION_IMPLEMENTATION_TPL (tag::blas_hbmv_, blas_hbmv
