...
//==============================================================================
#ifndef NT2_LINALG_FUNCTIONS_TIED_SYMEIG_HPP_INCLUDED
#define NT2_LINALG_FUNCTIONS_TIED_SYMEIG_HPP_INCLUDED

#include <nt2/linalg/functions/symeig.hpp>
#include <nt2/linalg/functions/factorizations/symeig.hpp>
...
namespace nt2 { namespace ext
{
  ...
  NT2_FUNCTOR_IMPLEMENTATION( nt2::tag::symeig_, tag::cpu_
                            , (A0)(N0)(A1)(N1)
                            , ((node_<A0, nt2::tag::symeig_, N0, nt2::container::domain>))
                            ...
                            )
  {
    ...
    typedef typename meta::
            call< nt2::tag::
                  factorization::symeig_(child0,char,char,nt2::ext::in_place_)
                >::type                                             fact_t;
    ...
    BOOST_FORCEINLINE result_type operator()( A0& a0, A1& a1 ) const
    {
      ...
      // Factorize in place
      fact_t f = factorization::symeig(boost::proto::child_c<0>(a1),jobz,uplo,nt2::in_place_);
      decomp(f, a1, N1());
    }
