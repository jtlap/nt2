...
//==============================================================================
#ifndef NT2_LINALG_FUNCTIONS_TIED_FULL_QR_SOLVE_HPP_INCLUDED
#define NT2_LINALG_FUNCTIONS_TIED_FULL_QR_SOLVE_HPP_INCLUDED

#include <nt2/linalg/functions/full_qr_solve.hpp>
#include <nt2/linalg/functions/solvers/full_qr_solve.hpp>
...
namespace nt2 { namespace ext
{
  ...
  NT2_FUNCTOR_IMPLEMENTATION( nt2::tag::full_qr_solve_, tag::cpu_
                              , (A0)(N0)(A1)(N1)
                              , ((node_<A0, nt2::tag::full_qr_solve_, N0, nt2::container::domain>))
