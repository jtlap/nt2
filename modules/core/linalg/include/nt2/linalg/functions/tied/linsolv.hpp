...
//==============================================================================
#ifndef NT2_TOOLBOX_LINALG_FUNCTIONS_TIED_LINSOLV_HPP_INCLUDED
#define NT2_TOOLBOX_LINALG_FUNCTIONS_TIED_LINSOLV_HPP_INCLUDED
...
namespace nt2 { namespace ext
{
  ...
  // LINSOLVE
  //============================================================================
  NT2_FUNCTOR_IMPLEMENTATION( nt2::tag::linsolv_, tag::cpu_
                            , (A0)(N0)(A1)(N1)
                            , ((node_<A0, nt2::tag::linsolv_
                            ...
                            )
  {
   ...
   //==========================================================================
    /// INTERNAL ONLY - X = LINSOLVE(A,B,opts) - Matrix must be square here /test
    //For matlab type opts(shape structure) add a dispatch case for solve_sqr
    BOOST_FORCEINLINE
