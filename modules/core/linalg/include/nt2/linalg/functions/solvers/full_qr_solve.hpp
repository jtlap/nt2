...
//==============================================================================
#ifndef NT2_LINALG_FUNCTIONS_SOLVERS_FULL_QR_SOLVE_HPP_INCLUDED
#define NT2_LINALG_FUNCTIONS_SOLVERS_FULL_QR_SOLVE_HPP_INCLUDED
...
#include <nt2/linalg/functions/details/full_qr_solve.hpp>
...
namespace nt2 { namespace ext
{
                            ...
                            )
  {
    ...
    typedef details::full_qr_solve_result< container::table<value_t,settings_t> > result_type;
