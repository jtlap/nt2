...
//==============================================================================
#ifndef NT2_TOOLBOX_LINALG_FUNCTIONS_LS_HPP_INCLUDED
#define NT2_TOOLBOX_LINALG_FUNCTIONS_LS_HPP_INCLUDED
...
namespace nt2
{
  namespace tag
  {
    ...
    struct ls_ : boost::dispatch::tag::formal_
    {
      /// INTERNAL ONLY
  ...
  /*!
    ...
    @return
  **/
  NT2_FUNCTION_IMPLEMENTATION_TPL (tag::ls_, ls
                                  , (A0&)(A1&)
                                  , 2
                                  );
  NT2_FUNCTION_IMPLEMENTATION_TPL (tag::ls_, ls
