...
//==============================================================================
#ifndef NT2_LINALG_FUNCTIONS_LINSOLV_HPP_INCLUDED
#define NT2_LINALG_FUNCTIONS_LINSOLV_HPP_INCLUDED
...
namespace nt2
{
  namespace tag
  {
    struct linsolv_ : ext::tieable_<linsolv_>
    {
      typedef ext::tieable_<linsolv_>  parent;
    };
  }
   ...
   **/
  NT2_FUNCTION_IMPLEMENTATION(tag::linsolv_, linsolv, 1)
  NT2_FUNCTION_IMPLEMENTATION(tag::linsolv_, linsolv, 2)
  NT2_FUNCTION_IMPLEMENTATION(tag::linsolv_, linsolv, 3)
}

namespace nt2 { namespace ext
{
  template<class Domain, int N, class Expr>
  struct  size_of<tag::linsolv_,Domain,N,Expr>
        : meta::size_as<Expr,0>
  {};

  template<class Domain, int N, class Expr>
  struct  value_type<tag::linsolv_,Domain,N,Expr>
