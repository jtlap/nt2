...
//==============================================================================
#ifndef NT2_LINALG_FUNCTIONS_BLAS_SYMV_HPP_INCLUDED
#define NT2_LINALG_FUNCTIONS_BLAS_SYMV_HPP_INCLUDED
...
namespace nt2
{
  namespace tag
  {
    /// @brief Defines blas_symv function tag
    struct blas_symv_ : ext::abstract_<blas_symv_>
    {
      /// INTERNAL ONLY
      typedef ext::abstract_<blas_symv_> parent;
      template<class... Args>
      static BOOST_FORCEINLINE BOOST_AUTO_DECLTYPE dispatch(Args&&... args)
      BOOST_AUTO_DECLTYPE_BODY( dispatching_blas_symv_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site>
    BOOST_FORCEINLINE generic_dispatcher<tag::blas_symv_, Site> dispatching_blas_symv_(adl_helper, boost::dispatch::meta::unknown_<Site>, ...)
    {
      return generic_dispatcher<tag::blas_symv_, Site>();
    }
    template<class... Args>
    struct impl_blas_symv_;
  }

  /*!
    @brief symv  performs  the  matrix-vector  operation y := alpha*a*x + beta*y,
  ...
  **/
  NT2_FUNCTION_IMPLEMENTATION_TPL (tag::blas_symv_, blas_symv
