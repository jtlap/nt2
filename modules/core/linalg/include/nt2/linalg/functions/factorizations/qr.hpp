...
namespace nt2 { namespace ext
{
  ...
  private:
    ...
    {
      eval1_1(a0, a1, nt2::policy<ext::lapack_>());
    }
    ...
    /// INTERNAL ONLY - [x, y] = qr(a, lapack_/matrix_/vector_/econ_/0 )
    /// with lapack_
    ///  [x, tau] = qr(a, lapack_)
