...
//==============================================================================
#ifndef NT2_LINALG_FUNCTIONS_BLAS_GEMM_HPP_INCLUDED
#define NT2_LINALG_FUNCTIONS_BLAS_GEMM_HPP_INCLUDED
...
namespace nt2
{
  namespace tag
  {
    ...
    struct blas_gemm_ : ext::abstract_<blas_gemm_>
    {
      /// INTERNAL ONLY
      typedef ext::abstract_<blas_gemm_> parent;
      template<class... Args>
      static BOOST_FORCEINLINE BOOST_AUTO_DECLTYPE dispatch(Args&&... args)
      BOOST_AUTO_DECLTYPE_BODY( dispatching_blas_gemm_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site>
    BOOST_FORCEINLINE generic_dispatcher<tag::blas_gemm_, Site> dispatching_blas_gemm_(adl_helper, boost::dispatch::meta::unknown_<Site>, ...)
    {
      return generic_dispatcher<tag::blas_gemm_, Site>();
    }
    template<class... Args>
    struct impl_blas_gemm_;
  }
