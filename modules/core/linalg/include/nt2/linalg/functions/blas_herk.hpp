...
//==============================================================================
#ifndef NT2_LINALG_FUNCTIONS_BLAS_HERK_HPP_INCLUDED
#define NT2_LINALG_FUNCTIONS_BLAS_HERK_HPP_INCLUDED

/*!
  @file
  @brief Defines and implements blas_herk function
**/
...
namespace nt2
{
  namespace tag
  {
    /// @brief Defines blas_herk function tag
    struct blas_herk_ : ext::abstract_<blas_herk_>
    {
      /// INTERNAL ONLY
      typedef ext::abstract_<blas_herk_> parent;
      template<class... Args>
      static BOOST_FORCEINLINE BOOST_AUTO_DECLTYPE dispatch(Args&&... args)
      BOOST_AUTO_DECLTYPE_BODY( dispatching_blas_herk_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site>
    BOOST_FORCEINLINE generic_dispatcher<tag::blas_herk_, Site> dispatching_blas_herk_(adl_helper, boost::dispatch::meta::unknown_<Site>, ...)
    {
      return generic_dispatcher<tag::blas_herk_, Site>();
    }
    template<class... Args>
    struct impl_blas_herk_;
  }
    ...
    c =   alpha*ctrans(a)*a + beta*c
     ...
     @param trans  - char
      ...
      @param c      -  container of dimension ( ldc, n ).
              ...
              are set to zero.
  **/
  NT2_FUNCTION_IMPLEMENTATION_TPL (tag::blas_herk_, blas_herk
