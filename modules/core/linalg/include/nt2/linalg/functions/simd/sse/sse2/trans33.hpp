...
//==============================================================================
#ifndef NT2_LINALG_FUNCTIONS_SIMD_SSE_SSE2_TRANS33_HPP_INCLUDED
#define NT2_LINALG_FUNCTIONS_SIMD_SSE_SSE2_TRANS33_HPP_INCLUDED
...
namespace nt2 { namespace ext
{
  ...
  NT2_FUNCTOR_IMPLEMENTATION( nt2::tag::trans33_, boost::simd::tag::sse2_,
                              (A0),
