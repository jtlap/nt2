...
namespace nt2 { namespace tag
  {
    ...
    **/
    struct lyapunov_ :   ext::unspecified_<lyapunov_>
    {
      ...
      BOOST_AUTO_DECLTYPE_BODY( dispatching_lyapunov_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site>
    BOOST_FORCEINLINE generic_dispatcher<tag::lyapunov_, Site> dispatching_lyapunov_(adl_helper, boost::dispatch::meta::unknown_<Site>, ...)
    {
