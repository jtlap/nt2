...
//==============================================================================
#ifndef NT2_LINALG_FUNCTIONS_BLAS_TBSV_HPP_INCLUDED
#define NT2_LINALG_FUNCTIONS_BLAS_TBSV_HPP_INCLUDED

/*!
  @file
  @brief Defines and implements blas_tbsv function
**/
...
namespace nt2
{
  namespace tag
  {
    /// @brief Defines blas_tbsv function tag
    struct blas_tbsv_ : ext::abstract_<blas_tbsv_>
    {
      /// INTERNAL ONLY
      typedef ext::abstract_<blas_tbsv_> parent;
      template<class... Args>
      static BOOST_FORCEINLINE BOOST_AUTO_DECLTYPE dispatch(Args&&... args)
      BOOST_AUTO_DECLTYPE_BODY( dispatching_blas_tbsv_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site>
    BOOST_FORCEINLINE generic_dispatcher<tag::blas_tbsv_, Site> dispatching_blas_tbsv_(adl_helper, boost::dispatch::meta::unknown_<Site>, ...)
    {
      return generic_dispatcher<tag::blas_tbsv_, Site>();
    }
    template<class... Args>
    struct impl_blas_tbsv_;
  }

  /*!
    @brief tbsv  -  solve  one  of  the systems of equations (a being a band triangular matrix)
   ...
   @param uplo   char
     ...
     @param a  container of triangular array dimension nxn in band form
   ...
   **/
  NT2_FUNCTION_IMPLEMENTATION_TPL (tag::blas_tbsv_, blas_tbsv
