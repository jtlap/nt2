...
//==============================================================================
#ifndef NT2_LINALG_FUNCTIONS_BLAS_HER2_HPP_INCLUDED
#define NT2_LINALG_FUNCTIONS_BLAS_HER2_HPP_INCLUDED

/*!
  @file
  @brief Defines and implements blas_her2 function
**/
...
namespace nt2
{
  namespace tag
  {
    /// @brief Defines blas_her2 function tag
    struct blas_her2_ : ext::abstract_<blas_her2_>
    {
      /// INTERNAL ONLY
      typedef ext::abstract_<blas_her2_> parent;
      template<class... Args>
      static BOOST_FORCEINLINE BOOST_AUTO_DECLTYPE dispatch(Args&&... args)
      BOOST_AUTO_DECLTYPE_BODY( dispatching_blas_her2_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site>
    BOOST_FORCEINLINE generic_dispatcher<tag::blas_her2_, Site> dispatching_blas_her2_(adl_helper, boost::dispatch::meta::unknown_<Site>, ...)
    {
      return generic_dispatcher<tag::blas_her2_, Site>();
    }
    template<class... Args>
    struct impl_blas_her2_;
  }
  ...
  **/
  NT2_FUNCTION_IMPLEMENTATION_TPL (tag::blas_her2_, blas_her2
