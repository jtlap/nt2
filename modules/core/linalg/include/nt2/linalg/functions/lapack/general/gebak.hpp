...
extern "C"
{
      void NT2_F77NAME(cgebak)(const char* job             , const char* side
                              , const nt2_la_int* n        , const nt2_la_int* ilo
                              , const nt2_la_int* ihi      , const float* scale
                              , const nt2_la_int* m        , nt2_la_complex* v
                              , const nt2_la_int* ldv      , nt2_la_int* info
                              );
      void NT2_F77NAME(dgebak)(const char* job             , const char* side
                              , const nt2_la_int* n        , const nt2_la_int* ilo
                              , const nt2_la_int* ihi      , const double* scale
                              , const nt2_la_int* m        , double* v
                              , const nt2_la_int* ldv      , nt2_la_int* info
                              );
      void NT2_F77NAME(sgebak)(const char* job             , const char* side
                              , const nt2_la_int* n        , const nt2_la_int* ilo
                              , const nt2_la_int* ihi      , const float* scale
                              , const nt2_la_int* m        , float* v
                              , const nt2_la_int* ldv      , nt2_la_int* info
                              );
      void NT2_F77NAME(zgebak)(const char* job             , const char* side
                              , const nt2_la_int* n        , const nt2_la_int* ilo
                              , const nt2_la_int* ihi      , const double* scale
                              , const nt2_la_int* m        , nt2_la_complex* v
                              , const nt2_la_int* ldv      , nt2_la_int* info
