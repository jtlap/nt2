...
//==============================================================================
#ifndef NT2_TOOLBOX_LINALG_FUNCTIONS_LAPACK_GESVD_HPP_INCLUDED
#define NT2_TOOLBOX_LINALG_FUNCTIONS_LAPACK_GESVD_HPP_INCLUDED
...
namespace nt2 { namespace ext
{
  ...
  NT2_FUNCTOR_IMPLEMENTATION( nt2::tag::gesvd_, tag::cpu_
                            ...
                            , ((expr_ < container_<nt2::tag::table_,  double_<A0>, S0 >
                              ...
                              ((expr_ < container_<nt2::tag::table_,  double_<A3>, S3 >
                                      , nt2::tag::terminal_
                                      , boost::mpl::long_<0>
                                      >
                              ))
