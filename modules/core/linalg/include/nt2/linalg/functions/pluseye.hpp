...
namespace nt2
{
  ...
  namespace ext
  {
      ...
      BOOST_FORCEINLINE generic_dispatcher<tag::pluseye_, Site> dispatching_pluseye_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<H>...)
      {
