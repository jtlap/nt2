...
//==============================================================================
#ifndef NT2_LINALG_FUNCTIONS_BLAS_BLAS2_HER2_HPP_INCLUDED
#define NT2_LINALG_FUNCTIONS_BLAS_BLAS2_HER2_HPP_INCLUDED

#include <nt2/linalg/functions/blas_her2.hpp>
...
//---------------------------------------------Real-single------------------------------------------------//
  ...
  BOOST_DISPATCH_IMPLEMENT  ( blas_her2_, tag::cpu_
