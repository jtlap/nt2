...
//==============================================================================
#ifndef NT2_LINALG_FUNCTIONS_BLAS_BLAS2_SPR_HPP_INCLUDED
#define NT2_LINALG_FUNCTIONS_BLAS_BLAS2_SPR_HPP_INCLUDED

#include <nt2/linalg/functions/blas_spr.hpp>
...
//---------------------------------------------Real-single------------------------------------------------//
  ...
  BOOST_DISPATCH_IMPLEMENT  ( blas_spr_, tag::cpu_
