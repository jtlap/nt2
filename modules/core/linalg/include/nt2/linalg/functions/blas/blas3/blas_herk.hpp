...
//==============================================================================
#ifndef NT2_LINALG_FUNCTIONS_BLAS_BLAS3_HERK_HPP_INCLUDED
#define NT2_LINALG_FUNCTIONS_BLAS_BLAS3_HERK_HPP_INCLUDED

#include <nt2/linalg/functions/blas_herk.hpp>
...
// /---------------------------------------------Real-single------------------------------------------------//
  ...
  BOOST_DISPATCH_IMPLEMENT  ( blas_herk_, tag::cpu_
