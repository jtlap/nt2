...
//==============================================================================
#ifndef NT2_LINALG_FUNCTIONS_BLAS_BLAS2_GERU_HPP_INCLUDED
#define NT2_LINALG_FUNCTIONS_BLAS_BLAS2_GERU_HPP_INCLUDED

#include <nt2/linalg/functions/blas_geru.hpp>
...
//---------------------------------------------Real-single------------------------------------------------//
  ...
  BOOST_DISPATCH_IMPLEMENT  ( blas_geru_, tag::cpu_
