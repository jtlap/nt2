...
//==============================================================================
#ifndef NT2_LINALG_FUNCTIONS_BLAS_BLAS2_TBMV_HPP_INCLUDED
#define NT2_LINALG_FUNCTIONS_BLAS_BLAS2_TBMV_HPP_INCLUDED

#include <nt2/linalg/functions/blas_tbmv.hpp>
...
// /---------------------------------------------Real-single------------------------------------------------//
  ...
  BOOST_DISPATCH_IMPLEMENT  ( blas_tbmv_, tag::cpu_
