...
//==============================================================================
#ifndef NT2_LINALG_FUNCTIONS_BLAS_UTILS_BLAS_UNBAND_H_HPP_INCLUDED
#define NT2_LINALG_FUNCTIONS_BLAS_UTILS_BLAS_UNBAND_H_HPP_INCLUDED

#include <nt2/linalg/functions/blas_unband_h.hpp>
...
namespace nt2 { namespace ext
{
  ...
  BOOST_DISPATCH_IMPLEMENT  ( blas_unband_h_, tag::cpu_,
                              (SHAPE)(UPLO)(IN)(KD),
                              (scalar_<int8_<SHAPE>>)
                              (scalar_<int8_<UPLO>>)
  ...
  BOOST_DISPATCH_IMPLEMENT  ( run_assign_, tag::cpu_
                            ...
                            , ((ast_<A0, nt2::container::domain>))
                              ((node_<A1,nt2::tag::blas_unband_h_,N,nt2::container::domain>))
                            )
  {
