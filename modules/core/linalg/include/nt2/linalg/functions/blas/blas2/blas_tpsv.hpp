...
//==============================================================================
#ifndef NT2_LINALG_FUNCTIONS_BLAS_BLAS2_TPSV_HPP_INCLUDED
#define NT2_LINALG_FUNCTIONS_BLAS_BLAS2_TPSV_HPP_INCLUDED

#include <nt2/linalg/functions/blas_tpsv.hpp>
...
// /---------------------------------------------Real-single------------------------------------------------//
  ...
  BOOST_DISPATCH_IMPLEMENT  ( blas_tpsv_, tag::cpu_
