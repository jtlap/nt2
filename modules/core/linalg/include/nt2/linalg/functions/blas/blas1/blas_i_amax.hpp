...
//==============================================================================
#ifndef NT2_LINALG_FUNCTIONS_BLAS_BLAS_I_AMAX_HPP_INCLUDED
#define NT2_LINALG_FUNCTIONS_BLAS_BLAS_I_AMAX_HPP_INCLUDED

#include <nt2/linalg/functions/blas_i_amax.hpp>
...
//---------------------------------------------Real-single------------------------------------------------//
  ...
  BOOST_DISPATCH_IMPLEMENT  ( blas_i_amax_, tag::cpu_
                            , (N)(A0)(S0)(INCX)
                            ...
                            )
  {
    ...
    BOOST_FORCEINLINE result_type operator()( const N& n
                                            , const A0& x, const INCX & incx) const
     {
       nt2_la_int in = n;
       nt2_la_int ix= incx;
       return NT2_F77NAME(isamax) (&in, x.raw(), &ix);
     }
  };
...
//---------------------------------------------Real-double------------------------------------------------//
                            ...
                            )
  {
                                     ...
                                     , const A0& x, const INCX & incx) const
    {
      nt2_la_int in = n;
      nt2_la_int ix= incx;
      return NT2_F77NAME(idamax) (&in, x.raw(), &ix);
    }
  };
                            ...
                            )
  {
    ...
    BOOST_FORCEINLINE result_type operator()( const N& n
                                     , const A0& x, const INCX & incx) const
     {
       nt2_la_int in = n;
       nt2_la_int ix= incx;
       return NT2_F77NAME(icamax) (&in, x.raw(), &ix);
     }
  };
...
//---------------------------------------------Complex-double------------------------------------------------//
                            ...
                            )
  {
                                     ...
                                     , const A0& x, const INCX & incx) const
    {
      nt2_la_int in = n;
      nt2_la_int ix= incx;
      return NT2_F77NAME(izamax) (&in, x.raw(), &ix);
    }
  };
