...
//==============================================================================
#ifndef NT2_LINALG_FUNCTIONS_BLAS_BLAS_NRM2_HPP_INCLUDED
#define NT2_LINALG_FUNCTIONS_BLAS_BLAS_NRM2_HPP_INCLUDED

#include <nt2/linalg/functions/blas_nrm2.hpp>
...
//---------------------------------------------Real-single------------------------------------------------//
  ...
  BOOST_DISPATCH_IMPLEMENT  ( blas_nrm2_, tag::cpu_
                            , (N)(A0)(S0)(INCX)
                            ...
                            )
  {
    ...
    BOOST_FORCEINLINE result_type operator()( const N& n
                                            , const A0& x, const INCX & incx) const
     {
       nt2_la_int in = n;
       nt2_la_int ix= incx;
       return NT2_F77NAME(snrm2) (&in, x.data(), &ix);
     }
  };
...
//---------------------------------------------Real-double------------------------------------------------//
                            ...
                            )
  {
                                     ...
                                     , const A0& x, const INCX & incx) const
    {
      nt2_la_int in = n;
      nt2_la_int ix= incx;
      return NT2_F77NAME(dnrm2) (&in, x.data(), &ix);
    }
  };
                            ...
                            )
  {
    ...
    BOOST_FORCEINLINE result_type operator()( const N& n
                                     , const A0& x, const INCX & incx) const
     {
       nt2_la_int in = n;
       nt2_la_int ix= incx;
       return NT2_F77NAME(scnrm2) (&in, x.data(), &ix);
     }
  };
...
//---------------------------------------------Complex-double------------------------------------------------//
                            ...
                            )
  {
                                     ...
                                     , const A0& x, const INCX & incx) const
    {
      nt2_la_int in = n;
      nt2_la_int ix= incx;
      return NT2_F77NAME(dznrm2) (&in, x.data(), &ix);
    }
  };
