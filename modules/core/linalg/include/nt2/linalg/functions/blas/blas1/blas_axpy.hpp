...
//==============================================================================
#ifndef NT2_LINALG_FUNCTIONS_BLAS_BLAS_AXPY_HPP_INCLUDED
#define NT2_LINALG_FUNCTIONS_BLAS_BLAS_AXPY_HPP_INCLUDED

#include <nt2/linalg/functions/blas_axpy.hpp>
...
//---------------------------------------------Real-single------------------------------------------------//
  ...
  BOOST_DISPATCH_IMPLEMENT  ( blas_axpy_, tag::cpu_
