                            ...
                            )
  {
    ...
    BOOST_FORCEINLINE void operator()( const N& n
                                     ...
                                     , A1& y, const INCY & incy) const
     {
       ...
       nt2_la_int ix= incx;
       nt2_la_int iy= incy;
       NT2_F77NAME(scopy) (&in, x.raw(), &ix, y.raw(), &iy);
     }
  };
...
//---------------------------------------------Real-double------------------------------------------------//
                            ...
                            )
  {
                                     ...
                                     , A1& y, const INCY & incy) const
    {
      ...
      nt2_la_int ix= incx;
      nt2_la_int iy= incy;
      NT2_F77NAME(dcopy) (&in, x.raw(), &ix, y.raw(), &iy);
    }
  };
                            ...
                            )
  {
    ...
    BOOST_FORCEINLINE void operator()( const N& n
                                     ...
                                     , A1& y, const INCY & incy) const
     {
       ...
       nt2_la_int ix= incx;
       nt2_la_int iy= incy;
       NT2_F77NAME(ccopy) (&in, x.raw(), &ix, y.raw(), &iy);
     }
  };
...
//---------------------------------------------Complex-double------------------------------------------------//
                            ...
                            )
  {
                                     ...
                                     , A1& y, const INCY & incy) const
    {
      ...
      nt2_la_int ix= incx;
      nt2_la_int iy= incy;
      NT2_F77NAME(zcopy) (&in, x.raw(), &ix, y.raw(), &iy);
    }
  };
