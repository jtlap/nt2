...
//==============================================================================
#ifndef NT2_LINALG_FUNCTIONS_BLAS_BLAS_COPY_HPP_INCLUDED
#define NT2_LINALG_FUNCTIONS_BLAS_BLAS_COPY_HPP_INCLUDED

#include <nt2/linalg/functions/blas_copy.hpp>
...
//---------------------------------------------Real-single------------------------------------------------//
  ...
  BOOST_DISPATCH_IMPLEMENT  ( blas_copy_, tag::cpu_
                            ...
                            )
  {
    ...
    BOOST_FORCEINLINE void operator()( const N& n
                                     ...
                                     , A1& y, const INCY & incy) const
     {
       ...
       nt2_la_int ix= incx;
       nt2_la_int iy= incy;
       NT2_F77NAME(scopy) (&in, x.data(), &ix, y.data(), &iy);
     }
  };
...
//---------------------------------------------Real-double------------------------------------------------//
                            ...
                            )
  {
                                     ...
                                     , A1& y, const INCY & incy) const
    {
      ...
      nt2_la_int ix= incx;
      nt2_la_int iy= incy;
      NT2_F77NAME(dcopy) (&in, x.data(), &ix, y.data(), &iy);
    }
  };
                            ...
                            )
  {
    ...
    BOOST_FORCEINLINE void operator()( const N& n
                                     ...
                                     , A1& y, const INCY & incy) const
     {
       ...
       nt2_la_int ix= incx;
       nt2_la_int iy= incy;
       NT2_F77NAME(ccopy) (&in, x.data(), &ix, y.data(), &iy);
     }
  };
...
//---------------------------------------------Complex-double------------------------------------------------//
                            ...
                            )
  {
                                     ...
                                     , A1& y, const INCY & incy) const
    {
      ...
      nt2_la_int ix= incx;
      nt2_la_int iy= incy;
      NT2_F77NAME(zcopy) (&in, x.data(), &ix, y.data(), &iy);
    }
  };
