 ...
 *         Copyright 2011-2012 LRI    UMR 8623 CNRS/Univ Pasampling Sud XI
 *
 *          Distributed under the Boost Software License, Version 1.0.
 *                 See accompanying file LICENSE.txt or copy at
 *                     http://www.boost.org/LICENSE_1_0.txt
 ******************************************************************************/
#ifndef NT2_TOOLBOX_LINALG_FUNCTIONS_GALLERY_SAMPLING_HPP_INCLUDED
#define NT2_TOOLBOX_LINALG_FUNCTIONS_GALLERY_SAMPLING_HPP_INCLUDED
#include <nt2/toolbox/linalg/functions/sampling.hpp>
