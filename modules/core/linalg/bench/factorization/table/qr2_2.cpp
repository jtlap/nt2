...
template<typename T> struct qr2_2_nt2
{
  qr2_2_nt2(std::size_t n)
              :  size_(n)
  {
  ...
  friend std::ostream& operator<<(std::ostream& os, qr2_2_nt2<T> const& p)
  {
    return os << "(" << p.size() << ")";
  }
