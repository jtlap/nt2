...
template<typename T> struct qr1_nt2
{
  qr1_nt2(std::size_t n)
              :  size_(n)
  {
  ...
  friend std::ostream& operator<<(std::ostream& os, qr1_nt2<T> const& p)
  {
    return os << "(" << p.size() << ")";
  }
