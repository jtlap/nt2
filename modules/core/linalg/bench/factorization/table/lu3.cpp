...
template<typename T> struct lu3_nt2
{
  lu3_nt2(std::size_t n)
              :  size_(n)
  {
  ...
  friend std::ostream& operator<<(std::ostream& os, lu3_nt2<T> const& p)
  {
    return os << "(" << p.size() << ")";
  }
