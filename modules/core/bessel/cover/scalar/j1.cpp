...
//==============================================================================
// cover for functor j1 in scalar mode
...
NT2_TEST_CASE_TPL(j1_0,  NT2_SIMD_REAL_TYPES)
{
  using nt2::unit::args;
  const std::size_t NR = args("samples", NT2_NB_RANDOM_TEST);
  const double ulpd = args("ulpd", 350);
  ...
  for(std::size_t i=0; i!=NR; ++i)
    ref[i] = cephes_j1l(a0[i]);

  NT2_COVER_ULP_EQUAL(nt2::tag::j1_, ((T, a0)), ref, ulpd);
