...
NT2_TEST_CASE_TPL ( df, NT2_REAL_TYPES)
{
  ...
  T x =  T(0);
  T r = T(1);
  T dfdx =  df(f, x, nt2::tag::forward_());
  NT2_TEST_ULP_EQUAL(dfdx, r,  nt2::rec(nt2::Sqrteps<T>()));

//   dfdx2 =  df(f, x,  nt2::Derivinc2<T>(), nt2::pow2den_);
//   NT2_TEST_ULP_EQUAL(dfdx2, r, nt2::rec(nt2::Sqrteps<T>()));

//   dfdx2 =  df(f, x, nt2::pow2den_);
//   NT2_TEST_ULP_EQUAL(dfdx2, r, nt2::rec(nt2::Sqrteps<T>()));
