...
namespace nt2 { namespace details
{
  ...
  struct get
  {
    ...
    static BOOST_FORCEINLINE R epsi2(const A1&, const boost::mpl::long_<2> & )
    {
      return Derivinc2<R>();
    }
    static BOOST_FORCEINLINE R epsi2(const A1& in, const boost::mpl::long_<3> & )
    {
      typedef typename boost::proto::result_of::child_c<A1&, 2>::value_type child2_t;
      typedef typename meta::is_scalar<child2_t>::type                      choose_t;
      return epsi2(in, choose_t(), boost::mpl::long_<3>());
    }
    static BOOST_FORCEINLINE R epsi2(const A1&, boost::mpl::false_, const boost::mpl::long_<3> & )
    {
      return  Derivinc2<R>();
    }
    static BOOST_FORCEINLINE R epsi2(const A1& in, boost::mpl::true_, const boost::mpl::long_<3> & )
    {
      return   boost::proto::value(boost::proto::child_c<2>(in));
    }
    static BOOST_FORCEINLINE R epsi2(const A1& in, const boost::mpl::long_<4> & )
    {
      return  boost::proto::value(boost::proto::child_c<2>(in));
    }
  };
