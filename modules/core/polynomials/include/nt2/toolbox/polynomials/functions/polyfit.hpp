...
//////////////////////////////////////////////////////////////////////////////
#ifndef NT2_TOOLBOX_POLYNOMIALS_FUNCTIONS_POLYFIT_HPP_INCLUDED
#define NT2_TOOLBOX_POLYNOMIALS_FUNCTIONS_POLYFIT_HPP_INCLUDED
 ...
 namespace nt2 { namespace ext
{
  ...
  struct  size_of<tag::polyfit_,Domain,N,Expr>
  {
    ...
    BOOST_FORCEINLINE result_type operator()(Expr& e) const
    {
      _2D sizee;
      sizee[0] = 1;
      sizee[1] = boost::proto::value(boost::proto::child_c<2>(e));
      return sizee; 
    }
  };
