...
namespace nt2 { namespace details
{
  ...
  struct gammaln_kernel < A0, float >
  {
    ...
    {
      /* log gamma(x+2), -.5 < x < .5 */
//       static const boost::array<sA0, 8 > B = {{
...
//       static const boost::array<sA0, 8 > C = {{
...
//       return polevl(x, C);
    ...
    {
//       static const boost::array<sA0, 3 > A = {{
//            6.789774945028216E-004f,
//           -2.769887652139868E-003f,
//            8.333316229807355E-002f
 //         }};
//       return polevl(p, A);
  ...
  struct gammaln_kernel < A0, double >
  {
    ...
    {
//       static const boost::array<sA0, 6 > B = {{
...
//         }};
//        static const boost::array<sA0, 7 > C = {
...
//        return polevl(x,B) / polevl(x,C);
   ...
   static BOOST_FORCEINLINE A0 gammalnA(const A0& p)
    {
//       static const boost::array<sA0, 5 > A = {{
...
//        return polevl(p, A);
      return horner<NT2_HORNER_COEFF_T(sA0, 5,
                                       (0x3f4a985027336661ll,
                                        0xbf437fbdb580e943ll,
                                        0x3f4a019f20dc5ebbll,
                                        0xbf66c16c16b0a5a1ll,
                                        0x3fb555555555554bll
                                       )
                                      )> (p);
    }
  };
