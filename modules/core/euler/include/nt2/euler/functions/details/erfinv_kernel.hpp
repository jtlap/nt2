...
//                                         )> (w);
      ...
      p =   splat < A0>(1.2858480715256400167e-18) + p*w;
      p =   splat < A0>( 1.115787767802518096e-17) + p*w;
      p =   splat < A0>(-1.333171662854620906e-16) + p*w;
      p =   splat < A0>(2.0972767875968561637e-17) + p*w;
      p =   splat < A0>(6.6376381343583238325e-15) + p*w;
      p =  splat < A0>(-4.0545662729752068639e-14) + p*w;
      p =  splat < A0>(-8.1519341976054721522e-14) + p*w;
      p =  splat < A0>( 2.6335093153082322977e-12) + p*w;
      p =  splat < A0>(-1.2975133253453532498e-11) + p*w;
      p =  splat < A0>(-5.4154120542946279317e-11) + p*w;
      p =  splat < A0>(  1.051212273321532285e-09) + p*w;
      p =  splat < A0>(-4.1126339803469836976e-09) + p*w;
      p =  splat < A0>(-2.9070369957882005086e-08) + p*w;
      p =  splat < A0>( 4.2347877827932403518e-07) + p*w;
      p =  splat < A0>(-1.3654692000834678645e-06) + p*w;
      p =  splat < A0>(-1.3882523362786468719e-05) + p*w;
      p =  splat < A0>(  0.0001867342080340571352) + p*w;
      p =  splat < A0>(-0.00074070253416626697512) + p*w;
      p =  splat < A0>( -0.0060336708714301490533) + p*w;
      p =  splat < A0>(    0.24015818242558961693) + p*w;
      p =  splat < A0>(     1.6536545626831027356) + p*w;
      return p;
    }
