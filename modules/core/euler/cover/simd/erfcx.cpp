...
//==============================================================================
// cover for functor erfcx in simd mode
...
NT2_TEST_CASE_TPL(erfcx_0,  NT2_SIMD_REAL_TYPES)
{
  ...
  const double ulpd = args("ulpd",  25);
  ...
  for(std::size_t i=0; i!=NR; ++i)
    ref[i] = nt2::erfcx(a0[i]);

  NT2_COVER_ULP_EQUAL(nt2::tag::erfcx_, ((vT, a0)), ref, ulpd);
