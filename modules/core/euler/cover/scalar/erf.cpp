...
//==============================================================================
// cover for functor erf in scalar mode
#include <nt2/euler/include/functions/erf.hpp>
#include <boost/simd/sdk/simd/io.hpp>
#include <cmath>
#include <iostream>
#include <nt2/boost_math/include/functions/erf.hpp>
...
NT2_TEST_CASE_TPL(erf_0,  NT2_SIMD_REAL_TYPES)
{
  using nt2::unit::args;
  ...
  for(std::size_t i=0; i!=NR; ++i)
    ref[i] = nt2::boost_math::erf(a0[i]);

  NT2_COVER_ULP_EQUAL(nt2::tag::erf_, ((T, a0)), ref, ulpd);
