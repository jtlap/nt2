...
namespace nt2
{
  ...
  {
    template<class Site>
    BOOST_FORCEINLINE generic_dispatcher<tag::cat_, Site> dispatching_cat_(adl_helper, boost::dispatch::meta::unknown_<Site>, ...)
    {
  ...
  **/
  ...
  template <class I, class F, class S, class... Args >
  BOOST_FORCEINLINE
  auto cat(const I & n, const F & f, const S & s, const Args&... args)
    -> decltype(cat(n, f, cat(n, s, args...)))
  {
    return cat(n, f, cat(n, s, args...));
  }
