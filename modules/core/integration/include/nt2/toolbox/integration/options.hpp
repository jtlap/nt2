...
namespace nt2 { namespace details
{
  ...
  template<typename T> struct integration_settings
  {
    ...
    integration_settings ( std::size_t it  = 100
    ...
    integration_settings ( nt2::details::option_expr<Expr> const& x)
        ...
        , absolute_tolerance(x(nt2::tolerance::absolute_, Sqrteps() ))
        , relative_tolerance(x(nt2::tolerance::relative_, Sqrteps() ))
        , residual_tolerance(x(nt2::tolerance::residual_, Sqrteps() ))
    {}
