 ...
 ******************************************************************************/
#ifndef NT2_TOOLBOX_INTEGRATION_FUNCTIONS_COMMON_INTGK_HPP_INCLUDED
#define NT2_TOOLBOX_INTEGRATION_FUNCTIONS_COMMON_INTGK_HPP_INCLUDED

#include <nt2/toolbox/integration/functions/intgk.hpp>
...
{
  template<class T, class V> class intgk_impl
  {
  public :
    typedef T                                                                input_t;
    ...
    typedef details::integration_settings<T, V, tag::intgk_>                     o_t;
...
namespace nt2 { namespace ext
                {
                  NT2_FUNCTOR_IMPLEMENTATION( nt2::tag::intgk_, tag::cpu_
                                              , (F)(X)(O)
                                              , (unspecified_< F >)
    ...
    )
  {
    ...
    {
      details::intgk_impl<input_t, value_t> q;
