...
//==============================================================================
#ifndef NT2_TOOLBOX_INTEGRATION_FUNCTIONS_ROMBERG_HPP_INCLUDED
#define NT2_TOOLBOX_INTEGRATION_FUNCTIONS_ROMBERG_HPP_INCLUDED
...
namespace nt2
{
  ...
  typename details::integration<F, X, tag::romberg_>::result_type
  romberg(F f, X x, nt2::details::option_expr<Xpr> const& opt)
  {
