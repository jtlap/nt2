...
/*!
 * \file
 * \brief Defines and implements the nt2::qmtc function
 */
...
namespace nt2
{
  ...
  //============================================================================
  /*!
   * Apply qmtc algorithm to integrate a function over a real hyper-rectangle
   *
   ...
   *
   *    q = qmtc(f,ranges, opt) tries to approximate the n superposed integrals
   ...
   * 4 - As qmtc uses a random generator the result can vary between call for
   *     the same inputs
   */
  //============================================================================
