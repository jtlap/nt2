...
//   nt2::tic();
//   BOOST_AUTO_TPL(res, (integration_call<T, T, f, nt2::tag::quad_, tab_t>::integ_call(f(), x)));
//   nt2::toc();
//   std::cout << "Integrals:" << res.integrals << ") with error " << res.errors
//             << " after " << res.eval_count <<  " evaluations\n";
//   NT2_DISPLAY(nt2::Quadabstol<T>());
//   NT2_TEST_LESSER_EQUAL(nt2::dist(res.integrals(1), nt2::sqr(T(5))*nt2::Half<T>()), nt2::Quadabstol<T>());
// }
...
//   nt2::tic();
//   BOOST_AUTO_TPL(res, (quad<T, cT>(h(), x)));
//   nt2::toc();
//   std::cout << "Integrals:" << res.integrals << ") with error " << res.errors
//             << " after " << res.eval_count <<  " evaluations\n";
//   NT2_DISPLAY(nt2::Quadabstol<T>());
...
//   nt2::tic();
//   BOOST_AUTO_TPL(res, (quad<cT, cT>(k(), x)));
//   nt2::toc();
//   std::cout << "Integrals:" << res.integrals << ") with error " << res.errors
//             << " after " << res.eval_count <<  " evaluations\n";
//   NT2_DISPLAY(nt2::Quadabstol<T>());
...
//   //output<tab_t,T>
//   nt2::tic();
//   BOOST_AUTO_TPL(res, (quad<T, T>(f(), T(0), T(5))));
//   nt2::toc();
//   std::cout << "Integrals:" << res.integrals << ") with error " << res.errors
//             << " after " << res.eval_count <<  " evaluations\n";
...
//   //output<tab_t,T>
//   nt2::tic();
//   BOOST_AUTO_TPL(res, (quad<T, T>(f(), T(0), T(5), options [ nt2::tolerance::abstol_ = T(1.0e-5),
...
//   //output<tab_t,T>
//   nt2::tic();
//   BOOST_AUTO_TPL(res, (quad<T, T>(f(), x, options [ nt2::tolerance::abstol_ = T(1.0e-5),
//                                                      nt2::range::return_waypoints_ = true])));
//   nt2::toc();
//   std::cout << "Integrals:" << res.integrals << ") with error " << res.errors
//             << " after " << res.eval_count <<  " evaluations\n";
...
//   nt2::tic();
//   output<tab_t,T> res =  (quad<T, T>(g(), x, options [ nt2::tolerance::abstol_ = T(1.0e-8),
//                                                        nt2::range::singular_a_ = true,
...
//   NT2_DISPLAY(x);
//   //output<tab_t,T>
//   BOOST_AUTO_TPL(res, (quad<T, T>(nt2::functor<nt2::tag::exp_>(), x)));
...
//   NT2_DISPLAY(x);
//   //output<tab_t,T>
//   BOOST_AUTO_TPL(res, (quad<T, T>(nt2::functor<nt2::tag::exp_>(), T(5), T(4))));
//   std::cout << "Integrals: " << res.integrals << " with " << res.errors
//             << " after " << res.eval_count <<  " evaluations\n";
//   NT2_DISPLAY(x);
//   NT2_DISPLAY(res.integrals);
