...
//==============================================================================
#define NT2_UNIT_MODULE "nt2 gallery toolbox - condex function"
...
NT2_TEST_CASE_TPL ( condex, NT2_REAL_TYPES)
{
  ...
  NT2_DISPLAY(r31);
  nt2::table<T> r =  nt2::condex(3, 1, T(100));
  NT2_DISPLAY(r);
  ...
  NT2_DISPLAY(r32);
  nt2::table<T> r2 =  nt2::condex(3, 2, nt2::meta::as_<T>());
  NT2_DISPLAY(r2);
  ...
  nt2::table<T> r3 =  nt2::condex(3, 3, nt2::meta::as_<T>());
  NT2_DISPLAY(r3);
