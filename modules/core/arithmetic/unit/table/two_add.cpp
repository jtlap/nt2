...
NT2_TEST_CASE_TPL(remquo_table, NT2_REAL_TYPES)
{
  ...
  for(std::size_t i=1; i <= nb; ++i)
  {
    ...
    im(i) = nt2::two_add(v(i), T(i*2), ie(i));
  }

  {
    ...
    nt2::two_add(v,nt2::linspace(T(2),T(10),nb),m,e);
    NT2_TEST_EQUAL(m, im);
    NT2_TEST_EQUAL(e, ie);
  }

  {
    ...
    m = two_add(v, nt2::linspace(T(2),T(10),nb), e);
    NT2_TEST_EQUAL(m, im);
    NT2_TEST_EQUAL(e, ie);
  }

  {
    ...
    nt2::tie(m, e) = nt2::two_add(v,nt2::linspace(T(2),T(10),nb));
...

  {
    ...
    m = nt2::two_add(v,nt2::linspace(T(2),T(10),nb));
    NT2_TEST_EQUAL(m, im);
  }
}
