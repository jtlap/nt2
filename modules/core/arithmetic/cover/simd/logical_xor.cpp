...
NT2_TEST_CASE_TPL ( logical_xor_all_types,  NT2_SIMD_TYPES)
{
  ...
  for(nt2::uint32_t i=0; i < NR ; ++i) ref[i] = logical_xor(in1[i], in2[i]);
  NT2_COVER_ULP_EQUAL(logical_xor_, ((nT, in1))((nT, in2)), ref, 0);
