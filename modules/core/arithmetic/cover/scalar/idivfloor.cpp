    ...
    for(nt2::uint32_t j =0; j < NR; ++j )
      {
        std::cout << "for params "
                  ...
                  << ", a1 = "<< u_t(a1 = tab_a1[j])
                  << std::endl;
        NT2_TEST_ULP_EQUAL( nt2::idivfloor(a0,a1),nt2::toint(nt2::floor(a0/a1)),0);
    ...
    for(nt2::uint32_t j =0; j < NR; ++j )
      {
        std::cout << "for params "
                  ...
                  << ", a1 = "<< u_t(a1 = tab_a1[j])
                  << std::endl;
        NT2_TEST_ULP_EQUAL( nt2::idivfloor(a0,a1),nt2::touint(nt2::floor((1.0*a0)/a1)),0);
        ulp0=nt2::max(ulpd,ulp0);
     }
     std::cout << "max ulp found is: " << ulp0 << std::endl;
   }
    ...
    for(nt2::uint32_t j =0; j < NR; ++j )
      {
        std::cout << "for params "
                  ...
                  << std::endl;
        if(a1) {
          NT2_TEST_ULP_EQUAL( nt2::idivfloor(a0,a1),nt2::toint(nt2::floor((1.0*a0)/a1)),0);
        } else if (a0 > 0) {
          NT2_TEST_ULP_EQUAL( nt2::idivfloor(a0,a1),nt2::Valmax<T>(),0);
        } else if (a0 <  0) {
          NT2_TEST_ULP_EQUAL( nt2::idivfloor(a0,a1),nt2::Valmin<T>(),0);
        } else {
          NT2_TEST_ULP_EQUAL( nt2::idivfloor(a0,a1),nt2::Zero<T>(),0);
        }
        ulp0=nt2::max(ulpd,ulp0);
     }
     std::cout << "max ulp found is: " << ulp0 << std::endl;
