...
NT2_TEST_CASE_TPL ( idivround_real__1_0_1,  NT2_REAL_TYPES)
{
 ...
 NT2_COVER_ULP_EQUAL(idivround_, ((T, in1))((T, in2)), ref, 0);

}
NT2_TEST_CASE_TPL ( idivround_real__1_0_2,  NT2_INTEGRAL_TYPES)
{
