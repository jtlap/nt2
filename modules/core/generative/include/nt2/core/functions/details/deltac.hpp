...
//==============================================================================
#ifndef NT2_CORE_FUNCTIONS_DETAILS_DELTAC_HPP_INCLUDED
#define NT2_CORE_FUNCTIONS_DETAILS_DELTAC_HPP_INCLUDED
...
namespace nt2 { namespace tag { struct deltac_; } }

namespace nt2 { namespace meta
{
  /// INTERNAL ONLY
  /// Functor used to generate deltac values
  template<class Base> struct constant_<nt2::tag::deltac_, Base>
  {
    typedef Base                                                    result_type;

    constant_ () {}
    template <class I0, class J0>
    constant_(const I0& i, const J0& j)  : i_(i), j_(j){}
