...
{
  NT2_TEST_EQUAL( nt2::extent( nt2::zeros(nt2::of_size(4,5)) ), nt2::of_size(4,5 ) );
  NT2_TEST_EQUAL( nt2::size( nt2::zeros(nt2::of_size(4,5)), 1 ), 4u );
  NT2_TEST_EQUAL( nt2::size( nt2::zeros(nt2::of_size(4,5)), 2 ), 5u );

  NT2_TEST_EQUAL( nt2::extent( nt2::zeros(nt2::of_size(4,5,6)) ), nt2::of_size(4,5,6 ) );
  ...
  NT2_TEST_EQUAL( nt2::extent( nt2::zeros(nt2::of_size(4,5,6,7)) ), nt2::of_size(4,5,6,7 ) );
...
NT2_TEST_CASE_TPL( zeros_nd_typed, NT2_TYPES )
{
  ...
  for(int i=1;i<=64;++i) NT2_TEST_EQUAL( T(0), x1(i) );

  nt2::table<T> x2 = nt2::zeros(8,8, nt2::meta::as_<T>() );
  for(int i=1;i<=64;++i) NT2_TEST_EQUAL( T(0), x2(i) );

  nt2::table<T> x3 = nt2::zeros(8,4,2, nt2::meta::as_<T>() );
  for(int i=1;i<=64;++i) NT2_TEST_EQUAL( T(0), x3(i) );
...
NT2_TEST_CASE_TPL( zeros_typed_of_size, NT2_TYPES )
{
  ...
  for(int i=1;i<=64;++i) NT2_TEST_EQUAL( T(0), x4(i) );
}
...
NT2_TEST_CASE_TPL( zeros_typed_expr, NT2_TYPES )
{
  ...
  for(int i=1;i<=20;++i) NT2_TEST_EQUAL( T(0), x1(i));
