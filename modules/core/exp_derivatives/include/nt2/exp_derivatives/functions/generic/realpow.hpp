...
//==============================================================================
#ifndef NT2_EXP_DERIVATIVES_FUNCTIONS_GENERIC_REALPOW_HPP_INCLUDED
#define NT2_EXP_DERIVATIVES_FUNCTIONS_GENERIC_REALPOW_HPP_INCLUDED
#include <nt2/exponential/functions/realpow.hpp>
#include <nt2/exp_derivatives/functions/realpow.hpp>
...
namespace nt2 { namespace ext
{
  ...
  private:
    ...
    BOOST_FORCEINLINE result_type compute(const boost::mpl::long_<P>
                                         ...
                                         , const A0& u, const A1& v) const
    {
      return realpow(u, v-sA0(P))*fact(boost::mpl::long_<P>(), v);
    }
    ...
    template<long Q>
      BOOST_FORCEINLINE result_type compute(const boost::mpl::long_<0>
                                           ...
                                           , const A0& u, const A1& v) const
    {
      return realpow(u, v)*pow<Q>(log(u)) ;
    }
    ...
    BOOST_FORCEINLINE result_type compute(const boost::mpl::long_<1>
                                         ...
                                         , const A0& u, const A1& v) const
    {
      return realpow(u, v-sA0(1))*fma(log(u), v, One<sA0>());
    }
