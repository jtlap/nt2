...
//==============================================================================
#ifndef NT2_EXP_DERIVATIVES_FUNCTIONS_GENERIC_LOGSPACE_ADD_HPP_INCLUDED
...
namespace nt2 { namespace ext
{
  ...
  private:
    ...
    {
      A0 eumv = exp(u-v);
      return rec(Two<result_type>()+eumv+rec(eumv));
    }
    BOOST_FORCEINLINE result_type compute( const boost::mpl::long_<0>
