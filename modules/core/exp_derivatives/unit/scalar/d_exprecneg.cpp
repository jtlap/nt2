...
//==============================================================================
#include <nt2/exp_derivatives/include/functions/d_exprecneg.hpp>
...
{
  using nt2::d_exprecneg;

  NT2_TEST_ULP_EQUAL(d_exprecneg(nt2::Half<T>()),
                     nt2::df(nt2::functor<nt2::tag::exprecneg_>(),nt2::Half<T>()
                            , nt2::centered_
                            )
