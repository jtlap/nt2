...
//==============================================================================
#include <nt2/exp_derivatives/include/functions/d2_pow_abs.hpp>
...
{
  using nt2::d2_pow_abs;
  T x =  nt2::Half<T>();
  auto test =  [x](const T & y){return nt2::pow_abs(x, y);};

  NT2_TEST_ULP_EQUAL(d2_pow_abs(x, T(3)),
                     nt2::df(test,T(3)
                            , nt2::centered_
                            )
