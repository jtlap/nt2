...
//==============================================================================
#include <nt2/exp_derivatives/include/functions/d_exprecnegc.hpp>
...
{
  using nt2::d_exprecnegc;

  NT2_TEST_ULP_EQUAL(d_exprecnegc(nt2::Half<T>()),
                     nt2::df(nt2::functor<nt2::tag::exprecnegc_>(),nt2::Half<T>()
                            , nt2::centered_
                            )
