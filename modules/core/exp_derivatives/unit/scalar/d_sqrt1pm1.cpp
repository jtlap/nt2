...
//==============================================================================
#include <nt2/exp_derivatives/include/functions/d_sqrt1pm1.hpp>
...
{
  using nt2::d_sqrt1pm1;

  NT2_TEST_ULP_EQUAL(d_sqrt1pm1(nt2::Half<T>()),
                     nt2::df(nt2::functor<nt2::tag::sqrt1pm1_>(),nt2::Half<T>()
                            , nt2::centered_
                            )
