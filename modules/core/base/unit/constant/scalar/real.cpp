...
{
  NT2_TEST_EXPR_TYPE( (nt2::Nan<T>())
                    , boost::mpl::_
                    , T
                    );

  NT2_TEST( check_is_nan(nt2::Nan<T>()) );
}
...
{
  NT2_TEST_EXPR_TYPE( (nt2::Const<double,0x3FF3BE76C8B43958LL>())
                    , boost::mpl::_
                    , double
                    );

  NT2_TEST_EXPR_TYPE( (nt2::Const<float,0x3F9DF3B6>())
                    , boost::mpl::_
                    , float
                    );

  NT2_TEST_EQUAL( (nt2::Const<double,0x3FF3BE76C8B43958LL>()), 1.234   );
  NT2_TEST_EQUAL( (nt2::Const<float,0x3F9DF3B6>()), 1.234f );
}

NT2_TEST_CASE_TPL(  real_constant, (double)(float) )
{
  NT2_TEST_EXPR_TYPE( (nt2::real_constant < T
  ...
  NT2_TEST_EQUAL( (nt2::real_constant < T
                                              , 0x3FF3BE76C8B43958LL
                                              , 0x3F9DF3B6
                                              >()
                  )
...
{
  NT2_TEST_EXPR_TYPE( (nt2::double_constant<double,0x3FF3BE76C8B43958LL>())
                    , boost::mpl::_
                    , double
                    );

  NT2_TEST_EQUAL( (nt2::double_constant<double,0x3FF3BE76C8B43958LL>())
                , 1.234
                );
}
...
{
  NT2_TEST_EXPR_TYPE( (nt2::single_constant<float,0x3F9DF3B6>())
                    , boost::mpl::_
                    , float
                    );

  NT2_TEST_EQUAL( (nt2::single_constant<float,0x3F9DF3B6>())
                , 1.234f
                );
}
