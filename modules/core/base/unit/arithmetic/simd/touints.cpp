...
NT2_TEST_CASE_TPL ( touints_real,  BOOST_SIMD_SIMD_REAL_TYPES)
{
  ...
  NT2_TEST_EQUAL(touints(nt2::splat<vT>(T(1)/T(0))),  nt2::Inf<r_t>());
  NT2_TEST_EQUAL(touints(nt2::Minf<vT>()), nt2::Minf<r_t>());
  NT2_TEST_EQUAL(touints(nt2::splat<vT>(T(-1)/T(0))),  nt2::Minf<r_t>());
  NT2_TEST_EQUAL(touints(nt2::Mone<vT>()), nt2::Zero<r_t>());
  NT2_TEST_EQUAL(touints(nt2::splat<vT>(T(0)/T(0))),  nt2::Zero<r_t>());
