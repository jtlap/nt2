...
NT2_TEST_CASE_TPL ( is_not_equal_with_equal_nans_all_types,  NT2_SIMD_TYPES)
{
  ...
  for(nt2::uint32_t i=0; i < NR ; ++i) ref[i] = is_not_equal_with_equal_nans(in1[i], in2[i]);
  NT2_COVER_ULP_EQUAL(is_not_equal_with_equal_nans_, ((nT, in1))((nT, in2)), ref, 0);
