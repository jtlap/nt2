...
NT2_TEST_CASE_TPL ( is_not_equal_with_equal_nans,  NT2_TYPES)
{
  ...
  {
    ref[i] = (in1[i] !=  in2[i]) && (nt2::is_not_nan(in1[i]) || nt2::is_not_nan(in2[i]));
  }

  NT2_COVER_ULP_EQUAL(is_not_equal_with_equal_nans_, ((T, in1))((T, in2)), ref, 0);
}
