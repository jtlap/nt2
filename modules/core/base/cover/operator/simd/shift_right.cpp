...
NT2_TEST_CASE_TPL(shift_right, NT2_SIMD_TYPES)
{
  ...
  {
    ref1[i] = shift_right(in1[i], in2[i]);
    ref2[i] = shift_right(in1[i], in2[i/N*N]);
  }
  NT2_COVER_ULP_EQUAL(shift_right_, ((nT, in1))((niT, in2)), ref1, 0.5);
  NT2_COVER_ULP_EQUAL(shift_right_, ((nT, in1))(( iT, in2)), ref2, 0.5);
}
