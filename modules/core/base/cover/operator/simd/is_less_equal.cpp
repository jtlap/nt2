...
NT2_TEST_CASE_TPL ( is_less_equal_all_types,  NT2_SIMD_TYPES)
{
  ...
  for(nt2::uint32_t i=0; i < NR ; ++i) ref[i] = is_less_equal(in1[i], in2[i]);
  NT2_COVER_ULP_EQUAL(is_less_equal_, ((nT, in1))((nT, in2)), ref, 0);
