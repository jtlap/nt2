...
NT2_TEST_CASE_TPL ( fast_hypot_real_types,  NT2_SIMD_REAL_TYPES)
{
  ...
  for(nt2::uint32_t i=0; i < NR ; ++i) ref[i] = fast_hypot(in1[i], in2[i]);
  NT2_COVER_ULP_EQUAL(fast_hypot_, ((nT, in1))((nT, in2)), ref, 0.5);
