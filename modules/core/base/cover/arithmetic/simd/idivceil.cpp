...
NT2_TEST_CASE_TPL ( idivceil_all_types,  NT2_SIMD_TYPES)
{
  using nt2::idivceil;
  ...
  for(nt2::uint32_t i=0; i < NR ; ++i) ref[i] = idivceil(in1[i], in2[i]);
  NT2_COVER_ULP_EQUAL(idivceil_, ((nT, in1))((nT, in2)), ref, 0);
