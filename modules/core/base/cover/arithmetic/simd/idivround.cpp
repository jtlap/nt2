...
NT2_TEST_CASE_TPL ( idivround_real_types,  NT2_SIMD_REAL_TYPES)
{
  using nt2::idivround;
  ...
  for(nt2::uint32_t i=0; i < NR ; ++i) ref[i] = idivround(in1[i], in2[i]);
  NT2_COVER_ULP_EQUAL(idivround_, ((nT, in1))((nT, in2)), ref, 0);
