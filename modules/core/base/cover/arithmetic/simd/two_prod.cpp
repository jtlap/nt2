...
NT2_TEST_CASE_TPL ( two_prod_real_types,  NT2_SIMD_REAL_TYPES)
{
  using nt2::two_prod;
  ...
  for(nt2::uint32_t i=0; i < NR ; ++i) ref[i] = two_prod(in1[i], in2[i]);
  NT2_COVER_ULP_EQUAL(two_prod_, ((nT, in1))((nT, in2)), ref, 0);
