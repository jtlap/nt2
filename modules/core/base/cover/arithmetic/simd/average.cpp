...
/// for elements of a0+a1 which are odd integral value
...
NT2_TEST_CASE_TPL ( average_all_types,  NT2_SIMD_TYPES)
{
  using nt2::average;
  ...
  for(nt2::uint32_t i=0; i < NR ; ++i) ref[i] = average(in1[i], in2[i]);
  NT2_COVER_ULP_EQUAL(average_, ((nT, in1))((nT, in2)), ref, 1);
