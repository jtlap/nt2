...
//==============================================================================
#define NT2_UNIT_MODULE "nt2 arithmetic toolbox - touints/simd Mode"
...
NT2_TEST_CASE_TPL ( touints_all_types,  NT2_SIMD_TYPES)
{
  using nt2::touints;
  ...
  for(nt2::uint32_t i=0; i < NR ; ++i) ref[i] = touints(in1[i]);
  NT2_COVER_ULP_EQUAL(touints_, ((nT, in1)), ref, 0);
}
