...
NT2_TEST_CASE_TPL ( iround2even_all_types,  NT2_SIMD_TYPES)
{
  ...
  for(nt2::uint32_t i=0; i < NR ; ++i) ref[i] = iround2even(in1[i]);
  NT2_COVER_ULP_EQUAL(iround2even_, ((nT, in1)), ref, 0);
}
