...
NT2_TEST_CASE_TPL ( negif_all_types,  NT2_SIMD_SIGNED_TYPES)
{
  using nt2::negif;
  ...
  typedef typename nt2::meta::call<negif_(lT, T)>::type r_t;
  ...
  {
    in0[i] = in1[i] > in2[i];
    ref[i] = negif(in0[i] , in2[i]);
  }
  NT2_COVER_ULP_EQUAL(negif_, ((nT, in0))((nT, in2)), ref, 0);
