...
NT2_TEST_CASE_TPL ( if_allbits_else_all_types,  NT2_SIMD_TYPES)
{
  ...
  typedef typename nt2::meta::call<if_allbits_else_(lT, T)>::type r_t;
  ...
  {
    in0[i] = in1[i] > in2[i];
    ref[i] = if_allbits_else(in0[i] , in2[i]);
  }

  NT2_COVER_ULP_EQUAL(if_allbits_else_, ((nT, in0))((nT, in2)), ref, 0);
