...
//==============================================================================
#include <nt2/boolean/include/functions/logical_notand.hpp>
#include <vector>
...
NT2_TEST_CASE_TPL ( logical_notand,  NT2_TYPES)
{

  using nt2::logical_notand;
  using nt2::tag::logical_notand_;
  ...
  NT2_COVER_ULP_EQUAL(logical_notand_, ((lT, in3))((lT, in4)), ref, 0);
}
