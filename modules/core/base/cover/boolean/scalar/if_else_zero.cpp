...
NT2_TEST_CASE_TPL ( if_else_zero_signed,  NT2_SIGNED_TYPES)
{
  ...
  {
    in3[i] = in0[i] > 0;
    ref[i] = in3[i] ? in1[i] : nt2::Zero<T>();
  }

  NT2_COVER_ULP_EQUAL(if_else_zero_, ((lT, in3))((T, in1)), ref, 0);
}

NT2_TEST_CASE_TPL ( if_else_zero_unsigned,  NT2_UNSIGNED_TYPES)
{
