...
NT2_TEST_CASE_TPL ( if_zero_else_signed,  NT2_SIGNED_TYPES)
{
  ...
  {
    in3[i] = in0[i] > 0;
    ref[i] = in3[i] ?  nt2::Zero<T>() :in1[i];
  }

  NT2_COVER_ULP_EQUAL(if_zero_else_, ((lT, in3))((T, in1)), ref, 0);
}

NT2_TEST_CASE_TPL ( if_zero_else_unsigned,  NT2_UNSIGNED_TYPES)
{
