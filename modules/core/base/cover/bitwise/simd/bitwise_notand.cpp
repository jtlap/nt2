...
NT2_TEST_CASE_TPL ( bitwise_notand_all_types,  NT2_SIMD_TYPES)
{
  ...
  for(nt2::uint32_t i=0; i < NR ; ++i) ref[i] = bitwise_notand(in1[i], in2[i]);
  NT2_COVER_ULP_EQUAL(bitwise_notand_, ((nT, in1))((nT, in2)), ref, 0);
