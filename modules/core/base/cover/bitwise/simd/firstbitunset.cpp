...
NT2_TEST_CASE_TPL ( firstbitunset_real_types,  NT2_SIMD_TYPES)
{
  ...
  for(nt2::uint32_t i=0; i < NR ; ++i) ref[i] = nt2::firstbitunset(in1[i]);
  NT2_COVER_ULP_EQUAL(firstbitunset_, ((nT, in1)), ref, 0);
}
