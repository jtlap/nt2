...
NT2_TEST_CASE_TPL ( firstbitset_real_types,  NT2_SIMD_TYPES)
{
  ...
  for(nt2::uint32_t i=0; i < NR ; ++i) ref[i] = nt2::firstbitset(in1[i]);
  NT2_COVER_ULP_EQUAL(firstbitset_, ((nT, in1)), ref, 0);
}
