...
NT2_TEST_CASE_TPL ( reversebits_real_types,  NT2_SIMD_INTEGRAL_TYPES)
{
  ...
  for(nt2::uint32_t i=0; i < NR ; ++i) ref[i] = nt2::reversebits(in1[i]);
  NT2_COVER_ULP_EQUAL(reversebits_, ((nT, in1)), ref, 0);
}
