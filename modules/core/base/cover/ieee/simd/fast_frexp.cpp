...
NT2_TEST_CASE_TPL ( fast_frexp_real_types,  NT2_SIMD_REAL_TYPES)
{
  ...
  for(nt2::uint32_t i=0; i < NR ; ++i) ref[i] = fast_frexp(in1[i]);
  NT2_COVER_ULP_EQUAL(fast_frexp_, ((nT, in1)), ref, 0);
}
