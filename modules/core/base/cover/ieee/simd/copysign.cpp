...
NT2_TEST_CASE_TPL ( copysign_all_types,  NT2_SIMD_REAL_TYPES)
{
  using nt2::copysign;
  ...
  for(nt2::uint32_t i=0; i < NR ; ++i) ref[i] = copysign(in1[i], in2[i]);
  NT2_COVER_ULP_EQUAL(copysign_, ((nT, in1))((nT, in2)), ref, 0);
