...
NT2_TEST_CASE_TPL ( exponentbits,   NT2_SIMD_REAL_TYPES)
{
  ...
  for(nt2::uint32_t i=0; i < NR ; ++i) ref[i] = nt2::exponentbits(in1[i]);
  NT2_COVER_ULP_EQUAL(exponentbits_, ((nT, in1)), ref, 0);
}
