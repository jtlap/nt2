...
NT2_TEST_CASE_TPL ( nextafter_all_types,  NT2_SIMD_REAL_TYPES)
{
  using nt2::nextafter;
  ...
  for(nt2::uint32_t i=0; i < NR ; ++i) ref[i] = nextafter(in1[i], in2[i]);
  NT2_COVER_ULP_EQUAL(nextafter_, ((nT, in1))((nT, in2)), ref, 0);
