...
NT2_TEST_CASE_TPL ( negate_all_types,  NT2_SIMD_REAL_TYPES)
{
  using nt2::negate;
  ...
  for(nt2::uint32_t i=0; i < NR ; ++i) ref[i] = negate(in1[i], in2[i]);
  NT2_COVER_ULP_EQUAL(negate_, ((nT, in1))((nT, in2)), ref, 0);
