...
NT2_TEST_CASE_TPL ( predecessor_all_types,  NT2_SIMD_REAL_TYPES)
{
  ...
  for(nt2::uint32_t i=0; i < NR ; ++i) ref[i] = predecessor(in1[i], in2[i]);
  NT2_COVER_ULP_EQUAL(predecessor_, ((nT, in1))((inT, in2)), ref, 0);
