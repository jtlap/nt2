...
NT2_TEST_CASE_TPL ( successor_all_types,  NT2_SIMD_REAL_TYPES)
{
  using nt2::successor;
  ...
  nt2::roll(in2, 0, 1000);
   ...
   for(nt2::uint32_t i=0; i < NR ; ++i) ref[i] = successor(in1[i], in2[i]);
   NT2_COVER_ULP_EQUAL(successor_, ((nT, in1))((inT, in2)), ref, 0);
