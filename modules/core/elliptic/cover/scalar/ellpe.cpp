...
//==============================================================================
// cover for functor ellpe in scalar mode
...
NT2_TEST_CASE_TPL(ellpe_0,  NT2_SIMD_REAL_TYPES)
{
  using nt2::unit::args;
  ...
  {
    ref1[i] = ::cephes_ellpel(a0[i]);
    ref2[i] = nt2::ellint_2( nt2::sqrt(nt2::oneminus(a0[i])));
  }

  NT2_COVER_ULP_EQUAL(nt2::tag::ellpe_, ((T, a0)), ref1, ulpd);
  NT2_COVER_ULP_EQUAL(nt2::tag::ellpe_, ((T, a0)), ref2, ulpd);
