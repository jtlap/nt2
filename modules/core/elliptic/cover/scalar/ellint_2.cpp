...
//==============================================================================
// cover for functor ellint_2 in scalar mode
...
NT2_TEST_CASE_TPL(ellint_2_0,  NT2_SIMD_REAL_TYPES)
{
  using nt2::unit::args;
  ...
  for(std::size_t i=0; i!=NR; ++i)
    ref[i] = boost::math::ellint_2(a0[i]);

  NT2_COVER_ULP_EQUAL(nt2::tag::ellint_2_, ((T, a0)), ref, ulpd);
