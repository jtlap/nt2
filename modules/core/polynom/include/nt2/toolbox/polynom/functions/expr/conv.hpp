...
namespace nt2{ namespace ext
{
                            ...
                            )
  {
    ...
    typedef typename nt2::container::table<value_type>                  tab_t;
    ...
    result_type operator()(A0& out, const A1& in) const
    {
      ...
      if (nt2::isempty(a) || nt2::isempty(b))
        out =  nt2::zeros(extent(out), meta::as_<value_type>());
      else
      {
        r = nt2::eye(na+nb ? na+nb-1u : 0u, meta::as_<value_type>());
        for(size_t i=1; i <= na; ++i){
          r(nt2::_(i, (i-1)+nb), i) = nt2::colvect(b);
        }
        BOOST_AUTO_TPL(tmp, nt2::catv(nt2::colvect(a), nt2::zeros(nb ? nb-1u :0u, 1, meta::as_<value_type>())));
        out = nt2::rowvect(nt2::mtimes(r,  tmp));
      }
      return out;
    }
  };
