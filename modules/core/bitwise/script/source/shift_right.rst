...
.. code-block:: cpp
  ...
  #include <nt2/toolbox/bitwise/functions/shift_right.hpp>
...
.. code-block:: cpp
    ...
    <unspecified return type>  shift_right(
...
.. literalinclude:: $self.path2examples2$/examples/src/shift_right.cpp
   :language: cpp
