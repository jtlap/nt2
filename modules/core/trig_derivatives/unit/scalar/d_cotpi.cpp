...
//==============================================================================
#include <nt2/trig_derivatives/include/functions/d_cotpi.hpp>
...
NT2_TEST_CASE_TPL ( cotpi,  NT2_REAL_TYPES)
{
  ...
  NT2_TEST_ULP_EQUAL(d_cotpi(nt2::Third<T>()),
                     nt2::df(nt2::functor<nt2::tag::cotpi_>(),nt2::Third<T>(), nt2::centered_) , nt2::rec(nt2::Sqrteps<T>()));
