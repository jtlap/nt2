...
//==============================================================================
#include <nt2/trig_derivatives/include/functions/d_cosd.hpp>
...
NT2_TEST_CASE_TPL ( cosd,  NT2_REAL_TYPES)
{
  ...
  NT2_TEST_ULP_EQUAL(d_cosd(nt2::Hundred<T>()),
                     nt2::df(nt2::functor<nt2::tag::cosd_>(),nt2::Hundred<T>(), nt2::centered_) , nt2::rec(nt2::Sqrteps<T>()));
