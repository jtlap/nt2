...
#include <nt2/trig_derivatives/include/functions/tangent.hpp>
...
NT2_TEST_CASE_TPL ( tangent,  NT2_REAL_TYPES)
{
  ...
  NT2_TEST_ULP_EQUAL((tangent<nt2::medium_,1>(nt2::Pio_6<T>())),
                     1.333333333333333, 1.5);
  NT2_TEST_ULP_EQUAL((tangent<nt2::medium_,2>(nt2::Pio_6<T>())),
                     1.539600717839002, 1.5);
  NT2_TEST_ULP_EQUAL((tangent<nt2::medium_,3>(nt2::Pio_6<T>())),
