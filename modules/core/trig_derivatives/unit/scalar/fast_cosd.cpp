...
#include <nt2/trig_derivatives/include/functions/fast_cosd.hpp>
...
NT2_TEST_CASE_TPL ( fast_cosd,  NT2_REAL_TYPES)
{
  using nt2::fast_cosd;
  using nt2::sind;
  NT2_TEST_ULP_EQUAL(fast_cosd<1>(nt2::_30<T>()),
                     (-sind(nt2::_30<T>())*nt2::pow<1>(nt2::Deginrad<T>())), 1.5);
  NT2_TEST_ULP_EQUAL(fast_cosd<2>(nt2::_30<T>()),
                     (-fast_cosd(nt2::_30<T>())*nt2::pow<2>(nt2::Deginrad<T>())), 1.5);
  NT2_TEST_ULP_EQUAL(fast_cosd<3>(nt2::_30<T>()),
