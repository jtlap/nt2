...
#include <nt2/trig_derivatives/include/functions/fast_tan.hpp>
...
NT2_TEST_CASE_TPL ( fast_tan,  NT2_REAL_TYPES)
{
  ...
  NT2_TEST_ULP_EQUAL(fast_tan<1>(nt2::Pio_6<T>()),
                     1.333333333333333, 1.5);
  NT2_TEST_ULP_EQUAL(fast_tan<2>(nt2::Pio_6<T>()),
                    1.539600717839002, 1.5);
  NT2_TEST_ULP_EQUAL(fast_tan<3>(nt2::Pio_6<T>()),
