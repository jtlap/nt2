...
//==============================================================================
#ifndef NT2_TRIG_DERIVATIVES_FUNCTIONS_GENERIC_SINE_HPP_INCLUDED
#define NT2_TRIG_DERIVATIVES_FUNCTIONS_GENERIC_SINE_HPP_INCLUDED
...
namespace nt2
{
  namespace ext
  {
    BOOST_DISPATCH_IMPLEMENT_G  ( tag::sine_<mode>, tag::cpu_
                              , (mode)(order)(A0)
                              , (unspecified_<order>)
