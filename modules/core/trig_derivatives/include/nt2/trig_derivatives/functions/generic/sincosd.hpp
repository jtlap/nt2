...
//==============================================================================
#ifndef NT2_TRIG_DERIVATIVES_FUNCTIONS_GENERIC_SINCOSD_HPP_INCLUDED
#define NT2_TRIG_DERIVATIVES_FUNCTIONS_GENERIC_SINCOSD_HPP_INCLUDED
...
namespace nt2 { namespace ext
{
                            ...
                            )
  {
                                             ...
                                             A0 const& a0, A0 & a1, A0 & a2) const
    {
      sincosd(a0, a1, a2);
      compute(order(), a1, a2);
      sA0 p = pow<order::value>(Deginrad<sA0>());
      a1*= p;
      a2*= p;
    }
    private:
