...
//==============================================================================
#ifndef NT2_TRIG_DERIVATIVES_FUNCTIONS_GENERIC_FAST_SIND_HPP_INCLUDED
#define NT2_TRIG_DERIVATIVES_FUNCTIONS_GENERIC_FAST_SIND_HPP_INCLUDED
  ...
  namespace ext
  {
                              ...
                              )
    {
      ...
      BOOST_FORCEINLINE result_type operator()(const order&
                                              , const A0& u) const
      {
        return compute(order(), u)*pow<order::value>(Deginrad<sA0>());
      }
    private:
