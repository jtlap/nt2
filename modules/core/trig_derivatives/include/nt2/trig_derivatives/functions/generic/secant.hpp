...
//==============================================================================
#ifndef NT2_TRIG_DERIVATIVES_FUNCTIONS_GENERIC_SECANT_HPP_INCLUDED
#define NT2_TRIG_DERIVATIVES_FUNCTIONS_GENERIC_SECANT_HPP_INCLUDED
...
namespace nt2
{
  namespace ext
  {
    ...
    BOOST_DISPATCH_IMPLEMENT_G  ( tag::secant_<mode>, tag::cpu_
                                , (mode)(order)(A0)
                                , (unspecified_<order>)
    ...
    private:
                                             ...
                                             , const A0& u) const
      {
        ...
        return secant<mode>(u)*polyval(pol, tangent<mode>(u));
      }
   };
  }
}
