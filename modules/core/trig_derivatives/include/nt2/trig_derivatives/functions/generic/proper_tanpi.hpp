...
//==============================================================================
#ifndef NT2_TRIG_DERIVATIVES_FUNCTIONS_GENERIC_PROPER_TANPI_HPP_INCLUDED
#define NT2_TRIG_DERIVATIVES_FUNCTIONS_GENERIC_PROPER_TANPI_HPP_INCLUDED
  ...
  namespace ext
  {
    ...
    private:
                                             ...
                                             , const A0& u) const
      {
        ...
        return polyval(pol, proper_tanpi(u));
      }
    };
  }
}
