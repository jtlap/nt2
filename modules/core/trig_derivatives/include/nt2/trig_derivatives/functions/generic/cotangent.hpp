...
//==============================================================================
#ifndef NT2_TRIG_DERIVATIVES_FUNCTIONS_GENERIC_COTANGENT_HPP_INCLUDED
#define NT2_TRIG_DERIVATIVES_FUNCTIONS_GENERIC_COTANGENT_HPP_INCLUDED
...
namespace nt2
{
  namespace ext
  {
    ...
    BOOST_DISPATCH_IMPLEMENT_G( tag::cotangent_<mode>, tag::cpu_
                              , (mode)(order)(A0)
                              , (unspecified_<order>)
    ...
    private:
                                             ...
                                             , const A0& u) const
      {
        ...
        details::tan_kernel<P, A0>::cot_pl(pol);
        return polyval(pol, cotangent<mode>(u));
      }
   };
  }
}
