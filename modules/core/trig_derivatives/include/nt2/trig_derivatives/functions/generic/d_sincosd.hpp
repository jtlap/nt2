...
//==============================================================================
#ifndef NT2_TRIG_DERIVATIVES_FUNCTIONS_GENERIC_D_SINCOSD_HPP_INCLUDED
#define NT2_TRIG_DERIVATIVES_FUNCTIONS_GENERIC_D_SINCOSD_HPP_INCLUDED
#include <nt2/trig_derivatives/functions/d_sincosd.hpp>
...
namespace nt2 { namespace ext
{
  ...
  BOOST_DISPATCH_IMPLEMENT  ( d_sincosd_
                            , tag::cpu_
                            , (A0)
                            ...
                            )
  {
    ...
    {
      A0 c;
      a2 = -sincosd(a0, c)*Deginrad<A0>();
      return c*Deginrad<A0>();
    }
  };

  BOOST_DISPATCH_IMPLEMENT  ( d_sincosd_, tag::cpu_
                            , (A0)
                            , (generic_< floating_<A0> >)
                            )
  {
