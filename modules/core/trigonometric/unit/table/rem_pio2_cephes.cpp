...
NT2_TEST_CASE_TPL(rem_pio2_cephes_table, NT2_REAL_TYPES)
{
  ...
  {
    rem_pio2_cephes(a, n, r);
    for(size_t i = 1; i <= nb; ++i)
    {
      iT n1;
      T r1;
      rem_pio2_cephes(a(i), n1, r1);
