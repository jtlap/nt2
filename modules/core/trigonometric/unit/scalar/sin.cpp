...
NT2_TEST_CASE_TPL ( sin_real,  NT2_REAL_TYPES)
{
  using nt2::sin;
  using nt2::tag::sin_;
...
#endif
  NT2_TEST_ULP_EQUAL(sin(-nt2::Pio_2<T>()), nt2::Mone<r_t>(), 0.5);
  NT2_TEST_ULP_EQUAL(sin(-nt2::Pio_4<T>()), -nt2::Sqrt_2o_2<r_t>(), 0.5);
  NT2_TEST_ULP_EQUAL(sin(nt2::Pio_2<T>()), nt2::One<r_t>(), 0.5);
  NT2_TEST_ULP_EQUAL(sin(nt2::Pio_4<T>()), nt2::Sqrt_2o_2<r_t>(), 0.5);
