...
NT2_TEST_CASE_TPL ( tan_real__1_0,  NT2_REAL_TYPES)
{
  ...
  NT2_TEST_ULP_EQUAL(tan(-nt2::Pi<T>()/T(4)), nt2::Mone<r_t>(), 1.0);
  ...
  NT2_TEST_ULP_EQUAL(tan(nt2::Pi<T>()), nt2::Zero<r_t>(), 0.75);
  NT2_TEST_ULP_EQUAL(tan(nt2::Pi<T>()/T(4)), nt2::One<r_t>(), 1.0);
  NT2_TEST_ULP_EQUAL(tan(nt2::Zero<T>()), nt2::Zero<r_t>(), 0.5);
} // end of test for floating_

NT2_TEST_CASE_TPL ( tan_unsigned_int__1_0,  NT2_UNSIGNED_TYPES)
{
...
NT2_TEST_CASE_TPL ( tan_signed_int__1_0,  NT2_INTEGRAL_SIGNED_TYPES)
{
