...
NT2_TEST_CASE_TPL ( csc_real,  NT2_REAL_TYPES)
{
  using nt2::csc;
  using nt2::tag::csc_;
...
#endif
  NT2_TEST_ULP_EQUAL(csc(-nt2::Pio_2<T>()), nt2::Mone<r_t>(), 0.5);
  NT2_TEST_ULP_EQUAL(csc(-nt2::Pio_4<T>()), -nt2::Sqrt_2<r_t>(), 0.5);
  NT2_TEST_ULP_EQUAL(csc(nt2::Pio_2<T>()), nt2::One<r_t>(), 0.5);
  NT2_TEST_ULP_EQUAL(csc(nt2::Pio_4<T>()), nt2::Sqrt_2<r_t>(), 0.5);
}
