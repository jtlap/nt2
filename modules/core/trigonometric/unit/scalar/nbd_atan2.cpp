...
NT2_TEST_CASE_TPL ( nbd_atan2_real,  NT2_REAL_TYPES)
{
  using nt2::nbd_atan2;
...
#endif
  NT2_TEST_ULP_EQUAL(nbd_atan2(nt2::Half<T>(), nt2::Half<T>()), nt2::Pio_4<r_t>(), 0.5);
  NT2_TEST_ULP_EQUAL(nbd_atan2(nt2::Mhalf<T>(), nt2::Mhalf<T>()), -nt2::Threepio_4<r_t>(), 0.5);
  NT2_TEST_ULP_EQUAL(nbd_atan2(nt2::Mone<T>(), nt2::Mone<T>()), -nt2::Threepio_4<r_t>(), 0.5);
  NT2_TEST_ULP_EQUAL(nbd_atan2(nt2::One<T>(), nt2::One<T>()), nt2::Pio_4<r_t>(), 0.5);
