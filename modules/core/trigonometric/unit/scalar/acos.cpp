...
#endif
  NT2_TEST_ULP_EQUAL(acos(nt2::Half<T>()), nt2::Pio_3<r_t>(), 0.5);
  NT2_TEST_ULP_EQUAL(acos(nt2::Mhalf<T>()), nt2::Twopio_3<r_t>(), 0.5);
  NT2_TEST_ULP_EQUAL(acos(nt2::Mone<T>()), nt2::Pi<r_t>(), 0);
  NT2_TEST_ULP_EQUAL(acos(nt2::One<T>()), nt2::Zero<r_t>(), 0);
  NT2_TEST_ULP_EQUAL(acos(nt2::Zero<T>()), nt2::Pio_2<r_t>(), 0);
}
