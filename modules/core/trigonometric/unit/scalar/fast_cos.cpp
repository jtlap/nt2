...
NT2_TEST_CASE_TPL ( fast_cos_real,  NT2_REAL_TYPES)
{
  using nt2::fast_cos;
  ...
  NT2_TEST_ULP_EQUAL(fast_cos(-nt2::Pio_2<T>()), nt2::Nan<r_t>(), 0.5);
  ...
  NT2_TEST_ULP_EQUAL(fast_cos(nt2::Pio_2<T>()), nt2::Nan<r_t>(), 0.5);
#endif
  NT2_TEST_ULP_EQUAL(fast_cos(-nt2::Pio_4<T>()), nt2::Sqrt_2o_2<r_t>(), 0.5);
  NT2_TEST_ULP_EQUAL(fast_cos(nt2::Pio_4<T>()), nt2::Sqrt_2o_2<r_t>(), 0.5);
