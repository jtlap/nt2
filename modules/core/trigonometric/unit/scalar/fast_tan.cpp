...
NT2_TEST_CASE_TPL ( fast_tan_real,  NT2_REAL_TYPES)
{
  using nt2::fast_tan;
  ...
  NT2_TEST_ULP_EQUAL(fast_tan(-nt2::Pio_2<T>()), nt2::Nan<r_t>(), 0.5);
  ...
  NT2_TEST_ULP_EQUAL(fast_tan(nt2::Pio_2<T>()), nt2::Nan<r_t>(), 0.5);
#endif
  NT2_TEST_ULP_EQUAL(fast_tan(-nt2::Pio_4<T>()), nt2::Mone<r_t>(), 1.0);
  NT2_TEST_ULP_EQUAL(fast_tan(nt2::Pio_4<T>()), nt2::One<r_t>(), 1.0);
