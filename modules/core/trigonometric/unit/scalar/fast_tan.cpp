...
NT2_TEST_CASE_TPL ( fast_tan_real__1_0,  NT2_REAL_TYPES)
{
  ...
  NT2_TEST_ULP_EQUAL(fast_tan(-nt2::Pi<T>()/T(2)), nt2::Nan<r_t>(), 0.5);
  NT2_TEST_ULP_EQUAL(fast_tan(-nt2::Pi<T>()/T(4)), nt2::Mone<r_t>(), 1.0);
  ...
  NT2_TEST_ULP_EQUAL(fast_tan(nt2::Pi<T>()), nt2::Nan<r_t>(), 0.5);
  NT2_TEST_ULP_EQUAL(fast_tan(nt2::Pi<T>()/T(2)), nt2::Nan<r_t>(), 0.5);
  NT2_TEST_ULP_EQUAL(fast_tan(nt2::Pi<T>()/T(4)), nt2::One<r_t>(), 1.0);
