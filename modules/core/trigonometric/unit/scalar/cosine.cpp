...
NT2_TEST_CASE_TPL ( cosine_real,  NT2_REAL_TYPES)
{
  using nt2::cosine;
  ...
  NT2_TEST_ULP_EQUAL(cosine<nt2::medium_>(-nt2::Pio_2<T>()), nt2::Zero<r_t>(), 0.5);
  NT2_TEST_ULP_EQUAL(cosine<nt2::medium_>(-nt2::Pio_4<T>()), nt2::Sqrt_2o_2<r_t>(), 0.5);
  NT2_TEST_ULP_EQUAL(cosine<nt2::medium_>(nt2::Pi<T>()), nt2::Mone<r_t>(), 0.5);
  NT2_TEST_ULP_EQUAL(cosine<nt2::medium_>(nt2::Pio_2<T>()), nt2::Zero<r_t>(), 0.5);
  NT2_TEST_ULP_EQUAL(cosine<nt2::medium_>(nt2::Pio_4<T>()), nt2::Sqrt_2o_2<r_t>(), 0.5);
