...
//==============================================================================
#ifndef NT2_TRIGONOMETRIC_FUNCTIONS_CONTAINER_CART2POL_HPP_INCLUDED
#define NT2_TRIGONOMETRIC_FUNCTIONS_CONTAINER_CART2POL_HPP_INCLUDED
...
namespace nt2 { namespace ext
{
                            ...
                            )
  {
    ...
    BOOST_FORCEINLINE result_type operator()(A0 const& a0, A1 const& a1
                                            ,A2 & r0,A3& r1) const
    {
      nt2::tie(r0,r1) = nt2::cart2pol(a0, a1);
    }
  };
