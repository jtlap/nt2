...
//==============================================================================
#ifndef NT2_TOOLBOX_TRIGONOMETRIC_FUNCTIONS_GENERIC_TANPI_HPP_INCLUDED
#define NT2_TOOLBOX_TRIGONOMETRIC_FUNCTIONS_GENERIC_TANPI_HPP_INCLUDED
...
namespace nt2 { namespace ext
{
                            ...
                            )
  {
    ...
    NT2_FUNCTOR_CALL(1)
    {
     return nt2::tanpi(nt2::tofloat(a0));
    }
  };
                            ...
                            )
  {
    ...
    NT2_FUNCTOR_CALL(1)
    {
      return impl::trig_base<A0,pi_tag,is_native_t,big_>::tana(a0);
    }
  };
} }
