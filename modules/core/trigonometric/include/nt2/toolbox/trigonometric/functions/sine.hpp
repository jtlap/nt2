...
/*
  ...
  ****************************************************
  ...
  There are two possibilities :
    ...
    Note for float the big_ case if both early an hyper sintly and
    shall be avoided whenever possible. To partially achieve this aim
    when double are available on the platform, this part of reduction
    is delegated to the double precision routines.
    ...
    if you d'ont care for precision you can use
                nt2::sine<medium_> or sine::nt2<small_>
    ...
    So the non direct methods will be interesting only if you want accurate
    results everywhere and have anyhow a big_ proportion of small_ angles.
    This i even truer (if possible) in simd and the more k is big_, because
    of the k power
    ...
    For instance in the medium_ float case:
       ...
       1.759218604441600e+13 falling in the small_ case...
       ...
       10*pi standard deviation,  80% of the intervals will be in the small_
       case (95% of the values).
    ...
    sine<clipped_pio4_> have a perhaps faster equivalent fast_sin.
*/
//////////////////////////////////////////////////////////////////////////////
