...
//==============================================================================
#ifndef NT2_TOOLBOX_TRIGONOMETRIC_FUNCTIONS_GENERIC_FAST_TANPI_HPP_INCLUDED
#define NT2_TOOLBOX_TRIGONOMETRIC_FUNCTIONS_GENERIC_FAST_TANPI_HPP_INCLUDED
...
namespace nt2 { namespace ext
{
                            ...
                            )
  {
    ...
    NT2_FUNCTOR_CALL(1)
    {
      return nt2::fast_tanpi(nt2::tofloat(a0));
    }
  };
                            ...
                            )
  {
    ...
    NT2_FUNCTOR_CALL(1)
    {
      return impl::trig_base<result_type,pi_tag,is_native_t,clipped_pio4_>::tana(a0);
    }
  };
} }
