...
//==============================================================================
#ifndef NT2_TOOLBOX_TRIGONOMETRIC_FUNCTIONS_GENERIC_SINCOS_HPP_INCLUDED
#define NT2_TOOLBOX_TRIGONOMETRIC_FUNCTIONS_GENERIC_SINCOS_HPP_INCLUDED
...
namespace nt2 { namespace ext
{
                            ...
                            )
  {
    ...
    {
      return impl::trig_base <A0,radian_tag,is_native_t>::sincosa(a0,a2);
    }
  };
                            ...
                            )
  {
    ...
    {
      result_type res;
      res.first = impl::trig_base <A0,radian_tag,is_native_t>::sincosa(a0,res.second);
      return res;
    }
  };
                            ...
                            )
  {
    ...
    {
      a1 = impl::trig_base <A0,radian_tag,is_native_t>::sincosa(a0,a2);
    }
  };
