#ifndef NT2_MODULES_TRIGONOMETRIC_EXHAUSTIVE_SIMD_SIN_NT2_INT32_T_HPP
#define NT2_MODULES_TRIGONOMETRIC_EXHAUSTIVE_SIMD_SIN_NT2_INT32_T_HPP

template <class T>
void exhaust_test_sin(const T& mini,const T& maxi);

template <>
void exhaust_test_sin<nt2::int32_t>(const nt2::int32_t& mini,const nt2::int32_t& maxi)
  {
    typedef boost::simd::native<nt2::int32_t,ext_t>  n_t;
    typedef typename nt2::meta::as_integer<n_t>::type   in_t;
    typedef typename nt2::meta::call<nt2::tag::sin_(nt2::int32_t)>::type r_t;
    typedef typename nt2::meta::call<nt2::tag::sin_(n_t)>::type r_t;
    nt2::int32_t mini = Valmin<nt2::int32_t>;
    nt2::int32_t maxi = Valmax<nt2::int32_t>;
    ...
    for(; a0[N-1] < maxi; a0 = nt2::successor(a0, vN))
      ...
      std::cout << " in simd mode and nt2::int32_t type" << std::endl;
