...
//==============================================================================
// cover for functor rem_pio2_cephes in simd mode
...
NT2_TEST_CASE_TPL(rem_pio2_cephes_0,  NT2_SIMD_REAL_TYPES)
{
  ...
  typedef typename nt2::meta::call<nt2::tag::rem_pio2_cephes_(T)>::type sr_t;

  std::vector<sr_t> ref(NR);
  for(std::size_t i=0; i!=NR; ++i)
    ref[i] = nt2::rem_pio2_cephes(a0[i]);

  NT2_COVER_ULP_EQUAL(nt2::tag::rem_pio2_cephes_, ((vT, a0)), ref, ulpd);
}
