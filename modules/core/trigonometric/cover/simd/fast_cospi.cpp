...
//==============================================================================
// cover for functor fast_cospi in simd mode
...
NT2_TEST_CASE_TPL(fast_cospi_0,  NT2_SIMD_REAL_TYPES)
{
  ...
  for(std::size_t i=0; i!=NR; ++i)
    ref[i] = T(nt2::fast_cospi(a0[i]));

  NT2_COVER_ULP_EQUAL(nt2::tag::fast_cospi_, ((vT, a0)), ref, ulpd);
