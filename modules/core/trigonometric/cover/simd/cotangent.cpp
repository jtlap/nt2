...
//==============================================================================
// cover for functor cotangent in simd mode
...
NT2_TEST_CASE_TPL(cotangent_0,  NT2_SIMD_REAL_TYPES)
{
  ...
  for(std::size_t i=0; i!=NR; ++i)
    ref[i] = T(nt2::cotangent<nt2::medium_>(a0[i]));

  NT2_COVER_ULP_EQUAL(nt2::tag::cotangent_<nt2::medium_>, ((vT, a0)), ref, ulpd);
