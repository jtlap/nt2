...
//==============================================================================
// cover for functor asec in scalar mode
...
NT2_TEST_CASE_TPL(asec_0,  NT2_SIMD_REAL_TYPES)
{
  using nt2::unit::args;
  const std::size_t NR = args("samples", NT2_NB_RANDOM_TEST);
  const double ulpd = args("ulpd", 5.0);
  ...
  for(std::size_t i=0; i!=NR; ++i)
    ref[i] = ::cephes_acosl(1.0l/(a0[i]));

  NT2_COVER_ULP_EQUAL(nt2::tag::asec_, ((T, a0)), ref, ulpd);
