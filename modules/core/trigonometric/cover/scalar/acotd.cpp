...
//==============================================================================
// cover for functor acotd in scalar mode
...
NT2_TEST_CASE_TPL(acotd_0,  NT2_SIMD_REAL_TYPES)
{
  using nt2::unit::args;
  ...
  for(std::size_t i=0; i!=NR; ++i)
    ref[i] = ::cephes_atanl(1.0l/(a0[i]))*long_radindeg;

  NT2_COVER_ULP_EQUAL(nt2::tag::acotd_, ((T, a0)), ref, ulpd);
