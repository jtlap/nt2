...
//==============================================================================
// cover for functor sinecosine in scalar mode
...
NT2_TEST_CASE_TPL(sinecosine_0,  NT2_SIMD_REAL_TYPES)
{
  using nt2::unit::args;
  ...
  for(std::size_t i=0; i!=NR; ++i)
    ref[i] = std::make_pair((T)::sinl(a0[i]), (T)::cosl(a0[i]));

  NT2_COVER_ULP_EQUAL(nt2::tag::sinecosine_<nt2::medium_>, ((T, a0)), ref, ulpd);
}
