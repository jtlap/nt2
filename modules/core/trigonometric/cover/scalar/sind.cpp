...
//==============================================================================
// cover for functor sind in scalar mode
...
NT2_TEST_CASE_TPL(sind_0,  NT2_SIMD_REAL_TYPES)
{
  using nt2::unit::args;
  ...
  for(std::size_t i=0; i!=NR; ++i)
    ref[i] = ::cephes_sinl(a0[i]*long_deginrad);

  NT2_COVER_ULP_EQUAL(nt2::tag::sind_, ((T, a0)), ref, ulpd);
