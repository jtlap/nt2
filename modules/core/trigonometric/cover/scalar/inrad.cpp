...
//==============================================================================
// cover for functor inrad in scalar mode
...
NT2_TEST_CASE_TPL(inrad_0,  NT2_SIMD_REAL_TYPES)
{
  using nt2::unit::args;
  ...
  for(std::size_t i=0; i!=NR; ++i)
    ref[i] = a0[i]*nt2::Pi<T>()/nt2::_180<T>();

  NT2_COVER_ULP_EQUAL(nt2::tag::inrad_, ((T, a0)), ref, ulpd);
