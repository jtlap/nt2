...
//==============================================================================
// cover for functor cotd in scalar mode
...
NT2_TEST_CASE_TPL(cotd_0,  NT2_SIMD_REAL_TYPES)
{
  using nt2::unit::args;
  ...
  for(std::size_t i=0; i!=NR; ++i)
    ref[i] = 1.0l/::tanl(a0[i]*long_deginrad);

  NT2_COVER_ULP_EQUAL(nt2::tag::cotd_, ((T, a0)), ref, ulpd);
