...
//==============================================================================
// cover for functor sinpi in scalar mode
...
NT2_TEST_CASE_TPL(sinpi_0,  NT2_SIMD_REAL_TYPES)
{
  using nt2::unit::args;
  ...
  for(std::size_t i=0; i!=NR; ++i)
    ref[i] = ::cephes_sinl(long_pi*a0[i]);

  NT2_COVER_ULP_EQUAL(nt2::tag::sinpi_, ((T, a0)), ref, ulpd);
