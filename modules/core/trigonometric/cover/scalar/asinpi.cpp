...
//==============================================================================
// cover for functor asinpi in scalar mode
...
NT2_TEST_CASE_TPL(asinpi_0,  NT2_SIMD_REAL_TYPES)
{
  using nt2::unit::args;
  ...
  for(std::size_t i=0; i!=NR; ++i)
    ref[i] = ::cephes_asinl(a0[i])/long_pi;

  NT2_COVER_ULP_EQUAL(nt2::tag::asinpi_, ((T, a0)), ref, ulpd);
