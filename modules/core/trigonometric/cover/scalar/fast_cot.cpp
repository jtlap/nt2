...
//==============================================================================
// cover for functor fast_cot in scalar mode
#include <nt2/trigonometric/include/functions/fast_cot.hpp>
#include <boost/simd/sdk/simd/io.hpp>
#include <cmath>
#include <iostream>
#include <nt2/include/constants/pi.hpp>
#include <nt2/include/functions/scalar/cot.hpp>
...
NT2_TEST_CASE_TPL(fast_cot_0,  NT2_SIMD_REAL_TYPES)
{
  using nt2::unit::args;
  ...
  NT2_COVER_ULP_EQUAL(nt2::tag::fast_cot_, ((T, a0)), ref, ulpd);
