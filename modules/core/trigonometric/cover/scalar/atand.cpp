...
//==============================================================================
// cover for functor atand in scalar mode
...
NT2_TEST_CASE_TPL(atand_0,  NT2_SIMD_REAL_TYPES)
{
  using nt2::unit::args;
  ...
  for(std::size_t i=0; i!=NR; ++i)
    ref[i] = ::cephes_atanl(a0[i])*long_radindeg;

  NT2_COVER_ULP_EQUAL(nt2::tag::atand_, ((T, a0)), ref, ulpd);
