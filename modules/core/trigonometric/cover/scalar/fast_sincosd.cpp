...
//==============================================================================
// cover for functor fast_sincosd in scalar mode
#include <nt2/trigonometric/include/functions/fast_sincosd.hpp>
#include <boost/fusion/include/std_pair.hpp>
#include <boost/simd/sdk/simd/io.hpp>
#include <cmath>
#include <iostream>
#include <nt2/include/functions/scalar/sincosd.hpp>
#include <nt2/sdk/unit/args.hpp>
#include <nt2/sdk/unit/module.hpp>
#include <nt2/sdk/unit/tests/cover.hpp>
#include <vector>

NT2_TEST_CASE_TPL(fast_sincosd_0,  NT2_SIMD_REAL_TYPES)
{
  using nt2::unit::args;
  ...
  for(std::size_t i=0; i!=NR; ++i)
    ref[i] = nt2::sincosd(a0[i]);

  NT2_COVER_ULP_EQUAL(nt2::tag::fast_sincosd_, ((T, a0)), ref, ulpd);
}
