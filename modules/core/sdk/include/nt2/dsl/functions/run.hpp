...
namespace nt2
{
  ...
  {
    template<class Site>
    BOOST_FORCEINLINE generic_dispatcher<tag::run_, Site> dispatching_run_(adl_helper, boost::dispatch::meta::unknown_<Site>, ...)
    {
    ...
    template<class Site>
    BOOST_FORCEINLINE generic_dispatcher<tag::run_assign_, Site> dispatching_run_assign_(adl_helper, boost::dispatch::meta::unknown_<Site>, ...)
    {
