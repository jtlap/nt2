...
NT2_TEST_CASE_TPL( container_dynamic_default_ctor, DIMS)
{
  ...
  container<some_kind_,foo,settings(T,deinterleaved_)> b;
...
NT2_TEST_CASE( container_static_default_ctor )
{
  ...
  typedef container<some_kind_,foo,settings(of_size_<3,7>,deinterleaved_)> type;
  type b;
...
NT2_TEST_CASE( container_automatic_static_default_ctor )
{
  ...
  typedef container<some_kind_,foo,settings(of_size_<3,7>, automatic_,deinterleaved_)> type;
  type b;
...
NT2_TEST_CASE( container_size_ctor )
{
  ...
  typedef container<some_kind_,foo,settings(deinterleaved_)> type;
  type b( of_size(3,7) );
...
NT2_TEST_CASE( automatic_container_copy_ctor )
{
  ...
  typedef container<some_kind_,foo,settings(of_size_<3,7>,deinterleaved_, automatic_)> type;
  type b;
...
NT2_TEST_CASE_TPL( automatic_container_assignment, DIMS)
{
  ...
  typedef container<some_kind_,foo,settings(deinterleaved_,of_size_<3,5>)> type;
  type b;
