...
NT2_TEST_CASE_TPL( container_dynamic_default_ctor, DIMS)
{
  ...
  container<foo,settings(T,deinterleaved_),some_kind_> b;
...
NT2_TEST_CASE( container_static_default_ctor )
{
  ...
  typedef container<foo,settings(of_size_<3,7>,deinterleaved_),some_kind_> type;
  type b;
...
NT2_TEST_CASE( container_automatic_static_default_ctor )
{
  ...
  typedef container<foo,settings(of_size_<3,7>, automatic_,deinterleaved_),some_kind_> type;
  type b;
...
NT2_TEST_CASE( container_size_ctor )
{
  ...
  typedef container<foo,settings(deinterleaved_),some_kind_> type;
  type b( of_size(3,7) );
...
NT2_TEST_CASE( automatic_container_copy_ctor )
{
  ...
  typedef container<foo,settings(of_size_<3,7>,deinterleaved_, automatic_),some_kind_> type;
  type b;
...
NT2_TEST_CASE_TPL( automatic_container_assignment, DIMS)
{
  ...
  typedef container<foo,settings(deinterleaved_,of_size_<3,5>),some_kind_> type;
  type b;
