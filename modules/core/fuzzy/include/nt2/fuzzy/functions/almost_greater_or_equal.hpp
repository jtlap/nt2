...
namespace nt2 { namespace tag
  ...
  {
   template<class Site>
   BOOST_FORCEINLINE generic_dispatcher<tag::almost_greater_or_equal_, Site> dispatching_almost_greater_or_equal_(adl_helper, boost::dispatch::meta::unknown_<Site>, ...)
   {
