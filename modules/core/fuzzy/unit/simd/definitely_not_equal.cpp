...
NT2_TEST_CASE_TPL ( definitely_not_equal_real_3,  NT2_SIMD_REAL_TYPES)
{
  ...
  NT2_TEST_EQUAL(definitely_not_equal(nt2::splat<vT>(0),nt2::splat<vT>(0),nt2::splat<ivT>(1)), nt2::False<r_t>());
  NT2_TEST_EQUAL(definitely_not_equal(nt2::splat<vT>(0),nt2::splat<vT>(1),nt2::splat<ivT>(1)), nt2::True<r_t>());
}
