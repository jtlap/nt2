...
NT2_TEST_CASE_TPL ( almost_greater_or_equal_real,  NT2_REAL_TYPES)
{
...
NT2_TEST_CASE_TPL ( almost_greater_or_equal_signed_int,  NT2_INTEGRAL_SIGNED_TYPES)
{
  using nt2::almost_greater_or_equal;
  using nt2::tag::almost_greater_or_equal_;
  typedef typename nt2::meta::as_integer<T>::type          iT;
...
NT2_TEST_CASE_TPL ( almost_greater_or_equal_unsigned_int,  NT2_UNSIGNED_TYPES)
{
  using nt2::almost_greater_or_equal;
  using nt2::tag::almost_greater_or_equal_;
  typedef typename nt2::meta::as_integer<T>::type          iT;
