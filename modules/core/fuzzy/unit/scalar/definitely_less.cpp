...
NT2_TEST_CASE_TPL ( definitely_less_real,  NT2_REAL_TYPES)
{
...
NT2_TEST_CASE_TPL ( definitely_less_signed_int,  NT2_INTEGRAL_SIGNED_TYPES)
{
  using nt2::definitely_less;
  using nt2::tag::definitely_less_;
  typedef typename nt2::meta::as_integer<T>::type          iT;
...
NT2_TEST_CASE_TPL ( definitely_less_unsigned_int,  NT2_UNSIGNED_TYPES)
{
  using nt2::definitely_less;
  using nt2::tag::definitely_less_;
  typedef typename nt2::meta::as_integer<T>::type          iT;
