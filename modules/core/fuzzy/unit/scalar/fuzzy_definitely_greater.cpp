...
NT2_TEST_CASE_TPL ( fuzzy_definitely_greater_real,  NT2_REAL_TYPES)
{
...
NT2_TEST_CASE_TPL ( fuzzy_definitely_greater_signed_int,  NT2_INTEGRAL_SIGNED_TYPES)
{
  using nt2::fuzzy_definitely_greater;
  using nt2::tag::fuzzy_definitely_greater_;
...
NT2_TEST_CASE_TPL ( fuzzy_definitely_greater_unsigned_int,  NT2_UNSIGNED_TYPES)
{
  using nt2::fuzzy_definitely_greater;
  using nt2::tag::fuzzy_definitely_greater_;
