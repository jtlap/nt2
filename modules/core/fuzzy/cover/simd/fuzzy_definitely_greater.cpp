...
//==============================================================================
// cover for functor fuzzy_definitely_greater in simd mode
...
NT2_TEST_CASE_TPL(fuzzy_definitely_greater_0,  NT2_SIMD_REAL_TYPES)
{
  ...
  typedef typename nt2::meta::call<nt2::tag::fuzzy_definitely_greater_(T, T, T)>::type r_t;
  ...
  for(std::size_t i=0; i!=NR; ++i)
    ref[i] = nt2::fuzzy_definitely_greater(a0[i],a1[i],a2[i]);

  NT2_COVER_ULP_EQUAL(nt2::tag::fuzzy_definitely_greater_, ((vT, a0))((vT, a1))((vT, a2)), ref, ulpd);
