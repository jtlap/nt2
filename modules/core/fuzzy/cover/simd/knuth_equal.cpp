...
//==============================================================================
// cover for functor knuth_equal in simd mode
...
NT2_TEST_CASE_TPL(knuth_equal_0,  NT2_SIMD_REAL_TYPES)
{
  ...
  typedef typename nt2::meta::call<nt2::tag::knuth_equal_(T, T, T)>::type r_t;
  ...
  for(std::size_t i=0; i!=NR; ++i)
    ref[i] = nt2::knuth_equal(a0[i],a1[i],a2[i]);

  NT2_COVER_ULP_EQUAL(nt2::tag::knuth_equal_, ((vT, a0))((vT, a1))((vT, a2)), ref, ulpd);
