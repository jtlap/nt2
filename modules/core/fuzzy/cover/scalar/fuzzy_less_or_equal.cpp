...
//==============================================================================
// cover for functor fuzzy_less_or_equal in scalar mode
...
NT2_TEST_CASE_TPL(fuzzy_less_or_equal_0,  NT2_REAL_TYPES)
{
  using nt2::unit::args;
  ...
  NT2_COVER_ULP_EQUAL(nt2::tag::fuzzy_less_or_equal_, ((T, a0))((T, a1))((T, a2)), ref, ulpd);
