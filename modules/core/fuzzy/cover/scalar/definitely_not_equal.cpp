...
//==============================================================================
// cover for functor definitely_not_equal in scalar mode
...
NT2_TEST_CASE_TPL(definitely_not_equal_2,  NT2_REAL_TYPES)
{
  using nt2::unit::args;
  ...
  NT2_COVER_ULP_EQUAL(nt2::tag::definitely_not_equal_, ((T, a0))((T, a1))((iT, a2)), ref, ulpd);
