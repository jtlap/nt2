...
//==============================================================================
// cover for functor definitely_less in scalar mode
...
NT2_TEST_CASE_TPL(definitely_less_2,  NT2_REAL_TYPES)
{
  using nt2::unit::args;
  ...
  NT2_COVER_ULP_EQUAL(nt2::tag::definitely_less_, ((T, a0))((T, a1))((iT, a2)), ref, ulpd);
