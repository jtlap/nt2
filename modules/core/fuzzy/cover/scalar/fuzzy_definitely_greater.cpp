...
//==============================================================================
// cover for functor fuzzy_definitely_greater in scalar mode
...
NT2_TEST_CASE_TPL(fuzzy_definitely_greater_2,  NT2_REAL_TYPES)
{
  using nt2::unit::args;
  ...
  NT2_COVER_ULP_EQUAL(nt2::tag::fuzzy_definitely_greater_, ((T, a0))((T, a1))((T, a2)), ref, ulpd);
