...
//==============================================================================
// cover for functor almost_less_or_equal in scalar mode
...
NT2_TEST_CASE_TPL(almost_less_or_equal_2,  NT2_REAL_TYPES)
{
  using nt2::unit::args;
  ...
  typedef typename nt2::meta::call<nt2::tag::almost_less_or_equal_(T, T, iT)>::type r_t;
  ...
  for(std::size_t i=0; i!=NR; ++i)
    ref[i] = nt2::almost_less_or_equal(a0[i],a1[i],a2[i]);

  NT2_COVER_ULP_EQUAL(nt2::tag::almost_less_or_equal_, ((T, a0))((T, a1))((iT, a2)), ref, ulpd);
