...
//==============================================================================
// cover for functor knuth_equal in scalar mode
...
NT2_TEST_CASE_TPL(knuth_equal_0,  NT2_REAL_TYPES)
{
  using nt2::unit::args;
  ...
  NT2_COVER_ULP_EQUAL(nt2::tag::knuth_equal_, ((T, a0))((T, a1))((T, a2)), ref, ulpd);
