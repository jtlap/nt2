...
//==============================================================================
// cover for functor almost_greater_or_equal in scalar mode
...
NT2_TEST_CASE_TPL(almost_greater_or_equal_2,  NT2_REAL_TYPES)
{
  using nt2::unit::args;
  ...
  NT2_COVER_ULP_EQUAL(nt2::tag::almost_greater_or_equal_, ((T, a0))((T, a1))((iT, a2)), ref, ulpd);
