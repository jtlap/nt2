...
NT2_TEST_CASE_TPL ( is_equal,  NT2_REAL_TYPES)
{
  ...
  NT2_TEST(is_less_equal(vx, vy));
  NT2_TEST(is_less_equal(x, vy));
  NT2_TEST(is_less_equal(vx, x));
  NT2_TEST(is_less_equal(vx, vx));
  NT2_TEST(!is_less_equal(vy, vx));
  NT2_TEST(!is_less_equal(vy, x));
}
