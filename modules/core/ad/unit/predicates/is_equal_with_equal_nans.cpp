...
auto test(const T1 & x, const T2 & y) -> decltype(is_equal_with_equal_nans(x, y))
{
  return is_equal_with_equal_nans(x, y);
}

using nt2::ad::valder;

NT2_TEST_CASE_TPL ( is_equal_with_equal_nans,  NT2_REAL_TYPES)
{
