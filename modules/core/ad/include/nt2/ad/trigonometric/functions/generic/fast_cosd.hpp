...
//==============================================================================
#ifndef NT2_AD_TRIGONOMETRIC_FUNCTIONS_GENERIC_FAST_COSD_HPP_INCLUDED
#define NT2_AD_TRIGONOMETRIC_FUNCTIONS_GENERIC_FAST_COSD_HPP_INCLUDED
...
namespace nt2
{
  namespace ad
  {
    ...
    valder<T> fast_cosd(const valder<T>&u)
    {
