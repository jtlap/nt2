...
//==============================================================================
#ifndef NT2_AD_TRIGONOMETRIC_FUNCTIONS_GENERIC_FAST_SIND_HPP_INCLUDED
#define NT2_AD_TRIGONOMETRIC_FUNCTIONS_GENERIC_FAST_SIND_HPP_INCLUDED
...
namespace nt2
{
  namespace ad
  {
    ...
    valder<T> fast_sind(const valder<T>&u)
    {
