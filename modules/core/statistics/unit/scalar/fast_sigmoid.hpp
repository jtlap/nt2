...
NT2_TEST_CASE_TPL ( fast_sigmoid_1, NT2_REAL_TYPES)
{
  ...
  NT2_TEST_ULP_EQUAL(fast_sigmoid(nt2::One<T>() ),  nt2::splat<T>(0.731058578630005), 1.5);
  ...
  NT2_TEST_ULP_EQUAL(fast_sigmoid(nt2::Half<T>()), nt2::splat<T>(0.622459331201855), 1);
