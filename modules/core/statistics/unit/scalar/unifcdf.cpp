...
NT2_TEST_CASE_TPL ( unifcdf_real__2_0,  NT2_REAL_TYPES)
{
  ...
  NT2_TEST_ULP_EQUAL(unifcdf(nt2::Nan<T>(), nt2::upper_)  , nt2::Nan<T>()  , 0);
  NT2_TEST_ULP_EQUAL(unifcdf(nt2::One<T>(), nt2::upper_)  , nt2::Zero<T>()  , 0);
  NT2_TEST_ULP_EQUAL(unifcdf(nt2::Half<T>(), nt2::upper_) , nt2::Half<T>() , 0);
  NT2_TEST_ULP_EQUAL(unifcdf(nt2::Zero<T>(), nt2::upper_) , nt2::One<T>() , 0);
  NT2_TEST_ULP_EQUAL(unifcdf(nt2::Inf<T>(), nt2::upper_)  , nt2::Zero<T>()  , 0);
  NT2_TEST_ULP_EQUAL(unifcdf(nt2::Minf<T>(), nt2::upper_) , nt2::One<T>() , 0);
...
NT2_TEST_CASE_TPL ( unifcdf_2,  NT2_REAL_TYPES)
{
  ...
  NT2_TEST_ULP_EQUAL(unifcdf(nt2::Nan<T>() ,  nt2::Zero<T>(),nt2::One<T>(), nt2::upper_)  , nt2::Nan<T>()  , 0);
  NT2_TEST_ULP_EQUAL(unifcdf(nt2::One<T>() ,  nt2::Zero<T>(),nt2::One<T>(), nt2::upper_)  , nt2::Zero<T>()  , 0);
  NT2_TEST_ULP_EQUAL(unifcdf(nt2::Half<T>(), nt2::Zero<T>(),nt2::One<T>() , nt2::upper_) , nt2::Half<T>() , 0);
  NT2_TEST_ULP_EQUAL(unifcdf(nt2::Zero<T>(), nt2::Zero<T>(),nt2::One<T>() , nt2::upper_) , nt2::One<T>() , 0);
  NT2_TEST_ULP_EQUAL(unifcdf(nt2::Inf<T>() ,  nt2::Zero<T>(),nt2::One<T>(), nt2::upper_)  , nt2::Zero<T>()  , 0);
  NT2_TEST_ULP_EQUAL(unifcdf(nt2::Minf<T>(), nt2::Zero<T>(),nt2::One<T>() , nt2::upper_) , nt2::One<T>() , 0);
} // end of test for floating_
