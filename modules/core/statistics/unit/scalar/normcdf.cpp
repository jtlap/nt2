...
NT2_TEST_CASE_TPL ( normcdf_2,  NT2_REAL_TYPES)
{
  ...
  nt2::table<T> a = _(T(-3), T(1), T(3));
  nt2::table<T> r0 = nt2::cons<T>( 0.0013498980316300926256, 0.022750131948179170421,
                                   0.15865525393145676891, 0.5, 0.84134474606854325884,
                                   0.97724986805182079141, 0.99865010196836989653
                                 );

  NT2_TEST_ULP_EQUAL(normcdf(a), r0, 25);
  NT2_TEST_ULP_EQUAL(normcdf(a, nt2::Zero<T>()), r0, 25);
  NT2_TEST_ULP_EQUAL(normcdf(a, nt2::Zero<T>(), nt2::One<T>()), r0, 25);
  nt2::table<T> r1 =  nt2::repnum(T(0.5), 1, 7);
  ...
  nt2::table<T> rr = nt2::cons<T>(3.1671241833184224292e-05,
                                  0.0013498980316300926256, 0.022750131948179170421, 0.15865525393145676891, 0.5,
                                  0.84134474606854325884, 0.97724986805182079141
                                 );
  nt2::table<T> pplo = nt2::cons<T>(6.6433555372421765656e-34, 1.8242118763224949552e-20,
                                    8.7045905576395988544e-11, 8.1034587105013216376e-05, 0.025000000000000008327, 0.038213246237494107038,
                                    0.0085951345568521120982
                                   );
  nt2::table<T> ppup = nt2::cons<T>(0.99997759218352755273, 0.99930795939422456531,
                                   0.99140486544314787576, 0.96178675376250588602, 0.9749999999999999778, 0.99991896541289493339,
                                   0.99999999991295407398);
  ...
  rr = nt2::cons<T>(0.0013498980316300926256, 0.022750131948179170421,
                    0.15865525393145676891, 0.5, 0.84134474606854325884, 0.97724986805182079141, 0.99865010196836989653
                   );
  pplo = nt2::cons<T>(1.8242118763224949552e-20, 8.7045905576395988544e-11,
                                    8.1034587105013216376e-05, 0.025000000000000008327, 0.038213246237494107038, 0.0085951345568521120982,
                                    0.00069204060577546125475
                                   );
  ppup = nt2::cons<T>(0.99930795939422456531, 0.99140486544314787576,
