...
// NT2_TEST_CASE_TPL ( fastnormcdf_2,  NT2_REAL_TYPES)
// {
...
//   // specific values tests
//   NT2_TEST_ULP_EQUAL(fastnormcdf(nt2::Nan<T>(), nt2::One<T>()), nt2::Nan<T>(), 0.5);
//   NT2_TEST_ULP_EQUAL(fastnormcdf(nt2::Zero<T>(), nt2::One<T>() ), T(0.158655253931457051414767454368), 5.5);
//   NT2_TEST_ULP_EQUAL(fastnormcdf(nt2::Mone<T>(), nt2::One<T>()),  T(0.0227501319481792072002826371665), 25);
//   NT2_TEST_ULP_EQUAL(fastnormcdf(nt2::Inf<T>(), nt2::One<T>()), nt2::One<T>(), 0.5);
//   NT2_TEST_ULP_EQUAL(fastnormcdf(nt2::Minf<T>(), nt2::One<T>()), nt2::Zero<T>(), 0.5);
...
//   NT2_TEST_ULP_EQUAL(fastnormcdf(a), r0, 3);
//   NT2_TEST_ULP_EQUAL(fastnormcdf(a, nt2::Zero<T>()), r0, 3);
//   NT2_TEST_ULP_EQUAL(fastnormcdf(a, nt2::Zero<T>(), nt2::One<T>()), r0, 3);
//   nt2::table<T> r1 =  nt2::repnum(T(0.5), 1, 11);
//   NT2_TEST_ULP_EQUAL(fastnormcdf(a, a), r1, 1);
//   NT2_TEST_ULP_EQUAL(fastnormcdf(a, a, T(2)),r1, 1);
//   r1(6) = nt2::Nan<T>();
//   NT2_TEST_ULP_EQUAL(fastnormcdf(a, a, nt2::abs(a)), r1, 1);
//   nt2::table<T> r, plo, pup;
//   nt2::table<T> cov = nt2::eye(2, nt2::meta::as_<T>());
//   nt2::tie(r, plo, pup) = nt2::fastnormcdf(a, nt2::ones(size(a), nt2::meta::as_<T>()), T(1), cov, T(0.05));
...
//   nt2::tie(r, plo, pup) = nt2::fastnormcdf(a, T(0), T(1), cov, T(0.05));
