...
//==============================================================================
#ifndef NT2_STATISTICS_FUNCTIONS_COV_HPP_INCLUDED
#define NT2_STATISTICS_FUNCTIONS_COV_HPP_INCLUDED
...
namespace nt2 {  namespace tag
  ...
  {
    template<class Site>
    BOOST_FORCEINLINE generic_dispatcher<tag::cov_, Site> dispatching_cov_(adl_helper, boost::dispatch::meta::unknown_<Site>, ...)
    {
