...
namespace nt2 { namespace ext
{
                            ...
                            )
  {
    ...
    NT2_FUNCTOR_CALL(1){ return Half<A0>()*(fma(sign(a0), nt2::erf(-Sqrt_2o_2<A0>()*nt2::abs(a0)), One<A0>())); }
  };
  ...
  {
    typedef A0 result_type;
    NT2_FUNCTOR_CALL(2){ return normcdf(a1-a0); }
  };
                            ...
                            )
  {
                                              ...
                                              const value_type& alpha )
    {
      ...
      BOOST_ASSERT_MSG(boost::simd::assert_all(nt2::is_gez(zvar)), "Covariance matrix must be positive");
