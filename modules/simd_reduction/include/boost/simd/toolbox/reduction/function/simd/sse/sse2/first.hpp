...
/////////////////////////////////////////////////////////////////////////////
                       ...
                       )
  {
    ...
    BOOST_DISPATCH_FUNCTOR_CALL_REPEAT(1)
    {
      ...
      boost::simd::meta::from_bits<float>::type t = {_mm_cvtsi128_si32(simd::native_cast<type>(a0))};
      return t.value;
    }
  };
...
/////////////////////////////////////////////////////////////////////////////
                       ...
                       )
  {
    ...
    BOOST_DISPATCH_FUNCTOR_CALL_REPEAT(1)
    {
      ...
      boost::simd::meta::as_bits<double>::type t = {_mm_cvtsd_f64(simd::native_cast<rtype>(a0))};
      return t.bits;    
    }
  };
