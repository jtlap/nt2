.. _fuzzy_definitely_less:

fuzzy_definitely_less
==========

.. index::
    single: fuzzy_definitely_less
...
.. code-block:: cpp
    ...
    <unspecified return type>  fuzzy_definitely_less(
...
.. literalinclude:: $self.path2examples2$/examples/src/fuzzy_definitely_less.cpp
   :language: cpp
