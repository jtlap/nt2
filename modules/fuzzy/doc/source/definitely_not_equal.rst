.. _definitely_not_equal:

definitely_not_equal
==========

.. index::
    single: definitely_not_equal
...
.. code-block:: cpp
    ...
    <unspecified return type>  definitely_not_equal(
...
.. literalinclude:: $self.path2examples2$/examples/src/definitely_not_equal.cpp
   :language: cpp
