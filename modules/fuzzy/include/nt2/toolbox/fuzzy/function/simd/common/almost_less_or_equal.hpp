...
{
  NT2_FUNCTOR_IMPLEMENTATION_IF(tag::almost_less_or_equal_, tag::cpu_,
			 (A0)(A1)(X),
			 (boost::mpl::equal_to<boost::mpl::sizeof_<A0>,boost::mpl::sizeof_<A1> >),
			 (tag::almost_less_or_equal_(simd_<integer_<A0>,X>,
						     simd_<integer_<A0>,X>, 
						     simd_<integer_<A1>,X>)), 
			 ((simd_<integer_<A0>,X>))
			 ((simd_<integer_<A0>,X>))
...
/////////////////////////////////////////////////////////////////////////////
  ...
  NT2_FUNCTOR_IMPLEMENTATION_IF(tag::almost_less_or_equal_, tag::cpu_,
			 (A0)(A1)(X),
			 (boost::mpl::equal_to<boost::mpl::sizeof_<A0>,boost::mpl::sizeof_<A1> >),
			 (tag::almost_less_or_equal_(simd_<real_<A0>,X>,
						     simd_<real_<A0>,X>, 
						     simd_<integer_<A1>,X>)), 
			 ((simd_<real_<A0>,X>))
			 ((simd_<real_<A0>,X>))
