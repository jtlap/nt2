...
NT2_TEST_CASE_TPL ( fuzzy_definitely_not_equal_real__3_0,  NT2_REAL_TYPES)
{
  ...
  NT2_TEST_EQUAL(fuzzy_definitely_not_equal(nt2::splat<vT>(0),nt2::splat<vT>(0),nt2::splat<vT>(1))[0]!=0, nt2::False<sr_t>());
  NT2_TEST_EQUAL(fuzzy_definitely_not_equal(nt2::splat<vT>(0),nt2::splat<vT>(1),nt2::splat<vT>(1))[0]!=0, nt2::False<sr_t>());
