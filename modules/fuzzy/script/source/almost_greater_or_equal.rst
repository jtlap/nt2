.. _almost_greater_or_equal:

almost_greater_or_equal
==========

.. index::
    single: almost_greater_or_equal
...
.. code-block:: cpp
    ...
    <unspecified return type>  almost_greater_or_equal(
...
.. literalinclude:: $self.path2examples2$/examples/src/almost_greater_or_equal.cpp
   :language: cpp
