...
namespace nt2
{
  ...
  namespace solvers
  {
    ...
    NT2_FUNCTION_IMPLEMENTATION_SELF(tag::solvers::full_qr_solve_, full_qr_solve, 3)
  }
}
...
namespace nt2 { namespace container { namespace ext
{
  ...
  struct  size_of<tag::full_qr_solve_,Domain,1,Expr>
  {
    // The size is contained in the first child
    typedef typename boost::proto::result_of::child_c<Expr&,0>::type seq_term;
    typedef typename meta::strip<seq_term>::type::extent_type        result_type;
  ...
  template<class Domain, int N, class Expr>
  struct  generator<tag::full_qr_solve_,Domain,N,Expr>
  {
    typedef typename boost::proto::result_of::child_c<Expr&,0>::type seq_term;
