...
namespace nt2 { namespace details
{
  ...
  //============================================================================
  template<class A, class B = A> struct svd_solve_result
  {
    ...
    //  B is            M x nrhs    
    ////////////////////////////////////////////////////////////////////////////
    svd_solve_result(A& a, const B& b)
      : a_(a),
        b_(b)
    {
      const nt2_la_int ml   = size(a_, 1);
      const nt2_la_int nl   = size(a_, 2);
      const nt2_la_int nrhs = size(b_, 2);
      const nt2_la_int lda  = a_.leading_size(); 
      const nt2_la_int ldb  = b_.leading_size(); 
    ...
    rtype_t   rcond()      const { return rcond_;}   
