...
//==============================================================================
#ifndef NT2_TOOLBOX_LINALG_FUNCTIONS_TIED_SVD_SOLVE_HPP_INCLUDED
#define NT2_TOOLBOX_LINALG_FUNCTIONS_TIED_SVD_SOLVE_HPP_INCLUDED

#include <nt2/toolbox/linalg/functions/svd_solve.hpp>
#include <nt2/toolbox/linalg/functions/solvers/svd_solve.hpp>
...
namespace nt2 { namespace ext
{
  ...
  NT2_FUNCTOR_IMPLEMENTATION( nt2::tag::svd_solve_, tag::cpu_
                              , (A0)(N0)(A1)(N1)
                              , ((node_<A0, nt2::tag::svd_solve_, N0>))
