 ...
 ******************************************************************************/
#ifndef NT2_TOOLBOX_LINALG_GALLERY_FUNCTIONS_CAUCHY_HPP_INCLUDED
#define NT2_TOOLBOX_LINALG_GALLERY_FUNCTIONS_CAUCHY_HPP_INCLUDED
...
namespace nt2 { namespace ext 
{
                                     ...
                                     )
  {
    ...
    typedef typename meta::call<tag::bsxfun_(nt2::functor<tag::plus_>, T0, T1) >::type T2;
    typedef typename meta::call<tag::rec_(T2)>::type result_type; 
    NT2_FUNCTOR_CALL(2)
      {
        BOOST_ASSERT_MSG(numel(a0) == numel(a1), "a0 and a1 have not the same number of elements"); 
                                     ...
                                     )
  {
    ...
    NT2_FUNCTOR_CALL(2)
      {      
        return cauchy(colon(One<value_type>(), value_type(a0)), a1);
      }
                                     ...
                                     )
  {
    ...
    NT2_FUNCTOR_CALL(2)
      {
        return cauchy(a0, colon(One<value_type>(), value_type(a1)));
      }
                                     ...
                                     )
  {
    ...
    BOOST_FORCEINLINE result_type operator()(A0 const& a0, A1 const& a1, A2 const& ) const
      {
        return cauchy(colon(One<value_type>(), value_type(a0)),
                      colon(One<value_type>(), value_type(a1)));
      }
                                     ...
                                     )
  {
    ...
    BOOST_FORCEINLINE result_type operator()(A0 const& a0, A1 const&) const
      {
        return cauchy(colon(One<value_type>(), value_type(a0)),
                      colon(One<value_type>(), value_type(a0)));
      }
