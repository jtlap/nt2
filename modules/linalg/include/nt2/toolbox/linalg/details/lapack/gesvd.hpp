 ...
 ******************************************************************************/
#ifndef NT2_TOOLBOX_LINALG_DETAILS_LAPACK_GESVD_HPP_INCLUDED
#define NT2_TOOLBOX_LINALG_DETAILS_LAPACK_GESVD_HPP_INCLUDED
...
#define NT2_GESVD(NAME, T, TBASE)                                       \
    ...
    {                                                                   \
      ...
      NT2_F77NAME( NAME )(jobu, jobvt, m, n, a, lda, s, u, ldu,         \
                      vt,ldvt,w.main(),&w.main_need(),w.reals(),info);  \
    }                                                                   \
    inline void gesvd(const char* jobu,                                 \
                      const char* jobvt,                                \
                      const nt2_la_int* m,                              \
...
#define NT2_GESVD(NAME, T)                                              \
    ...
    {                                                                   \
      ...
      w.resize_main(w.main_need());                                     \
      NT2_F77NAME( NAME )(jobu, jobvt, m, n, a, lda, s, u, ldu,         \
                          vt,ldvt,w.main(),&w.main_need(),info);        \
    }                                                                   \
    inline void gesvd(const char* jobu,                                 \
                      const char* jobvt,                                \
                      const nt2_la_int* m,                              \
