...
//////////////////////////////////////////////////////////////////////////////
#define NT2_UNIT_MODULE "nt2 elliptic toolbox - ellie/scalar Mode"
...
NT2_TEST_CASE_TPL ( ellie_real__2_0,  NT2_REAL_TYPES)
{
  ...
  NT2_TEST_ULP_EQUAL(ellie(nt2::One<T>(),0), nt2::One<r_t>(), 0);
  NT2_TEST_ULP_EQUAL(ellie(nt2::Pio_2<T>(),0), nt2::Pio_2<r_t>(), 0);
  NT2_TEST_ULP_EQUAL(ellie(nt2::Zero<T>(),0), nt2::Zero<r_t>(), 0);
    ...
    for (uint32_t j =0; j < NR; ++j )
      {
        std::cout << "for params "
                  ...
                  << ", a1 = "<< u_t(a1 = tab_a1[j])
                  << std::endl;
        NT2_TEST_ULP_EQUAL( nt2::ellie(a0,a1),::cephes_elliel(a0,a1),2.0);
