...
namespace boost { namespace dispatch { namespace meta
{
                                ...
                                )
  {
    ...
    typedef simd::native<typename  meta::double__<A0>::type,boost::simd::tag::sse_>    dtype;
    typedef typename boost::mpl::if_c<rboost::simd::tag::value,dtype,ttype>::type      rtype;
  ...
  private:
    ...
    eval(A0 const& a0, R0& r0, R1& r1, const simd::native<typename  meta::int16_t_<A0>::type,boost::simd::tag::sse_>&)const
    {
      typedef simd::native<typename  meta::int16_t_<A0>::type,boost::simd::tag::sse_> rtype;
      r1 = simd::native_cast<rtype>(_mm_unpackhi_epi8(a0, is_ltz(a0)));
      r0 = simd::native_cast<rtype>(_mm_unpacklo_epi8(a0, is_ltz(a0)));
    }
    template<class R0,class R1> inline void
    eval(A0 const& a0, R0& r0, R1& r1, const simd::native<typename  meta::uint16_t_<A0>::type,boost::simd::tag::sse_ > &)const
    {
      typedef simd::native<typename  meta::uint16_t_<A0>::type,boost::simd::tag::sse_> rtype;
      r1 = simd::native_cast<rtype>(_mm_unpackhi_epi8(a0, Zero<A0>()));
      r0 = simd::native_cast<rtype>(_mm_unpacklo_epi8(a0, Zero<A0>()));
    }
    template<class R0,class R1> inline void
    eval(A0 const& a0, R0& r0, R1& r1, const simd::native<typename  meta::int32_t_<A0>::type,boost::simd::tag::sse_ > &)const
    {
      typedef simd::native<typename  meta::int32_t_<A0>::type,boost::simd::tag::sse_> rtype;
      r1 = simd::native_cast<rtype>(_mm_unpackhi_epi16(a0, is_ltz(a0)));
      r0 = simd::native_cast<rtype>(_mm_unpacklo_epi16(a0, is_ltz(a0)));
    }
    template<class R0,class R1> inline void
    eval(A0 const& a0, R0& r0, R1& r1, const simd::native<typename  meta::uint32_t_<A0>::type,boost::simd::tag::sse_ > &)const
    {
      typedef simd::native<typename  meta::uint32_t_<A0>::type,boost::simd::tag::sse_> rtype;
      r1 = simd::native_cast<rtype>(_mm_unpackhi_epi16(a0, Zero<A0>()));
      r0 = simd::native_cast<rtype>(_mm_unpacklo_epi16(a0, Zero<A0>()));
    }
    template<class R0,class R1> inline void
    eval(A0 const& a0, R0& r0, R1& r1, const simd::native<typename  meta::int64_t_<A0>::type,boost::simd::tag::sse_ > &)const
    {
      typedef simd::native<typename  meta::int64_t_<A0>::type,boost::simd::tag::sse_> rtype;
      r1 = simd::native_cast<rtype>(_mm_unpackhi_epi32(a0, is_ltz(a0)));
      r0 = simd::native_cast<rtype>(_mm_unpacklo_epi32(a0, is_ltz(a0)));
    }
    template<class R0,class R1> inline void
    eval(A0 const& a0, R0& r0, R1& r1, const simd::native<typename  meta::uint64_t_<A0>::type,boost::simd::tag::sse_ > &)const
    {
      typedef simd::native<typename  meta::uint64_t_<A0>::type,boost::simd::tag::sse_> rtype;
      r1 = simd::native_cast<rtype>(_mm_unpackhi_epi32(a0, Zero<A0>()));
      r0 = simd::native_cast<rtype>(_mm_unpacklo_epi32(a0, Zero<A0>()));
    }

    template<class R0,class R1> inline void
    eval(A0 const& a0, R0& r0, R1& r1, const simd::native<typename  meta::double__<A0>::type,boost::simd::tag::sse_> &)const
    {
  ...
  BOOST_DISPATCH_FUNCTOR_IMPLEMENTATION_IF(boost::simd::tag::split_, tag::cpu_,
				(A0),
				(boost::mpl::not_< boost::is_same<A0, typename meta::upgrade<A0>::type> >), 
				(boost::simd::tag::split_(simd_<arithmetic_<A0>,tag::sse_>)),
