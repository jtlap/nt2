...
{
  BOOST_DISPATCH_FUNCTION_IMPLEMENTATION(boost::dispatch::tag::splatted_prod_, splatted_prod, 1)
} }
 
#include <boost/simd/toolbox/operator.hpp>
#include <boost/simd/toolbox/swar/function/scalar/splatted_prod.hpp>
#include <boost/simd/toolbox/swar/function/simd/all/splatted_prod.hpp> 
