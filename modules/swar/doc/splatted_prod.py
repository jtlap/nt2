     ...
     'unit' : {
         ...
         'specific_values' : {
             ...
             'real_' : {
                 ...
                 'nt2::Minf<T>()' : {'result' : '(nt2::meta::cardinal_of<vT>::value == 1) ? nt2::Minf<r_t>() : nt2::Inf<r_t>()','ulp_thresh' : '0',},
                 'nt2::Mone<T>()' : {'result' : '(nt2::meta::cardinal_of<vT>::value == 1) ? nt2::Mone<r_t>() : nt2::One<r_t>()','ulp_thresh' : '0',},
