...
//////////////////////////////////////////////////////////////////////////////
#define NT2_UNIT_MODULE "nt2 crlibm toolbox - cospi/scalar Mode"
...
NT2_TEST_CASE_TPL ( cospi_real__1_0,  NT2_REAL_TYPES)
{
  ...
  typedef typename nt2::meta::call<cospi_<rn>(T)>::type r_t;
    ...
    for (uint32_t j =0; j < NR; ++j )
      {
        std::cout << "for param "
                  << "  a0 = "<< u_t(a0 = tab_a0[j])
                  << std::endl;
        NT2_TEST_ULP_EQUAL( nt2::crlibm::cospi<rn>(a0),nt2::cospi(a0),1);
