 ...
 * \file
**/
#ifndef NT2_TOOLBOX_CRLIBM_FUNCTIONS_LOG1P_RU_HPP_INCLUDED
#define NT2_TOOLBOX_CRLIBM_FUNCTIONS_LOG1P_RU_HPP_INCLUDED
...
/*!
 * \ingroup crlibm
 * \defgroup crlibm_log1p_ru log1p_ru
 *
 * \par Description
 ...
 *   {
 *     template <class A0>
 *       meta::call<tag::log1p_ru_(A0)>::type
 *       log1p_ru(const A0 & a0);
 *   }
 * }
 * \endcode
 *
...
namespace nt2 { namespace crlibm { namespace tag
  {
    ...
    **/
    struct log1p_ru_ : ext::elementwise_<log1p_ru_> {};
  }
  NT2_FUNCTION_IMPLEMENTATION(crlibm::tag::log1p_ru_, log1p_ru, 1)
} }
