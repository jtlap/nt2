 ...
 * \file
**/
#ifndef NT2_TOOLBOX_CRLIBM_FUNCTIONS_ASINPI_HPP_INCLUDED
#define NT2_TOOLBOX_CRLIBM_FUNCTIONS_ASINPI_HPP_INCLUDED
 ...
 * mode used by the function asinpi.
...
namespace nt2 { namespace crlibm { namespace tag
  {
    ...
    **/
    template <class T>
    struct asinpi_ : ext::elementwise_<asinpi_<T> > { typedef ext::elementwise_<asinpi_<T> > parent; };
  }
  NT2_CRLIBM_FUNCTION_IMPLEMENTATION_TPL(asinpi, 1)
} }
