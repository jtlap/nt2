 ...
 * \file
**/
#ifndef NT2_TOOLBOX_CRLIBM_FUNCTIONS_LOG_RU_HPP_INCLUDED
#define NT2_TOOLBOX_CRLIBM_FUNCTIONS_LOG_RU_HPP_INCLUDED
 ...
 *   {
 *     template <class A0>
 *       meta::call<tag::log_ru_(A0)>::type
 *       log_ru(const A0 & a0);
 *   }
 * }
 * \endcode
 *
 * \param a0 the unique parameter of log_ru
 * 
...
namespace nt2 { namespace crlibm { namespace tag
  {
    ...
    **/
    struct log_ru_ : ext::elementwise_<log_ru_> { typedef ext::elementwise_<log_ru_> parent; };
  }
