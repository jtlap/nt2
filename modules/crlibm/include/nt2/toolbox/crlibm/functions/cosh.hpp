 ...
 * \file
**/
#ifndef NT2_TOOLBOX_CRLIBM_FUNCTIONS_COSH_HPP_INCLUDED
#define NT2_TOOLBOX_CRLIBM_FUNCTIONS_COSH_HPP_INCLUDED
 ...
 * mode used by the function cosh.
...
namespace nt2 { namespace crlibm { namespace tag
  {
    ...
    **/
    template <class T>
    struct cosh_ : ext::elementwise_<cosh_<T> > { typedef ext::elementwise_<cosh_<T> > parent; };
  }
