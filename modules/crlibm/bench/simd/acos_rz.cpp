...
NT2_TIMING(nt2::crlibm::tag::acos_rz_,(RS(vfloat,-1.0f,1.0f)))
NT2_TIMING(nt2::crlibm::tag::acos_rz_,(RS(vdouble,-1.0,1.0)))
NT2_TIMING(nt2::crlibm::tag::acos_rz_,(RS(vint32_t,-1.0,1.0)))
