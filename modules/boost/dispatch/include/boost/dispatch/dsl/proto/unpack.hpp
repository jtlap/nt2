      ...
      : transform_impl<Expr, State, Data>
{
  ...
  typedef typename
          which::template impl<typename unpack_impl::expr, typename unpack_impl::state, typename unpack_impl::data>::result_type result_type;
  ...
  {
    return typename which:: template impl<typename unpack_impl::expr, typename unpack_impl::state, typename unpack_impl::data>()(e, s, d);
  }
};
      ...
      : transform_impl<Expr, State, Data>
{
  ...
  typedef typename which::template impl<typename unpack_impl::expr, typename unpack_impl::state, typename unpack_impl::data>::result_type result_type;
