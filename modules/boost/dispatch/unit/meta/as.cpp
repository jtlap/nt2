 ...
 ******************************************************************************/
#define BOOST_SIMD_UNIT_MODULE "boost::dispatch::meta::hierarchy_of for as_<T>"
...
BOOST_SIMD_TEST_CASE(hierarchy_of_ints64)
{
  ...
  BOOST_SIMD_TEST( (is_same<target_<scalar_<real_sized_< as_<boost::simd::int64_t> >  > > , UP(base,3) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<scalar_<int_< as_<boost::simd::int64_t> >         > > , UP(base,4) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<scalar_<signed_< as_<boost::simd::int64_t> >      > > , UP(base,5) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<scalar_<integer_< as_<boost::simd::int64_t> >     > > , UP(base,6) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<scalar_<arithmetic_< as_<boost::simd::int64_t> >  > > , UP(base,7) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<scalar_<fundamental_< as_<boost::simd::int64_t> > > > , UP(base,8) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<scalar_<unspecified_< as_<boost::simd::int64_t> > > > , UP(base,9) >::value) );

  BOOST_SIMD_TEST( (is_same<target_<generic_<int64_< as_<boost::simd::int64_t> >        > > , UP(base,10) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<generic_<ints64_< as_<boost::simd::int64_t> >       > > , UP(base,11) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<generic_<type64_< as_<boost::simd::int64_t> >       > > , UP(base,12) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<generic_<real_sized_< as_<boost::simd::int64_t> >   > > , UP(base,13) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<generic_<int_< as_<boost::simd::int64_t> >          > > , UP(base,14) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<generic_<signed_< as_<boost::simd::int64_t> >       > > , UP(base,15) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<generic_<integer_< as_<boost::simd::int64_t> >      > > , UP(base,16) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<generic_<arithmetic_< as_<boost::simd::int64_t> >   > > , UP(base,17) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<generic_<fundamental_< as_<boost::simd::int64_t> >  > > , UP(base,18) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<generic_<unspecified_< as_<boost::simd::int64_t> >  > > , UP(base,19) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<unspecified_< as_<boost::simd::int64_t> > >             , UP(base,20) >::value) );
}
...
BOOST_SIMD_TEST_CASE(hierarchy_of_uints64)
{
  ...
  BOOST_SIMD_TEST( (is_same<target_<scalar_<real_sized_< as_<boost::simd::uint64_t> >  > > , UP(base,3) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<scalar_<uint_< as_<boost::simd::uint64_t> >        > > , UP(base,4) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<scalar_<unsigned_< as_<boost::simd::uint64_t> >    > > , UP(base,5) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<scalar_<integer_< as_<boost::simd::uint64_t> >     > > , UP(base,6) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<scalar_<arithmetic_< as_<boost::simd::uint64_t> >  > > , UP(base,7) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<scalar_<fundamental_< as_<boost::simd::uint64_t> > > > , UP(base,8) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<scalar_<unspecified_< as_<boost::simd::uint64_t> > > > , UP(base,9) >::value) );

  BOOST_SIMD_TEST( (is_same<target_<generic_<uint64_< as_<boost::simd::uint64_t> >       > > , UP(base,10) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<generic_<ints64_< as_<boost::simd::uint64_t> >       > > , UP(base,11) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<generic_<type64_< as_<boost::simd::uint64_t> >       > > , UP(base,12) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<generic_<real_sized_< as_<boost::simd::uint64_t> >   > > , UP(base,13) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<generic_<uint_< as_<boost::simd::uint64_t> >         > > , UP(base,14) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<generic_<unsigned_< as_<boost::simd::uint64_t> >     > > , UP(base,15) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<generic_<integer_< as_<boost::simd::uint64_t> >      > > , UP(base,16) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<generic_<arithmetic_< as_<boost::simd::uint64_t> >   > > , UP(base,17) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<generic_<fundamental_< as_<boost::simd::uint64_t> >  > > , UP(base,18) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<generic_<unspecified_< as_<boost::simd::uint64_t> >  > > , UP(base,19) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<unspecified_< as_<boost::simd::uint64_t> > >             , UP(base,20) >::value) );
}
...
BOOST_SIMD_TEST_CASE(hierarchy_of_ints32)
{
  ...
  BOOST_SIMD_TEST( (is_same<target_<scalar_<real_sized_< as_<boost::simd::int32_t> >  > > , UP(base,3) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<scalar_<int_< as_<boost::simd::int32_t> >         > > , UP(base,4) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<scalar_<signed_< as_<boost::simd::int32_t> >      > > , UP(base,5) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<scalar_<integer_< as_<boost::simd::int32_t> >     > > , UP(base,6) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<scalar_<arithmetic_< as_<boost::simd::int32_t> >  > > , UP(base,7) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<scalar_<fundamental_< as_<boost::simd::int32_t> > > > , UP(base,8) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<scalar_<unspecified_< as_<boost::simd::int32_t> > > > , UP(base,9) >::value) );

  BOOST_SIMD_TEST( (is_same<target_<generic_<int32_< as_<boost::simd::int32_t> >        > > , UP(base,10) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<generic_<ints32_< as_<boost::simd::int32_t> >       > > , UP(base,11) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<generic_<type32_< as_<boost::simd::int32_t> >       > > , UP(base,12) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<generic_<real_sized_< as_<boost::simd::int32_t> >   > > , UP(base,13) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<generic_<int_< as_<boost::simd::int32_t> >          > > , UP(base,14) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<generic_<signed_< as_<boost::simd::int32_t> >       > > , UP(base,15) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<generic_<integer_< as_<boost::simd::int32_t> >      > > , UP(base,16) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<generic_<arithmetic_< as_<boost::simd::int32_t> >   > > , UP(base,17) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<generic_<fundamental_< as_<boost::simd::int32_t> >  > > , UP(base,18) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<generic_<unspecified_< as_<boost::simd::int32_t> >  > > , UP(base,19) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<unspecified_< as_<boost::simd::int32_t> > >             , UP(base,20) >::value) );
}
...
BOOST_SIMD_TEST_CASE(hierarchy_of_uints32)
{
  ...
  BOOST_SIMD_TEST( (is_same<target_<scalar_<real_sized_< as_<boost::simd::uint32_t> >  > > , UP(base,3) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<scalar_<uint_< as_<boost::simd::uint32_t> >        > > , UP(base,4) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<scalar_<unsigned_< as_<boost::simd::uint32_t> >    > > , UP(base,5) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<scalar_<integer_< as_<boost::simd::uint32_t> >     > > , UP(base,6) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<scalar_<arithmetic_< as_<boost::simd::uint32_t> >  > > , UP(base,7) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<scalar_<fundamental_< as_<boost::simd::uint32_t> > > > , UP(base,8) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<scalar_<unspecified_< as_<boost::simd::uint32_t> > > > , UP(base,9) >::value) );

  BOOST_SIMD_TEST( (is_same<target_<generic_<uint32_< as_<boost::simd::uint32_t> >       > > , UP(base,10) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<generic_<ints32_< as_<boost::simd::uint32_t> >       > > , UP(base,11) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<generic_<type32_< as_<boost::simd::uint32_t> >       > > , UP(base,12) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<generic_<real_sized_< as_<boost::simd::uint32_t> >   > > , UP(base,13) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<generic_<uint_< as_<boost::simd::uint32_t> >         > > , UP(base,14) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<generic_<unsigned_< as_<boost::simd::uint32_t> >     > > , UP(base,15) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<generic_<integer_< as_<boost::simd::uint32_t> >      > > , UP(base,16) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<generic_<arithmetic_< as_<boost::simd::uint32_t> >   > > , UP(base,17) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<generic_<fundamental_< as_<boost::simd::uint32_t> >  > > , UP(base,18) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<generic_<unspecified_< as_<boost::simd::uint32_t> >  > > , UP(base,19) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<unspecified_< as_<boost::simd::uint32_t> > >             , UP(base,20) >::value) );
}
...
BOOST_SIMD_TEST_CASE(hierarchy_of_double)
{
  ...
  BOOST_SIMD_TEST( (is_same<target_<scalar_<real_sized_<as_<double> >  > > , UP(base,2) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<scalar_<real_<as_<double> >        > > , UP(base,3) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<scalar_<signed_<as_<double> >      > > , UP(base,4) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<scalar_<arithmetic_<as_<double> >  > > , UP(base,5) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<scalar_<fundamental_<as_<double> > > > , UP(base,6) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<scalar_<unspecified_<as_<double> > > > , UP(base,7) >::value) );

  BOOST_SIMD_TEST( (is_same<target_<generic_<double_<as_<double> >      > > , UP(base,8) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<generic_<type64_<as_<double> >      > > , UP(base,9) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<generic_<real_sized_<as_<double> >  > > , UP(base,10) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<generic_<real_<as_<double> >        > > , UP(base,11) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<generic_<signed_<as_<double> >      > > , UP(base,12) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<generic_<arithmetic_<as_<double> >  > > , UP(base,13) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<generic_<fundamental_<as_<double> > > > , UP(base,14) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<generic_<unspecified_<as_<double> > > > , UP(base,15) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<unspecified_<as_<double> > >            , UP(base,16) >::value) );
}
...
BOOST_SIMD_TEST_CASE(hierarchy_of_float)
{
  ...
  BOOST_SIMD_TEST( (is_same<target_<scalar_<real_sized_<as_<float> >  > > , UP(base,2) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<scalar_<real_<as_<float> >        > > , UP(base,3) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<scalar_<signed_<as_<float> >      > > , UP(base,4) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<scalar_<arithmetic_<as_<float> >  > > , UP(base,5) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<scalar_<fundamental_<as_<float> > > > , UP(base,6) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<scalar_<unspecified_<as_<float> > > > , UP(base,7) >::value) );

  BOOST_SIMD_TEST( (is_same<target_<generic_<float_<as_<float> >      > > , UP(base,8) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<generic_<type32_<as_<float> >      > > , UP(base,9) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<generic_<real_sized_<as_<float> >  > > , UP(base,10) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<generic_<real_<as_<float> >        > > , UP(base,11) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<generic_<signed_<as_<float> >      > > , UP(base,12) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<generic_<arithmetic_<as_<float> >  > > , UP(base,13) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<generic_<fundamental_<as_<float> > > > , UP(base,14) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<generic_<unspecified_<as_<float> > > > , UP(base,15) >::value) );
  BOOST_SIMD_TEST( (is_same<target_<unspecified_<as_<float> > >            , UP(base,16) >::value) );
}
