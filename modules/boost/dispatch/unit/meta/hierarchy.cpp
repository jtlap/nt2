 ...
 ******************************************************************************/
#define BOOST_SIMD_UNIT_MODULE "boost::dispatch::meta::hierarchy_of"
...
BOOST_SIMD_TEST_CASE(hierarchy_of_ints64)
{
  ...
  BOOST_SIMD_TEST( (is_same<scalar_<real_sized_<boost::simd::int64_t>  > , UP(base,3) >::value) );
  BOOST_SIMD_TEST( (is_same<scalar_<int_<boost::simd::int64_t>         > , UP(base,4) >::value) );
  BOOST_SIMD_TEST( (is_same<scalar_<signed_<boost::simd::int64_t>      > , UP(base,5) >::value) );
  BOOST_SIMD_TEST( (is_same<scalar_<integer_<boost::simd::int64_t>     > , UP(base,6) >::value) );
  BOOST_SIMD_TEST( (is_same<scalar_<arithmetic_<boost::simd::int64_t>  > , UP(base,7) >::value) );
  BOOST_SIMD_TEST( (is_same<scalar_<fundamental_<boost::simd::int64_t> > , UP(base,8) >::value) );
  BOOST_SIMD_TEST( (is_same<scalar_<unspecified_<boost::simd::int64_t> > , UP(base,9) >::value) );

  BOOST_SIMD_TEST( (is_same<generic_<int64_<boost::simd::int64_t>        > , UP(base,10) >::value) );
  BOOST_SIMD_TEST( (is_same<generic_<ints64_<boost::simd::int64_t>       > , UP(base,11) >::value) );
  BOOST_SIMD_TEST( (is_same<generic_<type64_<boost::simd::int64_t>       > , UP(base,12) >::value) );
  BOOST_SIMD_TEST( (is_same<generic_<real_sized_<boost::simd::int64_t>   > , UP(base,13) >::value) );
  BOOST_SIMD_TEST( (is_same<generic_<int_<boost::simd::int64_t>          > , UP(base,14) >::value) );
  BOOST_SIMD_TEST( (is_same<generic_<signed_<boost::simd::int64_t>       > , UP(base,15) >::value) );
  BOOST_SIMD_TEST( (is_same<generic_<integer_<boost::simd::int64_t>      > , UP(base,16) >::value) );
  BOOST_SIMD_TEST( (is_same<generic_<arithmetic_<boost::simd::int64_t>   > , UP(base,17) >::value) );
  BOOST_SIMD_TEST( (is_same<generic_<fundamental_<boost::simd::int64_t>  > , UP(base,18) >::value) );
  BOOST_SIMD_TEST( (is_same<generic_<unspecified_<boost::simd::int64_t>  > , UP(base,19) >::value) );
  BOOST_SIMD_TEST( (is_same<unspecified_<boost::simd::int64_t>             , UP(base,20) >::value) );
}
...
BOOST_SIMD_TEST_CASE(hierarchy_of_uints64)
{
  ...
  BOOST_SIMD_TEST( (is_same<scalar_<real_sized_<boost::simd::uint64_t>  > , UP(base,3) >::value) );
  BOOST_SIMD_TEST( (is_same<scalar_<uint_<boost::simd::uint64_t>        > , UP(base,4) >::value) );
  BOOST_SIMD_TEST( (is_same<scalar_<unsigned_<boost::simd::uint64_t>    > , UP(base,5) >::value) );
  BOOST_SIMD_TEST( (is_same<scalar_<integer_<boost::simd::uint64_t>     > , UP(base,6) >::value) );
  BOOST_SIMD_TEST( (is_same<scalar_<arithmetic_<boost::simd::uint64_t>  > , UP(base,7) >::value) );
  BOOST_SIMD_TEST( (is_same<scalar_<fundamental_<boost::simd::uint64_t> > , UP(base,8) >::value) );
  BOOST_SIMD_TEST( (is_same<scalar_<unspecified_<boost::simd::uint64_t> > , UP(base,9) >::value) );

  BOOST_SIMD_TEST( (is_same<generic_<uint64_<boost::simd::uint64_t>       > , UP(base,10) >::value) );
  BOOST_SIMD_TEST( (is_same<generic_<ints64_<boost::simd::uint64_t>       > , UP(base,11) >::value) );
  BOOST_SIMD_TEST( (is_same<generic_<type64_<boost::simd::uint64_t>       > , UP(base,12) >::value) );
  BOOST_SIMD_TEST( (is_same<generic_<real_sized_<boost::simd::uint64_t>   > , UP(base,13) >::value) );
  BOOST_SIMD_TEST( (is_same<generic_<uint_<boost::simd::uint64_t>         > , UP(base,14) >::value) );
  BOOST_SIMD_TEST( (is_same<generic_<unsigned_<boost::simd::uint64_t>     > , UP(base,15) >::value) );
  BOOST_SIMD_TEST( (is_same<generic_<integer_<boost::simd::uint64_t>      > , UP(base,16) >::value) );
  BOOST_SIMD_TEST( (is_same<generic_<arithmetic_<boost::simd::uint64_t>   > , UP(base,17) >::value) );
  BOOST_SIMD_TEST( (is_same<generic_<fundamental_<boost::simd::uint64_t>  > , UP(base,18) >::value) );
  BOOST_SIMD_TEST( (is_same<generic_<unspecified_<boost::simd::uint64_t>  > , UP(base,19) >::value) );
  BOOST_SIMD_TEST( (is_same<unspecified_<boost::simd::uint64_t>             , UP(base,20) >::value) );
}
...
BOOST_SIMD_TEST_CASE(hierarchy_of_ints32)
{
  ...
  BOOST_SIMD_TEST( (is_same<scalar_<real_sized_<boost::simd::int32_t>  > , UP(base,3) >::value) );
  BOOST_SIMD_TEST( (is_same<scalar_<int_<boost::simd::int32_t>         > , UP(base,4) >::value) );
  BOOST_SIMD_TEST( (is_same<scalar_<signed_<boost::simd::int32_t>      > , UP(base,5) >::value) );
  BOOST_SIMD_TEST( (is_same<scalar_<integer_<boost::simd::int32_t>     > , UP(base,6) >::value) );
  BOOST_SIMD_TEST( (is_same<scalar_<arithmetic_<boost::simd::int32_t>  > , UP(base,7) >::value) );
  BOOST_SIMD_TEST( (is_same<scalar_<fundamental_<boost::simd::int32_t> > , UP(base,8) >::value) );
  BOOST_SIMD_TEST( (is_same<scalar_<unspecified_<boost::simd::int32_t> > , UP(base,9) >::value) );

  BOOST_SIMD_TEST( (is_same<generic_<int32_<boost::simd::int32_t>        > , UP(base,10) >::value) );
  BOOST_SIMD_TEST( (is_same<generic_<ints32_<boost::simd::int32_t>       > , UP(base,11) >::value) );
  BOOST_SIMD_TEST( (is_same<generic_<type32_<boost::simd::int32_t>       > , UP(base,12) >::value) );
  BOOST_SIMD_TEST( (is_same<generic_<real_sized_<boost::simd::int32_t>   > , UP(base,13) >::value) );
  BOOST_SIMD_TEST( (is_same<generic_<int_<boost::simd::int32_t>          > , UP(base,14) >::value) );
  BOOST_SIMD_TEST( (is_same<generic_<signed_<boost::simd::int32_t>       > , UP(base,15) >::value) );
  BOOST_SIMD_TEST( (is_same<generic_<integer_<boost::simd::int32_t>      > , UP(base,16) >::value) );
  BOOST_SIMD_TEST( (is_same<generic_<arithmetic_<boost::simd::int32_t>   > , UP(base,17) >::value) );
  BOOST_SIMD_TEST( (is_same<generic_<fundamental_<boost::simd::int32_t>  > , UP(base,18) >::value) );
  BOOST_SIMD_TEST( (is_same<generic_<unspecified_<boost::simd::int32_t>  > , UP(base,19) >::value) );
  BOOST_SIMD_TEST( (is_same<unspecified_<boost::simd::int32_t>             , UP(base,20) >::value) );
}
...
BOOST_SIMD_TEST_CASE(hierarchy_of_uints32)
{
  ...
  BOOST_SIMD_TEST( (is_same<scalar_<real_sized_<boost::simd::uint32_t>  > , UP(base,3) >::value) );
  BOOST_SIMD_TEST( (is_same<scalar_<uint_<boost::simd::uint32_t>        > , UP(base,4) >::value) );
  BOOST_SIMD_TEST( (is_same<scalar_<unsigned_<boost::simd::uint32_t>    > , UP(base,5) >::value) );
  BOOST_SIMD_TEST( (is_same<scalar_<integer_<boost::simd::uint32_t>     > , UP(base,6) >::value) );
  BOOST_SIMD_TEST( (is_same<scalar_<arithmetic_<boost::simd::uint32_t>  > , UP(base,7) >::value) );
  BOOST_SIMD_TEST( (is_same<scalar_<fundamental_<boost::simd::uint32_t> > , UP(base,8) >::value) );
  BOOST_SIMD_TEST( (is_same<scalar_<unspecified_<boost::simd::uint32_t> > , UP(base,9) >::value) );

  BOOST_SIMD_TEST( (is_same<generic_<uint32_<boost::simd::uint32_t>       > , UP(base,10) >::value) );
  BOOST_SIMD_TEST( (is_same<generic_<ints32_<boost::simd::uint32_t>       > , UP(base,11) >::value) );
  BOOST_SIMD_TEST( (is_same<generic_<type32_<boost::simd::uint32_t>       > , UP(base,12) >::value) );
  BOOST_SIMD_TEST( (is_same<generic_<real_sized_<boost::simd::uint32_t>   > , UP(base,13) >::value) );
  BOOST_SIMD_TEST( (is_same<generic_<uint_<boost::simd::uint32_t>         > , UP(base,14) >::value) );
  BOOST_SIMD_TEST( (is_same<generic_<unsigned_<boost::simd::uint32_t>     > , UP(base,15) >::value) );
  BOOST_SIMD_TEST( (is_same<generic_<integer_<boost::simd::uint32_t>      > , UP(base,16) >::value) );
  BOOST_SIMD_TEST( (is_same<generic_<arithmetic_<boost::simd::uint32_t>   > , UP(base,17) >::value) );
  BOOST_SIMD_TEST( (is_same<generic_<fundamental_<boost::simd::uint32_t>  > , UP(base,18) >::value) );
  BOOST_SIMD_TEST( (is_same<generic_<unspecified_<boost::simd::uint32_t>  > , UP(base,19) >::value) );
  BOOST_SIMD_TEST( (is_same<unspecified_<boost::simd::uint32_t>             , UP(base,20) >::value) );
}
...
BOOST_SIMD_TEST_CASE(hierarchy_of_double)
{
  ...
  BOOST_SIMD_TEST( (is_same<scalar_<real_sized_<double>  > , UP(base,2) >::value) );
  BOOST_SIMD_TEST( (is_same<scalar_<real_<double>        > , UP(base,3) >::value) );
  BOOST_SIMD_TEST( (is_same<scalar_<signed_<double>      > , UP(base,4) >::value) );
  BOOST_SIMD_TEST( (is_same<scalar_<arithmetic_<double>  > , UP(base,5) >::value) );
  BOOST_SIMD_TEST( (is_same<scalar_<fundamental_<double> > , UP(base,6) >::value) );
  BOOST_SIMD_TEST( (is_same<scalar_<unspecified_<double> > , UP(base,7) >::value) );

  BOOST_SIMD_TEST( (is_same<generic_<double_<double>      > , UP(base,8) >::value) );
  BOOST_SIMD_TEST( (is_same<generic_<type64_<double>      > , UP(base,9) >::value) );
  BOOST_SIMD_TEST( (is_same<generic_<real_sized_<double>  > , UP(base,10) >::value) );
  BOOST_SIMD_TEST( (is_same<generic_<real_<double>        > , UP(base,11) >::value) );
  BOOST_SIMD_TEST( (is_same<generic_<signed_<double>      > , UP(base,12) >::value) );
  BOOST_SIMD_TEST( (is_same<generic_<arithmetic_<double>  > , UP(base,13) >::value) );
  BOOST_SIMD_TEST( (is_same<generic_<fundamental_<double> > , UP(base,14) >::value) );
  BOOST_SIMD_TEST( (is_same<generic_<unspecified_<double> > , UP(base,15) >::value) );
  BOOST_SIMD_TEST( (is_same<unspecified_<double>            , UP(base,16) >::value) );
}
...
BOOST_SIMD_TEST_CASE(hierarchy_of_float)
{
  ...
  BOOST_SIMD_TEST( (is_same<scalar_<real_sized_<float>  > , UP(base,2) >::value) );
  BOOST_SIMD_TEST( (is_same<scalar_<real_<float>        > , UP(base,3) >::value) );
  BOOST_SIMD_TEST( (is_same<scalar_<signed_<float>      > , UP(base,4) >::value) );
  BOOST_SIMD_TEST( (is_same<scalar_<arithmetic_<float>  > , UP(base,5) >::value) );
  BOOST_SIMD_TEST( (is_same<scalar_<fundamental_<float> > , UP(base,6) >::value) );
  BOOST_SIMD_TEST( (is_same<scalar_<unspecified_<float> > , UP(base,7) >::value) );

  BOOST_SIMD_TEST( (is_same<generic_<float_<float>      > , UP(base,8) >::value) );
  BOOST_SIMD_TEST( (is_same<generic_<type32_<float>      > , UP(base,9) >::value) );
  BOOST_SIMD_TEST( (is_same<generic_<real_sized_<float>  > , UP(base,10) >::value) );
  BOOST_SIMD_TEST( (is_same<generic_<real_<float>        > , UP(base,11) >::value) );
  BOOST_SIMD_TEST( (is_same<generic_<signed_<float>      > , UP(base,12) >::value) );
  BOOST_SIMD_TEST( (is_same<generic_<arithmetic_<float>  > , UP(base,13) >::value) );
  BOOST_SIMD_TEST( (is_same<generic_<fundamental_<float> > , UP(base,14) >::value) );
  BOOST_SIMD_TEST( (is_same<generic_<unspecified_<float> > , UP(base,15) >::value) );
  BOOST_SIMD_TEST( (is_same<unspecified_<float>            , UP(base,16) >::value) );
}
