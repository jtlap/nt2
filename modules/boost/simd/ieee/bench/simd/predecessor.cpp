...
//////////////////////////////////////////////////////////////////////////////
#define BOOST_SIMD_BENCH_MODULE "nt2 ieee toolbox - predecessor/simd Mode"
...
namespace n1 {
  ...
  BOOST_SIMD_TIMING(predecessor_,(RS(vT,T(-10),T(10))))
}
namespace n2 {
  typedef double T;
  typedef boost::simd::meta::as_integer<T>::type iT;
...
namespace n3 {
  ...
  BOOST_SIMD_TIMING(predecessor_,(RS(vT,T(-10),T(10)))(RS(viT,iT(2),iT(2))))
}
namespace n4 {
  typedef double T;
  typedef boost::simd::meta::as_integer<T>::type iT;
