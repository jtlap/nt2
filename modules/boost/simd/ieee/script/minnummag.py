[ ## this file was manually modified by jt
    {
     'functor' : {
         'description' : ['Returns the input value which have the least absolute value, ignoring nan.'],
         'module' : 'boost',
         'arity' : '2',
         'call_types' : [],
         'ret_arity' : '0',
     ...
     'unit' : {
         'global_header' : {
             ...
             'included' : ['#include <boost/simd/include/functions/abs.hpp>'],
             'no_ulp' : 'True',
             'notes' : [],
         ...
         'verif_test' : {
             'property_call' : {
                 'default' : ['boost::simd::minnummag(a0,a1)'],
                },
             'property_value' : {
                 'default' : ['(boost::simd::abs(a0) < boost::simd::abs(a1)) ? a0 : a1'],
                },
             'ulp_thresh' : '0',
            },
        },
