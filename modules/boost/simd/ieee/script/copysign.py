[ ## this file was manually modified by jt
    {
     ...
     'unit' : {
         'global_header' : {
             ...
             'included' : ['#include <boost/simd/include/functions/signnz.hpp>',
         ...
         'specific_values' : {
             ...
             'real_' : {
                 ...
                 'boost::simd::One<T>(), -boost::simd::Zero<T>()' : '-boost::simd::One<r_t>()',
                 'boost::simd::One<T>(), boost::simd::Zero<T>()' : 'boost::simd::One<r_t>()',
         ...
         'verif_test' : {
             'property_call' : {
                 'default' :['boost::simd::copysign(a0,a1)'],
                },
             'property_value' : {
                 'default' : ['boost::simd::abs(a0)*boost::simd::signnz(a1)'],
                },
             'ulp_thresh' : '0',
            },
        },
