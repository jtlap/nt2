[ ## this file was manually modified by jt
    {
     ...
     'unit' : {
         'global_header' : {
             ...
             'included' : ['#include <nt2/include/functions/max.hpp>'],
             'no_ulp' : 'True',
             'notes' : [],
         ...
         'specific_values' : {
             ...
             'real_' : {
                 ...
                 'nt2::Nan<T>(),nt2::One<T>()' : 'nt2::One<r_t>()',
                 'nt2::One<T>()' : 'nt2::One<r_t>()',
                 'nt2::One<T>(),nt2::Nan<T>()' : 'nt2::One<r_t>()',
         ...
         'verif_test' : {
             'property_call' : {
                 'default' : ['nt2::maxnum(a0,a1)'],
                },
             'property_value' : {
                 'default' : ['nt2::max(a0,a1)'],
                },
             'ulp_thresh' : '0',
            },
        },
