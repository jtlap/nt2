...
//==============================================================================
#ifndef BOOST_SIMD_TOOLBOX_IEEE_FUNCTIONS_GENERIC_FREXP_HPP_INCLUDED
#define BOOST_SIMD_TOOLBOX_IEEE_FUNCTIONS_GENERIC_FREXP_HPP_INCLUDED
...
namespace boost { namespace simd { namespace ext
{
                                    ...
                                    )
  {
    ...
    {
      result_type res;
      boost::simd::frexp( a0, res.first, res.second );
      return res;
    }
  };
} } }
