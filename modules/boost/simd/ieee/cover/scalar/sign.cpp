...
//////////////////////////////////////////////////////////////////////////////
#define NT2_UNIT_MODULE "nt2 boost.simd.ieee toolbox - sign/scalar Mode"
...
NT2_TEST_CASE_TPL ( sign_real__1_0,  BOOST_SIMD_REAL_TYPES)
{
    ...
    for(nt2::uint32_t j =0; j < NR; ++j )
      {
        std::cout << "for param "
                  << "  a0 = "<< u_t(a0 = tab_a0[j])
                  << std::endl;
        NT2_TEST_EQUAL( boost::simd::sign(a0),(a0==0) ? 0 : (a0>0) ? 1 : -1);
     }
     
   }
} // end of test for floating_

NT2_TEST_CASE_TPL ( sign_unsigned_int__1_0,  BOOST_SIMD_UNSIGNED_TYPES)
{
...
NT2_TEST_CASE_TPL ( sign_signed_int__1_0,  BOOST_SIMD_INTEGRAL_SIGNED_TYPES)
{
