...
namespace boost { namespace simd { namespace ext
{
  ...
  BOOST_SIMD_FUNCTOR_IMPLEMENTATION( boost::simd::tag::schedule_, tag::formal_
                                   , (A0)(D)(F)
                                   , ((node_<A0, boost::simd::tag::assign_, mpl::long_<2>, D>))
                                     (unspecified_<F>)
                                   )
  {
