...
{
  //============================================================================
  // Run an expression witohut state nor data
  //============================================================================
                            ...
                            )
  {
    ...
    struct result<This(A0_)>
      : transform::template result<transform(A0_)>
    {
    };
    ...
    unpack< proto::
            call< dispatch::
                ...
                > ( proto::
                    when< proto::_
                        , proto::call< typename dispatch::
                                       make_functor< tag::run_, A0>::type( proto::_expr
                                                                         , proto::_state
                                                                         )
                                     >
                        >
  ...
  BOOST_SIMD_FUNCTOR_IMPLEMENTATION( boost::simd::tag::run_, tag::cpu_
                            , (A0)(Domain)(State)
                            , ((expr_< unspecified_<A0>, Domain, tag::terminal_ >))
                              (unspecified_<State>)
                            )
  {
    template<class Sig>
    ...
    operator()(A0_& a0, State_& state) const
    {
      return typename dispatch::make_functor<tag::terminal_, A0>::type()(a0, state);
    }
  };
                            ...
                            )
  {
    ...
    template<class A0_, class State_, class Data_>
    BOOST_DISPATCH_FORCE_INLINE typename result<implement(A0_&, State_&, Data_&)>::type
                            ...
                            )
  {
    ...
    operator()(A0_& a0, State_& state, Data_& data) const
    {
      return typename dispatch::make_functor<tag::terminal_, A0>::type()(a0, state,data);
    }
  };
