...
//==============================================================================
#ifndef BOOST_SIMD_SDK_SIMD_EXTENSIONS_X86_FMA_HPP_INCLUDED
#define BOOST_SIMD_SDK_SIMD_EXTENSIONS_X86_FMA_HPP_INCLUDED

#if defined(__FMA__)
#  ifndef BOOST_SIMD_HAS_FMA_SUPPORT
#    define BOOST_SIMD_HAS_FMA_SUPPORT
#  endif
#elif defined(BOOST_SIMD_HAS_FMA_SUPPORT) && !defined(_MSC_VER)
#  undef BOOST_SIMD_HAS_FMA_SUPPORT
#endif

#if defined(BOOST_SIMD_HAS_FMA_SUPPORT) && !defined(BOOST_SIMD_HAS_AVX_SUPPORT)
...
#define BOOST_SIMD_STRING             "FMA"
#define BOOST_SIMD_STRING_LIST        "SSE2 SSE3 SSSE3 SSE4_1 SSE4_2 AVX FMA"
...
#define BOOST_SIMD_DEFAULT_SITE       ::boost::simd::tag::fma_
