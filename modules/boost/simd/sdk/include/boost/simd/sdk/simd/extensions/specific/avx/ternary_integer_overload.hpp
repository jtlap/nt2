...
//==============================================================================
#ifndef BOOST_SIMD_SDK_SIMD_EXTENSIONS_SPECIFIC_AVX_TERNARY_INTEGER_OVERLOAD_HPP_INCLUDED
#define BOOST_SIMD_SDK_SIMD_EXTENSIONS_SPECIFIC_AVX_TERNARY_INTEGER_OVERLOAD_HPP_INCLUDED
...
namespace boost { namespace simd { namespace ext
{
                     ...
                     )
  {
    ...
    BOOST_SIMD_FUNCTOR_CALL_REPEAT(3)
    {
      ...
      // Perform computation
      r0 = callee(a00,a10,a20);
      r1 = callee(a01,a11,a21);
