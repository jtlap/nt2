...
namespace boost { namespace simd
{
  ...
  namespace meta
  {
    ...
    struct as_tuple
    {
      ...
      typedef tuple<BOOST_PP_ENUM(BOOST_DISPATCH_MAX_ARITY, M0, ~)> type;
      #undef M0
    };
  }
...
namespace boost { namespace fusion { namespace extension
{
  ...
  struct value_at_impl<boost::simd::tag::tuple_>
  {
    template<class Seq, class N>
    struct apply
     : remove_reference<typename at_impl<boost::simd::tag::tuple_>::template apply<Seq, N>::type>
    {
    };
  };
...
namespace boost { namespace fusion { namespace extension
{
  template<BOOST_PP_ENUM_PARAMS(BOOST_DISPATCH_MAX_ARITY, class T)>
  struct at_impl<boost::simd::tag::tuple_>
  ::apply_c< boost::simd::tuple<BOOST_PP_ENUM_PARAMS(BOOST_DISPATCH_MAX_ARITY, T)>, BOOST_PP_DEC(N) >
  {
    typedef BOOST_PP_CAT(T, BOOST_PP_DEC(N))& type;
    static type call(boost::simd::tuple<BOOST_PP_ENUM_PARAMS(BOOST_DISPATCH_MAX_ARITY, T)>& seq)
    {
  ...
  template<BOOST_PP_ENUM_PARAMS(BOOST_DISPATCH_MAX_ARITY, class T)>
  struct at_impl<boost::simd::tag::tuple_>
  ::apply_c< boost::simd::tuple<BOOST_PP_ENUM_PARAMS(BOOST_DISPATCH_MAX_ARITY, T)> const, BOOST_PP_DEC(N) >
  {
    typedef BOOST_PP_CAT(T, BOOST_PP_DEC(N)) const& type;
    static type call(boost::simd::tuple<BOOST_PP_ENUM_PARAMS(BOOST_DISPATCH_MAX_ARITY, T)> const& seq)
    {
      return seq.BOOST_PP_CAT(m, BOOST_PP_DEC(N));
    }
  };
