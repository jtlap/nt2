...
int main()
{
  ...
  typedef boost::simd::meta::prev_power_of_2<int_<0>    >::type  a0;
  typedef boost::simd::meta::prev_power_of_2<int_<9>    >::type  a9;
  typedef boost::simd::meta::prev_power_of_2<int_<1055> >::type  a1055;
