...
namespace boost { namespace simd { namespace tag
  ...
  {
    template<class Site>
    BOOST_FORCEINLINE generic_dispatcher<tag::cummin_, Site> dispatching_cummin_(adl_helper, boost::dispatch::meta::unknown_<Site>, ...)
    {
  ...
  /*!
    compute the cumulate min of the vector elements
