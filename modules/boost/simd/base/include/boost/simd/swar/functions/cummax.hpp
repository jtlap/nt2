...
namespace boost { namespace simd { namespace tag
  ...
  {
    template<class Site>
    BOOST_FORCEINLINE generic_dispatcher<tag::cummax_, Site> dispatching_cummax_(adl_helper, boost::dispatch::meta::unknown_<Site>, ...)
    {
  ...
  /*!
    compute the cumulate max of the vector elements
