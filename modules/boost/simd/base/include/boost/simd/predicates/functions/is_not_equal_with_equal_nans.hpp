...
namespace boost { namespace simd { namespace tag
  ...
  {
   template<class Site>
   BOOST_FORCEINLINE generic_dispatcher<tag::is_not_equal_with_equal_nans_, Site> dispatching_is_not_equal_with_equal_nans_(adl_helper, boost::dispatch::meta::unknown_<Site>, ...)
   {
