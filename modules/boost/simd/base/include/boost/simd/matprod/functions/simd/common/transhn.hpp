...
//==============================================================================
#ifndef BOOST_SIMD_MATPROD_FUNCTIONS_SIMD_COMMON_TRANSHN_HPP_INCLUDED
#define BOOST_SIMD_MATPROD_FUNCTIONS_SIMD_COMMON_TRANSHN_HPP_INCLUDED
...
//         }
//       }
// r is the transpose of the (N/2)x(2*N) (or (2*N)x(N/2)) matrix.
...
namespace boost { namespace simd {
  ...
  namespace details
  {
    ...
    template <size_t N, class A, class R> struct  do_transpose<N, 1, A, R>
    {
...
namespace ext
{
  ...
  BOOST_SIMD_FUNCTOR_IMPLEMENTATION ( boost::simd::tag::transhn_
                                    , boost::simd::tag::cpu_
                                    , (A)(X)
...

  {
    ...
    BOOST_FORCEINLINE  result_type operator()(const A& a) const
    {
      ...
      result_type r;
       ...
       details::do_transpose<N, N/2, A, result_type>()(a, r);
       return r;
    }
  };
