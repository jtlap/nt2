...
//==============================================================================
#ifndef BOOST_SIMD_ARITHMETIC_FUNCTIONS_SIMD_COMMON_IDIVROUND2EVEN_HPP_INCLUDED
#define BOOST_SIMD_ARITHMETIC_FUNCTIONS_SIMD_COMMON_IDIVROUND2EVEN_HPP_INCLUDED
...
namespace boost { namespace simd { namespace ext
{
                            ...
                            )
  {
    ...
    BOOST_SIMD_FUNCTOR_CALL_REPEAT(2)
    {
      ...
      split(a0, a0l, a0h );
      split(a1, a1l, a1h);
      return simd::bitwise_cast<A0>(groups(idivround2even(a0l, a1l),
                               idivround2even(a0h, a1h)));
    }
  };
