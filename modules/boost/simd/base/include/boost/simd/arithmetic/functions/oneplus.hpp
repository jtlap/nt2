...
namespace boost { namespace simd { namespace tag
  ...
  BOOST_FORCEINLINE generic_dispatcher<tag::oneplus_, Site> dispatching_oneplus_(adl_helper, boost::dispatch::meta::unknown_<Site>, boost::dispatch::meta::unknown_<H>...)
  {
