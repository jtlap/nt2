...
//==============================================================================
#ifndef BOOST_SIMD_ARITHMETIC_FUNCTIONS_SIMD_COMMON_ROUND2ZERO_HPP_INCLUDED
#define BOOST_SIMD_ARITHMETIC_FUNCTIONS_SIMD_COMMON_ROUND2ZERO_HPP_INCLUDED
...
namespace boost { namespace simd { namespace ext
{
  ...
  BOOST_SIMD_FUNCTOR_IMPLEMENTATION( boost::simd::tag::round2zero_, boost::simd::tag::simd_,
                                     (A0)(X)
                                   ...
                                   )
  {
    ...
    BOOST_SIMD_FUNCTOR_CALL(1)
    {
      ...
      result_type r =  tofloat(toint(v+Half<result_type>()));
      return if_else(is_nlt(v, Maxflint<result_type>()), a0,
                     b_or(tofloat(toint(selsub(eq(abs(r-v), Half<result_type>()),
                                               r, One<result_type>()))),
                          bitofsign(a0))
                    );
    }
