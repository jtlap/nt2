...
//==============================================================================
#define NT2_UNIT_MODULE "nt2 boost.simd.boolean toolbox - ifnotdec/scalar Mode"
...
NT2_TEST_CASE_TPL ( ifnotdec_signed_int__2_0,  BOOST_SIMD_SIMD_INTEGRAL_SIGNED_TYPES)
{
  typedef boost::simd::native<T, BOOST_SIMD_DEFAULT_EXTENSION> vT;

  using boost::simd::ifnotdec;
  using boost::simd::tag::ifnotdec_;
  typedef typename boost::dispatch::meta::call<ifnotdec_(vT, vT)>::type r_t;
...
NT2_TEST_CASE_TPL ( ifnotdec_unsigned_int__2_0,  BOOST_SIMD_SIMD_UNSIGNED_TYPES)
{
  typedef boost::simd::native<T, BOOST_SIMD_DEFAULT_EXTENSION> vT;
