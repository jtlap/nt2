...
//==============================================================================
#define NT2_UNIT_MODULE "nt2 boost.simd.boolean toolbox - ifnotinc/scalar Mode"
...
NT2_TEST_CASE_TPL ( ifnotinc_signed_int__2_0,  BOOST_SIMD_SIMD_INTEGRAL_SIGNED_TYPES)
{
  ...
  typedef typename boost::dispatch::meta::call<ifnotinc_(vT, vT)>::type r_t;
...
NT2_TEST_CASE_TPL ( ifnotinc_unsigned_int__2_0,  BOOST_SIMD_SIMD_UNSIGNED_TYPES)
{
  typedef boost::simd::native<T, BOOST_SIMD_DEFAULT_EXTENSION> vT;
