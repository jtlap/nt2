...
NT2_TEST_CASE ( is_not_greater_equal_bool)
{
  using boost::simd::is_not_greater_equal;
  using boost::simd::tag::is_not_greater_equal_;
  typedef typename boost::dispatch::meta::call<is_not_greater_equal_(bool, bool)>::type r_t;
  ...
  // specific values tests
  NT2_TEST_EQUAL(is_not_greater_equal(true, false), false);
  NT2_TEST_EQUAL(is_not_greater_equal(false, true), true);
  NT2_TEST_EQUAL(is_not_greater_equal(true, true), false);
  NT2_TEST_EQUAL(is_not_greater_equal(false, false), false);
}
