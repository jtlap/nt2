...
NT2_TEST_CASE_TPL(is_eqz_real, BOOST_SIMD_SIMD_REAL_TYPES)
{
  ...
  NT2_TEST_EQUAL(is_eqz(boost::simd::Inf<vT>()), boost::simd::False<r_t>());
  NT2_TEST_EQUAL(is_eqz(boost::simd::Minf<vT>()), boost::simd::False<r_t>());
  NT2_TEST_EQUAL(is_eqz(boost::simd::Nan<vT>()), boost::simd::False<r_t>());
#endif
  NT2_TEST_EQUAL(is_eqz(boost::simd::Mzero<vT>()), boost::simd::True<r_t>());
  NT2_TEST_EQUAL(is_eqz(boost::simd::Half<vT>()), boost::simd::False<r_t>());
  ...
  NT2_TEST_EQUAL(is_eqz(boost::simd::Quarter<vT>()), boost::simd::False<r_t>());
  NT2_TEST_EQUAL(is_eqz(boost::simd::Two<vT>()), boost::simd::False<r_t>());
