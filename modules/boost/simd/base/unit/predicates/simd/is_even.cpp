...
NT2_TEST_CASE_TPL(is_even_real, BOOST_SIMD_REAL_TYPES)
{
...
NT2_TEST_CASE_TPL(is_even_ui, BOOST_SIMD_UNSIGNED_TYPES)
{
  using boost::simd::is_even;
  using boost::simd::tag::is_even_;
  using boost::simd::native;
...
NT2_TEST_CASE_TPL(is_even_si, BOOST_SIMD_INTEGRAL_SIGNED_TYPES)
{
  using boost::simd::is_even;
  using boost::simd::tag::is_even_;
  using boost::simd::native;
