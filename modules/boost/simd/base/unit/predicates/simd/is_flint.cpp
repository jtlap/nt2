...
NT2_TEST_CASE_TPL(is_flint_real, BOOST_SIMD_REAL_TYPES)
{
...
NT2_TEST_CASE_TPL(is_flint_ui, BOOST_SIMD_UNSIGNED_TYPES)
{
  using boost::simd::is_flint;
  using boost::simd::tag::is_flint_;
  using boost::simd::native;
...
NT2_TEST_CASE_TPL(is_flint_si, BOOST_SIMD_INTEGRAL_SIGNED_TYPES)
{
  using boost::simd::is_flint;
  using boost::simd::tag::is_flint_;
  using boost::simd::native;
