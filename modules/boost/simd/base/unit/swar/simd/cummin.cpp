...
NT2_TEST_CASE_TPL ( cummin_real,  BOOST_SIMD_SIMD_REAL_TYPES)
{
...
NT2_TEST_CASE_TPL ( cummin_signed_int__1_0,  BOOST_SIMD_SIMD_INTEGRAL_SIGNED_TYPES)
{
  using boost::simd::cummin;
  using boost::simd::tag::cummin_;
  using boost::simd::native;
...
NT2_TEST_CASE_TPL ( cummin_unsigned_int__1_0,  BOOST_SIMD_SIMD_UNSIGNED_TYPES)
{
  using boost::simd::cummin;
  using boost::simd::tag::cummin_;
  using boost::simd::native;
