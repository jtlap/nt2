...
NT2_TEST_CASE_TPL ( negate_real,  BOOST_SIMD_REAL_TYPES)
{
...
NT2_TEST_CASE_TPL ( negate_unsigned_int,  BOOST_SIMD_UNSIGNED_TYPES)
{
  using boost::simd::negate;
  using boost::simd::tag::negate_;
  typedef typename boost::dispatch::meta::call<negate_(T,T)>::type r_t;
...
NT2_TEST_CASE_TPL ( negate_signed_int,  BOOST_SIMD_INTEGRAL_SIGNED_TYPES)
{
  using boost::simd::negate;
  using boost::simd::tag::negate_;
  typedef typename boost::dispatch::meta::call<negate_(T,T)>::type r_t;
