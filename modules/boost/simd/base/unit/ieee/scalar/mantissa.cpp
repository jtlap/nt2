...
NT2_TEST_CASE_TPL ( mantissa_real,  BOOST_SIMD_REAL_TYPES)
{
  ...
  NT2_TEST_EQUAL(mantissa(boost::simd::Two <T>()), boost::simd::One<r_t>());
  NT2_TEST_EQUAL(mantissa(T(1.5)), T(1.5));
  NT2_TEST_EQUAL(mantissa(T(2.5)), T(1.25));
}
