...
NT2_TEST_CASE_TPL ( sbits_real,  BOOST_SIMD_REAL_TYPES)
{
...
NT2_TEST_CASE_TPL ( sbits_unsigned_int,  BOOST_SIMD_UNSIGNED_TYPES)
{
  using boost::simd::sbits;
  using boost::simd::tag::sbits_;
  typedef typename boost::dispatch::meta::call<sbits_(T)>::type r_t;
...
NT2_TEST_CASE_TPL ( sbits_signed_int,  BOOST_SIMD_INTEGRAL_SIGNED_TYPES)
{
  using boost::simd::sbits;
  using boost::simd::tag::sbits_;
  typedef typename boost::dispatch::meta::call<sbits_(T)>::type r_t;
