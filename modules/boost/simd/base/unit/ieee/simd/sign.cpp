...
NT2_TEST_CASE_TPL ( sign_si,  BOOST_SIMD_SIMD_REAL_TYPES)
{
  ...
  NT2_TEST_EQUAL(sign(boost::simd::Inf<vT>()), boost::simd::One<r_t>());
  NT2_TEST_EQUAL(sign(boost::simd::Minf<vT>()), boost::simd::Mone<r_t>());
  NT2_TEST_EQUAL(sign(boost::simd::Nan<vT>()), boost::simd::Nan<r_t>());
#endif
...
NT2_TEST_CASE_TPL ( sign_real,  BOOST_SIMD_SIMD_INTEGRAL_SIGNED_TYPES)
{
  ...
  NT2_TEST_EQUAL(sign(boost::simd::One<vT>()), boost::simd::One<r_t>());
  NT2_TEST_EQUAL(sign(boost::simd::Zero<vT>()), boost::simd::Zero<r_t>());
  NT2_TEST_EQUAL(sign(boost::simd::Mtwo<vT>()), boost::simd::Mone<r_t>());
  NT2_TEST_EQUAL(sign(boost::simd::Two<vT>()), boost::simd::One<r_t>());
}
