...
NT2_TEST_CASE_TPL ( maxnummag_real,  BOOST_SIMD_SIMD_REAL_TYPES)
{
  ...
  NT2_TEST_EQUAL(maxnummag(boost::simd::Inf<vT>(), boost::simd::Inf<vT>()), boost::simd::Inf<r_t>());
  NT2_TEST_EQUAL(maxnummag(boost::simd::Minf<vT>(), boost::simd::Minf<vT>()), boost::simd::Minf<r_t>());
  NT2_TEST_EQUAL(maxnummag(boost::simd::Nan<vT>(), boost::simd::Nan<vT>()), boost::simd::Nan<r_t>());
  NT2_TEST_EQUAL(maxnummag(boost::simd::Nan<vT>(),boost::simd::One<vT>()), boost::simd::One<r_t>());
  NT2_TEST_EQUAL(maxnummag(boost::simd::One<vT>(),boost::simd::Nan<vT>()), boost::simd::One<r_t>());
#endif
