...
#endif
  NT2_TEST_EQUAL(dist(boost::simd::Mone<T>(), boost::simd::Mone<T>()), boost::simd::Zero<T>());
  NT2_TEST_EQUAL(dist(boost::simd::One<T>(), boost::simd::One<T>()), boost::simd::Zero<T>());
...
NT2_TEST_CASE_TPL ( dist_unsigned_int,  BOOST_SIMD_UNSIGNED_TYPES)
{
  ...
  NT2_TEST_EQUAL(dist(boost::simd::One<T>(), boost::simd::One<T>()), boost::simd::Zero<T>());
  NT2_TEST_EQUAL(dist(boost::simd::Zero<T>(), boost::simd::Zero<T>()), boost::simd::Zero<T>());
  NT2_TEST_EQUAL(dist(boost::simd::One<T>(), boost::simd::Two<T>()), boost::simd::One<T>());
  NT2_TEST_EQUAL(dist(boost::simd::Two<T>(), boost::simd::One<T>()), boost::simd::One<T>());
