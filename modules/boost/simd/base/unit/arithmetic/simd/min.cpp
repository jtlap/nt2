...
NT2_TEST_CASE_TPL ( min_real, BOOST_SIMD_SIMD_REAL_TYPES )
{
  ...
  NT2_TEST_EQUAL(min(boost::simd::Zero<vT>(), boost::simd::Zero<vT>()), boost::simd::Zero<r_t>());
  NT2_TEST_EQUAL(min(boost::simd::Nan<vT>(), boost::simd::One<vT>()), boost::simd::One<r_t>());
  NT2_TEST_EQUAL(min(boost::simd::One<vT>(), boost::simd::Nan<vT>()), boost::simd::Nan<r_t>());
}

NT2_TEST_CASE_TPL ( min_si, BOOST_SIMD_SIMD_INTEGRAL_SIGNED_TYPES )
{
  using boost::simd::min;
  using boost::simd::tag::min_;
  using boost::simd::native;
  ...
  NT2_TEST_EQUAL(min(boost::simd::One<vT>(), boost::simd::One<vT>()), boost::simd::One<r_t>());
  NT2_TEST_EQUAL(min(boost::simd::Zero<vT>(), boost::simd::Zero<vT>()), boost::simd::Zero<r_t>());
  NT2_TEST_EQUAL(min(boost::simd::One<vT>(), boost::simd::Zero<vT>()), boost::simd::Zero<r_t>());
  NT2_TEST_EQUAL(min(boost::simd::Zero<vT>(), boost::simd::One<vT>()), boost::simd::Zero<r_t>());
}

NT2_TEST_CASE_TPL ( min_ui, BOOST_SIMD_SIMD_UNSIGNED_TYPES )
{
  using boost::simd::min;
  using boost::simd::tag::min_;
  using boost::simd::native;
