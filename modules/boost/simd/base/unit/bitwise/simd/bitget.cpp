...
// NT2_TEST_CASE_TPL ( bitget_ui_1,  BOOST_SIMD_SIMD_UNSIGNED_TYPES)
// {
...
//   typedef typename boost::dispatch::meta::call<bitget_(vT,iT)>::type r_t;

//   // specific values tests
//   NT2_TEST_EQUAL(bitget(boost::simd::Two<vT>(),1), boost::simd::One<r_t>());
//   NT2_TEST_EQUAL(bitget(boost::simd::Mone<vT>(),(sizeof(T)*8-1)), boost::simd::One<r_t>());
//   NT2_TEST_EQUAL(bitget(boost::simd::Mone<vT>(),(sizeof(T)*8-2)), boost::simd::Three<r_t>());
//   NT2_TEST_EQUAL(bitget(boost::simd::One<vT>(),1), boost::simd::Zero<r_t>());
//   NT2_TEST_EQUAL(bitget(boost::simd::Zero<vT>(),1), boost::simd::Zero<r_t>());
// } // end of test for unsigned_int_

// NT2_TEST_CASE_TPL ( bitget_si_1,  BOOST_SIMD_SIMD_INTEGRAL_SIGNED_TYPES)
// {
//   using boost::simd::bitget;
//   using boost::simd::tag::bitget_;
//   using boost::simd::native;
