...
NT2_TEST_CASE_TPL ( shr_uit,  BOOST_SIMD_UNSIGNED_TYPES)
{
  ...
  NT2_TEST_EQUAL(shr(boost::simd::Valmax<T>(),(sizeof(T)*8-1)), boost::simd::One<r_t>());
  NT2_TEST_EQUAL(shr(boost::simd::Valmax<T>(),(sizeof(T)*8-2)), boost::simd::Three<r_t>());
  NT2_TEST_EQUAL(shr(boost::simd::One<T>(),1), boost::simd::Zero<r_t>());
  NT2_TEST_EQUAL(shr(boost::simd::Zero<T>(),1), boost::simd::Zero<r_t>());
} // end of test for unsigned_int_

NT2_TEST_CASE_TPL ( shr_si,  BOOST_SIMD_INTEGRAL_SIGNED_TYPES)
{
