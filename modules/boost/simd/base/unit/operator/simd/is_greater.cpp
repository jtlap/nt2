...
NT2_TEST_CASE_TPL ( is_greater_integer,  BOOST_SIMD_SIMD_TYPES)
{
  ...
  NT2_TEST_EQUAL(is_greater(boost::simd::Valmax<vT>(), boost::simd::Valmin<vT>()), True<r_t>());
  NT2_TEST_EQUAL(is_greater(boost::simd::Valmax<vT>(), boost::simd::Valmax<vT>()), False<r_t>());
  NT2_TEST_EQUAL(is_greater(boost::simd::Valmin<vT>(), boost::simd::Valmax<vT>()), False<r_t>());
}
...
NT2_TEST_CASE_TPL ( is_greater_signed_integer,  BOOST_SIMD_SIMD_INTEGRAL_SIGNED_TYPES)
{
  ...
  NT2_TEST_EQUAL(is_greater(boost::simd::Zero<vT>()  , boost::simd::Mone<vT>()), True<r_t>());
  NT2_TEST_EQUAL(is_greater(boost::simd::Zero<vT>()  , boost::simd::One<vT>()), False<r_t>());
}
...
NT2_TEST_CASE_TPL ( is_greater_real,  BOOST_SIMD_SIMD_REAL_TYPES)
{
  ...
  NT2_TEST_EQUAL(is_greater(boost::simd::Inf<vT>() , boost::simd::Minf<vT>()), True<r_t>());
