...
#include <boost/simd/matprod/functions/simd/common/tmul_np.hpp>
...
NT2_TEST_CASE_TPL ( tmul_n1,  BOOST_SIMD_SIMD_REAL_TYPES)
{
  using boost::simd::meta::cardinal_of;
  using boost::simd::tmul_np;
  using boost::simd::tag::tmul_np_;
  ...
  boost::array<vT, P >    r = tmul_np(a, x);
