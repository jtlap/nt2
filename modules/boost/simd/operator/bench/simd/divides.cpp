...
//==============================================================================
#define NT2_BENCH_MODULE "nt2 boost.simd.operator toolbox - divides/simd Mode"
...
namespace n1 {
  ...
  NT2_TIMING(divides_,(RS(vT,boost::simd::Valmin<T>()/2,boost::simd::Valmax<T>()/2))(RS(vT,boost::simd::One<T>(),boost::simd::Valmax<T>()/2)))
}
namespace n2 {
  typedef double T;
  typedef boost::dispatch::meta::as_integer<T>::type iT;
