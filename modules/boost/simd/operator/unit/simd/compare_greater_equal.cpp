...
NT2_TEST_CASE_TPL ( compare_greater_equal_real__2_0,  BOOST_SIMD_SIMD_REAL_TYPES)
{
  ...
  NT2_TEST_EQUAL(compare_greater_equal(boost::simd::Inf<vT>(), boost::simd::Inf<vT>()), true);
  NT2_TEST_EQUAL(compare_greater_equal(boost::simd::Minf<vT>(), boost::simd::Minf<vT>()), true);
  NT2_TEST_EQUAL(compare_greater_equal(boost::simd::Nan<vT>(), boost::simd::Nan<vT>()), false);
  NT2_TEST_EQUAL(compare_greater_equal(boost::simd::One<vT>(),boost::simd::Zero<vT>()), true);
  NT2_TEST_EQUAL(compare_greater_equal(boost::simd::Zero<vT>(), boost::simd::Zero<vT>()), true);
...
NT2_TEST_CASE_TPL ( compare_greater_equal_signed_int__2_0,  BOOST_SIMD_SIMD_INTEGRAL_SIGNED_TYPES)
{
  ...
  // specific values tests
  NT2_TEST_EQUAL(compare_greater_equal(boost::simd::Mone<vT>(),boost::simd::Zero<vT>()), false);
  NT2_TEST_EQUAL(compare_greater_equal(boost::simd::One<vT>(), boost::simd::One<vT>()), true);
  NT2_TEST_EQUAL(compare_greater_equal(boost::simd::One<vT>(),boost::simd::Zero<vT>()), true);
  NT2_TEST_EQUAL(compare_greater_equal(boost::simd::Zero<vT>(), boost::simd::Zero<vT>()), true);
