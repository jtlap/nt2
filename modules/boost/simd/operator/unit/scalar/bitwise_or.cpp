...
//////////////////////////////////////////////////////////////////////////////
#define NT2_UNIT_MODULE "nt2 boost.simd.operator toolbox - bitwise_or/scalar Mode"
...
NT2_TEST_CASE_TPL ( bitwise_or_real__2_0,  BOOST_SIMD_REAL_TYPES)
{
  ...
  NT2_TEST_EQUAL(bitwise_or(boost::simd::One<T>(),boost::simd::Zero<T>()), boost::simd::One<r_t>());
  NT2_TEST_EQUAL(bitwise_or(boost::simd::Zero<T>(), boost::simd::Zero<T>()), boost::simd::Zero<r_t>());
} // end of test for real_

NT2_TEST_CASE_TPL ( bitwise_or_integer__2_0,  BOOST_SIMD_INTEGRAL_TYPES)
{
  ...
  // specific values tests
  NT2_TEST_EQUAL(bitwise_or(boost::simd::One<T>(), boost::simd::One<T>()), boost::simd::One<r_t>());
  NT2_TEST_EQUAL(bitwise_or(boost::simd::One<T>(),boost::simd::Zero<T>()), boost::simd::One<r_t>());
  NT2_TEST_EQUAL(bitwise_or(boost::simd::Zero<T>(), boost::simd::Zero<T>()), boost::simd::Zero<r_t>());
