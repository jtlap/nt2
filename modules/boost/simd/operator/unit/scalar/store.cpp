...
NT2_TEST_CASE_TPL ( store_integer__2_0,  BOOST_SIMD_INTEGRAL_TYPES)
{
...
//   NT2_TEST_EQUAL(store(boost::simd::One<T>(), boost::simd::One<T>()), boost::simd::One<r_t>());
...
//   // specific values tests
//   NT2_TEST_EQUAL(store(boost::simd::Inf<T>(), boost::simd::Inf<T>()), boost::simd::Inf<r_t>());
//   NT2_TEST_EQUAL(store(boost::simd::Minf<T>(), boost::simd::Minf<T>()), boost::simd::Minf<r_t>());
