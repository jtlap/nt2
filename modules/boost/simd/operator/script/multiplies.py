[ ## this file was manually modified by jt
    {
     'functor' : {
         'description' : ['return the elementwise multiplication of the two parameters',
     ...
     'unit' : {
         ...
         'specific_values' : {
             ...
             'integer_   ' : {
                 'boost::simd::Mone<T>(),boost::simd::Zero<T>()' : {'result' : 'boost::simd::Zero<r_t>()','ulp_thresh' : '0',},
                 'boost::simd::One<T>()' : {'result' : 'boost::simd::One<r_t>()','ulp_thresh' : '0',},
                 'boost::simd::One<T>(),boost::simd::Zero<T>()' : {'result' : 'boost::simd::Zero<r_t>()','ulp_thresh' : '0',},
                 'boost::simd::Zero<T>()' : {'result' : 'boost::simd::Zero<r_t>()','ulp_thresh' : '0',},
                },
         ...
         'verif_test' : {
             'property_call' : {
                 'integer_' : ['boost::simd::multiplies(a0,a1)'],
                },
             'property_value' : {
                 'integer_' : ['a0*a1'],
                },
