[ ## this file was manually modified by jt
    {
     'functor' : {
         'description' : ['return the elementwise sum of the two parameters',
     ...
     'unit' : {
         ...
         'specific_values' : {
             'default' : {
                 'boost::simd::One<T>()' : {'result' : 'boost::simd::Two<r_t>()','ulp_thresh' : '0',},
         ...
         'verif_test' : {
             'property_call' : {
                 'integer_' : ['boost::simd::bitwise_andnot(a0,a1)'],
                },
             'property_value' : {
                 'integer_' : ['a0&(~a1)'],
                },
