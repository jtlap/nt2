     ...
     'unit' : {
         ...
         'specific_values' : {
             'default' : {
                 ...
                 'boost::simd::One<T>(),boost::simd::Two<T>()' : {'result' : 'boost::simd::Zero<r_t>()','ulp_thresh' : '0',},
             ...
             'real_' : {
                 ...
                 'boost::simd::One<T>(),boost::simd::Zero<T>()' : {'result' : 'boost::simd::Inf<r_t>()','ulp_thresh' : '0',},
                 'boost::simd::Zero<T>()' : {'result' : 'boost::simd::Nan<r_t>()','ulp_thresh' : '0',},
                },
            },
         'verif_test' : {
             'property_call' : {
                 'integer_' : ['boost::simd::divides(a0,a1)'],
                },
             'property_value' : {
                 'integer_' : ['a0/a1'],
                },
