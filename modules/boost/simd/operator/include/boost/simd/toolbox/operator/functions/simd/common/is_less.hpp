...
//==============================================================================
#ifndef BOOST_SIMD_TOOLBOX_OPERATOR_FUNCTIONS_SIMD_COMMON_IS_LESS__HPP_INCLUDED
#define BOOST_SIMD_TOOLBOX_OPERATOR_FUNCTIONS_SIMD_COMMON_IS_LESS__HPP_INCLUDED
...
namespace boost { namespace simd { namespace ext
{
                                   ...
                                   )
  {
    ...
    {
      return boost::simd::is_less(a0, boost::simd::splat<A0>(a1));
    }
  };
                                   ...
                                   )
  {
    ...
    BOOST_SIMD_FUNCTOR_CALL(2)
    {
      return boost::simd::is_less(boost::simd::splat<A1>(a0), a1);
    }
  };
} } }
