 ...
 * \defgroup compare_not_equal compare_not_equal function
 *
 * \par Description
 ...
 * \endcode
 *
 * \param a0 is the first parameter of compare_not_equal
 * \param a1 is the second parameter of compare_not_equal
 * 
