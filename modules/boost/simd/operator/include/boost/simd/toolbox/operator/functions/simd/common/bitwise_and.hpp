...
namespace boost { namespace simd { namespace ext
{
  ...
  // mixed scalar/simd
  BOOST_SIMD_FUNCTOR_IMPLEMENTATION( boost::simd::tag::bitwise_and_, tag::cpu_,
                                    (A0)(A1)(X),
                                   ...
                                   )
  {
    ...
    BOOST_SIMD_FUNCTOR_CALL(2)
    {
      return boost::simd::bitwise_and(a0, boost::simd::splat<A0>(a1));
    }
  };
                                   ...
                                   )
  {
    ...
    BOOST_SIMD_FUNCTOR_CALL(2)
    {
      return boost::simd::bitwise_and(boost::simd::splat<A1>(a0), a1);
    }
  };
} } }
