...
//==============================================================================
#ifndef BOOST_SIMD_OPERATOR_FUNCTIONS_SIMD_COMMON_STREAM_HPP_INCLUDED
#define BOOST_SIMD_OPERATOR_FUNCTIONS_SIMD_COMMON_STREAM_HPP_INCLUDED

#include <boost/simd/operator/functions/stream.hpp>
