...
int main()
{
  ...
  typedef boost::simd::meta::next_power_of_2_c<0    >::type  a0;
  typedef boost::simd::meta::next_power_of_2_c<3    >::type  a3;
  typedef boost::simd::meta::next_power_of_2_c<1055 >::type  a1055;
