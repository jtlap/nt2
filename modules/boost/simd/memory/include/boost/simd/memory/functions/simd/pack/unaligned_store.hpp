...
//==============================================================================
#ifndef BOOST_SIMD_MEMORY_FUNCTIONS_SIMD_PACK_UNALIGNED_STORE_HPP_INCLUDED
#define BOOST_SIMD_MEMORY_FUNCTIONS_SIMD_PACK_UNALIGNED_STORE_HPP_INCLUDED
...
namespace boost { namespace simd { namespace ext
{
                                    ...
                                    )
  {
    ...
    {
      boost::simd::unaligned_store(evaluate(a0),a1,a2);
    }
  };
                                    ...
                                    )
  {
    ...
    {
      boost::simd::unaligned_store(evaluate(a0),a1);
    }
  };
} } }
