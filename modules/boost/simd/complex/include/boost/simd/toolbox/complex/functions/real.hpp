 ...
 * \file
**/
#ifndef BOOST_SIMD_TOOLBOX_COMPLEX_FUNCTIONS_REAL_HPP_INCLUDED
#define BOOST_SIMD_TOOLBOX_COMPLEX_FUNCTIONS_REAL_HPP_INCLUDED
 ...
 * \defgroup boost_simd_complex_real real
 *
 * \par Description
