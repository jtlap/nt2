...
//==============================================================================
#ifndef BOOST_SIMD_TOOLBOX_ARITHMETIC_FUNCTIONS_COMPLEX_GENERIC_FLOOR_HPP_INCLUDED
#define BOOST_SIMD_TOOLBOX_ARITHMETIC_FUNCTIONS_COMPLEX_GENERIC_FLOOR_HPP_INCLUDED
...
namespace boost { namespace simd { namespace ext
{
                            ...
                            )
  {
    ...
    BOOST_SIMD_FUNCTOR_CALL(1)
    {
      return boost::simd::floor(imag(a0)); 
    }
  };
