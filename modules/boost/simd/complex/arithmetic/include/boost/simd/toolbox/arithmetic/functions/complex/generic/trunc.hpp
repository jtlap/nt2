...
//==============================================================================
#ifndef BOOST_SIMD_TOOLBOX_ARITHMETIC_FUNCTIONS_COMPLEX_GENERIC_TRUNC_HPP_INCLUDED
#define BOOST_SIMD_TOOLBOX_ARITHMETIC_FUNCTIONS_COMPLEX_GENERIC_TRUNC_HPP_INCLUDED
...
{
  BOOST_SIMD_FUNCTOR_IMPLEMENTATION( boost::simd::tag::trunc_, tag::cpu_, (A0)
                            ...
                            )
  {
    ...
    BOOST_SIMD_FUNCTOR_CALL(1)
    {
      return boost::simd::trunc(imag(a0)); 
    }
  };
