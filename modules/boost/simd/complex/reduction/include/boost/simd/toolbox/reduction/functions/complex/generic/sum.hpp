...
//==============================================================================
#ifndef BOOST_SIMD_TOOLBOX_ARITHMETIC_FUNCTIONS_COMPLEX_GENERIC_SUM_HPP_INCLUDED
#define BOOST_SIMD_TOOLBOX_ARITHMETIC_FUNCTIONS_COMPLEX_GENERIC_SUM_HPP_INCLUDED
...
{
  BOOST_SIMD_FUNCTOR_IMPLEMENTATION( boost::simd::tag::sum_, tag::cpu_, (A0)
                            ...
                            )
  {
    ...
    BOOST_SIMD_FUNCTOR_CALL(1)
    {
      return result_type(boost::simd::sum(imag(a0))); 
    }
  };
