...
//==============================================================================
#ifndef BOOST_SIMD_TOOLBOX_OPERATOR_FUNCTIONS_COMPLEX_GENERIC_IS_FINITE_HPP_INCLUDED
#define BOOST_SIMD_TOOLBOX_OPERATOR_FUNCTIONS_COMPLEX_GENERIC_IS_FINITE_HPP_INCLUDED
...
{
  // complex
  BOOST_SIMD_FUNCTOR_IMPLEMENTATION( boost::simd::tag::is_finite_, tag::cpu_, (A0)
