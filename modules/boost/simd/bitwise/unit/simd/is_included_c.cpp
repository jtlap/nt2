...
NT2_TEST_CASE_TPL ( is_included_c_integer__2_0,  BOOST_SIMD_SIMD_INTEGRAL_TYPES)
{
  ...
  NT2_TEST_EQUAL(is_included_c(boost::simd::Mone<vT>(),~boost::simd::Zero<vT>()), false);
  NT2_TEST_EQUAL(is_included_c(boost::simd::One<vT>(), boost::simd::One<vT>()), false);
  NT2_TEST_EQUAL(is_included_c(boost::simd::One<vT>(),~boost::simd::Mone<vT>()), true);
  NT2_TEST_EQUAL(is_included_c(boost::simd::One<vT>(),~boost::simd::Three<vT>()), true);
  NT2_TEST_EQUAL(is_included_c(boost::simd::One<vT>(),~boost::simd::Two<vT>()), false);
  NT2_TEST_EQUAL(is_included_c(boost::simd::One<vT>(),~boost::simd::Zero<vT>()), false);
