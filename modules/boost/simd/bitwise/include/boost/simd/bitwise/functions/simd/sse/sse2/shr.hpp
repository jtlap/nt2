...
//==============================================================================
#ifndef BOOST_SIMD_BITWISE_FUNCTIONS_SIMD_SSE_SSE2_SHR_HPP_INCLUDED
#define BOOST_SIMD_BITWISE_FUNCTIONS_SIMD_SSE_SSE2_SHR_HPP_INCLUDED
...
{
  BOOST_SIMD_FUNCTOR_IMPLEMENTATION ( boost::simd::tag::shr_
  ...
  BOOST_SIMD_FUNCTOR_IMPLEMENTATION ( boost::simd::tag::shr_, boost::simd::tag::sse2_
                                    , (A0)(A1)
