...
//==============================================================================
#ifndef BOOST_SIMD_BITWISE_FUNCTIONS_SIMD_COMMON_SHRI_HPP_INCLUDED
#define BOOST_SIMD_BITWISE_FUNCTIONS_SIMD_COMMON_SHRI_HPP_INCLUDED

#include <boost/simd/bitwise/functions/shri.hpp>
...
namespace boost { namespace simd { namespace ext
{
                            ...
                            )
  {
    ...
    BOOST_SIMD_FUNCTOR_CALL(2)
    {
      ...
      return bitwise_cast<A0>( map( typename dispatch::make_functor<tag::shift_right_, A0>::type()
