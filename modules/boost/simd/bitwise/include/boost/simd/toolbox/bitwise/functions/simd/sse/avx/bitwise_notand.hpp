...
/////////////////////////////////////////////////////////////////////////////
BOOST_SIMD_REGISTER_DISPATCH(boost::simd::tag::bitwise_notand_, boost::simd::tag::avx_,
                                 (A0),
...
namespace boost { namespace simd { namespace ext
{
  ...
  struct call<boost::simd::tag::bitwise_notand_(tag::simd_<tag::arithmetic_, tag::avx_),
...
{
  template<class Dummy>
  struct call<boost::simd::tag::bitwise_notand_(tag::simd_<tag::double_, tag::avx_),
...
{
  template<class Dummy>
  struct call<boost::simd::tag::bitwise_notand_(tag::simd_<tag::float_, tag::avx_),
