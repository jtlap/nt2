...
//==============================================================================
#ifndef BOOST_SIMD_TOOLBOX_REDUCTION_FUNCTIONS_SIMD_avx_AVX_ANY_HPP_INCLUDED
#define BOOST_SIMD_TOOLBOX_REDUCTION_FUNCTIONS_SIMD_avx_AVX_ANY_HPP_INCLUDED
...
namespace boost { namespace simd { namespace ext
{
                       ...
                       )
  {
    ...
    BOOST_SIMD_FUNCTOR_CALL_REPEAT(1)
    {
      ...
      return result_type(!result_type(_mm256_testz_si256(bitwise_cast<iA0>(a0), Allbits<iA0>())));
    }
  };
