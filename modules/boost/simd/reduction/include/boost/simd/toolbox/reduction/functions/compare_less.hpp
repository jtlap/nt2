 ...
 * \file
**/
#ifndef BOOST_SIMD_TOOLBOX_REDUCTION_FUNCTIONS_COMPARE_LESS_HPP_INCLUDED
#define BOOST_SIMD_TOOLBOX_REDUCTION_FUNCTIONS_COMPARE_LESS_HPP_INCLUDED
 ...
 * \defgroup boost_simd_reduction_compare_less compare_less
 *
 * \par Description
