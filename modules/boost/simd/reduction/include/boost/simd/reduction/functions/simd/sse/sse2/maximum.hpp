...
//==============================================================================
#ifndef BOOST_SIMD_REDUCTION_FUNCTIONS_SIMD_SSE_SSE2_MAXIMUM_HPP_INCLUDED
#define BOOST_SIMD_REDUCTION_FUNCTIONS_SIMD_SSE_SSE2_MAXIMUM_HPP_INCLUDED
...
{
  BOOST_SIMD_FUNCTOR_IMPLEMENTATION ( boost::simd::tag::maximum_
                                    ...
                                    )
  {
    ...
    BOOST_SIMD_FUNCTOR_CALL(1)
    {
      return boost::simd::max(a0[0], a0[1]);
    }
  };
