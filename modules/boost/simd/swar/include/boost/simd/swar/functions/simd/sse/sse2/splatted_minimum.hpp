...
//==============================================================================
#ifndef BOOST_SIMD_SWAR_FUNCTIONS_SIMD_SSE_SSE2_SPLATTED_MINIMUM_HPP_INCLUDED
#define BOOST_SIMD_SWAR_FUNCTIONS_SIMD_SSE_SSE2_SPLATTED_MINIMUM_HPP_INCLUDED
...
namespace boost { namespace simd { namespace ext
{
                                   ...
                                   )
  {
    ...
    BOOST_SIMD_FUNCTOR_CALL(1)
    {
      ...
      return simd::bitwise_cast<A0>(_mm_unpacklo_ps(min5, min5));
    }
  };
    ...
    BOOST_SIMD_FUNCTOR_CALL(1)
      {
        ...
        return min(min1, simd::bitwise_cast<A0>(_mm_shuffle_epi32(min1, _MM_SHUFFLE(2, 3, 0, 1))));
      }
  };
} } }
