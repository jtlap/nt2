...
//==============================================================================
#ifndef BOOST_SIMD_SWAR_FUNCTIONS_SIMD_SSE_SSE2_SPLATTED_MAXIMUM_HPP_INCLUDED
#define BOOST_SIMD_SWAR_FUNCTIONS_SIMD_SSE_SSE2_SPLATTED_MAXIMUM_HPP_INCLUDED
...
namespace boost { namespace simd { namespace ext
{
                                   ...
                                   )
  {
    ...
    BOOST_SIMD_FUNCTOR_CALL(1)
    {
      ...
      return simd::bitwise_cast<A0>(_mm_unpacklo_ps(max5, max5));
    }
  };
    ...
    BOOST_SIMD_FUNCTOR_CALL(1)
      {
        ...
        return max(max1, simd::bitwise_cast<A0>(_mm_shuffle_epi32(max1, _MM_SHUFFLE(2, 3, 0, 1))));
      }
  };
} } }
