...
namespace boost { namespace simd { namespace ext
{
                                   ...
                                   )
  {
    ...
    BOOST_FORCEINLINE result_type operator()(A0 const& a0, A0 const& a1) const
    {
      ...
      result_type that = _mm256_insertf128_ps(that,boost::simd::deinterleave_first(a00, a01), 0);
                                   ...
                                   )
  {
    ...
    BOOST_FORCEINLINE result_type operator()(A0 const& a0, A0 const& a1) const
    {
      ...
      result_type that = _mm256_insertf128_pd(that,boost::simd::deinterleave_first(a00, a01), 0);
                                   ...
                                   )
  {
    ...
    BOOST_FORCEINLINE result_type operator()(A0 const& a0, A0 const& a1) const
    {
      ...
      result_type that = _mm256_insertf128_si256(that,boost::simd::deinterleave_first(a00, a01), 0);
