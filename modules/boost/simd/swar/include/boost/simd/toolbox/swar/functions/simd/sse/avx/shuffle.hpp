  ...
  namespace ext
  {
                                      ...
                                      )
    {
      ...
      result_type operator()(A0 const& a, P const&) const
      {
        return  bitwise_cast<A0>
                ( _mm256_permutevar_ps( bitwise_cast<__m256>(a)
                                      ...
                                      )
    {
                                              ...
                                              , P const&) const
      {
        ...
        return eval(a0,sel< i0_t::value,i1_t::value,i2_t::value,i3_t::value
                          , i4_t::value,i5_t::value,i6_t::value,i7_t::value
                          >());
      }

      template<int I0, int I1, int I2, int I3, int I4, int I5, int I6, int I7>
      BOOST_FORCEINLINE __m256 eval( __m256d a0, __m256d a1
                                   , sel<I0,I1,I2,I3,I4,I5,I6,I7,true> const&) const
      {
        return details::shuffle<I0,I1,I2,I3,I4,I5,I6,I7>(a0,a1);
      }

      template<int I0, int I1, int I2, int I3, int I4, int I5, int I6, int I7>
      BOOST_FORCEINLINE __m256i eval( __m256i a0, __m256i a1
                                    , sel<I0,I1,I2,I3,I4,I5,I6,I7,true> const&) const
      {
        return details::shuffle<I0,I1,I2,I3,I4,I5,I6,I7>(a0,a1);
      }
      ...
      template<int I0, int I1, int I2, int I3, int I4, int I5, int I6, int I7>
      BOOST_FORCEINLINE __m256 eval( __m256 a0, __m256 a1
                                    , sel<I0,I1,I2,I3,I4,I5,I6,I7,false> const&) const
      {
        __m256i mask = _mm256_set_epi8(
                         mask_t<0 >::value, mask_t<1 >::value
                       , mask_t<2 >::value, mask_t<3 >::value
        ...
        __m256  that = details::shuffle<I0,I1,I2,I3,I4,I5,I6,I7>(a0,a1);
        return _mm256_and_ps(_mm256_castsi256_ps(mask),that);
      }
      ...
      BOOST_FORCEINLINE __m256i eval( __m256i a0, __m256i a1
                                    , sel<I0,I1,I2,I3,I4,I5,I6,I7,false> const&) const
      {
        return _mm256_castps_si256(eval( _mm256_castsi256_ps(a0)
                                       , _mm256_castsi256_ps(a1)
                                       ,sel<I0,I1,I2,I3,I4,I5,I6,I7,false>()
                                       )
                                  );
      }     
    };
