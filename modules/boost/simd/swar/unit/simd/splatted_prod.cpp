...
NT2_TEST_CASE_TPL ( splatted_prod_real__1_0,  BOOST_SIMD_REAL_TYPES)
{
  ...
  NT2_TEST_EQUAL(splatted_prod(boost::simd::Minf<vT>())[0], boost::simd::Inf<sr_t>());
  NT2_TEST_EQUAL(splatted_prod(boost::simd::Mone<vT>())[0], boost::simd::One<sr_t>());
