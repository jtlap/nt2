...
//////////////////////////////////////////////////////////////////////////////
#define BOOST_SIMD_BENCH_MODULE "nt2 swar toolbox - lookup/simd Mode"
...
namespace n1 {
  ...
  BOOST_SIMD_TIMING(lookup_,(RS(vT,T(-100),T(100)))(RS(viT,0,boost::simd::meta::cardinal_of<T>::value-1)))
}
namespace n2 {
  typedef double T;
  typedef boost::simd::meta::as_integer<T>::type iT;
