[ ## this file was manually modified by jt
    {
     'functor' : {
            'description' : ['returns the minimum of a0 splatted in a vector'],
         'module' : 'boost',
         'arity' : '1',
         'call_types' : [],
         'ret_arity' : '0',
     ...
     'unit' : {
         'global_header' : {
             ...
             'simd_included' : ['#include <boost/simd/include/functions/minimum.hpp>'],
             'no_ulp' : 'True',
             'notes' : [],
         ...
         'verif_test' : {
             ...
             'property_call' : {
                 'default' : ['boost::simd::splatted_minimum(a0)'],
                },
             'property_value' : {
                 'default' : ['(a0)'],
                },
