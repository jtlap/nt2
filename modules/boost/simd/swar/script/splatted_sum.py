[ ## this file was manually modified by jt
    {
     'functor' : {
         'description' : ['returns the sum of a0 elements splatted in a vector'],
         'module' : 'boost',
         'arity' : '1',
         'call_types' : [],
         'ret_arity' : '0',
     ...
     'unit' : {
         'global_header' : {
             ...
             'simd_included' : ['#include <boost/simd/include/functions/sum.hpp>'],
             'included' : [],
             'no_ulp' : 'True',
             'notes' : [],
         ...
         'specific_values' : {
             'default' : {
                 'boost::simd::One<T>()' : {'result' : 'cardinal_of<n_t>()','ulp_thresh' : '0',},
         ...
         'verif_test' : {
             ...
             'property_call' : {
                 'default' : ['boost::simd::splatted_sum(a0)'],
                },
             'property_value' : {
                 'default' : ['(a0)'],
                },
