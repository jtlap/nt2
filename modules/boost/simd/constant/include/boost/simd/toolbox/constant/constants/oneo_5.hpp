 ...
 * \file
**/
#ifndef BOOST_SIMD_TOOLBOX_CONSTANT_CONSTANTS_ONEO_5_HPP_INCLUDED
#define BOOST_SIMD_TOOLBOX_CONSTANT_CONSTANTS_ONEO_5_HPP_INCLUDED
...
namespace boost { namespace simd
{
  namespace tag
  {
    ...
    **/
    BOOST_SIMD_CONSTANT_REGISTER( Oneo_5, int, 0
