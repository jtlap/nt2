[ ## this file was manually modified by jt
    {
     'functor' : {
         'description' : ['Returns True<result_type>() or False<result_type>() according a0 is odd or not.',
     ...
     'unit' : {
         ...
         'verif_test' : {
             'property_call' : {
                 'default' : ['boost::simd::is_odd(a0)'],
                },
             'property_value' : {
                 'default' : ['int(boost::simd::abs(a0)/2.0)*2+boost::simd::One<T>()==boost::simd::abs(a0)'],
                },
             'simd' : {
                },
             'ulp_thresh' : {
