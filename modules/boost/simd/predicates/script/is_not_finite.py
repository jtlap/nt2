[ ## this file was manually modified by jt
    {
     'functor' : {
         'description' : ['Returns True<result_type>() if a0 is  inf, -inf or nan, else returns False<result_type>().'],   
          'module' : 'boost',
         'arity' : '1',
         'call_types' : [],
         'ret_arity' : '0',
     ...
     'unit' : {
         ...
         'verif_test' : {
             'property_call' : {
                 'default' : ['boost::simd::is_not_finite(a0)'],
                },
             'property_value' : {
                 'default' : ['boost::simd::False<r_t>()'],
                },
             'simd' : {
                },
             'ulp_thresh' : {
