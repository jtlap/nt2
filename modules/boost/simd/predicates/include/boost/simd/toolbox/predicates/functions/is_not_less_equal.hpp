 ...
 * \defgroup is_not_less_equal is_not_less_equal function
 *
 * \par Description
 ...
 * \endcode
 *
 * \param a0 is the first parameter of is_not_less_equal
 * \param a1 is the second parameter of is_not_less_equal
 * 
