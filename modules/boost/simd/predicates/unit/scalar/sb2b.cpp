...
NT2_TEST_CASE_TPL ( sb2b_real__1_0,  BOOST_SIMD_REAL_TYPES)
{
  ...
  NT2_TEST_EQUAL(sb2b(boost::simd::Half<T>()), r_t(true));
  NT2_TEST_EQUAL(sb2b(boost::simd::Inf<T>()), r_t(true));
  NT2_TEST_EQUAL(sb2b(boost::simd::Minf<T>()), r_t(true));
  NT2_TEST_EQUAL(sb2b(boost::simd::Mone<T>()), r_t(true));
  NT2_TEST_EQUAL(sb2b(boost::simd::Nan<T>()), r_t(true));
  NT2_TEST_EQUAL(sb2b(boost::simd::One<T>()), r_t(true));
  NT2_TEST_EQUAL(sb2b(boost::simd::Quarter<T>()), r_t(true));
