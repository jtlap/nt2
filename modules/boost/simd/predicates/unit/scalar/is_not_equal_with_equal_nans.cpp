...
BOOST_SIMD_TEST_CASE_TPL ( is_not_equal_with_equal_nans_real__2_0,  BOOST_SIMD_REAL_TYPES)
{
  ...
  BOOST_SIMD_TEST_EQUAL(is_not_equal_with_equal_nans(boost::simd::One<T>(), boost::simd::One<T>()), boost::simd::False<r_t>());
  BOOST_SIMD_TEST_EQUAL(is_not_equal_with_equal_nans(boost::simd::Two<T>(), boost::simd::Two<T>()), boost::simd::False<r_t>());
  BOOST_SIMD_TEST_EQUAL(is_not_equal_with_equal_nans(boost::simd::Zero<T>(), boost::simd::Zero<T>()), boost::simd::False<r_t>());
