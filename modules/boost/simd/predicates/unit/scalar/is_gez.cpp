...
NT2_TEST_CASE_TPL ( is_gez_real__1_0,  BOOST_SIMD_REAL_TYPES)
{
  ...
  NT2_TEST_EQUAL(is_gez(-boost::simd::Zero<T>()), r_t(true));
  NT2_TEST_EQUAL(is_gez(boost::simd::Half<T>()), r_t(true));
  NT2_TEST_EQUAL(is_gez(boost::simd::Inf<T>()), r_t(true));
  NT2_TEST_EQUAL(is_gez(boost::simd::Minf<T>()), r_t(false));
  NT2_TEST_EQUAL(is_gez(boost::simd::Mone<T>()), r_t(false));
  NT2_TEST_EQUAL(is_gez(boost::simd::Nan<T>()), r_t(false));
  NT2_TEST_EQUAL(is_gez(boost::simd::One<T>()), r_t(true));
  NT2_TEST_EQUAL(is_gez(boost::simd::Quarter<T>()), r_t(true));
  NT2_TEST_EQUAL(is_gez(boost::simd::Two<T>()), r_t(true));
  NT2_TEST_EQUAL(is_gez(boost::simd::Zero<T>()), r_t(true));
