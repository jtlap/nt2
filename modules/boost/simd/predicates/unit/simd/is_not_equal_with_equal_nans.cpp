...
BOOST_SIMD_TEST_CASE_TPL ( is_not_equal_with_equal_nans_real__2_0,  BOOST_SIMD_REAL_TYPES)
{
  ...
  BOOST_SIMD_TEST_EQUAL(is_not_equal_with_equal_nans(boost::simd::One<vT>(), boost::simd::One<vT>())[0]!=0, boost::simd::False<sr_t>());
  BOOST_SIMD_TEST_EQUAL(is_not_equal_with_equal_nans(boost::simd::Two<vT>(), boost::simd::Two<vT>())[0]!=0, boost::simd::False<sr_t>());
  BOOST_SIMD_TEST_EQUAL(is_not_equal_with_equal_nans(boost::simd::Zero<vT>(), boost::simd::Zero<vT>())[0]!=0, boost::simd::False<sr_t>());
