...
//////////////////////////////////////////////////////////////////////////////
#ifndef BOOST_SIMD_TOOLBOX_BOOLEAN_FUNCTIONS_SELECT_HPP_INCLUDED
#define BOOST_SIMD_TOOLBOX_BOOLEAN_FUNCTIONS_SELECT_HPP_INCLUDED
#include <boost/simd/include/simd.hpp>
#include <boost/dispatch/include/functor.hpp>

/*!
 * \ingroup boost_simd_boolean
 * \defgroup boost_simd_boolean_select select
 *
 * \par Description
 ...
 *     meta::call<tag::select_(A0,A1,A1)>::type
 *     select(const A0 & a0,const A1 & a1,const A1 & a2);
 * }
 * \endcode
 *
 * \param a0 the first parameter of select
 * \param a1 the second parameter of select, must be an integer value
