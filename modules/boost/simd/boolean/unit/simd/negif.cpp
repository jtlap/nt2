...
NT2_TEST_CASE_TPL ( negif_real__2_0,  BOOST_SIMD_SIMD_REAL_TYPES)
{
  ...
  NT2_TEST_EQUAL(negif(boost::simd::is_nez(boost::simd::Zero<vT>()),boost::simd::splat<vT>(1))[0], 1);
  NT2_TEST_EQUAL(negif(boost::simd::is_nez(boost::simd::One<vT>()),boost::simd::splat<vT>(1))[0], -1);
