[ ## this file was manually modified by jt
    {
     ...
     'unit' : {
         'global_header' : {
             ...
             'cover_included' : ['#include <boost/simd/toolbox/standard/include/floor.hpp>'],
             'notes' : [],
         ...
         'specific_values' : {
             ...
             'real_' : {
                 ...
                 'boost::simd::Mhalf<T>()' : 'boost::simd::Mone<r_t>()',
         ...
         'verif_test' : {
             'property_call' : {
                 'default' : ['boost::simd::ifloor(a0)'],
                },
             'property_value' : {
                 'default' : ['r_t(boost::simd::standard::floor(a0))'],
                },
             'ulp_thresh' : {
                 'default' : ['0'],
                },
