...
//////////////////////////////////////////////////////////////////////////////
#define BOOST_SIMD_BENCH_MODULE "nt2 arithmetic toolbox - iround2even/scalar Mode"
...
//////////////////////////////////////////////////////////////////////////////
// scalar runtime benchmark for functor<iround2even_> from arithmetic
//////////////////////////////////////////////////////////////////////////////
...
namespace n1 {
  ...
  BOOST_SIMD_TIMING(iround2even_,(RS(T,T(-10),T(10))))
}
namespace n2 {
  typedef double T;
  typedef boost::simd::meta::as_integer<T>::type iT;
...
namespace n3 {
  ...
  typedef boost::simd::meta::as_integer<T>::type iT;
  BOOST_SIMD_TIMING(iround2even_,(RS(T,0,100)))
}
namespace n4 {
...
namespace n7 {
  ...
  typedef boost::simd::meta::as_integer<T>::type iT;
  BOOST_SIMD_TIMING(iround2even_,(RS(T,-100,100)))
}
namespace n8 {
