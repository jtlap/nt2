...
NT2_TEST_CASE_TPL ( max_real__2_0,  BOOST_SIMD_REAL_TYPES)
{
  ...
  NT2_TEST_ULP_EQUAL(max(boost::simd::Inf<T>(), boost::simd::Inf<T>()), boost::simd::Inf<T>(), 0);
  NT2_TEST_ULP_EQUAL(max(boost::simd::Minf<T>(), boost::simd::Minf<T>()), boost::simd::Minf<T>(), 0);
  NT2_TEST_ULP_EQUAL(max(boost::simd::Mone<T>(), boost::simd::Mone<T>()), boost::simd::Mone<T>(), 0);
