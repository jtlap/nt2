...
//////////////////////////////////////////////////////////////////////////////
#define NT2_UNIT_MODULE "nt2 boost.simd.arithmetic toolbox - hypot/scalar Mode"
...
NT2_TEST_CASE_TPL ( hypot_unsigned_int__2_0,  BOOST_SIMD_UNSIGNED_TYPES)
{
  ...
  // specific values tests
  NT2_TEST_ULP_EQUAL(hypot(boost::simd::One<T>(), boost::simd::One<T>()), boost::simd::Sqrt_2<r_t>(), 0.5);
  NT2_TEST_ULP_EQUAL(hypot(boost::simd::Zero<T>(), boost::simd::Zero<T>()), boost::simd::Zero<r_t>(), 0);
} // end of test for unsigned_int_

NT2_TEST_CASE_TPL ( hypot_signed_int__2_0,  BOOST_SIMD_INTEGRAL_SIGNED_TYPES)
{
