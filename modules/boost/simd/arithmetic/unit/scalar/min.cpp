...
NT2_TEST_CASE_TPL ( min_real__2_0,  BOOST_SIMD_REAL_TYPES)
{
  ...
  NT2_TEST_ULP_EQUAL(min(boost::simd::Inf<T>(), boost::simd::Inf<T>()), boost::simd::Inf<T>(), 0);
  NT2_TEST_ULP_EQUAL(min(boost::simd::Minf<T>(), boost::simd::Minf<T>()), boost::simd::Minf<T>(), 0);
  NT2_TEST_ULP_EQUAL(min(boost::simd::Mone<T>(), boost::simd::Mone<T>()), boost::simd::Mone<T>(), 0);
...
NT2_TEST_CASE_TPL ( min_signed_int__2_0,  BOOST_SIMD_INTEGRAL_SIGNED_TYPES)
{
