...
NT2_TEST_CASE_TPL ( divfloor_unsigned_int__2_0,  BOOST_SIMD_UNSIGNED_TYPES)
{
  ...
  NT2_TEST_ULP_EQUAL(divfloor(boost::simd::One<T>(), boost::simd::One<T>()), boost::simd::One<T>(), 0);
...
NT2_TEST_CASE_TPL ( divfloor_signed_int__2_0,  BOOST_SIMD_INTEGRAL_SIGNED_TYPES)
{
  ...
  NT2_TEST_ULP_EQUAL(divfloor(boost::simd::Mone<T>(), boost::simd::Mone<T>()), boost::simd::One<T>(), 0);
  NT2_TEST_ULP_EQUAL(divfloor(boost::simd::One<T>(), boost::simd::One<T>()), boost::simd::One<T>(), 0);
