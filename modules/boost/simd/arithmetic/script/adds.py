[ ## this file was manually modified by jt
    {
     'functor' : {
            'description' : ['The result is the mathetical adddition of the arguments',
     ...
     'unit' : {
         ...
         'specific_values' : {
             ...
             'signed_int_' : {
                 'boost::simd::Mone<T>()' : '-boost::simd::Two<T>()',
                 ...
                 'boost::simd::Valmin<T>(),boost::simd::Mone<T>()' :  'boost::simd::Valmin<T>()',
                },
             'unsigned_int_' : {
                 'boost::simd::One<T>()' : 'boost::simd::Two<T>()',
                 'boost::simd::Zero<T>()' : 'boost::simd::Zero<T>()',
