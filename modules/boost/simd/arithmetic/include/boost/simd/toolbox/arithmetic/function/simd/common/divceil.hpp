...
{
  BOOST_DISPATCH_FUNCTOR_IMPLEMENTATION( boost::simd::tag::divceil_, tag::cpu_, (A0)(X)
                            ...
                            )
  {
    ...
    BOOST_DISPATCH_FUNCTOR_CALL_REPEAT(2) { return rdivide(a0+a1-boost::simd::One<A0>(), a1); }
  };
