...
//==============================================================================
#ifndef BOOST_SIMD_TOOLBOX_ARITHMETIC_FUNCTION_SIMD_SSE_XOP_MIN_HPP_INCLUDED
#define BOOST_SIMD_TOOLBOX_ARITHMETIC_FUNCTION_SIMD_SSE_XOP_MIN_HPP_INCLUDED
...
{
  BOOST_SIMD_FUNCTOR_IMPLEMENTATION(boost::simd::tag::min_, boost::simd::tag::xop_,
                      (A0),
