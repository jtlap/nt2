    ...
    for(nt2::uint32_t j =0; j < NR; ++j )
      {
        std::cout << "for params "
                  ...
                  << ", a1 = "<< u_t(a1 = tab_a1[j])
                  << std::endl;
        NT2_TEST_ULP_EQUAL( boost::simd::divfloor(a0,a1),r_t(boost::simd::floor(a0/a1)),0);
    ...
    for(nt2::uint32_t j =0; j < NR; ++j )
      {
        std::cout << "for params "
                  ...
                  << ", a1 = "<< u_t(a1 = tab_a1[j])
                  << std::endl;
        NT2_TEST_ULP_EQUAL( boost::simd::divfloor(a0,a1),a1 ? r_t(boost::simd::floor(double(a0)/double(a1))) : (a0 ? boost::simd::Valmax<r_t>() : 0),0);
        ulp0=nt2::max(ulpd,ulp0);
     }
     std::cout << "max ulp found is: " << ulp0 << std::endl;
   }
    ...
    for(nt2::uint32_t j =0; j < NR; ++j )
      {
        std::cout << "for params "
                  ...
                  << ", a1 = "<< u_t(a1 = tab_a1[j])
                  << std::endl;
        NT2_TEST_ULP_EQUAL( boost::simd::divfloor(a0,a1),a1 ? r_t(boost::simd::floor(double(a0)/double(a1))) : (a0<0 ? boost::simd::Valmin<r_t>() : (a0 ? boost::simd::Valmax<r_t>() : 0)),0);
        ulp0=nt2::max(ulpd,ulp0);
     }
     std::cout << "max ulp found is: " << ulp0 << std::endl;
   }
