...
//////////////////////////////////////////////////////////////////////////////
#define NT2_UNIT_MODULE "nt2 boost.simd.arithmetic toolbox - abss/scalar Mode"
    ...
    for(nt2::uint32_t j =0; j < NR; ++j )
      {
        std::cout << "for param "
                  << "  a0 = "<< u_t(a0 = tab_a0[j])
                  << std::endl;
        NT2_TEST_EQUAL( boost::simd::abss(a0),(a0>=0 ? a0 : (a0==boost::simd::Valmin<T>()?boost::simd::Valmax<T>():-a0)));
     }
