 ...
 * \file
**/
#ifndef NT2_TOOLBOX_BOOLEAN_FUNCTIONS_BOOLEAN_IF_ELSE_ZERO_HPP_INCLUDED
#define NT2_TOOLBOX_BOOLEAN_FUNCTIONS_BOOLEAN_IF_ELSE_ZERO_HPP_INCLUDED
...
namespace nt2
{
  ...
  {
    /*!
     * \brief Bring the tag boolean_if_else_zero_ of functor boolean_if_else_zero 
