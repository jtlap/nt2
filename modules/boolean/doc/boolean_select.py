[ ## this file was manually modified by jt
    {
     'functor' : {
         'description' : ['Returns the selection of the second',
                          'or third operand according to the setting',
                          'of the first operand',
                          '\par',
                          'The operands must share the same size and',
                          'the result type is the common one of the second',
                          'and third operands'],
         'equalparams' : False,   
         'module' : 'boolean',
         'arity' : '3',
