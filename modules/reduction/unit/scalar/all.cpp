...
NT2_TEST_CASE_TPL ( all_real__1_0,  NT2_REAL_TYPES)
{
  ...
  typedef typename nt2::meta::call<all_(T)>::type r_t;
  ...
  NT2_TEST_EQUAL(all(nt2::Inf<T>()), nt2::One<r_t>());
  NT2_TEST_EQUAL(all(nt2::Minf<T>()), nt2::One<r_t>());
  NT2_TEST_EQUAL(all(nt2::Mone<T>()), nt2::One<r_t>());
  NT2_TEST_EQUAL(all(nt2::Nan<T>()), nt2::One<r_t>());
  NT2_TEST_EQUAL(all(nt2::One<T>()), nt2::One<r_t>());
  NT2_TEST_EQUAL(all(nt2::Zero<T>()), nt2::Zero<r_t>());
    ...
    for (uint32_t j =0; j < NR; ++j )
      {
        std::cout << "for param "
                  << "  a0 = "<< u_t(a0 = tab_a0[j])
                  << std::endl;
        NT2_TEST_EQUAL( nt2::all(a0),a0!=0);
     }
