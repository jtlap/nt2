...
#define BOOST_SIMD_PREDICATES_BASE() boost/simd/toolbox/predicates/function/scalar/
#define BOOST_SIMD_PREDICATES_RELATIVE() boost/simd/toolbox/predicates/function/
