...
{
  BOOST_DISPATCH_FUNCTION_IMPLEMENTATION(boost::dispatch::tag::is_odd_, is_odd, 1)
} }
 
#include <boost/simd/toolbox/operator.hpp>
#include <boost/simd/toolbox/predicates/function/scalar/is_odd.hpp>
#include <boost/simd/toolbox/predicates/function/simd/all/is_odd.hpp> 
