...
//////////////////////////////////////////////////////////////////////////////
#define BOOST_SIMD_BENCH_MODULE "nt2 predicates toolbox - is_not_equal_with_equal_nans/scalar Mode"
...
namespace n1 {
  ...
  BOOST_SIMD_TIMING(is_not_equal_with_equal_nans_,(RS(T,T(-10000),T(10000)))(RS(T,T(-10000),T(10000))))
}
namespace n2 {
  typedef double T;
  typedef boost::simd::meta::as_integer<T>::type iT;
