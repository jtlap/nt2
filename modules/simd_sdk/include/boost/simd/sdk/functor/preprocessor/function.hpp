...
#define BOOST_SIMD_FN_TYPES(z,n,t) BOOST_PP_SEQ_ELEM(n,t)
#define BOOST_SIMD_FN_ARGS(z,n,t)  BOOST_PP_SEQ_ELEM(n,t) BOOST_PP_CAT(a,n)
...
template<BOOST_PP_ENUM_PARAMS(N, class A)> BOOST_SIMD_FORCE_INLINE               \
typename meta::                                                           \
call<TAG(BOOST_PP_ENUM(BOOST_PP_SEQ_SIZE(ARGS),BOOST_SIMD_FN_TYPES,ARGS))>::type \
NAME( BOOST_PP_ENUM(BOOST_PP_SEQ_SIZE(ARGS),BOOST_SIMD_FN_ARGS,ARGS) )           \
{                                                                         \
  BOOST_SIMD_FUNCTION_BODY(TAG, BOOST_PP_SEQ_SIZE(ARGS) )                        \
}                                                                         \
/**/
...
#define BOOST_SIMD_FN_REF(z,n,t) (BOOST_PP_CAT(A,BOOST_PP_INC(n)) const&)
#define BOOST_SIMD_FUNCTION_IMPLEMENTATION_SELF(TAG,NAME,N)        \
BOOST_SIMD_FUNCTION_IMPLEMENTATION_TPL(TAG,NAME, \
    (A0&)BOOST_PP_REPEAT(BOOST_PP_DEC(N),BOOST_SIMD_FN_REF,~),N) \
/**/
