...
/*!
 * \file
 * \brief Defines macros for building a \ref boost::simd::ext::call specialization
 */
...
//==============================================================================
/*!
 * Generates a \ref boost::simd::ext::call specialization \c operator() prototype.
 * In this function, arguments are defined as \c a0,...,an-1.
 *
 * \param N Number of parameters for the current \ref boost::simd::ext::call
 *
 * \usage
 *
 * \code
 ...
 */
//==============================================================================
#define BOOST_SIMD_FUNCTOR_CALL_REPEAT(N)                                          \
...
BOOST_SIMD_REGISTER_DISPATCH(Tag,Site,Types,Seq)                                 \
template< BOOST_PP_ENUM(BOOST_PP_SEQ_SIZE(Types),BOOST_SIMD_DISPATCH_TYPE,Types) \
        , class Dummy                                                     \
        >                                                                 \
struct  implement                                                         \
        < BOOST_SIMD_PP_STRIP(Tag)(BOOST_PP_ENUM ( BOOST_PP_SEQ_SIZE(Seq)        \
...
BOOST_SIMD_REGISTER_DISPATCH_TPL(Tag,Site,Types,Seq)                                 \
...
BOOST_SIMD_REGISTER_DISPATCH_IF(Tag,Site,Types,Cond,Ret,Seq)                     \
template< BOOST_PP_ENUM(BOOST_PP_SEQ_SIZE(Types),BOOST_SIMD_DISPATCH_TYPE,Types) \
        , class Dummy                                                     \
        >                                                                 \
struct  implement<BOOST_SIMD_PP_STRIP(Ret),Site,Dummy>                           \
/**/
