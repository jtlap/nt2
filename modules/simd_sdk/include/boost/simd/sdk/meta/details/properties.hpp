...
//==============================================================================
#ifndef BOOST_SIMD_SDK_META_DETAILS_PROPERTIES_HPP_INCLUDED
#define BOOST_SIMD_SDK_META_DETAILS_PROPERTIES_HPP_INCLUDED
...
#include <boost/simd/sdk/meta/details/hierarchy_base.hpp>
...
namespace boost { namespace simd {  namespace meta
{
  ...
  //////////////////////////////////////////////////////////////////////////////
  BOOST_SIMD_HIERARCHY_CLASS_TPL_META (type8_, (boost::mpl::if_< behave_as<boost::is_signed<boost::mpl::_1>,T>
                                                        , int_<T>
                                                        , uint_<T>
                                                        >
                                    )
  ...
  BOOST_SIMD_HIERARCHY_CLASS_TPL_META (type16_, (boost::mpl::if_< behave_as<boost::is_signed<boost::mpl::_1>,T>
                                                         , int_<T>
                                                         , uint_<T>
                                                         >
                                    )
