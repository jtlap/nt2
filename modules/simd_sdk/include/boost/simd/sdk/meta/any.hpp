...
//==============================================================================
#ifndef BOOST_SIMD_META_ANY_HPP_INCLUDED
#define BOOST_SIMD_META_ANY_HPP_INCLUDED

/*!
 * \file
 * \brief Defines and implements boost::simd::meta::any
 */
...
namespace boost { namespace simd { namespace meta
{
  ...
  template< class Pred
          ...
          >
  struct  any
        : details::any_impl<Pred,BOOST_PP_ENUM_PARAMS(BOOST_DISPATCH_MAX_META_ARITY, A)>
  {};
  #endif
} } }
