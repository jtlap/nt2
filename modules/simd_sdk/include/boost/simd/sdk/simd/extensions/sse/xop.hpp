...
#define BOOST_SIMD_TAG_SEQ            (::boost::dispatch::tag::xop_)(::boost::dispatch::tag::sse_)
#define BOOST_SIMD_DEFAULT_EXTENSION  ::boost::dispatch::tag::xop_
#define BOOST_SIMD_DEFAULT_SITE       ::boost::dispatch::tag::xop_
