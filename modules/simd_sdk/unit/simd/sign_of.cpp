 ...
 ******************************************************************************/
#define BOOST_SIMD_UNIT_MODULE "boost::simd::meta::sign_of SIMD"
...
////////////////////////////////////////////////////////////////////////////////
BOOST_SIMD_TEST_CASE_TPL(sign_of_simd, BOOST_SIMD_TYPES)
{
  ...
  BOOST_SIMD_TEST( (is_same< typename sign_of<native_t>::type
