...
/////////////////////////////////////////////////////////////////////////////
NT2_REGISTER_DISPATCH(standard::tag::atan2_, tag::cpu_,
                       (A0)(A1),
...
namespace nt2 { namespace ext
{
  ...
  struct call<standard::tag::atan2_(tag::arithmetic_,tag::arithmetic_),
...
{
  template<class Dummy>
  struct call<standard::tag::atan2_(tag::real_,tag::real_),
              tag::cpu_, Dummy> : callable
  {
    template<class Sig> struct result;
    template<class This,class A0, class A1>
    ...
    NT2_FUNCTOR_CALL(2){ return std::atan2(a0, a1); }
  };
} }
