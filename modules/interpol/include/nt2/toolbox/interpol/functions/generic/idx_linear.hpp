...
//       std::cout <<  "extrap     "<<  extrap    << std::endl;
//       std::cout <<  "extrapval1 "<<  extrapval1<< std::endl;
//       std::cout <<  "extrapval2 "<<  extrapval2<< std::endl;
...
//       std::cout <<  "nt2::along1 " << nt2::along(y, i_index, dim)<< std::endl;
//       std::cout <<  "nt2::along2 "<< nt2::along(y, nt2::min(oneplus(i_index), il), dim)<< std::endl;
