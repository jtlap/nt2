...
NT2_TEST_CASE_TPL ( groups_complex,  BOOST_SIMD_SIMD_REAL_GROUPABLE_TYPES)
{
  using nt2::groups;
  ...
  typedef typename nt2::meta::call<groups_(cvT,cvT)>::type r_t;
  typedef typename nt2::meta::downgrade<cvT>::type   wished_t;

  NT2_TEST_TYPE_IS(r_t, wished_t);

  NT2_TEST_EQUAL(groups(nt2::One<cvT>(), nt2::One<cvT>()),   nt2::One<r_t>());
  NT2_TEST_EQUAL(groups(nt2::Zero<cvT>(), nt2::Zero<cvT>()), nt2::Zero<r_t>());
}
