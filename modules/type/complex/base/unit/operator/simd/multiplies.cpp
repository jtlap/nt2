...
NT2_TEST_CASE_TPL ( multiplies_real,  NT2_SIMD_REAL_TYPES)
{
  ...
  NT2_TEST_EQUAL(nt2::multiplies(nt2::Inf<vcT>(), nt2::Inf<vcT>()), nt2::Inf<vcT>());
  NT2_TEST_EQUAL(nt2::multiplies(nt2::Inf<vdT>(), nt2::Inf<vcT>()), nt2::Inf<vcT>());
  NT2_TEST_EQUAL(nt2::multiplies(nt2::Inf<vdT>(), nt2::Inf<vdT>()), nt2::Inf<vdT>());
#endif
  NT2_TEST_EQUAL(nt2::multiplies(nt2::One<vcT>(), nt2::Zero<vcT>()), nt2::Zero<vcT>());
  NT2_TEST_EQUAL(nt2::multiplies(nt2::Zero<vcT>(),nt2::Zero<vcT>()), nt2::Zero<vcT>());
  NT2_TEST_EQUAL(nt2::multiplies(nt2::I<vcT>(),nt2::One<vT>()), nt2::I<vcT>());
  NT2_TEST_EQUAL(nt2::multiplies(nt2::One<vcT>(),nt2::One<vcT>()),nt2::One<vcT>() );
