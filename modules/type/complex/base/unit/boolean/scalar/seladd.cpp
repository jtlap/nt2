...
NT2_TEST_CASE_TPL ( seladd_real,  NT2_REAL_TYPES)
{
  using nt2::seladd;
  using nt2::tag::seladd_;
  typedef typename std::complex<T> cT;
  typedef typename nt2::meta::call<seladd_(nt2::logical<T>, cT, cT)>::type r_t;
...
#endif
  NT2_TEST_EQUAL(seladd(nt2::False< nt2::logical<T> >(), cT(1), cT(0, 1)), cT(1));
  NT2_TEST_EQUAL(seladd(nt2::True< nt2::logical<T> >(),cT(1),cT(0, 1)), cT(1, 1));
  NT2_TEST_EQUAL(seladd(nt2::Zero<cT>(), cT(1),cT(0, 1)),  cT(1));
  NT2_TEST_EQUAL(seladd(nt2::False< nt2::logical<T> >(), T(1), cT(0, 1)), cT(1));
  NT2_TEST_EQUAL(seladd(nt2::True< nt2::logical<T> >(),T(1),cT(0, 1)), cT(1, 1));
  NT2_TEST_EQUAL(seladd(nt2::Zero<cT>(), T(1),cT(0, 1)),  cT(1));
  NT2_TEST_EQUAL(seladd(nt2::False< nt2::logical<T> >(),cT(0, 1),  T(1)),  cT(0, 1));
  NT2_TEST_EQUAL(seladd(nt2::True< nt2::logical<T> >(), cT(0, 1),  T(1)),  cT(1, 1));
  NT2_TEST_EQUAL(seladd(nt2::Zero<cT>(),           cT(0, 1),  T(1)),  cT(0, 1));
  NT2_TEST_EQUAL(seladd(nt2::Zero<T>(),            cT(0, 1),  T(1)),  cT(0, 1));
  NT2_TEST_EQUAL(seladd(nt2::One<cT>(),            cT(0, 1),  T(1)),  cT(1, 1));
  NT2_TEST_EQUAL(seladd(nt2::One<T>(),             cT(0, 1),  T(1)),  cT(1, 1));
}
