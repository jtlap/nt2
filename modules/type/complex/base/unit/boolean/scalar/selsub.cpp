...
NT2_TEST_CASE_TPL ( selsub_real,  NT2_REAL_TYPES)
{
  using nt2::selsub;
  using nt2::tag::selsub_;
  typedef typename std::complex<T> cT;
  typedef typename nt2::meta::call<selsub_(nt2::logical<T>, cT, cT)>::type r_t;
...
#endif
  NT2_TEST_EQUAL(selsub(nt2::False< nt2::logical<T> >(), cT(1), cT(0, 1)), cT(1));
  NT2_TEST_EQUAL(selsub(nt2::True< nt2::logical<T> >(),cT(1),cT(0, 1)), cT(1, -1));
  NT2_TEST_EQUAL(selsub(nt2::Zero<cT>(), cT(1),cT(0, 1)),  cT(1));
  NT2_TEST_EQUAL(selsub(nt2::False< nt2::logical<T> >(), T(1), cT(0, 1)), cT(1));
  NT2_TEST_EQUAL(selsub(nt2::True< nt2::logical<T> >(),T(1),cT(0, 1)), cT(1, -1));
  NT2_TEST_EQUAL(selsub(nt2::Zero<cT>(), T(1),cT(0, 1)),  cT(1));
  NT2_TEST_EQUAL(selsub(nt2::False< nt2::logical<T> >(),cT(0, 1),  T(1)),  cT(0, 1));
  NT2_TEST_EQUAL(selsub(nt2::True< nt2::logical<T> >(), cT(0, 1),  T(1)),  cT(-1, 1));
  NT2_TEST_EQUAL(selsub(nt2::Zero<cT>(),           cT(0, 1),  T(1)),  cT(0, 1));
  NT2_TEST_EQUAL(selsub(nt2::Zero<T>(),            cT(0, 1),  T(1)),  cT(0, 1));
  NT2_TEST_EQUAL(selsub(nt2::One<cT>(),            cT(0, 1),  T(1)),  cT(-1, 1));
  NT2_TEST_EQUAL(selsub(nt2::One<T>(),             cT(0, 1),  T(1)),  cT(-1, 1));
}
