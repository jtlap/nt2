...
//==============================================================================
#define NT2_UNIT_MODULE "nt2 boost.simd.boolean toolbox - ifnotadd/scalar Mode"
...
NT2_TEST_CASE_TPL ( ifnotadd_real__2_0,  NT2_REAL_TYPES)
{
  using nt2::ifnotadd;
  ...
  NT2_TEST_TYPE_IS( typename nt2::meta::call<ifnotadd_(logical<T>, cT, cT)>::type
                  , cT
                  );

  // specific values tests
  NT2_TEST_EQUAL(ifnotadd(nt2::True< logical<T> >(), cT(1), cT(0, 1)), cT(1));
  NT2_TEST_EQUAL(ifnotadd(nt2::False< logical<T> >(),cT(1),cT(0, 1)), cT(1, 1));
  ...
  NT2_TEST_EQUAL(ifnotadd(nt2::True< logical<T> >(), T(1), cT(0, 1)), cT(1));
  NT2_TEST_EQUAL(ifnotadd(nt2::False< logical<T> >(),T(1),cT(0, 1)), cT(1, 1));
  ...
  NT2_TEST_EQUAL(ifnotadd(nt2::True< logical<T> >(),cT(0, 1),  T(1)),  cT(0, 1));
  NT2_TEST_EQUAL(ifnotadd(nt2::False< logical<T> >(), cT(0, 1),  T(1)),  cT(1, 1));
