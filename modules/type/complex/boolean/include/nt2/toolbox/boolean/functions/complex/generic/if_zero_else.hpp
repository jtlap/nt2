...
//==============================================================================
#ifndef NT2_TOOLBOX_BOOLEAN_FUNCTIONS_COMPLEX_GENERIC_IF_ZERO_ELSE_HPP_INCLUDED
#define NT2_TOOLBOX_BOOLEAN_FUNCTIONS_COMPLEX_GENERIC_IF_ZERO_ELSE_HPP_INCLUDED
...
namespace nt2 { namespace ext
{
                              ...
                              )
  {
    ...
    result_type  operator()(A0 const& a0, A1 const& a1) const
    {      
      return result_type(if_zero_else(is_nez(a0), real(a1)), if_zero_else(is_nez(a0), imag(a1))); 
    }
  };  
} } 
