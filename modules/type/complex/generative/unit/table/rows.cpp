...
NT2_TEST_CASE_TPL( _0d, NT2_TYPES )
{
 ...
 typedef std::complex<T> cT;
  ...
  nt2::table<cT> x1 = nt2::rows( cT(42) );
  NT2_TEST_EXPR_TYPE( ( nt2::rows( cT(42) )), (value_type_<_>), (cT) );
  NT2_TEST_EQUAL( nt2::extent(x1), nt2::of_size(1) );
  NT2_TEST_EQUAL( x1(1),cT(42) );
}
...
NT2_TEST_CASE_TPL( square, NT2_TYPES )
{
  ...
  nt2::table<cT> x0 = nt2::rows(3,s);

  NT2_TEST_EXPR_TYPE( ( nt2::rows( 3,s )), (value_type_<_>), (cT) );
...
NT2_TEST_CASE_TPL( nd, NT2_TYPES )
{
  ...
  nt2::table<cT> x1 = nt2::rows(nt2::of_size(8, 8), s );

  NT2_TEST_EXPR_TYPE( ( nt2::rows(nt2::of_size(8, 8), s ) ), (value_type_<_>), (cT) );
  NT2_TEST_EQUAL(x1,ref);

  nt2::table<cT> x2 = nt2::rows(8, 8, s );
  NT2_TEST_EQUAL(x2,ref);

  nt2::table<cT> x3 = nt2::rows(8, s );
...
NT2_TEST_CASE_TPL( typed_expr, NT2_TYPES )
{
  ...
  nt2::table<cT> x1 = nt2::rows( t1, s );
  NT2_TEST_EXPR_TYPE( ( nt2::rows(t1, s ) ), (value_type_<_>), (cT) );
  NT2_TEST_EQUAL(x1,ref);
