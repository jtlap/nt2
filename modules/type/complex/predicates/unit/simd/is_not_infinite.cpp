...
NT2_TEST_CASE_TPL ( is_not_infinite_real__1_0,  BOOST_SIMD_SIMD_REAL_TYPES)
{
  ...
  NT2_TEST_EQUAL(is_not_infinite(nt2::Half<cvT>())[0], nt2::True<sr_t>());
  ...
  NT2_TEST_EQUAL(is_not_infinite(nt2::Quarter<cvT>())[0], nt2::True<sr_t>());
  NT2_TEST_EQUAL(is_not_infinite(nt2::Two<cvT>())[0], nt2::True<sr_t>());
