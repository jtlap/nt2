...
NT2_TEST_CASE_TPL ( is_not_nan_real__1_0,  BOOST_SIMD_REAL_TYPES)
{
  ...
  NT2_TEST_EQUAL(is_not_nan(nt2::Mzero<T>()), r_t(true));
  NT2_TEST_EQUAL(is_not_nan(nt2::Half<T>()), r_t(true));
  NT2_TEST_EQUAL(is_not_nan(nt2::Inf<T>()), r_t(true));
  NT2_TEST_EQUAL(is_not_nan(nt2::Minf<T>()), r_t(true));
  NT2_TEST_EQUAL(is_not_nan(nt2::Mone<T>()), r_t(true));
  NT2_TEST_EQUAL(is_not_nan(nt2::Nan<T>()), r_t(false));
  NT2_TEST_EQUAL(is_not_nan(nt2::One<T>()), r_t(true));
  NT2_TEST_EQUAL(is_not_nan(nt2::Quarter<T>()), r_t(true));
  NT2_TEST_EQUAL(is_not_nan(nt2::Two<T>()), r_t(true));
  NT2_TEST_EQUAL(is_not_nan(nt2::Zero<T>()), r_t(true));
