...
NT2_TEST_CASE_TPL ( is_not_finite_real__1_0,  BOOST_SIMD_REAL_TYPES)
{
  ...
  NT2_TEST_TYPE_IS( typename boost::dispatch::meta::call<is_not_finite_(cT)>::type, nt2::logical<T> );
  NT2_TEST_TYPE_IS( typename boost::dispatch::meta::call<is_not_finite_(ciT)>::type, nt2::logical<T> );
