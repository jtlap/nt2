...
NT2_TEST_CASE_TPL ( is_nez_real__1_0,  BOOST_SIMD_REAL_TYPES)
{
  ...
  NT2_TEST_EQUAL(is_nez(-nt2::Zero<T>()), r_t(false));
  NT2_TEST_EQUAL(is_nez(nt2::Half<T>()), r_t(true));
  NT2_TEST_EQUAL(is_nez(nt2::Inf<T>()), r_t(true));
  NT2_TEST_EQUAL(is_nez(nt2::Minf<T>()), r_t(true));
  NT2_TEST_EQUAL(is_nez(nt2::Mone<T>()), r_t(true));
  NT2_TEST_EQUAL(is_nez(nt2::Nan<T>()), r_t(true));
  NT2_TEST_EQUAL(is_nez(nt2::One<T>()), r_t(true));
  NT2_TEST_EQUAL(is_nez(nt2::Quarter<T>()), r_t(true));
  NT2_TEST_EQUAL(is_nez(nt2::Two<T>()), r_t(true));
  NT2_TEST_EQUAL(is_nez(nt2::Zero<T>()), r_t(false));
