...
NT2_TEST_CASE_TPL ( ratfracder_real__1_0, NT2_REAL_TYPES)
{
  ...
  T dab[] = { 1, 4, 10,  4, 1 };
  T da [] = { 3, 4, 3 };
  nt2::table<cT> rdab(nt2::of_size(1, 5), &dab[0], &dab[5]);
  nt2::table<cT> rda (nt2::of_size(1, 3), &da[0], &da[3]);
  nt2::table<cT> rnn (nt2::of_size(1, 5), &rn[0], &rn[5]);
  nt2::table<cT> rdd (nt2::of_size(1, 5), &rd[0], &rd[5]);
