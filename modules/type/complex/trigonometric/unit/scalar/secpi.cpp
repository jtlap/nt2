...
NT2_TEST_CASE_TPL ( secpi_real__1_0,  NT2_REAL_TYPES)
{
  ...
  typedef typename nt2::meta::call<secpi_(cT)>::type r_t;
  ...
  NT2_TEST_ULP_EQUAL(nt2::secpi(cT(nt2::Inf<T>())), cT(nt2::Nan<T>()), 2);
  NT2_TEST_ULP_EQUAL(nt2::secpi(cT(nt2::Minf<T>())), cT(nt2::Nan<T>()), 2);
  NT2_TEST_ULP_EQUAL(nt2::secpi(cT(1, 1)),nt2::rec(nt2::cospi(cT(1.0, 1.0))), 2);
  NT2_TEST_ULP_EQUAL(nt2::secpi(cT(1, 2)),nt2::rec(nt2::cospi(cT(1.0, 2.0))), 2);
  NT2_TEST_ULP_EQUAL(nt2::secpi(cT(2, 1)),nt2::rec(nt2::cospi(cT(2.0, 1.0))), 2);
  NT2_TEST_ULP_EQUAL(nt2::secpi(cT(2, 2)),nt2::rec(nt2::cospi(cT(2.0, 2.0))), 2);
