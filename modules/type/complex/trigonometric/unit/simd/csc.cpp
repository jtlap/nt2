...
NT2_TEST_CASE_TPL ( csc, NT2_SIMD_REAL_TYPES)
{
  ...
  typedef typename nt2::meta::call<csc_(vcT)>::type r_t;
  ...
  {
    NT2_TEST_ULP_EQUAL(nt2::csc(nt2::splat<vcT>(a[i])), nt2::splat<vcT>(nt2::csc(a[i])), 1.0);
  }
