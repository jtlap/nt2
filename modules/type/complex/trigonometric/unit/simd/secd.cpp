...
NT2_TEST_CASE_TPL ( secd, NT2_SIMD_REAL_TYPES)
{
  ...
  typedef typename nt2::meta::call<secd_(vcT)>::type r_t;
  ...
  {
    NT2_TEST_ULP_EQUAL(nt2::secd(nt2::splat<vcT>(a[i])), nt2::splat<vcT>(nt2::secd(a[i])), 18.0);
  }
