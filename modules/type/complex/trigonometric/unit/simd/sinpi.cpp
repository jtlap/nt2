...
NT2_TEST_CASE_TPL ( sinpi, NT2_SIMD_REAL_TYPES)
{
  ...
  typedef typename nt2::meta::call<sinpi_(vcT)>::type r_t;
  ...
  {
    NT2_TEST_ULP_EQUAL(nt2::sinpi(nt2::splat<vcT>(a[i])), nt2::splat<vcT>(nt2::sinpi(a[i])), 2.5);
  }
