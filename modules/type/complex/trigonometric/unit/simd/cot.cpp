...
NT2_TEST_CASE_TPL ( cot, NT2_SIMD_REAL_TYPES)
{
  ...
  typedef typename nt2::meta::call<cot_(vcT)>::type r_t;
  ...
  {
    NT2_TEST_ULP_EQUAL(nt2::cot(nt2::splat<vcT>(a[i])), nt2::splat<vcT>(nt2::cot(a[i])), 1.0);
  }
