...
NT2_TEST_CASE_TPL ( sec, NT2_SIMD_REAL_TYPES)
{
  ...
  typedef typename nt2::meta::call<sec_(vcT)>::type r_t;
  ...
  {
    NT2_TEST_ULP_EQUAL(nt2::sec(nt2::splat<vcT>(a[i])), nt2::splat<vcT>(nt2::sec(a[i])), 1.5);
  }
