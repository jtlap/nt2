...
NT2_TEST_CASE_TPL ( sin, NT2_SIMD_REAL_TYPES)
{
  ...
  typedef typename nt2::meta::call<sin_(vcT)>::type r_t;
  ...
  {
    NT2_TEST_ULP_EQUAL(nt2::sin(nt2::splat<vcT>(a[i])), nt2::splat<vcT>(nt2::sin(a[i])), 1.0);
  }
