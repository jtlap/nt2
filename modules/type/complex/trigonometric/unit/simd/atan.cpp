...
NT2_TEST_CASE_TPL ( atan, NT2_SIMD_REAL_TYPES)
{
  ...
  typedef typename nt2::meta::call<atan_(vcT)>::type r_t;
  ...
  {
    NT2_TEST_ULP_EQUAL(nt2::atan(nt2::splat<vcT>(a[i])), nt2::splat<vcT>(nt2::atan(a[i])), 1.0);
  }
