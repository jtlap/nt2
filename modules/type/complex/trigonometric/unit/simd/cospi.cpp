...
NT2_TEST_CASE_TPL ( cospi, NT2_SIMD_REAL_TYPES)
{
  ...
  typedef typename nt2::meta::call<cospi_(vcT)>::type r_t;
  ...
  {
    NT2_TEST_ULP_EQUAL(nt2::cospi(nt2::splat<vcT>(a[i])), nt2::splat<vcT>(nt2::cospi(a[i])), 2.5);
  }
