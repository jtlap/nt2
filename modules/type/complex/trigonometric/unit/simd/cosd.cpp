...
NT2_TEST_CASE_TPL ( cosd, NT2_SIMD_REAL_TYPES)
{
  ...
  typedef typename nt2::meta::call<cosd_(vcT)>::type r_t;
  ...
  {
    NT2_TEST_ULP_EQUAL(nt2::cosd(nt2::splat<vcT>(a[i])), nt2::splat<vcT>(nt2::cosd(a[i])), 17.0);
  }
