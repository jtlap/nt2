...
NT2_TEST_CASE_TPL ( asin, NT2_SIMD_REAL_TYPES)
{
  ...
  typedef typename nt2::meta::call<asin_(vcT)>::type r_t;
  ...
  {
    NT2_TEST_ULP_EQUAL(nt2::asin(nt2::splat<vcT>(a[i])), nt2::splat<vcT>(nt2::asin(a[i])), 5.0);
  }
