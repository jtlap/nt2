...
NT2_TEST_CASE_TPL ( cscd, NT2_SIMD_REAL_TYPES)
{
  ...
  typedef typename nt2::meta::call<cscd_(vcT)>::type r_t;
  ...
  {
    NT2_TEST_ULP_EQUAL(nt2::cscd(nt2::splat<vcT>(a[i])), nt2::splat<vcT>(nt2::cscd(a[i])), 25.0);
  }
