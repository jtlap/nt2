...
NT2_TEST_CASE_TPL ( cscpi, NT2_SIMD_REAL_TYPES)
{
  ...
  typedef typename nt2::meta::call<cscpi_(vcT)>::type r_t;
  ...
  {
    NT2_TEST_ULP_EQUAL(nt2::cscpi(nt2::splat<vcT>(a[i])), nt2::splat<vcT>(nt2::cscpi(a[i])), 3.0);
  }
