...
NT2_TEST_CASE_TPL ( acos, NT2_SIMD_REAL_TYPES)
{
  ...
  typedef typename nt2::meta::call<acos_(vcT)>::type r_t;
  ...
  {
    NT2_TEST_ULP_EQUAL(nt2::acos(nt2::splat<vcT>(a[i])), nt2::splat<vcT>(nt2::acos(a[i])), 1.0);
  }
