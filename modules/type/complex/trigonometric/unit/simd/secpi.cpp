...
NT2_TEST_CASE_TPL ( secpi, NT2_SIMD_REAL_TYPES)
{
  ...
  typedef typename nt2::meta::call<secpi_(vcT)>::type r_t;
  ...
  {
    NT2_TEST_ULP_EQUAL(nt2::secpi(nt2::splat<vcT>(a[i])), nt2::splat<vcT>(nt2::secpi(a[i])), 3.0);
  }
