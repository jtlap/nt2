...
NT2_TEST_CASE_TPL ( sind, NT2_SIMD_REAL_TYPES)
{
  ...
  typedef typename nt2::meta::call<sind_(vcT)>::type r_t;
  ...
  {
    NT2_TEST_ULP_EQUAL(nt2::sind(nt2::splat<vcT>(a[i])), nt2::splat<vcT>(nt2::sind(a[i])), 1.0);
  }
