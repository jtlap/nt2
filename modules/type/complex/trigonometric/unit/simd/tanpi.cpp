...
NT2_TEST_CASE_TPL ( tanpi, NT2_SIMD_REAL_TYPES)
{
  ...
  typedef typename nt2::meta::call<tanpi_(vcT)>::type r_t;
  ...
  {
    NT2_TEST_ULP_EQUAL(nt2::tanpi(nt2::splat<vcT>(a[i])), nt2::splat<vcT>(nt2::tanpi(a[i])), 1.0);
  }
