...
NT2_TEST_CASE_TPL ( tand, NT2_SIMD_REAL_TYPES)
{
  ...
  typedef typename nt2::meta::call<tand_(vcT)>::type r_t;
  ...
  {
    NT2_TEST_ULP_EQUAL(nt2::tand(nt2::splat<vcT>(a[i])), nt2::splat<vcT>(nt2::tand(a[i])), 5.0);
  }
