...
NT2_TEST_CASE_TPL ( group_complex,  BOOST_SIMD_SIMD_REAL_GROUPABLE_TYPES)
{
  ...
  std::cout << nt2::type_id<cvT>() << std::endl;
  std::cout << nt2::type_id<r_t>() << std::endl;
  std::cout << nt2::type_id<wished_t>() << std::endl;
  std::cout << nt2::One<cvT>() << std::endl;
  std::cout << nt2::One<r_t>() << std::endl;
  std::cout << group(nt2::One<cvT>(), nt2::One<cvT>())<< std::endl;
