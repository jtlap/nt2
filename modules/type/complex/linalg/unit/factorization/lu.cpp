...
NT2_TEST_CASE_TPL ( square_lu, NT2_REAL_TYPES)
{
  ...
  NT2_TEST_EQUAL    ( p                  , (nt2::eye(4, nt2::meta::as_<cT>())) );
...
NT2_TEST_CASE_TPL ( non_square_lu, NT2_REAL_TYPES)
{
  ...
  nt2::table<cT> lu, l, u, p;
  nt2::table<cT> a = nt2::ones(4, 7, as_<cT>()) + T(10)*nt2::eye(4, 7, as_<cT>());
  ...
  lu = nt2::zeros(4, 7, nt2::meta::as_<cT>());
