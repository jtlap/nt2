...
//==============================================================================
#ifndef NT2_TOOLBOX_EXPONENTIAL_FUNCTIONS_COMPLEX_GENERIC_EXPI_HPP_INCLUDED
#define NT2_TOOLBOX_EXPONENTIAL_FUNCTIONS_COMPLEX_GENERIC_EXPI_HPP_INCLUDED

#include <nt2/toolbox/exponential/functions/expi.hpp>
...
namespace nt2 { namespace ext
{
                            ...
                            )
  {
    ...
    NT2_FUNCTOR_CALL(1)
    {
      return result_type(nt2::exp(-nt2::imag(a0)));
    }
  };
