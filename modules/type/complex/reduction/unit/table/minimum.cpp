...
NT2_TEST_CASE_TPL( minimum_2, (float)(double) )
{
  ...
  sy = nt2::minimum(y);
  NT2_TEST_EQUAL(y(1, nt2::_),  nt2::minimum(y));
  sy = nt2::minimum(y, 1);
  NT2_TEST_EQUAL(y(1, nt2::_),  nt2::minimum(y, 1));
  sy = nt2::minimum(y, 2);
  NT2_TEST_EQUAL(y(nt2::_, 1),  nt2::minimum(y, 2));
  sy = nt2::minimum(y, 1);
  NT2_TEST_EQUAL(y,  nt2::minimum(y, 3));
