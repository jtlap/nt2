 ...
 ******************************************************************************/
#ifndef NT2_TOOLBOX_STATISTICS_FUNCTIONS_EXPR_NORMRND_HPP_INCLUDED
#define NT2_TOOLBOX_STATISTICS_FUNCTIONS_EXPR_NORMRND_HPP_INCLUDED
...
namespace nt2 { namespace ext
{
  ...
  {
    typedef meta::as_<A0>                                                           TGT; 
    typedef typename meta::call<tag::randn_(const A1&, const A2&,
