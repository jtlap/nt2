 ...
 * \file
**/
#ifndef NT2_TOOLBOX_CRLIBM_FUNCTIONS_ASINPI_RZ_HPP_INCLUDED
#define NT2_TOOLBOX_CRLIBM_FUNCTIONS_ASINPI_RZ_HPP_INCLUDED
 ...
 *   {
 *     template <class A0>
 *       meta::call<tag::asinpi_rz_(A0)>::type
 *       asinpi_rz(const A0 & a0);
 *   }
 * }
 * \endcode
 *
 * \param a0 the unique parameter of asinpi_rz
 * 
...
namespace nt2 { namespace crlibm { namespace tag
  {
    /*!
     * \brief Define the tag asinpi_rz_ of functor asinpi_rz 
     *        in namespace nt2::crlibm::tag for toolbox crlibm
    **/
    struct asinpi_rz_ : ext::elementwise_<asinpi_rz_> { typedef ext::elementwise_<asinpi_rz_> parent; };
  }
