 ...
 * \file
**/
#ifndef NT2_TOOLBOX_CRLIBM_FUNCTIONS_SINH_RU_HPP_INCLUDED
#define NT2_TOOLBOX_CRLIBM_FUNCTIONS_SINH_RU_HPP_INCLUDED
 ...
 *   {
 *     template <class A0>
 *       meta::call<tag::sinh_ru_(A0)>::type
 *       sinh_ru(const A0 & a0);
 *   }
 * }
 * \endcode
 *
 * \param a0 the unique parameter of sinh_ru
 *
...
namespace nt2 { namespace crlibm { namespace tag
  {
    /*!
     * \brief Define the tag sinh_ru_ of functor sinh_ru
     *        in namespace nt2::crlibm::tag for toolbox crlibm
    **/
    struct sinh_ru_ : ext::elementwise_<sinh_ru_> { typedef ext::elementwise_<sinh_ru_> parent; };
  }
