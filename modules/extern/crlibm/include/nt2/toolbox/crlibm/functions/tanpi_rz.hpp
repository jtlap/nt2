 ...
 * \file
**/
#ifndef NT2_TOOLBOX_CRLIBM_FUNCTIONS_TANPI_RZ_HPP_INCLUDED
#define NT2_TOOLBOX_CRLIBM_FUNCTIONS_TANPI_RZ_HPP_INCLUDED
...
/*!
 * \ingroup crlibm
 * \defgroup crlibm_tanpi_rz tanpi_rz
 *
 * \par Description
 ...
 *   {
 *     template <class A0>
 *       meta::call<tag::tanpi_rz_(A0)>::type
 *       tanpi_rz(const A0 & a0);
 *   }
 * }
 * \endcode
 *
 * \param a0 the unique parameter of tanpi_rz
 *
...
namespace nt2 { namespace crlibm { namespace tag
  {
    ...
    **/
    struct tanpi_rz_ : ext::elementwise_<tanpi_rz_> { typedef ext::elementwise_<tanpi_rz_> parent; };
  }
