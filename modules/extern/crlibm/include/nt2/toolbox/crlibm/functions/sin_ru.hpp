 ...
 * \file
**/
#ifndef NT2_TOOLBOX_CRLIBM_FUNCTIONS_SIN_RU_HPP_INCLUDED
#define NT2_TOOLBOX_CRLIBM_FUNCTIONS_SIN_RU_HPP_INCLUDED
 ...
 *   {
 *     template <class A0>
 *       meta::call<tag::sin_ru_(A0)>::type
 *       sin_ru(const A0 & a0);
 *   }
 * }
 * \endcode
 *
 * \param a0 the unique parameter of sin_ru
 *
...
namespace nt2 { namespace crlibm { namespace tag
  {
    ...
    **/
    struct sin_ru_ : ext::elementwise_<sin_ru_> { typedef ext::elementwise_<sin_ru_> parent; };
  }
