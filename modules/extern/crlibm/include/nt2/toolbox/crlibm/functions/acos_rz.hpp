 ...
 * \file
**/
#ifndef NT2_TOOLBOX_CRLIBM_FUNCTIONS_ACOS_RZ_HPP_INCLUDED
#define NT2_TOOLBOX_CRLIBM_FUNCTIONS_ACOS_RZ_HPP_INCLUDED
 ...
 *   {
 *     template <class A0>
 *       meta::call<tag::acos_rz_(A0)>::type
 *       acos_rz(const A0 & a0);
 *   }
 * }
 * \endcode
 *
 * \param a0 the unique parameter of acos_rz
 *
...
namespace nt2 { namespace crlibm { namespace tag
  {
    /*!
     * \brief Define the tag acos_rz_ of functor acos_rz
     *        in namespace nt2::crlibm::tag for toolbox crlibm
    **/
    struct acos_rz_ : ext::elementwise_<acos_rz_> { typedef ext::elementwise_<acos_rz_> parent; };
  }
