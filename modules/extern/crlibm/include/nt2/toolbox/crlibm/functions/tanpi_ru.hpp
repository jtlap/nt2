...
/*!
 * \ingroup crlibm
 * \defgroup crlibm_tanpi_ru tanpi_ru
 *
 * \par Description
 ...
 *   {
 *     template <class A0>
 *       meta::call<tag::tanpi_ru_(A0)>::type
 *       tanpi_ru(const A0 & a0);
 *   }
 * }
 * \endcode
 *
 * \param a0 the unique parameter of tanpi_ru
 *
...
namespace nt2 { namespace crlibm { namespace tag
  {
    /*!
     * \brief Define the tag tanpi_ru_ of functor tanpi_ru
     *        in namespace nt2::crlibm::tag for toolbox crlibm
    **/
    struct tanpi_ru_ : ext::elementwise_<tanpi_ru_> { typedef ext::elementwise_<tanpi_ru_> parent; };
  }
