 ...
 * \file
**/
#ifndef NT2_TOOLBOX_CRLIBM_FUNCTIONS_COS_RU_HPP_INCLUDED
#define NT2_TOOLBOX_CRLIBM_FUNCTIONS_COS_RU_HPP_INCLUDED
#include <nt2/include/functor.hpp>
#include <nt2/toolbox/crlibm/specific/interface.hpp>

/*!
 * \ingroup crlibm
 * \defgroup crlibm_cos_ru cos_ru
 *
 * \par Description
 ...
 *   {
 *     template <class A0>
 *       meta::call<tag::cos_ru_(A0)>::type
 *       cos_ru(const A0 & a0);
 *   }
 * }
 * \endcode
 *
 * \param a0 the unique parameter of cos_ru
 *
...
namespace nt2 { namespace crlibm { namespace tag
  {
    ...
    **/
    struct cos_ru_ : ext::elementwise_<cos_ru_> { typedef ext::elementwise_<cos_ru_> parent; };
  }
