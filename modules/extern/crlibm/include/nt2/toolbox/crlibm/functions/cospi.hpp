 ...
 * \file
**/
#ifndef NT2_TOOLBOX_CRLIBM_FUNCTIONS_COSPI_HPP_INCLUDED
#define NT2_TOOLBOX_CRLIBM_FUNCTIONS_COSPI_HPP_INCLUDED
#include <nt2/include/functor.hpp>
#include <nt2/toolbox/crlibm/specific/interface.hpp>

/*!
 * \ingroup crlibm
 * \defgroup crlibm_cospi cospi
 *
 * \par Description
 ...
 * mode used by the function cospi.
...
namespace nt2 { namespace crlibm { namespace tag
  {
    ...
    **/
    template <class T>
    struct cospi_ : ext::elementwise_<cospi_<T> > { typedef ext::elementwise_<cospi_<T> > parent; };
  }
