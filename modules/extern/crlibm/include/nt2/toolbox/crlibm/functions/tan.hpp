 ...
 * \file
**/
#ifndef NT2_TOOLBOX_CRLIBM_FUNCTIONS_TAN_HPP_INCLUDED
#define NT2_TOOLBOX_CRLIBM_FUNCTIONS_TAN_HPP_INCLUDED
#include <nt2/include/functor.hpp>
#include <nt2/toolbox/crlibm/specific/interface.hpp>

/*!
 * \ingroup crlibm
 * \defgroup crlibm_tan tan
 *
 * \par Description
...
namespace nt2 { namespace crlibm { namespace tag
  {
    ...
    **/
    template <class T>
    struct tan_ : ext::elementwise_<tan_<T> > { typedef ext::elementwise_<tan_<T> > parent; };
  }
