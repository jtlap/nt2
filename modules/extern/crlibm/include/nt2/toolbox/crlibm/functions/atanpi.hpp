 ...
 * \file
**/
#ifndef NT2_TOOLBOX_CRLIBM_FUNCTIONS_ATANPI_HPP_INCLUDED
#define NT2_TOOLBOX_CRLIBM_FUNCTIONS_ATANPI_HPP_INCLUDED
 ...
 * mode used by the function atanpi.
...
namespace nt2 { namespace crlibm { namespace tag
  {
    ...
    **/
    template <class T>
    struct atanpi_ : ext::elementwise_<atanpi_<T> > { typedef ext::elementwise_<atanpi_<T> > parent; };
  }
  NT2_CRLIBM_FUNCTION_IMPLEMENTATION_TPL(atanpi, 1)
} }
