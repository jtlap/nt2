 ...
 * \file
**/
#ifndef NT2_TOOLBOX_CRLIBM_FUNCTIONS_TANPI_HPP_INCLUDED
#define NT2_TOOLBOX_CRLIBM_FUNCTIONS_TANPI_HPP_INCLUDED
 ...
 * mode used by the function tanpi.
...
namespace nt2 { namespace crlibm { namespace tag
  {
    ...
    **/
    template <class T>
    struct tanpi_ : ext::elementwise_<tanpi_<T> > { typedef ext::elementwise_<tanpi_<T> > parent; };
  }
