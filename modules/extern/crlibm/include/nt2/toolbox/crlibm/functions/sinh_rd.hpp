...
/*!
 * \ingroup crlibm
 * \defgroup crlibm_sinh_rd sinh_rd
 *
 * \par Description
 ...
 *   {
 *     template <class A0>
 *       meta::call<tag::sinh_rd_(A0)>::type
 *       sinh_rd(const A0 & a0);
 *   }
 * }
 * \endcode
 *
 * \param a0 the unique parameter of sinh_rd
 *
...
namespace nt2 { namespace crlibm { namespace tag
  {
    ...
    **/
    struct sinh_rd_ : ext::elementwise_<sinh_rd_> { typedef ext::elementwise_<sinh_rd_> parent; };
  }
