...
/*!
 * \ingroup crlibm
 * \defgroup crlibm_tanpi_rn tanpi_rn
 *
 * \par Description
 ...
 *   {
 *     template <class A0>
 *       meta::call<tag::tanpi_rn_(A0)>::type
 *       tanpi_rn(const A0 & a0);
 *   }
 * }
 * \endcode
 *
 * \param a0 the unique parameter of tanpi_rn
 *
...
namespace nt2 { namespace crlibm { namespace tag
  {
    /*!
     * \brief Define the tag tanpi_rn_ of functor tanpi_rn
     *        in namespace nt2::crlibm::tag for toolbox crlibm
    **/
    struct tanpi_rn_ : ext::elementwise_<tanpi_rn_> { typedef ext::elementwise_<tanpi_rn_> parent; };
  }
