 ...
 * \file
**/
#ifndef NT2_TOOLBOX_CRLIBM_FUNCTIONS_ACOS_HPP_INCLUDED
#define NT2_TOOLBOX_CRLIBM_FUNCTIONS_ACOS_HPP_INCLUDED
 ...
 * mode used by the function acos.
...
namespace nt2 { namespace crlibm { namespace tag
  {
    ...
    **/
    template <class T>
    struct acos_ : ext::elementwise_<acos_<T> > { typedef ext::elementwise_<acos_<T> > parent; };
  }
