 ...
 * \file
**/
#ifndef NT2_TOOLBOX_CRLIBM_FUNCTIONS_ATAN_HPP_INCLUDED
#define NT2_TOOLBOX_CRLIBM_FUNCTIONS_ATAN_HPP_INCLUDED
 ...
 * mode used by the function atan.
...
namespace nt2 { namespace crlibm { namespace tag
  {
    ...
    **/
    template <class T>
    struct atan_ : ext::elementwise_<atan_<T> > { typedef ext::elementwise_<atan_<T> > parent; };
  }
  NT2_CRLIBM_FUNCTION_IMPLEMENTATION_TPL(atan, 1)
} }
