...
//////////////////////////////////////////////////////////////////////////////
#define NT2_UNIT_MODULE "nt2 boost_math toolbox - double_factorial/scalar Mode"
...
NT2_TEST_CASE_TPL ( double_factorial_integer__1_0,  NT2_INTEGRAL_TYPES)
{

  using nt2::boost_math::double_factorial;
    ...
    for(nt2::uint32_t j =0; j < NR; ++j )
      {
        std::cout << "for param "
                  << "  a0 = "<< u_t(a0 = tab_a0[j])
                  << std::endl;
        NT2_TEST_ULP_EQUAL( nt2::boost_math::double_factorial<double>(a0),nt2::boost_math::double_factorial<double>(a0),1);
