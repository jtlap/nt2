...
//==============================================================================
#ifndef NT2_BLAS_FUNCTIONS_BLAS_SYR2K_HPP_INCLUDED
#define NT2_BLAS_FUNCTIONS_BLAS_SYR2K_HPP_INCLUDED
...
namespace nt2 { namespace blas
{
  namespace tag
  {
    ...
    struct syr2k_ : ext::abstract_<syr2k_>
    {
      /// INTERNAL ONLY
      typedef ext::abstract_<syr2k_> parent;
      template<class... Args>
      static BOOST_FORCEINLINE BOOST_AUTO_DECLTYPE dispatch(Args&&... args)
      BOOST_AUTO_DECLTYPE_BODY( dispatching_syr2k_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site>
    BOOST_FORCEINLINE generic_dispatcher<tag::syr2k_, Site> dispatching_syr2k_(adl_helper, boost::dispatch::meta::unknown_<Site>, ...)
    {
      return generic_dispatcher<tag::syr2k_, Site>();
    }
    template<class... Args>
    struct impl_syr2k_;
  }
    ...
    c =   alpha*trans(a)*a + beta*c
     ...
     @param trans  - char
      ...
      @param c      -  container of dimension ( ldc, n ).
              ...
              are set to zero.
  **/
  NT2_FUNCTION_IMPLEMENTATION_TPL (tag::syr2k_, syr2k
