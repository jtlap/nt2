...
//==============================================================================
#ifndef NT2_BLAS_FUNCTIONS_BLAS2_HEMV_HPP_INCLUDED
#define NT2_BLAS_FUNCTIONS_BLAS2_HEMV_HPP_INCLUDED

#include <nt2/blas/functions/hemv.hpp>
...
// /---------------------------------------------Real-single------------------------------------------------//
  ...
  BOOST_DISPATCH_IMPLEMENT  ( hemv_, tag::cpu_
...
// /---------------------------------------------Complex-single------------------------------------------------//
                            ...
                            )
  {
                                     ...
                                     ) const
    {
      ...
      nt2_la_int ix= incx;
      nt2_la_int iy= incy;
      NT2_F77NAME(chemv) (&uplo, &n, &alpha, a.data(), &lda, x.data(), &ix, &beta, y.data(), &iy);
    }
  };
...
// /---------------------------------------------Complex-double------------------------------------------------//
                            ...
                            )
  {
                                     ...
                                     ) const
    {
      ...
      nt2_la_int ix= incx;
      nt2_la_int iy= incy;
      NT2_F77NAME(zhemv) (&uplo, &n, &alpha, a.data(), &lda, x.data(), &ix, &beta, y.data(), &iy);
    }
  };
