...
//==============================================================================
#ifndef NT2_BLAS_FUNCTIONS_BLAS2_GBMV_HPP_INCLUDED
#define NT2_BLAS_FUNCTIONS_BLAS2_GBMV_HPP_INCLUDED

#include <nt2/blas/functions/gbmv.hpp>
...
// /---------------------------------------------Real-single------------------------------------------------//
  ...
  BOOST_DISPATCH_IMPLEMENT  ( gbmv_, tag::cpu_
