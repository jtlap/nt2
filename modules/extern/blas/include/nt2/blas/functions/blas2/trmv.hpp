...
//==============================================================================
#ifndef NT2_BLAS_FUNCTIONS_BLAS2_TRMV_HPP_INCLUDED
#define NT2_BLAS_FUNCTIONS_BLAS2_TRMV_HPP_INCLUDED

#include <nt2/blas/functions/trmv.hpp>
...
// /---------------------------------------------Real-single------------------------------------------------//
  ...
  BOOST_DISPATCH_IMPLEMENT  ( trmv_, tag::cpu_
