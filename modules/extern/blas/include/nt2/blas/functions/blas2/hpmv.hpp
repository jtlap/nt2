...
//==============================================================================
#ifndef NT2_BLAS_FUNCTIONS_BLAS2_HPMV_HPP_INCLUDED
#define NT2_BLAS_FUNCTIONS_BLAS2_HPMV_HPP_INCLUDED

#include <nt2/blas/functions/hpmv.hpp>
...
// /---------------------------------------------Real-single------------------------------------------------//
  ...
  BOOST_DISPATCH_IMPLEMENT  ( hpmv_, tag::cpu_
