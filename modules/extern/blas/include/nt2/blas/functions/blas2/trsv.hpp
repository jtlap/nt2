...
//==============================================================================
#ifndef NT2_BLAS_FUNCTIONS_BLAS2_TRSV_HPP_INCLUDED
#define NT2_BLAS_FUNCTIONS_BLAS2_TRSV_HPP_INCLUDED

#include <nt2/blas/functions/trsv.hpp>
...
// /---------------------------------------------Real-single------------------------------------------------//
  ...
  BOOST_DISPATCH_IMPLEMENT  ( trsv_, tag::cpu_
                            ...
                            )
  {
                                     ...
                                     ) const
    {
      ...
      nt2_la_int lda = n;
      nt2_la_int ix= incx;
      NT2_F77NAME(strsv)  (&uplo, &trans, &diag, &n, a.data(), &lda, x.data(), &ix);
    }
  };
...
// /---------------------------------------------Real-double------------------------------------------------//
                            ...
                            )
  {
                                     ...
                                     ) const
    {
      ...
      nt2_la_int lda = n;
      nt2_la_int ix= incx;
      NT2_F77NAME(dtrsv) (&uplo, &trans, &diag, &n, a.data(), &lda, x.data(), &ix);
    }
  };
...
// /---------------------------------------------Complex-single------------------------------------------------//
                            ...
                            )
  {
                                     ...
                                     ) const
    {
      ...
      nt2_la_int lda = n;
      nt2_la_int ix= incx;
      NT2_F77NAME(ctrsv) (&uplo, &trans, &diag, &n, a.data(), &lda, x.data(), &ix);
    }
  };
...
// /---------------------------------------------Complex-double------------------------------------------------//
                            ...
                            )
  {
                                     ...
                                     ) const
    {
      ...
      nt2_la_int lda = n;
      nt2_la_int ix= incx;
      NT2_F77NAME(ztrsv) (&uplo, &trans, &diag, &n, a.data(), &lda, x.data(), &ix);
    }
  };
