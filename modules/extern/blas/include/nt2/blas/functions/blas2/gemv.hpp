...
//==============================================================================
#ifndef NT2_BLAS_FUNCTIONS_BLAS2_GEMV_HPP_INCLUDED
#define NT2_BLAS_FUNCTIONS_BLAS2_GEMV_HPP_INCLUDED

#include <nt2/blas/functions/gemv.hpp>
...
// /---------------------------------------------Real-single------------------------------------------------//
  ...
  BOOST_DISPATCH_IMPLEMENT  ( gemv_, tag::cpu_
