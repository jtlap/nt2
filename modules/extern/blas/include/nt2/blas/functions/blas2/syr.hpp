...
//==============================================================================
#ifndef NT2_BLAS_FUNCTIONS_BLAS2_SYR_HPP_INCLUDED
#define NT2_BLAS_FUNCTIONS_BLAS2_SYR_HPP_INCLUDED

#include <nt2/blas/functions/syr.hpp>
...
//---------------------------------------------Real-single------------------------------------------------//
  ...
  BOOST_DISPATCH_IMPLEMENT  ( syr_, tag::cpu_
...
//---------------------------------------------Complex-single------------------------------------------------//
                            ...
                            )
  {
                                     ...
                                     , A& a) const
    {
      ...
      nt2_la_int lda = a.leading_size();
      nt2_la_int ix = incx;
      NT2_F77NAME(csyr)(&uplo, &n, &alpha, x.data(), &ix, a.data(), &lda);
    }
  };
...
//---------------------------------------------Complex-double------------------------------------------------//
                            ...
                            )
  {
                                     ...
                                     , A& a) const
    {
      ...
      nt2_la_int lda = a.leading_size();
      nt2_la_int ix = incx;
      NT2_F77NAME(zsyr) (&uplo, &n, &alpha, x.data(), &ix, a.data(), &lda);
    }
  };
