...
//==============================================================================
#ifndef NT2_BLAS_FUNCTIONS_BLAS2_GER_HPP_INCLUDED
#define NT2_BLAS_FUNCTIONS_BLAS2_GER_HPP_INCLUDED

#include <nt2/blas/functions/ger.hpp>
...
//---------------------------------------------Real-single------------------------------------------------//
  ...
  BOOST_DISPATCH_IMPLEMENT  ( ger_, tag::cpu_
...
//---------------------------------------------Complex-single------------------------------------------------//
                            ...
                            )
  {
                                     ...
                                     , A& a) const
    {
      ...
      nt2_la_int ix = incx;
      nt2_la_int iy = incy;
      NT2_F77NAME(cgerc)(&m, &n, &alpha, x.data(), &ix, y.data(), &iy, a.data(), &lda);
    }
  };
...
//---------------------------------------------Complex-double------------------------------------------------//
                            ...
                            )
  {
                                     ...
                                     , A& a) const
    {
      ...
      nt2_la_int ix = incx;
      nt2_la_int iy = incy;
      NT2_F77NAME(zgerc) (&m, &n, &alpha, x.data(), &ix, y.data(), &iy, a.data(), &lda);
    }
  };
