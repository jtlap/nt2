...
//==============================================================================
#ifndef NT2_BLAS_FUNCTIONS_BLAS2_TPMV_HPP_INCLUDED
#define NT2_BLAS_FUNCTIONS_BLAS2_TPMV_HPP_INCLUDED

#include <nt2/blas/functions/tpmv.hpp>
...
// /---------------------------------------------Real-single------------------------------------------------//
  ...
  BOOST_DISPATCH_IMPLEMENT  ( tpmv_, tag::cpu_
                            ...
                            )
  {
                                     ...
                                     ) const
    {
      ...
      nt2_la_int ix= incx;
      NT2_F77NAME(stpmv)  (&uplo, &trans, &diag, &n, a.data(), x.data(), &ix);
    }
  };
...
// /---------------------------------------------Real-double------------------------------------------------//
                            ...
                            )
  {
                                     ...
                                     ) const
    {
      nt2_la_int n = iround(sqrt(oneplus(Eight<size_t>()*numel(a)))) >> 1;
      nt2_la_int ix= incx;
      NT2_F77NAME(dtpmv) (&uplo, &trans, &diag, &n, a.data(), x.data(), &ix);
    }
  };
...
// /---------------------------------------------Complex-single------------------------------------------------//
                            ...
                            )
  {
                                     ...
                                     ) const
    {
      nt2_la_int n = iround(sqrt(oneplus(Eight<size_t>()*numel(a)))) >> 1;
      nt2_la_int ix= incx;
      NT2_F77NAME(ctpmv) (&uplo, &trans, &diag, &n, a.data(), x.data(), &ix);
    }
  };
...
// /---------------------------------------------Complex-double------------------------------------------------//
                            ...
                            )
  {
                                     ...
                                     ) const
    {
      nt2_la_int n = iround(sqrt(oneplus(Eight<size_t>()*numel(a)))) >> 1;
      nt2_la_int ix= incx;
      NT2_F77NAME(ztpmv) (&uplo, &trans, &diag, &n, a.data(), x.data(), &ix);
    }
  };
