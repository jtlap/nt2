...
//==============================================================================
#ifndef NT2_BLAS_FUNCTIONS_BLAS2_GERU_HPP_INCLUDED
#define NT2_BLAS_FUNCTIONS_BLAS2_GERU_HPP_INCLUDED

#include <nt2/blas/functions/geru.hpp>
...
//---------------------------------------------Real-single------------------------------------------------//
  ...
  BOOST_DISPATCH_IMPLEMENT  ( geru_, tag::cpu_
