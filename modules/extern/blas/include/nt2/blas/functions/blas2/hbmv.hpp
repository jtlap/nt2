...
//==============================================================================
#ifndef NT2_BLAS_FUNCTIONS_BLAS2_HBMV_HPP_INCLUDED
#define NT2_BLAS_FUNCTIONS_BLAS2_HBMV_HPP_INCLUDED

#include <nt2/blas/functions/hbmv.hpp>
...
// /---------------------------------------------Real-single------------------------------------------------//
  ...
  BOOST_DISPATCH_IMPLEMENT  ( hbmv_, tag::cpu_
