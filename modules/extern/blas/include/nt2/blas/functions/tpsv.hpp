...
//==============================================================================
#ifndef NT2_BLAS_FUNCTIONS_BLAS_TPSV_HPP_INCLUDED
#define NT2_BLAS_FUNCTIONS_BLAS_TPSV_HPP_INCLUDED

/*!
  @file
  @brief Defines and implements tpsv function
**/
...
namespace nt2 { namespace blas
{
  namespace tag
  {
    /// @brief Defines tpsv function tag
    struct tpsv_ : ext::abstract_<tpsv_>
    {
      /// INTERNAL ONLY
      typedef ext::abstract_<tpsv_> parent;
      template<class... Args>
      static BOOST_FORCEINLINE BOOST_AUTO_DECLTYPE dispatch(Args&&... args)
      BOOST_AUTO_DECLTYPE_BODY( dispatching_tpsv_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site>
    BOOST_FORCEINLINE generic_dispatcher<tag::tpsv_, Site> dispatching_tpsv_(adl_helper, boost::dispatch::meta::unknown_<Site>, ...)
    {
      return generic_dispatcher<tag::tpsv_, Site>();
    }
    template<class... Args>
    struct impl_tpsv_;
  }
   ...
   **/
  NT2_FUNCTION_IMPLEMENTATION_TPL (tag::tpsv_, tpsv
