...
//==============================================================================
#ifndef NT2_BLAS_FUNCTIONS_BLAS_TRSV_HPP_INCLUDED
#define NT2_BLAS_FUNCTIONS_BLAS_TRSV_HPP_INCLUDED

/*!
  @file
  @brief Defines and implements trsv function
**/
...
namespace nt2 { namespace blas
{
  namespace tag
  {
    /// @brief Defines trsv function tag
    struct trsv_ : ext::abstract_<trsv_>
    {
      /// INTERNAL ONLY
      typedef ext::abstract_<trsv_> parent;
      template<class... Args>
      static BOOST_FORCEINLINE BOOST_AUTO_DECLTYPE dispatch(Args&&... args)
      BOOST_AUTO_DECLTYPE_BODY( dispatching_trsv_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site>
    BOOST_FORCEINLINE generic_dispatcher<tag::trsv_, Site> dispatching_trsv_(adl_helper, boost::dispatch::meta::unknown_<Site>, ...)
    {
      return generic_dispatcher<tag::trsv_, Site>();
    }
    template<class... Args>
    struct impl_trsv_;
  }
   ...
   **/
  NT2_FUNCTION_IMPLEMENTATION_TPL (tag::trsv_, trsv
