...
//==============================================================================
#ifndef NT2_BLAS_FUNCTIONS_BLAS_TPMV_HPP_INCLUDED
#define NT2_BLAS_FUNCTIONS_BLAS_TPMV_HPP_INCLUDED

/*!
  @file
  @brief Defines and implements tpmv function
**/
...
namespace nt2 { namespace blas
{
  namespace tag
  {
    /// @brief Defines tpmv function tag
    struct tpmv_ : ext::abstract_<tpmv_>
    {
      /// INTERNAL ONLY
      typedef ext::abstract_<tpmv_> parent;
      template<class... Args>
      static BOOST_FORCEINLINE BOOST_AUTO_DECLTYPE dispatch(Args&&... args)
      BOOST_AUTO_DECLTYPE_BODY( dispatching_tpmv_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site>
    BOOST_FORCEINLINE generic_dispatcher<tag::tpmv_, Site> dispatching_tpmv_(adl_helper, boost::dispatch::meta::unknown_<Site>, ...)
    {
      return generic_dispatcher<tag::tpmv_, Site>();
    }
    template<class... Args>
    struct impl_tpmv_;
  }
  ...
  **/
  NT2_FUNCTION_IMPLEMENTATION_TPL (tag::tpmv_, tpmv
