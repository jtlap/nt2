...
//==============================================================================
#ifndef NT2_BLAS_FUNCTIONS_BLAS_TRMV_HPP_INCLUDED
#define NT2_BLAS_FUNCTIONS_BLAS_TRMV_HPP_INCLUDED

/*!
  @file
  @brief Defines and implements trmv function
**/
...
namespace nt2 { namespace blas
{
  namespace tag
  {
    /// @brief Defines trmv function tag
    struct trmv_ : ext::abstract_<trmv_>
    {
      /// INTERNAL ONLY
      typedef ext::abstract_<trmv_> parent;
      template<class... Args>
      static BOOST_FORCEINLINE BOOST_AUTO_DECLTYPE dispatch(Args&&... args)
      BOOST_AUTO_DECLTYPE_BODY( dispatching_trmv_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site>
    BOOST_FORCEINLINE generic_dispatcher<tag::trmv_, Site> dispatching_trmv_(adl_helper, boost::dispatch::meta::unknown_<Site>, ...)
    {
      return generic_dispatcher<tag::trmv_, Site>();
    }
    template<class... Args>
    struct impl_trmv_;
  }
  ...
  **/
  NT2_FUNCTION_IMPLEMENTATION_TPL (tag::trmv_, trmv
