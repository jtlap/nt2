...
//==============================================================================
#ifndef NT2_BLAS_FUNCTIONS_BLAS_SPMV_HPP_INCLUDED
#define NT2_BLAS_FUNCTIONS_BLAS_SPMV_HPP_INCLUDED

/*!
  @file
  @brief Defines and implements spmv function
**/
...
namespace nt2 { namespace blas
{
  namespace tag
  {
    /// @brief Defines spmv function tag
    struct spmv_ : ext::abstract_<spmv_>
    {
      /// INTERNAL ONLY
      typedef ext::abstract_<spmv_> parent;
      template<class... Args>
      static BOOST_FORCEINLINE BOOST_AUTO_DECLTYPE dispatch(Args&&... args)
      BOOST_AUTO_DECLTYPE_BODY( dispatching_spmv_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site>
    BOOST_FORCEINLINE generic_dispatcher<tag::spmv_, Site> dispatching_spmv_(adl_helper, boost::dispatch::meta::unknown_<Site>, ...)
    {
      return generic_dispatcher<tag::spmv_, Site>();
    }
    template<class... Args>
    struct impl_spmv_;
  }
  ...
  **/
  NT2_FUNCTION_IMPLEMENTATION_TPL (tag::spmv_, spmv
