...
//==============================================================================
#ifndef NT2_BLAS_FUNCTIONS_BLAS_BAND_HPP_INCLUDED
#define NT2_BLAS_FUNCTIONS_BLAS_BAND_HPP_INCLUDED

/*!
  @file
  @brief Defines and implements band function
**/
...
namespace nt2 { namespace blas { namespace tag
  {
    /*!
     * \brief Define the tag band_ of functor band
     *        in namespace nt2 { namespace blas::tag for toolbox algebra
     **/
    struct band_ : ext::unspecified_<band_>
    {
      typedef ext::unspecified_<band_> parent;
      template<class... Args>
  ...
  {
    template<class Site>
    BOOST_FORCEINLINE generic_dispatcher<tag::band_, Site> dispatching_band_(adl_helper, boost::dispatch::meta::unknown_<Site>, ...)
    {
  ...
  NT2_FUNCTION_IMPLEMENTATION(tag::band_, band, 2)
  NT2_FUNCTION_IMPLEMENTATION(tag::band_, band, 3)
  /*!
...
namespace nt2 { namespace blas { namespace ext
{
  ...
  struct  size_of<tag::band_, Domain, N, Expr>
  {
  ...
  template <class Domain, class Expr, int N>
  struct value_type < tag::band_, Domain,N,Expr>
  {
