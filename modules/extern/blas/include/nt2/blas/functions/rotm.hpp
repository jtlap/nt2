...
//==============================================================================
#ifndef NT2_BLAS_FUNCTIONS_BLAS_ROTM_HPP_INCLUDED
#define NT2_BLAS_FUNCTIONS_BLAS_ROTM_HPP_INCLUDED
...
namespace nt2 { namespace blas
{
  namespace tag
  {
    ...
    struct rotm_ : ext::abstract_<rotm_>
    {
      /// INTERNAL ONLY
      typedef ext::abstract_<rotm_> parent;
      template<class... Args>
      static BOOST_FORCEINLINE BOOST_AUTO_DECLTYPE dispatch(Args&&... args)
      BOOST_AUTO_DECLTYPE_BODY( dispatching_rotm_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site>
    BOOST_FORCEINLINE generic_dispatcher<tag::rotm_, Site> dispatching_rotm_(adl_helper, boost::dispatch::meta::unknown_<Site>, ...)
    {
      return generic_dispatcher<tag::rotm_, Site>();
    }
    template<class... Args>
    struct impl_rotm_;
  }
  ...
  **/
  NT2_FUNCTION_IMPLEMENTATION_TPL (tag::rotm_, rotm
