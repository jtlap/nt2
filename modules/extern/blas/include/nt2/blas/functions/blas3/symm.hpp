...
//==============================================================================
#ifndef NT2_BLAS_FUNCTIONS_BLAS3_SYMM_HPP_INCLUDED
#define NT2_BLAS_FUNCTIONS_BLAS3_SYMM_HPP_INCLUDED

#include <nt2/blas/functions/symm.hpp>
...
// /---------------------------------------------Real-single------------------------------------------------//
  ...
  BOOST_DISPATCH_IMPLEMENT  ( symm_, tag::cpu_
