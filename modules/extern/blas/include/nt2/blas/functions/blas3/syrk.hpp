...
//==============================================================================
#ifndef NT2_BLAS_FUNCTIONS_BLAS3_SYRK_HPP_INCLUDED
#define NT2_BLAS_FUNCTIONS_BLAS3_SYRK_HPP_INCLUDED

#include <nt2/blas/functions/syrk.hpp>
...
// /---------------------------------------------Real-single------------------------------------------------//
  ...
  BOOST_DISPATCH_IMPLEMENT  ( syrk_, tag::cpu_
...
// /---------------------------------------------Complex-single------------------------------------------------//
                            ...
                            )
  {
                                     ...
                                     ) const
    {
      ...
      nt2_la_int lda = a.leading_size();
      nt2_la_int ldc = c.leading_size();
      NT2_F77NAME(csyrk) (&uplo, &trans, &n, &k, &alpha, a.data(), &lda, &beta, c.data(), &ldc);
    }
  };
...
// /---------------------------------------------Complex-double------------------------------------------------//
                            ...
                            )
  {
                                     ...
                                     ) const
    {
      ...
      nt2_la_int lda = a.leading_size();
      nt2_la_int ldc = c.leading_size();
      NT2_F77NAME(zsyrk) (&uplo, &trans, &n, &k, &alpha, a.data(), &lda, &beta, c.data(), &ldc);
    }
  };
