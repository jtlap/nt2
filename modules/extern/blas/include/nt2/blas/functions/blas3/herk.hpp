...
//==============================================================================
#ifndef NT2_BLAS_FUNCTIONS_BLAS3_HERK_HPP_INCLUDED
#define NT2_BLAS_FUNCTIONS_BLAS3_HERK_HPP_INCLUDED

#include <nt2/blas/functions/herk.hpp>
...
// /---------------------------------------------Real-single------------------------------------------------//
  ...
  BOOST_DISPATCH_IMPLEMENT  ( herk_, tag::cpu_
