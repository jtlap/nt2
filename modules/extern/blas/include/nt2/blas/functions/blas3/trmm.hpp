...
//==============================================================================
#ifndef NT2_BLAS_FUNCTIONS_BLAS3_TRMM_HPP_INCLUDED
#define NT2_BLAS_FUNCTIONS_BLAS3_TRMM_HPP_INCLUDED

#include <nt2/blas/functions/trmm.hpp>
...
// /---------------------------------------------Real-single------------------------------------------------//
  ...
  BOOST_DISPATCH_IMPLEMENT  ( trmm_, tag::cpu_
