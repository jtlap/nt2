...
//==============================================================================
#ifndef NT2_BLAS_FUNCTIONS_BLAS3_HER2K_HPP_INCLUDED
#define NT2_BLAS_FUNCTIONS_BLAS3_HER2K_HPP_INCLUDED

#include <nt2/blas/functions/her2k.hpp>
...
// /---------------------------------------------Real-single------------------------------------------------//
  ...
  BOOST_DISPATCH_IMPLEMENT  ( her2k_, tag::cpu_
