...
//==============================================================================
#ifndef NT2_BLAS_FUNCTIONS_BLAS_TRMM_HPP_INCLUDED
#define NT2_BLAS_FUNCTIONS_BLAS_TRMM_HPP_INCLUDED
...
namespace nt2 { namespace blas
{
  namespace tag
  {
    ...
    struct trmm_ : ext::abstract_<trmm_>
    {
      /// INTERNAL ONLY
      typedef ext::abstract_<trmm_> parent;
      template<class... Args>
      static BOOST_FORCEINLINE BOOST_AUTO_DECLTYPE dispatch(Args&&... args)
      BOOST_AUTO_DECLTYPE_BODY( dispatching_trmm_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site>
    BOOST_FORCEINLINE generic_dispatcher<tag::trmm_, Site> dispatching_trmm_(adl_helper, boost::dispatch::meta::unknown_<Site>, ...)
    {
      return generic_dispatcher<tag::trmm_, Site>();
    }
    template<class... Args>
    struct impl_trmm_;
  }
  ...
  **/
  NT2_FUNCTION_IMPLEMENTATION_TPL (tag::trmm_, trmm
