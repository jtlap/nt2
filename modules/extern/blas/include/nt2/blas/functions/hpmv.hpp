...
//==============================================================================
#ifndef NT2_BLAS_FUNCTIONS_BLAS_HPMV_HPP_INCLUDED
#define NT2_BLAS_FUNCTIONS_BLAS_HPMV_HPP_INCLUDED

/*!
  @file
  @brief Defines and implements hpmv function
**/
...
namespace nt2 { namespace blas
{
  namespace tag
  {
    /// @brief Defines hpmv function tag
    struct hpmv_ : ext::abstract_<hpmv_>
    {
      /// INTERNAL ONLY
      typedef ext::abstract_<hpmv_> parent;
      template<class... Args>
      static BOOST_FORCEINLINE BOOST_AUTO_DECLTYPE dispatch(Args&&... args)
      BOOST_AUTO_DECLTYPE_BODY( dispatching_hpmv_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site>
    BOOST_FORCEINLINE generic_dispatcher<tag::hpmv_, Site> dispatching_hpmv_(adl_helper, boost::dispatch::meta::unknown_<Site>, ...)
    {
      return generic_dispatcher<tag::hpmv_, Site>();
    }
    template<class... Args>
    struct impl_hpmv_;
  }
  ...
  **/
  NT2_FUNCTION_IMPLEMENTATION_TPL (tag::hpmv_, hpmv
