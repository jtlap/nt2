...
//==============================================================================
#ifndef NT2_BLAS_FUNCTIONS_BLAS_HER_HPP_INCLUDED
#define NT2_BLAS_FUNCTIONS_BLAS_HER_HPP_INCLUDED

/*!
  @file
  @brief Defines and implements her function
**/
...
namespace nt2 { namespace blas
{
  namespace tag
  {
    /// @brief Defines her function tag
    struct her_ : ext::abstract_<her_>
    {
      /// INTERNAL ONLY
      typedef ext::abstract_<her_> parent;
      template<class... Args>
      static BOOST_FORCEINLINE BOOST_AUTO_DECLTYPE dispatch(Args&&... args)
      BOOST_AUTO_DECLTYPE_BODY( dispatching_her_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site>
    BOOST_FORCEINLINE generic_dispatcher<tag::her_, Site> dispatching_her_(adl_helper, boost::dispatch::meta::unknown_<Site>, ...)
    {
      return generic_dispatcher<tag::her_, Site>();
    }
    template<class... Args>
    struct impl_her_;
  }
  ...
  **/
  NT2_FUNCTION_IMPLEMENTATION_TPL (tag::her_, her
