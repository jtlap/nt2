...
//==============================================================================
#ifndef NT2_BLAS_FUNCTIONS_BLAS_GEMV_HPP_INCLUDED
#define NT2_BLAS_FUNCTIONS_BLAS_GEMV_HPP_INCLUDED
...
namespace nt2 { namespace blas
{
  namespace tag
  {
    ...
    struct gemv_ : ext::abstract_<gemv_>
    {
      /// INTERNAL ONLY
      typedef ext::abstract_<gemv_> parent;
      template<class... Args>
      static BOOST_FORCEINLINE BOOST_AUTO_DECLTYPE dispatch(Args&&... args)
      BOOST_AUTO_DECLTYPE_BODY( dispatching_gemv_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site>
    BOOST_FORCEINLINE generic_dispatcher<tag::gemv_, Site> dispatching_gemv_(adl_helper, boost::dispatch::meta::unknown_<Site>, ...)
    {
      return generic_dispatcher<tag::gemv_, Site>();
    }
    template<class... Args>
    struct impl_gemv_;
  }
  ...
  **/
  NT2_FUNCTION_IMPLEMENTATION_TPL (tag::gemv_, gemv
