...
//==============================================================================
#ifndef NT2_BLAS_FUNCTIONS_BLAS1T_SCAL_HPP_INCLUDED
#define NT2_BLAS_FUNCTIONS_BLAS1T_SCAL_HPP_INCLUDED

#include <nt2/blas/functions/scal.hpp>
...
//---------------------------------------------Real-single------------------------------------------------//
  ...
  BOOST_DISPATCH_IMPLEMENT  ( scal_, tag::cpu_
                            , (N)(A0)(A1)(S1)(A2)
                            ...
                            )
  {
                                     ...
                                     , const A2& incx) const
    {
      nt2_la_int in =n;
      nt2_la_int ix =incx;
      NT2_F77NAME(sscal) (&in, &alpha, x.data(), &ix);
    }
  };
...
//---------------------------------------------Real-double------------------------------------------------//
                            ...
                            )
  {
                                     ...
                                     , const A2& incx) const
    {
      nt2_la_int in = n;
      nt2_la_int ix =incx;
      NT2_F77NAME(dscal) (&in, &alpha, x.data(), &ix);
    }
  };
...
//---------------------------------------------Complex-single------------------------------------------------//
                            ...
                            )
  {
                                     ...
                                     , const A2& incx) const
    {
      nt2_la_int in =n;
      nt2_la_int ix =incx;
      NT2_F77NAME(cscal) (&in, &alpha, x.data(), &ix);
    }
  };
...
//---------------------------------------------Complex-double------------------------------------------------//
                            ...
                            )
  {
                                     ...
                                     , const A2& incx) const
    {
      nt2_la_int in = n;
      nt2_la_int ix = incx;
      NT2_F77NAME(zscal) (&in, &alpha, x.data(), &ix);
    }
  };
}  } }
