...
//==============================================================================
#ifndef NT2_BLAS_FUNCTIONS_BLAS1_DOTU_HPP_INCLUDED
#define NT2_BLAS_FUNCTIONS_BLAS1_DOTU_HPP_INCLUDED

#include <nt2/blas/functions/dotu.hpp>
...
//---------------------------------------------Real-single------------------------------------------------//
  ...
  BOOST_DISPATCH_IMPLEMENT  ( dotu_, tag::cpu_
