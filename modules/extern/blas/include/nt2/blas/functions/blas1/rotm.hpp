...
//==============================================================================
#ifndef NT2_BLAS_FUNCTIONS_BLAS1_ROTM_HPP_INCLUDED
#define NT2_BLAS_FUNCTIONS_BLAS1_ROTM_HPP_INCLUDED

#include <nt2/blas/functions/rotm.hpp>
...
/// /---------------------------------------------Real-single------------------------------------------------//
  ...
  BOOST_DISPATCH_IMPLEMENT  ( rotm_, tag::cpu_
