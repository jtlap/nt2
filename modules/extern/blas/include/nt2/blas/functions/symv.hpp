...
//==============================================================================
#ifndef NT2_BLAS_FUNCTIONS_BLAS_SYMV_HPP_INCLUDED
#define NT2_BLAS_FUNCTIONS_BLAS_SYMV_HPP_INCLUDED

/*!
  @file
  @brief Defines and implements symv function
**/
...
namespace nt2 { namespace blas
{
  namespace tag
  {
    /// @brief Defines symv function tag
    struct symv_ : ext::abstract_<symv_>
    {
      /// INTERNAL ONLY
      typedef ext::abstract_<symv_> parent;
      template<class... Args>
      static BOOST_FORCEINLINE BOOST_AUTO_DECLTYPE dispatch(Args&&... args)
      BOOST_AUTO_DECLTYPE_BODY( dispatching_symv_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site>
    BOOST_FORCEINLINE generic_dispatcher<tag::symv_, Site> dispatching_symv_(adl_helper, boost::dispatch::meta::unknown_<Site>, ...)
    {
      return generic_dispatcher<tag::symv_, Site>();
    }
    template<class... Args>
    struct impl_symv_;
  }
  ...
  **/
  NT2_FUNCTION_IMPLEMENTATION_TPL (tag::symv_, symv
