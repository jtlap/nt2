...
//==============================================================================
#ifndef NT2_BLAS_FUNCTIONS_BLAS_SYR2_HPP_INCLUDED
#define NT2_BLAS_FUNCTIONS_BLAS_SYR2_HPP_INCLUDED

/*!
  @file
  @brief Defines and implements syr2 function
**/
...
namespace nt2 { namespace blas
{
  namespace tag
  {
    /// @brief Defines syr2 function tag
    struct syr2_ : ext::abstract_<syr2_>
    {
      /// INTERNAL ONLY
      typedef ext::abstract_<syr2_> parent;
      template<class... Args>
      static BOOST_FORCEINLINE BOOST_AUTO_DECLTYPE dispatch(Args&&... args)
      BOOST_AUTO_DECLTYPE_BODY( dispatching_syr2_( ext::adl_helper(), static_cast<Args&&>(args)... ) )
    };
  }
  namespace ext
  {
    template<class Site>
    BOOST_FORCEINLINE generic_dispatcher<tag::syr2_, Site> dispatching_syr2_(adl_helper, boost::dispatch::meta::unknown_<Site>, ...)
    {
      return generic_dispatcher<tag::syr2_, Site>();
    }
    template<class... Args>
    struct impl_syr2_;
  }
  ...
  **/
  NT2_FUNCTION_IMPLEMENTATION_TPL (tag::syr2_, syr2
