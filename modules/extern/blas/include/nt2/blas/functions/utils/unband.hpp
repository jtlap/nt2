...
//==============================================================================
#ifndef NT2_BLAS_FUNCTIONS_UTILS_BLAS_UNBAND_HPP_INCLUDED
#define NT2_BLAS_FUNCTIONS_UTILS_BLAS_UNBAND_HPP_INCLUDED

#include <nt2/blas/functions/unband.hpp>
...
namespace nt2 { namespace blas { namespace ext
{
  ...
  BOOST_DISPATCH_IMPLEMENT  ( unband_, tag::cpu_,
                              (IN)(M)(KL)(KU),
  ...
  BOOST_DISPATCH_IMPLEMENT  ( run_assign_, tag::cpu_
                            ...
                            , ((ast_<A0, nt2::container::domain>))
                              ((node_<A1,nt2::tag::unband_,N,nt2::container::domain>))
                            )
  {
