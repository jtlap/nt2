...
//==============================================================================
#ifndef NT2_BLAS_FUNCTIONS_UTILS_PACK_HPP_INCLUDED
#define NT2_BLAS_FUNCTIONS_UTILS_PACK_HPP_INCLUDED

#include <nt2/blas/functions/pack.hpp>
...
namespace nt2 { namespace blas { namespace ext
{
  ...
  BOOST_DISPATCH_IMPLEMENT  ( pack_, tag::cpu_,
                              (UPLO)(IN),
  ...
  BOOST_DISPATCH_IMPLEMENT  ( run_assign_, tag::cpu_
                            ...
                            , ((ast_<A0, nt2::container::domain>))
                              ((node_<A1,nt2::tag::pack_,N,nt2::container::domain>))
                            )
  {
