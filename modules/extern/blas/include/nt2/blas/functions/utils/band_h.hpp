...
//==============================================================================
#ifndef NT2_BLAS_FUNCTIONS_UTILS_BLAS_BAND_H_HPP_INCLUDED
#define NT2_BLAS_FUNCTIONS_UTILS_BLAS_BAND_H_HPP_INCLUDED

#include <nt2/blas/functions/band_h.hpp>
...
namespace nt2 { namespace blas { namespace ext
{
  ...
  BOOST_DISPATCH_IMPLEMENT  ( band_h_, tag::cpu_,
                              (UPLO)(IN)(KD),
  ...
  BOOST_DISPATCH_IMPLEMENT  ( run_assign_, tag::cpu_
                            ...
                            , ((ast_<A0, nt2::container::domain>))
                              ((node_<A1,nt2::tag::band_h_,N,nt2::container::domain>))
                            )
  {
