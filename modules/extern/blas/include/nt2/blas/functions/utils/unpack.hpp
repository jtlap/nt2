...
//==============================================================================
#ifndef NT2_BLAS_FUNCTIONS_UTILS_UNPACK_HPP_INCLUDED
#define NT2_BLAS_FUNCTIONS_UTILS_UNPACK_HPP_INCLUDED

#include <nt2/blas/functions/unpack.hpp>
#include <nt2/include/functions/height.hpp>
#include <nt2/blas/details/utility/f77_wrapper.hpp>
...
namespace nt2 { namespace blas { namespace ext
{
  ...
  BOOST_DISPATCH_IMPLEMENT  ( unpack_, tag::cpu_,
                              (UPLO)(SHAPE)(IN),
  ...
  BOOST_DISPATCH_IMPLEMENT  ( run_assign_, tag::cpu_
                            ...
                            , ((ast_<A0, nt2::container::domain>))
                              ((node_<A1,nt2::tag::unpack_,N,nt2::container::domain>))
                            )
  {
