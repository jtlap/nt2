 ...
 * \file
**/
#ifndef NT2_TOOLBOX_LIBC_FUNCTIONS_ASIN_HPP_INCLUDED
#define NT2_TOOLBOX_LIBC_FUNCTIONS_ASIN_HPP_INCLUDED
...
namespace nt2 { namespace libc { namespace tag
  ...
  NT2_FUNCTION_IMPLEMENTATION(libc::tag::asin_, asin, 1)
  } }

#include <nt2/toolbox/libc/functions/scalar/asin.hpp>
// #include <nt2/toolbox/libc/functions/simd/all/asin.hpp>
