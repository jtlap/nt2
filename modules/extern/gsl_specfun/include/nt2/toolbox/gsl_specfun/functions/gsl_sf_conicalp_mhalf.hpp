...
/*!
 * \ingroup gsl_specfun
 * \defgroup gsl_specfun_gsl_sf_conicalp_mhalf gsl_sf_conicalp_mhalf
 *
 * \par Description
 ...
 *   {
 *     template <class A0>
 *       meta::call<tag::gsl_sf_conicalp_mhalf_(A0,A0)>::type
 *       gsl_sf_conicalp_mhalf(const A0 & a0,const A0 & a1);
 *   }
 * }
 * \endcode
 *
 * \param a0 the first parameter of gsl_sf_conicalp_mhalf
 * \param a1 the second parameter of gsl_sf_conicalp_mhalf
 *
...
namespace nt2 { namespace gsl_specfun { namespace tag
  {
    /*!
     * \brief Define the tag gsl_sf_conicalp_mhalf_ of functor gsl_sf_conicalp_mhalf
     *        in namespace nt2::gsl_specfun::tag for toolbox gsl_specfun
    **/
    struct gsl_sf_conicalp_mhalf_ : ext::elementwise_<gsl_sf_conicalp_mhalf_> { typedef ext::elementwise_<gsl_sf_conicalp_mhalf_> parent; };
  }
