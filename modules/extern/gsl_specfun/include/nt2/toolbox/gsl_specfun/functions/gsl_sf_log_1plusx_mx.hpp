 ...
 * \file
**/
#ifndef NT2_TOOLBOX_GSL_SPECFUN_FUNCTIONS_GSL_SF_LOG_1PLUSX_MX_HPP_INCLUDED
#define NT2_TOOLBOX_GSL_SPECFUN_FUNCTIONS_GSL_SF_LOG_1PLUSX_MX_HPP_INCLUDED
 ...
 *   {
 *     template <class A0>
 *       meta::call<tag::gsl_sf_log_1plusx_mx_(A0)>::type
 *       gsl_sf_log_1plusx_mx(const A0 & a0);
 *   }
 * }
 * \endcode
 *
 * \param a0 the unique parameter of gsl_sf_log_1plusx_mx
 *
...
namespace nt2 { namespace gsl_specfun { namespace tag
  {
    ...
    **/
    struct gsl_sf_log_1plusx_mx_ : ext::elementwise_<gsl_sf_log_1plusx_mx_> { typedef ext::elementwise_<gsl_sf_log_1plusx_mx_> parent; };
  }
  NT2_FUNCTION_IMPLEMENTATION(gsl_specfun::tag::gsl_sf_log_1plusx_mx_, gsl_sf_log_1plusx_mx, 1)
  } }

#include <nt2/toolbox/gsl_specfun/functions/scalar/gsl_sf_log_1plusx_mx.hpp>
// #include <nt2/toolbox/gsl_specfun/functions/simd/all/gsl_sf_log_1plusx_mx.hpp>
