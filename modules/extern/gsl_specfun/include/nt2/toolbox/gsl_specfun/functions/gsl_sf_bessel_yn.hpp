...
/*!
 * \ingroup gsl_specfun
 * \defgroup gsl_specfun_gsl_sf_bessel_yn gsl_sf_bessel_yn
 *
 * \par Description
 ...
 *   {
 *     template <class A0>
 *       meta::call<tag::gsl_sf_bessel_yn_(A0,A0)>::type
 *       gsl_sf_bessel_yn(const A0 & a0,const A0 & a1);
 *   }
 * }
 * \endcode
 *
 * \param a0 the first parameter of gsl_sf_bessel_yn
 * \param a1 the second parameter of gsl_sf_bessel_yn
 *
...
namespace nt2 { namespace gsl_specfun { namespace tag
  {
    /*!
     * \brief Define the tag gsl_sf_bessel_yn_ of functor gsl_sf_bessel_yn
     *        in namespace nt2::gsl_specfun::tag for toolbox gsl_specfun
    **/
    struct gsl_sf_bessel_yn_ : ext::elementwise_<gsl_sf_bessel_yn_> { typedef ext::elementwise_<gsl_sf_bessel_yn_> parent; };
  }
