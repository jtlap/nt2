 ...
 * \file
**/
#ifndef NT2_TOOLBOX_CEPHES_FUNCTIONS_FLOOR_HPP_INCLUDED
#define NT2_TOOLBOX_CEPHES_FUNCTIONS_FLOOR_HPP_INCLUDED
...
// #include <nt2/toolbox/cephes/functions/simd/all/floor.hpp>
