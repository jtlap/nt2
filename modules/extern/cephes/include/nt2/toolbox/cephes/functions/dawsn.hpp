 ...
 * \file
**/
#ifndef NT2_TOOLBOX_CEPHES_FUNCTIONS_DAWSN_HPP_INCLUDED
#define NT2_TOOLBOX_CEPHES_FUNCTIONS_DAWSN_HPP_INCLUDED
 ...
 *   {
 *     template <class A0>
 *       meta::call<tag::dawsn_(A0)>::type
 *       dawsn(const A0 & a0);
 *   }
 * }
 * \endcode
 *
 * \param a0 the unique parameter of dawsn
 * 
...
namespace nt2 { namespace cephes { namespace tag
  {         
    ...
    **/
    struct dawsn_ : ext::elementwise_<dawsn_> { typedef ext::elementwise_<dawsn_> parent; };
  }
  NT2_FUNCTION_IMPLEMENTATION(cephes::tag::dawsn_, dawsn, 1)
  } }

#include <nt2/toolbox/cephes/functions/scalar/dawsn.hpp>
// #include <nt2/toolbox/cephes/functions/simd/all/dawsn.hpp> 
