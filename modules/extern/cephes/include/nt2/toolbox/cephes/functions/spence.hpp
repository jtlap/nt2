 ...
 * \file
**/
#ifndef NT2_TOOLBOX_CEPHES_FUNCTIONS_SPENCE_HPP_INCLUDED
#define NT2_TOOLBOX_CEPHES_FUNCTIONS_SPENCE_HPP_INCLUDED
...
// #include <nt2/toolbox/cephes/functions/simd/all/spence.hpp>
