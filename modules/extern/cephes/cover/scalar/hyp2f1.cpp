...
//////////////////////////////////////////////////////////////////////////////
#define NT2_UNIT_MODULE "nt2 cephes toolbox - hyp2f1/scalar Mode"
...
NT2_TEST_CASE_TPL ( hyp2f1_real__4_0,  NT2_REAL_TYPES)
{

  using nt2::cephes::hyp2f1;
  using nt2::cephes::tag::hyp2f1_;
  typedef typename nt2::meta::as_integer<T>::type iT;
  typedef typename nt2::meta::call<hyp2f1_(T,T,T,T)>::type r_t;
  ...
  static const nt2::uint32_t NR = NT2_NB_RANDOM_TEST;
  {
    ...
    NT2_CREATE_BUF(tab_a3,T, NR, T(-100), T(100));
    ...
    for(nt2::uint32_t j =0; j < NR; ++j )
      {
        std::cout << "for params "
                  ...
                  << ", a3 = "<< u_t(a3 = tab_a3[j])
                  << std::endl;
        NT2_TEST_ULP_EQUAL( nt2::cephes::hyp2f1(a0,a1,a2,a3),nt2::cephes::hyp2f1(a0,a1,a2,a3),0.5);
