...
//////////////////////////////////////////////////////////////////////////////
#define NT2_UNIT_MODULE "nt2 cephes toolbox - jn/scalar Mode"
...
NT2_TEST_CASE_TPL ( jn_double_2_0,  (double))
{
    ...
    for(nt2::uint32_t j =0; j < NR; ++j )
      {
        std::cout << "for params "
                  ...
                  << ", a1 = "<< u_t(a1 = tab_a1[j])
                  << std::endl;
        NT2_TEST_ULP_EQUAL( nt2::cephes::jn(a0,a1),nt2::jni(a0,a1),10000);
