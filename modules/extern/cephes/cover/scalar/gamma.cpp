...
//==============================================================================
#define NT2_UNIT_MODULE "nt2 cephes toolbox - gamma/scalar Mode"
...
NT2_TEST_CASE_TPL ( gamma_real__1_0,  NT2_REAL_TYPES)
{
  ...
  using nt2::cephes::gamma;
  using nt2::cephes::tag::gamma_;
    ...
    for(nt2::uint32_t j =0; j < NR; ++j )
      {
        std::cout << "for param "
                  << "  a0 = "<< u_t(a0 = tab_a0[j])
                  << std::endl;
        NT2_TEST_ULP_EQUAL( nt2::cephes::gamma(a0),nt2::gamma(a0),12.5);
