...
//////////////////////////////////////////////////////////////////////////////
#define NT2_UNIT_MODULE "nt2 cephes toolbox - lbeta/scalar Mode"
...
NT2_TEST_CASE_TPL ( lbeta_real__2_0,  NT2_REAL_TYPES)
{
    ...
    for(nt2::uint32_t j =0; j < NR; ++j )
      {
        std::cout << "for params "
                  ...
                  << ", a1 = "<< u_t(a1 = tab_a1[j])
                  << std::endl;
        NT2_TEST_ULP_EQUAL( nt2::cephes::lbeta(a0,a1),nt2::cephes::lbeta(a0,a1),0.5);
