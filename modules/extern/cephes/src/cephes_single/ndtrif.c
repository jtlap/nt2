...
float cephes_logf(float), cephes_sqrtf(float);
#else
float cephes_polevlf(), cephes_p1evlf(), cephes_logf(), cephes_sqrtf();
#endif


#ifdef ANSIC
float cephes_ndtrif(float yy0)
#else
float cephes_ndtrif(yy0)
double yy0;
#endif
{
