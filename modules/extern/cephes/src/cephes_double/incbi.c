 ...
 * SYNOPSIS:
 *
 * double a, b, x, y, cephes_incbi();
 *
 * x = cephes_incbi( a, b, y );
 *
 *
 *
 * DESCRIPTION:
 ...
 *
 *  cephes_incbet( a, b, x ) = y .
 *
 * The routine performs interval halving or Newton iterations to find the
 * root of cephes_incbet(a,b,x) - y = 0.
 *
 *
 * ACCURACY:
 *
...
#else
double cephes_ndtri(), cephes_exp(), fabs(), cephes_log(), cephes_sqrt(), cephes_lgam(), cephes_incbet();
#endif

double cephes_incbi( aa, bb, yy0 )
double aa, bb, yy0;
{
