 ...
 * rather than m for compatibility with cephes_ellpk().
 *
 * E(1) = 1; E(0) = pi/2.
 *
 *
...
#else
double cephes_polevl(), cephes_log();
#endif

double cephes_ellpe(x)
double x;
{
