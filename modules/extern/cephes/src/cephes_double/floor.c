 ...
 * SYNOPSIS:
 *
 * double cephes_ceil(), cephes_floor(), cephes_frexp(), cephes_ldexp();
 ...
 * result.
 *
 * cephes_floor() returns the largest integer less than or equal to x.
 * It truncates toward minus infinity.
 *
 * cephes_ceil() returns the smallest integer greater than or equal
 * to x.  It truncates toward plus infinity.
 *
 * cephes_frexp() extracts the exponent from x.  It returns an integer
 * power of two to expnt and the significand between 0.5 and 1
 * to y.  Thus  x = y * 2**expn.
 *
 * cephes_ldexp() multiplies x by 2**n.
 *
...
#ifdef UNK
/* cephes_ceil(), cephes_floor(), cephes_frexp(), cephes_ldexp() may need to be rewritten. */
#undef UNK
#if BIGENDIAN
#define MIEEE 1
#else
