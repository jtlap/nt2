 ...
 *      (-1/8) (42 cephes_zeta(4) - 12 pi^2 cephes_zeta(2) + pi^4 ) c1 (T/c2)^4
 *       = (pi^4 / 15)  c1 (T/c2)^4
 *       =  5.6705032e-8 T^4
 ...
 * amplification in computing the dominant term cephes_exp(-c2/(lambda T)).
...
#else
double polylog(), cephes_exp(), log1p(), expm1();
