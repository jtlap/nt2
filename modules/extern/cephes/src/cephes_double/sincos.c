 ...
 *
 * cephes_sin(i) is internally tabulated for 0 <= i <= 90 degrees.
 ...
 * formulas for cephes_sin(A+B) and cephes_cos(A+B).
 *
 ...
 * x = 0.5 deg, the absolute error is then cephes_sin(0.5) = 0.0087.
 *
 ...
 * In-line 8087 (/FPi)
 * cephes_sin(), cephes_cos()		1.0	1.0	1.0	1.0
 *
 * In-line 8087 (/FPi)
 * sincos()		1.1	1.4	1.9	3.0
 *
 * Software (/FPa)
 * cephes_sin(), cephes_cos()		0.19	0.19	0.19	0.19
 *
 * Software (/FPa)
 ...
 * is for the function 1 - cephes_cos(x).
 *
...
#if MOD360
x = x  -  360.0 * cephes_floor( x/360.0 );
#endif
