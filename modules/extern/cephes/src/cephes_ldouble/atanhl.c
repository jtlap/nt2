...
#else
long double cephes_fabsl(), cephes_logl(), cephes_polevll(), cephes_p1evll();
#endif
#ifdef INFINITIES
...
return( 0.5L * cephes_logl((1.0L+x)/(1.0L-x)) );
}
