...
if( x > lossth )
	{
	cephes_mtherr( "sinl", TLOSS );
	return(0.0L);
	}

y = cephes_floorl( x/PIO4L ); /* integer part of x/PIO4 */

/* strip high bits of integer part to prevent integer overflow */
z = cephes_ldexpl( y, -4 );
z = cephes_floorl(z);           /* integer part of y/8 */
