 ...
 * SYNOPSIS:
 *
 * long double x, y, z, cephes_atan2l();
 *
 * z = cephes_atan2l( y, x );
 *
 *
...
#else
long double cephes_polevll(), cephes_p1evll(), cephes_fabsl(), cephes_signbitl(), cephes_isnanl();
long double cephes_atanl();
#endif
#ifdef INFINITIES
...
#if ANSIC
long double cephes_atan2l( y, x )
#else
long double cephes_atan2l( x, y )
#endif
long double x, y;
{
long double z, w;
...
if( x == 0.0L )
#else
if( cephes_fabsl(x) <= (cephes_fabsl(y) / MAXNUML) )
#endif
	{
	if( code & 1 )
		{
