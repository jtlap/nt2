...
#ifdef Ldouble
#define NPRT 6
extern long double cephes_fabsl(), cephes_floorl(), cephes_logl(), cephes_powl(), cephes_sqrtl();
#define FLOAT long double
#define FABS(x) cephes_fabsl(x)
#define FLOOR(x) cephes_floorl(x)
#define LOG(x) cephes_logl(x)
#define POW(x,y) cephes_powl(x,y)
#define SQRT(x) cephes_sqrtl(x)
