 ...
 * \file
**/
#ifndef NT2_TOOLBOX_FDLIBM_FUNCTIONS_EXP_HPP_INCLUDED
#define NT2_TOOLBOX_FDLIBM_FUNCTIONS_EXP_HPP_INCLUDED
...
#include <nt2/toolbox/fdlibm/functions/scalar/exp.hpp>
// #include <nt2/toolbox/fdlibm/functions/simd/all/exp.hpp>
