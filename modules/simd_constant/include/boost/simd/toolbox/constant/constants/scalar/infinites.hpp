...
BOOST_SIMD_LOCAL(tag::m_inf_ , 0xFFF0000000000000LL, 0xFF800000, Valmin<result_type>())
BOOST_SIMD_LOCAL(tag::nan_   , 0xFFFFFFFFFFFFFFFFLL, 0xFFFFFFFF, Valmax<result_type>())
