...
//==============================================================================
#ifndef BOOST_DISPATCH_META_SET_HPP_INCLUDED
#define BOOST_DISPATCH_META_SET_HPP_INCLUDED

/*!
 * \file
 * \brief Defines and implements the boost::dispatch::meta::set class
 */
...
namespace boost { namespace dispatch { namespace meta
{
   ...
   *
   * \see boost::dispatch::meta::has_key
   */
  //============================================================================
  ...
  template<BOOST_PP_ENUM_BINARY_PARAMS( BOOST_DISPATCH_MAX_META_ARITY
                                      , class A
  ...
  struct set
  {
    ...
    BOOST_PP_REPEAT(BOOST_DISPATCH_MAX_META_ARITY,M0,~)
  };
  ...
  //============================================================================
  BOOST_PP_REPEAT_FROM_TO(1,BOOST_DISPATCH_MAX_META_ARITY,M1,~)
