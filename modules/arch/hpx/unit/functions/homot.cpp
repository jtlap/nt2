...
NT2_TEST_CASE( hierarchy )
{
  ...
  NT2_TEST_EXPR_TYPE( (nt2::tag::homot_() )
  ...
  NT2_TEST_EXPR_TYPE( (nt2::tag::homot_() )
                    ...
                    , (nt2::ext::state_constant_< nt2::tag::homot_ >
                      )
                    );

  NT2_TEST_EXPR_TYPE( (nt2::tag::homot_() )
                    , (nth_hierarchy<_,int_<2> >)
                    , (nt2::ext::constant_< nt2::tag::homot_ >
                      )
                    );

  NT2_TEST_EXPR_TYPE( (nt2::tag::homot_() )
                    , (nth_hierarchy<_,int_<3> >)
                    , (nt2::ext::elementwise_<nt2::tag::homot_>)
                    );

  NT2_TEST_EXPR_TYPE( (nt2::tag::homot_() )
                    , (nth_hierarchy<_,int_<4> >)
                    , (nt2::ext::unspecified_<nt2::tag::homot_>)
                    );
}
...
NT2_TEST_CASE_TPL( square, NT2_TYPES )
{
  ...
  NT2_TEST_EXPR_TYPE( (nt2::homot(T(42),3)), (value_type_<_>), (T) );
...
NT2_TEST_CASE_TPL( nd, NT2_TYPES )
{
  ...
  NT2_TEST_EXPR_TYPE( ( nt2::homot(T(42),nt2::of_size(8, 8)) ), (value_type_<_>), (T) );
  NT2_TEST_EQUAL(x1,ref);

  nt2::table<T> x2 = nt2::homot(T(42), 8, 8 );
...
NT2_TEST_CASE_TPL( typed_expr, NT2_TYPES )
{
  ...
  nt2::table<T> x1 = nt2::homot( T(42), t1 );
  NT2_TEST_EXPR_TYPE( ( nt2::homot(T(42), t1) ), (value_type_<_>), (T) );
  NT2_TEST_EQUAL(x1,ref);
  ...
  NT2_TEST_ASSERT( x1 = nt2::homot(T(42),x2) );
}
