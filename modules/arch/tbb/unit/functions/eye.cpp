...
NT2_TEST_CASE( hierarchy )
{
  ...
  NT2_TEST_EXPR_TYPE( (nt2::tag::eye_() )
  ...
  NT2_TEST_EXPR_TYPE( (nt2::tag::eye_() )
                    ...
                    , (nt2::ext::pure_constant_< nt2::tag::eye_ >
                      )
                    );

  NT2_TEST_EXPR_TYPE( (nt2::tag::eye_() )
                    , (nth_hierarchy<_,int_<2> >)
                    , (nt2::ext::constant_< nt2::tag::eye_ >
                      )
                    );

  NT2_TEST_EXPR_TYPE( (nt2::tag::eye_() )
                    , (nth_hierarchy<_,int_<3> >)
                    , (nt2::ext::elementwise_<nt2::tag::eye_>)
                    );

  NT2_TEST_EXPR_TYPE( (nt2::tag::eye_() )
                    , (nth_hierarchy<_,int_<4> >)
                    , (nt2::ext::unspecified_<nt2::tag::eye_>)
                    );
}
...
NT2_TEST_CASE_TPL( _0d_typed, NT2_TYPES )
{
  ...
  nt2::table<T> x1 = nt2::eye( as_<T>() );

  NT2_TEST_EXPR_TYPE( (nt2::eye( as_<T>() )), (value_type_<_>), (T) );
...
NT2_TEST_CASE( untyped_square )
{
  ...
  nt2::table<double> x0 = nt2::eye(3);

  NT2_TEST_EXPR_TYPE( (nt2::eye( 3 )), (value_type_<_>), (double) );
...
NT2_TEST_CASE( nd_untyped )
{
  ...
  nt2::table<double> x1 = nt2::eye(8, 4);

  NT2_TEST_EXPR_TYPE( (nt2::eye(8,4)), (value_type_<_>), (double) );
  ...
  nt2::table<double> x2 = nt2::eye(1, 4);
  ...
  nt2::table<double> x3 = nt2::eye(7,1);
...
NT2_TEST_CASE_TPL( nd_typed, NT2_TYPES )
{
  ...
  nt2::table<T> x1 = nt2::eye(nt2::of_size(8, 8), as_<T>() );

  NT2_TEST_EXPR_TYPE( (nt2::eye( nt2::of_size(8, 8), as_<T>() )), (value_type_<_>), (T) );
  NT2_TEST_EQUAL(x1,ref);

  nt2::table<T> x2 = nt2::eye(8, 8, as_<T>() );
  NT2_TEST_EQUAL(x2,ref);

  nt2::table<T> x3 = nt2::eye(8, as_<T>() );
  NT2_TEST_EQUAL(x3,ref);
}
...
NT2_TEST_CASE( expr )
{
  ...
  nt2::table<double> x1 = nt2::eye( t1 );

  NT2_TEST_EXPR_TYPE( (nt2::eye( t1 )), (value_type_<_>), (double) );
  NT2_TEST_EQUAL(x1,ref);
  ...
  nt2::table<double> x2 = nt2::eye( t2 );
  NT2_TEST_EQUAL(x2,ref);

  NT2_TEST_ASSERT( x1 = nt2::eye(x2) );
}
...
NT2_TEST_CASE_TPL( typed_expr, NT2_TYPES )
{
  ...
  nt2::table<T> x1 = nt2::eye( t1, as_<T>() );

  NT2_TEST_EXPR_TYPE( (nt2::eye( t1, as_<T>() )), (value_type_<_>), (T) );
  NT2_TEST_EQUAL(x1,ref);
  ...
  nt2::table<T> x2 = nt2::eye( t2, as_<T>() );
  NT2_TEST_EQUAL(x2,ref);

  NT2_TEST_ASSERT( x1 = nt2::eye(x2, as_<T>()) );
}
