...
NT2_REGISTER_DISPATCH ( tag::bitwise_or_ , tag::recognition_, (A0)(A1)(Dom)(Sema)
...
namespace nt2 { namespace ext
{
  ...
  struct call < tag::bitwise_or_(tag::unspecified_, tag::expr_<Domain,tag::complement_,Semantic>)
...
{
  template<class Domain,class Semantic,class Dummy>
  struct call < tag::bitwise_or_(tag::expr_<Domain,tag::complement_,Semantic>, tag::unspecified_)
              , tag::recognition_, Dummy
              >
        : callable
  {
