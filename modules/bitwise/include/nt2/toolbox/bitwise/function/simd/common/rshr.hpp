...
/////////////////////////////////////////////////////////////////////////////
NT2_REGISTER_DISPATCH_IF(tag::rshr_, tag::cpu_,
			 (A0)(A1)(X),
			 (boost::mpl::equal_to<boost::mpl::sizeof_<A0>,boost::mpl::sizeof_<A1> >),
			 (tag::rshr_(tag::simd_<tag::arithmetic_,X>, tag::simd_<tag::integer_,X>)), 
...
namespace nt2 { namespace ext
{
  ...
  struct call<tag::rshr_(tag::simd_<tag::arithmetic_, X> ,
              ...
              tag::cpu_, Dummy> : callable
  {
    ...
    NT2_FUNCTOR_CALL(2)
    {
      return map(functor<tag::rshr_>(), a0, a1);
    }
