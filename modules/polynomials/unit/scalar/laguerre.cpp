...
NT2_TEST_CASE_TPL ( laguerre_real__2_0,  NT2_REAL_TYPES)
{
  ...
  NT2_TEST_ULP_EQUAL(laguerre(1,nt2::Half<T>()), nt2::Half<r_t>(), 0.5);
  NT2_TEST_ULP_EQUAL(laguerre(1,nt2::Inf<T>()), nt2::Minf<r_t>(), 0.5);
  NT2_TEST_ULP_EQUAL(laguerre(1,nt2::Minf<T>()), nt2::Inf<r_t>(), 0.5);
