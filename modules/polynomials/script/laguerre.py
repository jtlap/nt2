[ ## this file was manually modified by jt
    {
     ...
     'unit' : {
         'global_header' : {
             ...
             'cover_included' : ['#include <nt2/toolbox/boost_math/include/functions/laguerre.hpp>'],
             'notes' : [],
         ...
         'specific_values' : {
             'default' : {
                 ...
                 '1,nt2::Zero<T>()' : {'result' : 'nt2::One<r_t>()','ulp_thresh' : '0.5',},
                },
             'real_' : {
                 '1,nt2::Half<T>()' : {'result' : 'nt2::Half<r_t>()','ulp_thresh' : '0.5',},
                 '1,nt2::Inf<T>()' : {'result' : 'nt2::Minf<r_t>()','ulp_thresh' : '0.5',},
                 '1,nt2::Minf<T>()' : {'result' : 'nt2::Inf<r_t>()','ulp_thresh' : '0.5',},
         ...
         'verif_test' : {
             'property_call' : {
                 'real_' : ['nt2::laguerre(a0,a1)'],
                },
             'property_value' : {
                 'real_' : ['nt2::boost_math::laguerre(a0,a1)'],
                },
             'simd' : {
                },
             'ulp_thresh' : {
