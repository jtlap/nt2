...
/////////////////////////////////////////////////////////////////////////////
NT2_REGISTER_DISPATCH(fdlibm::tag::ldexp_, tag::cpu_,
                       (A0)(A1),
...
namespace nt2 { namespace ext
{
  ...
  struct call<fdlibm::tag::ldexp_(tag::arithmetic_,tag::arithmetic_),
...
{
  template<class Dummy>
  struct call<fdlibm::tag::ldexp_(tag::double_,tag::double_),
              tag::cpu_, Dummy> : callable
  {
    template<class Sig> struct result;
    template<class This,class A0, class A1>
    ...
    NT2_FUNCTOR_CALL(2){ return fd_ldexp(a0, a1); }
  };
} }
