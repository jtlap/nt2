 ...
 * \file
**/
#ifndef NT2_TOOLBOX_FDLIBM_FUNCTIONS_IEEE754_POW_HPP_INCLUDED
#define NT2_TOOLBOX_FDLIBM_FUNCTIONS_IEEE754_POW_HPP_INCLUDED
...
namespace nt2 { namespace fdlibm { namespace tag
  {         
    ...
    **/
    struct __ieee754_pow_ : ext::elementwise_<__ieee754_pow_> { typedef ext::elementwise_<__ieee754_pow_> parent; };
  }
