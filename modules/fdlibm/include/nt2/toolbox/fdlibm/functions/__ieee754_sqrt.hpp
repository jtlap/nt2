 ...
 * \file
**/
#ifndef NT2_TOOLBOX_FDLIBM_FUNCTIONS_IEEE754_SQRT_HPP_INCLUDED
#define NT2_TOOLBOX_FDLIBM_FUNCTIONS_IEEE754_SQRT_HPP_INCLUDED
...
namespace nt2 { namespace fdlibm { namespace tag
  {         
    ...
    **/
    struct __ieee754_sqrt_ : ext::elementwise_<__ieee754_sqrt_> { typedef ext::elementwise_<__ieee754_sqrt_> parent; };
  }
