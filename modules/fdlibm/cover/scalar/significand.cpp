...
//////////////////////////////////////////////////////////////////////////////
#define NT2_UNIT_MODULE "nt2 fdlibm toolbox - significand/scalar Mode"
...
NT2_TEST_CASE_TPL ( significand_real__1_0,  NT2_REAL_TYPES)
{
  
  using nt2::fdlibm::significand;
  using nt2::fdlibm::tag::significand_;
  typedef typename nt2::meta::as_integer<T>::type iT;
  typedef typename nt2::meta::call<significand_(T)>::type r_t;
    ...
    for(nt2::uint32_t j =0; j < NR; ++j )
      {
        std::cout << "for param "
                  << "  a0 = "<< u_t(a0 = tab_a0[j])
                  << std::endl;
        NT2_TEST_ULP_EQUAL( nt2::fdlibm::significand(a0),nt2::mantissa(a0),1);
