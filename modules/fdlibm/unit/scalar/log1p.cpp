...
//////////////////////////////////////////////////////////////////////////////
#define NT2_UNIT_MODULE "nt2 fdlibm toolbox - log1p/scalar Mode"
...
NT2_TEST_CASE_TPL ( log1p_real__1_0,  (double))
{
    ...
    for (uint32_t j =0; j < NR; ++j )
      {
        std::cout << "for param "
                  << "  a0 = "<< u_t(a0 = tab_a0[j])
                  << std::endl;
        NT2_TEST_ULP_EQUAL( nt2::fdlibm::log1p(a0),nt2::log1p(a0),1);
