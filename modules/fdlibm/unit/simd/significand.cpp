...
//////////////////////////////////////////////////////////////////////////////
#define NT2_UNIT_MODULE "nt2 fdlibm toolbox - significand - unit/simd Mode"
...
//////////////////////////////////////////////////////////////////////////////
//NT2_TEST_CASE_TPL(significand, NT2_SIMD_TYPES )
//{
//  using nt2::significand;
//  using nt2::functors::significand;
// 
...
//    data[i] = i; // good value here for significand
//
//    n_t a0 = load<n_t>(&data[0],0);
//    n_t v  = significand(a0);
//    for(std::size_t j=0;j<cardinal_of<n_t>::value;++j)
//    {
//      NT2_TEST_EQUAL( v[j], significand(a0[j]) );
//    }
//  }
//}
