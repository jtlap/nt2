...
//////////////////////////////////////////////////////////////////////////////
#define NT2_UNIT_MODULE "nt2 fdlibm toolbox - logb - unit/simd Mode"
...
//////////////////////////////////////////////////////////////////////////////
//NT2_TEST_CASE_TPL(logb, NT2_SIMD_TYPES )
//{
//  using nt2::logb;
//  using nt2::functors::logb;
// 
...
//    data[i] = i; // good value here for logb
//
//    n_t a0 = load<n_t>(&data[0],0);
//    n_t v  = logb(a0);
//    for(std::size_t j=0;j<cardinal_of<n_t>::value;++j)
//    {
//      NT2_TEST_EQUAL( v[j], logb(a0[j]) );
//    }
//  }
//}
