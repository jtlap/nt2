...
//==============================================================================
#ifndef BOOST_SIMD_TOOLBOX_ARITHMETIC_FUNCTION_SIMD_COMMON_IDIVROUND_HPP_INCLUDED
#define BOOST_SIMD_TOOLBOX_ARITHMETIC_FUNCTION_SIMD_COMMON_IDIVROUND_HPP_INCLUDED
...
{
  BOOST_DISPATCH_FUNCTOR_IMPLEMENTATION( boost::simd::tag::idivround_, tag::cpu_
                            , (A0)(X)
