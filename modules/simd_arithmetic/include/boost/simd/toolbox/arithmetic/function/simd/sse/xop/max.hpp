...
{
  BOOST_DISPATCH_FUNCTOR_IMPLEMENTATION(boost::simd::tag::max_, tag::cpu_,
                      (A0),
                     ...
                     )
  {
    ...
    {
      BOOST_SIMD_XOP_JOIN128INT(that, _mm_max_epu8); return that;
    }
  };
...
/////////////////////////////////////////////////////////////////////////////
                     ...
                     )
  {
    ...
    BOOST_DISPATCH_FUNCTOR_CALL_REPEAT(2)
    {
      BOOST_SIMD_XOP_JOIN128INT(that, _mm_max_epi32); return that;
    }
  };
...
/////////////////////////////////////////////////////////////////////////////
                     ...
                     )
  {
    ...
    BOOST_DISPATCH_FUNCTOR_CALL_REPEAT(2)
    {
      BOOST_SIMD_XOP_JOIN128INT(that, _mm_max_epi8); return that;
    }
  };
...
/////////////////////////////////////////////////////////////////////////////
                     ...
                     )
  {
    ...
    BOOST_DISPATCH_FUNCTOR_CALL_REPEAT(2)
    {
      BOOST_SIMD_XOP_JOIN128INT(that, _mm_max_epi16); return that;
    }
  };
...
/////////////////////////////////////////////////////////////////////////////
                     ...
                     )
  {
    ...
    BOOST_DISPATCH_FUNCTOR_CALL_REPEAT(2)
    {
      BOOST_SIMD_XOP_JOIN128INT(that, _mm_max_epu32); return that;
    }
  };
...
/////////////////////////////////////////////////////////////////////////////
                     ...
                     )
  {
    ...
    BOOST_DISPATCH_FUNCTOR_CALL_REPEAT(2)
    {
      BOOST_SIMD_XOP_JOIN128INT(that, _mm_max_epu16); return that;
    }
  };
} } }
#endif
