...
//////////////////////////////////////////////////////////////////////////////
#define BOOST_SIMD_UNIT_MODULE "nt2 arithmetic toolbox - two_prod/simd Mode"
...
BOOST_SIMD_TEST_CASE_TPL ( two_prod_real__2_0,  BOOST_SIMD_REAL_TYPES)
{
  ...
  typedef typename boost::simd::meta::call<two_prod_(vT,vT)>::type r_t;
  typedef typename boost::simd::meta::call<two_prod_(T,T)>::type sr_t;
