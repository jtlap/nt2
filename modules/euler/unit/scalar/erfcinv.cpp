...
//////////////////////////////////////////////////////////////////////////////
#define NT2_UNIT_MODULE "nt2 euler toolbox - erfcinv/scalar Mode"
...
NT2_TEST_CASE_TPL ( erfcinv_real__1_0, NT2_REAL_TYPES)
{
  ...
  NT2_TEST_ULP_EQUAL(erfcinv(nt2::Zero<r_t>()      ),  nt2::Inf<T>()   , 10);
  NT2_TEST_ULP_EQUAL(erfcinv(nt2::One<r_t>()     ),  nt2::Mzero<T>() , 10);
  NT2_TEST_ULP_EQUAL(erfcinv(nt2::Nan<r_t>()      ),  nt2::Nan<T>()   , 10);
