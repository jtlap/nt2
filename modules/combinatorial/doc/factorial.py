     ...
     'unit' : {
         ...
         'specific_values' : {
            ...
            'real_' : {
                ...
                'nt2::Four<T>()'  : 'T(24)',
                'nt2::Five<T>()'  : 'T(120)',
                'nt2::Six<T>()'   : 'nt2::min((720ll      ),nt2::Valmax<T>())',
                'nt2::Seven<T>()' : 'nt2::min((5040ll     ),nt2::Valmax<T>())',
                'nt2::Eight<T>()' : 'nt2::min((40320ll    ),nt2::Valmax<T>())',
                'nt2::Nine<T>()'  : 'nt2::min((362880ll   ),nt2::Valmax<T>())',
                'nt2::Ten<T>()'   : 'nt2::min((3628800ll  ),nt2::Valmax<T>())',
                'nt2::Eleven<T>()': 'nt2::min((39916800ll ),nt2::Valmax<T>())',
                'nt2::Twelve<T>()': 'nt2::min((479001600ll),nt2::Valmax<T>())',
            },
            'integer_' : {
                    'nt2::One<T>()'    : 'nt2::One<T>()',
                    'nt2::Zero<T>()'   : 'nt2::One<T>()',
