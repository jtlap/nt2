     ...
     'unit' : {
         ...
         'specific_values' : {
            ...
            'integer_' : {
                    ...
                    'nt2::Four<T>()'   : 'T(24)',
                    'nt2::Five<T>()'   : 'T(120)',
                    'nt2::Six<T>()'    : 'nt2::min((720ll      ),(long long)nt2::Valmax<T>())',
                    'nt2::Seven<T>()'  : 'nt2::min((5040ll     ),(long long)nt2::Valmax<T>())',
                    'nt2::Eight<T>()'  : 'nt2::min((40320ll    ),(long long)nt2::Valmax<T>())',
                    'nt2::Nine<T>()'   : 'nt2::min((362880ll   ),(long long)nt2::Valmax<T>())',
                    'nt2::Ten<T>()'    : 'nt2::min((3628800ll  ),(long long)nt2::Valmax<T>())',
                    'nt2::Eleven<T>()' : 'nt2::min((39916800ll ),(long long)nt2::Valmax<T>())',
                    'nt2::Twelve<T>()' : 'nt2::min((479001600ll),(long long)nt2::Valmax<T>())',
            },
          },
         'verif_test' : {
             'property_call' : {
