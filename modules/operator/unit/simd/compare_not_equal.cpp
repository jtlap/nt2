...
NT2_TEST_CASE_TPL ( compare_not_equal_real__2_0,  NT2_SIMD_REAL_TYPES)
{
  ...
  NT2_TEST_EQUAL(compare_not_equal(nt2::Inf<vT>(), nt2::Inf<vT>()), false);
  NT2_TEST_EQUAL(compare_not_equal(nt2::Minf<vT>(), nt2::Minf<vT>()), false);
...
NT2_TEST_CASE_TPL ( compare_not_equal_integer__2_0,  NT2_SIMD_INTEGRAL_TYPES)
{
  ...
  // specific values tests
  NT2_TEST_EQUAL(compare_not_equal(nt2::Mone<vT>(),nt2::Zero<vT>()), true);
  NT2_TEST_EQUAL(compare_not_equal(nt2::One<vT>(), nt2::One<vT>()), false);
  NT2_TEST_EQUAL(compare_not_equal(nt2::One<vT>(),nt2::Zero<vT>()), true);
  NT2_TEST_EQUAL(compare_not_equal(nt2::Zero<vT>(), nt2::Zero<vT>()), false);
