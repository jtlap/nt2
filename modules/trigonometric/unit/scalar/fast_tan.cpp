...
NT2_TEST_CASE_TPL ( fast_tan_real__1_0,  NT2_REAL_TYPES)
{
    ...
    for (uint32_t j =0; j < NR; ++j )
      {
        std::cout << "for param "
                  << "  a0 = "<< u_t(a0 = tab_a0[j])
                  << std::endl;
        NT2_TEST_ULP_EQUAL( nt2::fast_tan(a0),::cephes_tanl(a0),0.5);
...
NT2_TEST_CASE_TPL ( fast_tan_unsigned_int__1_0,  NT2_UNSIGNED_TYPES)
{
...
NT2_TEST_CASE_TPL ( fast_tan_signed_int__1_0,  NT2_INTEGRAL_SIGNED_TYPES)
{
