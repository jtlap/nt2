...
NT2_TEST_CASE_TPL ( cosine_real__1_0, (float))
{
  ...
  NT2_TEST_ULP_EQUAL(cosine<nt2::big>(-nt2::Pi<T>()),      nt2::Mone<r_t>(), 0.5);	    
  NT2_TEST_ULP_EQUAL(cosine<nt2::big>(-nt2::Pi<T>()/T(2)), nt2::Zero<r_t>(), 0.5);	    
  NT2_TEST_ULP_EQUAL(cosine<nt2::big>(-nt2::Pi<T>()/T(4)), nt2::Sqrt_2o_2<r_t>(), 0.5); 
  NT2_TEST_ULP_EQUAL(cosine<nt2::big>(nt2::Inf<T>()),      nt2::Nan<r_t>(), 0.5);	    
  NT2_TEST_ULP_EQUAL(cosine<nt2::big>(nt2::Minf<T>()),     nt2::Nan<r_t>(), 0.5);	    
  NT2_TEST_ULP_EQUAL(cosine<nt2::big>(nt2::Nan<T>()),      nt2::Nan<r_t>(), 0.5);	    
  NT2_TEST_ULP_EQUAL(cosine<nt2::big>(nt2::Pi<T>()),       nt2::Mone<r_t>(), 0.5);	    
  NT2_TEST_ULP_EQUAL(cosine<nt2::big>(nt2::Pi<T>()/T(2)),  nt2::Zero<r_t>(), 0.5);	    
  NT2_TEST_ULP_EQUAL(cosine<nt2::big>(nt2::Pi<T>()/T(4)),  nt2::Sqrt_2o_2<r_t>(), 0.5); 
  ...
  NT2_TEST_ULP_EQUAL(cosine<nt2::small>(nt2::Inf<T>()),       nt2::Nan<r_t>(), 0.5);	    
  NT2_TEST_ULP_EQUAL(cosine<nt2::small>(nt2::Minf<T>()),      nt2::Nan<r_t>(), 0.5);	    
  NT2_TEST_ULP_EQUAL(cosine<nt2::small>(nt2::Nan<T>()),       nt2::Nan<r_t>(), 0.5);	    
  NT2_TEST_ULP_EQUAL(cosine<nt2::small>(nt2::Pi<T>()),        nt2::Mone<r_t>(), 0.5);	    
  NT2_TEST_ULP_EQUAL(cosine<nt2::small>(nt2::Pi<T>()/T(2)),   nt2::Zero<r_t>(), 0.5);	    
  NT2_TEST_ULP_EQUAL(cosine<nt2::small>(nt2::Pi<T>()/T(4)),   nt2::Sqrt_2o_2<r_t>(), 0.5); 
  NT2_TEST_ULP_EQUAL(cosine<nt2::small>(nt2::Zero<T>()),      nt2::One<r_t>(), 0.5);       
