...
NT2_TEST_CASE_TPL ( fast_sincospi_real__1_0,  NT2_REAL_TYPES)
{
  ...
  {
    r_t res = fast_sincospi(-nt2::Quarter<vT>());
  ...
  {
    r_t res = fast_sincospi(nt2::Half<vT>());
  ...
  {
    r_t res = fast_sincospi(nt2::Inf<vT>());
    NT2_TEST_TUPLE_ULP_EQUAL( boost::fusion::get<0>(res)[0], nt2::Nan<r_t0>()[0], 0.75);
    NT2_TEST_TUPLE_ULP_EQUAL( boost::fusion::get<1>(res)[0], nt2::Nan<r_t0>()[0], 0.75);
  }
  {
    r_t res = fast_sincospi(nt2::Mhalf<vT>());
    NT2_TEST_TUPLE_ULP_EQUAL( boost::fusion::get<0>(res)[0], nt2::Nan<r_t0>()[0], 0.75);
    NT2_TEST_TUPLE_ULP_EQUAL( boost::fusion::get<1>(res)[0], nt2::Nan<r_t1>()[0], 0.75);
  }
  {
    r_t res = fast_sincospi(nt2::Minf<vT>());
    NT2_TEST_TUPLE_ULP_EQUAL( boost::fusion::get<0>(res)[0], nt2::Nan<r_t0>()[0], 0.75);
    NT2_TEST_TUPLE_ULP_EQUAL( boost::fusion::get<1>(res)[0], nt2::Nan<r_t0>()[0], 0.75);
  }
  {
    r_t res = fast_sincospi(nt2::Nan<vT>());
    NT2_TEST_TUPLE_ULP_EQUAL( boost::fusion::get<0>(res)[0], nt2::Nan<r_t0>()[0], 0.75);
    NT2_TEST_TUPLE_ULP_EQUAL( boost::fusion::get<1>(res)[0], nt2::Nan<r_t0>()[0], 0.75);
  }
  {
