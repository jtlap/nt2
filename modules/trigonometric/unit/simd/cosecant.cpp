...
NT2_TEST_CASE_TPL ( cosecant_real__1_0,  NT2_SIMD_REAL_TYPES)
{
  ...
  typedef typename nt2::meta::call<cosecant_<nt2::medium>(vT)>::type r_t;
  typedef typename nt2::meta::call<cosecant_<nt2::medium>(T)>::type sr_t;
  ...
  NT2_TEST_ULP_EQUAL(cosecant<nt2::medium>(nt2::Pi<vT>()/nt2::splat<vT>(2))[0], nt2::One<sr_t>(), 0.5);
  NT2_TEST_ULP_EQUAL(cosecant<nt2::medium>(nt2::Pi<vT>()/nt2::splat<vT>(4))[0], nt2::Sqrt_2<sr_t>(), 0.5);
  NT2_TEST_ULP_EQUAL(cosecant<nt2::medium>(nt2::Zero<vT>())[0], nt2::Inf<sr_t>(), 0.5);
...
NT2_TEST_CASE_TPL ( cosecant_int_convert__1_0,  NT2_SIMD_INT_CONVERT_TYPES)
{
  ...
  // specific values tests
  NT2_TEST_ULP_EQUAL(cosecant<nt2::medium>(nt2::Zero<vT>())[0], nt2::Nan<sr_t>(), 0.5);
