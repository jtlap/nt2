[ ## this file was manually modified by jt
    {
     'functor' : {
         'description' :['inverse sine in \\\\f$\pi\\\\f$ multiples.'] ,
         'arity' : '1',
         'call_types' : [],
         'ret_arity' : '0',
         'rturn' : {
     ...
     'unit' : {
         ...
         'specific_values' : {
             'default' : {
                 'nt2::One<T>()' : {'result' : '0.5','ulp_thresh' : '0.5',},
                 'nt2::Zero<T>()' : {'result' : 'nt2::Zero<r_t>()','ulp_thresh' : '0.5',},
                },
             'real_' : {
                 'nt2::Half<T>()' : {'result' : 'T(1)/6','ulp_thresh' : '0.5',},
                 'nt2::Mhalf<T>()' : {'result' : '-T(1)/6','ulp_thresh' : '0.5',},
                 'nt2::Mone<T>()' : {'result' : '-0.5','ulp_thresh' : '0.5',},
