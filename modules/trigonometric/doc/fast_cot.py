[ ## this file was manually modified by jt
    {
     'functor' : {
         'description' :['cotangent in the interval \\\\f$[-\pi/4, \pi/4]\\\\f$, nan outside.'],
         'arity' : '1',
         'call_types' : [],
         'ret_arity' : '0',
         'rturn' : {
     ...
     'unit' : {
         ...
         'specific_values' : {
             ...
             'real_' : {
                 '-nt2::Pi<T>()/T(2)' : {'result' : 'nt2::Nan<r_t>()','ulp_thresh' : '0.5',},
         ...
         'verif_test' : {
             'property_call' : {
                 'real_' : ['nt2::fast_cot(a0)'],
                },
             'property_value' : {
                 'real_' : ['1.0l/::cephes_tanl(a0)'],
                },
             'ulp_thresh' : {
                 'real_' : ['1.0'],
                },
