    ...
    for(nt2::uint32_t j =0; j < NR; ++j )
      {
        ...
        NT2_TEST_TUPLE_ULP_EQUAL( r0, boost::fusion::get<0>(nt2::rem_pio2_medium(a0)), 0.5);
        if (ulpd>ulp0) ulp0=ulpd;
        NT2_TEST_TUPLE_ULP_EQUAL( r1, nt2::Zero<r_t1>(), 0);
        if (ulpd>ulp0) ulp0=ulpd;
        NT2_TEST_TUPLE_ULP_EQUAL( r2, boost::fusion::get<2>(nt2::rem_pio2_medium(a0)), 0);
        if (ulpd>ulp0) ulp0=ulpd;
     }
