    ...
    for(nt2::uint32_t j = 0; j < NR/cardinal_of<n_t>::value; j++)
      {
        ...
        for(int i = 0; i< cardinal_of<n_t>::value; i++)
        {
          ...
          NT2_TEST_ULP_EQUAL( v[i],ssr_t(nt2::fast_sind (tab_a0[k])), 1.0);
...
NT2_TEST_CASE_TPL ( fast_sind_int_convert__1_0,  (nt2::int32_t)(nt2::int64_t))
{
  using nt2::fast_sind;
  using nt2::tag::fast_sind_;
  using nt2::load; 
...
NT2_TEST_CASE_TPL ( fast_sind_uint_convert__1_0,  (nt2::uint32_t)(nt2::uint64_t))
{
  using nt2::fast_sind;
  using nt2::tag::fast_sind_;
  using nt2::load; 
