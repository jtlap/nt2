    ...
    for(uint32_t j = 0; j < NR/cardinal_of<n_t>::value; j++)
      {
        ...
        for(int i = 0; i< cardinal_of<n_t>::value; i++)
        {
          ...
          NT2_TEST_ULP_EQUAL( v[i],ssr_t(nt2::fast_cosd (tab_a0[k])), 1.0);
...
NT2_TEST_CASE_TPL ( fast_cosd_int_convert__1_0,  (int32_t)(int64_t))
{
  using nt2::fast_cosd;
  using nt2::tag::fast_cosd_;
  using nt2::load; 
...
NT2_TEST_CASE_TPL ( fast_cosd_uint_convert__1_0,  (uint32_t)(uint64_t))
{
  using nt2::fast_cosd;
  using nt2::tag::fast_cosd_;
  using nt2::load; 
