 ...
 ******************************************************************************/
#ifndef NT2_TOOLBOX_TRIGONOMETRIC_FUNCTIONS_SCALAR_IMPL_TRIGO_REM_PIO2_HPP_INCLUDED
#define NT2_TOOLBOX_TRIGONOMETRIC_FUNCTIONS_SCALAR_IMPL_TRIGO_REM_PIO2_HPP_INCLUDED
 ...
 */
  namespace details
  {
	...
	recompute:
	  ...
	  /* convert integer "bit" chunk to A0ing-point value */
	  fw = nt2::ldexp(one,q0);
	  for(i=jz;i>=0;i--) {
