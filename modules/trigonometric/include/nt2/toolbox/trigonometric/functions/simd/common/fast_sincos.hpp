...
{
  NT2_FUNCTOR_IMPLEMENTATION_IF(nt2::tag::fast_sincos_, boost::simd::tag::simd_,(A0)(A1)(X),
  ...
  /////////////////////////////////////////////////////////////////////////////
  NT2_FUNCTOR_IMPLEMENTATION(nt2::tag::fast_sincos_, boost::simd::tag::simd_,
                              (A0)(X),
                              ((simd_<arithmetic_<A0>,X>))
                             )
  {
