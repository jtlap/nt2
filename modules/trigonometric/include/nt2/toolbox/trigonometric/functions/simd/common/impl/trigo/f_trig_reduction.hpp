...
namespace nt2
{
  namespace details
  {
	...
	static inline logic cot_invalid(const A0& x) { return False<A0>(); }
	static inline logic tan_invalid(const A0& x) { return False<A0>(); }
	...
	static inline int_type inner_reduce(const typename A0::native_type x_n, A0& xr, A0& xc, const clipped_medium&)
      ...
      struct trig_reduction<A0,degree_tag, tag::simd_type,big, float>
      {
        ...
        static inline logic cot_invalid(const A0& x) { return /*is_invalid(x)|*/(is_nez(x)&is_flint(x/_180<A0>())); }
        static inline logic tan_invalid(const A0& x) { return /*is_invalid(x)|*/is_flint((x-_90<A0>())/_180<A0>()); }
       ...
       struct trig_reduction < A0, pi_tag,  tag::simd_type, big, float>
      {
        ...
        // cotpi*x) is thus Nan
        ////////////////////////////////////////////////////////////////////////
        static inline logic cot_invalid(const A0& x) { return (is_nez(x)&is_flint(x)); }
        static inline logic tan_invalid(const A0& x) { return is_flint(x-Half<A0>()) ; }
