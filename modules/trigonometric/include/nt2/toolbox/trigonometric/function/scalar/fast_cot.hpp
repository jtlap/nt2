...
//==============================================================================
#ifndef NT2_TOOLBOX_TRIGONOMETRIC_FUNCTION_SCALAR_FAST_COT_HPP_INCLUDED
...
namespace nt2 { namespace meta
{
                            ...
                            )
  {
    ...
    NT2_FUNCTOR_CALL(1)
    {
      ...
      return impl::trig_base<A0,radian_tag, trig_tag, tag::not_simd_type, clipped_pio4>::cota(a0);
    }
  };
} }
