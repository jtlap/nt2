...
{
  NT2_FUNCTOR_IMPLEMENTATION( tag::fast_tand_, tag::cpu_
                            , (A0)
                            ...
                            )
  {
    ...
    NT2_FUNCTOR_CALL(1)
    {
      return impl::trig_base<result_type,degree_tag, trig_tag, tag::not_simd_type, clipped_pio4>::tana(result_type(a0));
    }
  };
} }
