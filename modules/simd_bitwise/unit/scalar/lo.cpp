...
//////////////////////////////////////////////////////////////////////////////
#define BOOST_SIMD_UNIT_MODULE "nt2 bitwise toolbox - lo/scalar Mode"
...
BOOST_SIMD_TEST_CASE_TPL ( lo_real__1_0,  BOOST_SIMD_REAL_TYPES)
{
  ...
  typedef typename boost::simd::meta::call<lo_(T)>::type r_t;
  ...
  BOOST_SIMD_TEST_EQUAL(lo(boost::simd::Nan<T>()), boost::simd::Mone<r_t>());
  BOOST_SIMD_TEST_EQUAL(lo(boost::simd::One<T>()), boost::simd::Zero<r_t>());
  BOOST_SIMD_TEST_EQUAL(lo(boost::simd::Zero<T>()), boost::simd::Zero<r_t>());
...
BOOST_SIMD_TEST_CASE_TPL ( lo_int64__1_0,  (boost::simd::int64_t)(boost::simd::uint64_t))
{
  ...
  // specific values tests
  BOOST_SIMD_TEST_EQUAL(lo(boost::simd::One<T>()), boost::simd::One<r_t>());
  BOOST_SIMD_TEST_EQUAL(lo(boost::simd::Zero<T>()), boost::simd::Zero<r_t>());
