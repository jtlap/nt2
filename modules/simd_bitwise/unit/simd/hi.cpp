...
//////////////////////////////////////////////////////////////////////////////
#define BOOST_SIMD_UNIT_MODULE "nt2 bitwise toolbox - hi/simd Mode"
...
BOOST_SIMD_TEST_CASE_TPL ( hi_real__1_0,  BOOST_SIMD_REAL_TYPES)
{
  ...
  typedef typename boost::simd::meta::call<hi_(vT)>::type r_t;
  typedef typename boost::simd::meta::call<hi_(T)>::type sr_t;
  ...
  BOOST_SIMD_TEST_EQUAL(hi(boost::simd::Nan<vT>())[0], boost::simd::Mone<sr_t>());
  BOOST_SIMD_TEST_EQUAL(hi(boost::simd::Zero<vT>())[0], boost::simd::Zero<sr_t>());
...
BOOST_SIMD_TEST_CASE_TPL ( hi_int64__1_0,  (boost::simd::int64_t)(boost::simd::uint64_t))
{
  ...
  // specific values tests
  BOOST_SIMD_TEST_EQUAL(hi(boost::simd::One<vT>())[0], boost::simd::Zero<sr_t>());
  BOOST_SIMD_TEST_EQUAL(hi(boost::simd::Zero<vT>())[0], boost::simd::Zero<sr_t>());
