...
{
  BOOST_DISPATCH_FUNCTION_IMPLEMENTATION(boost::dispatch::tag::rshr_, rshr, 2)
} }
 
#include <boost/simd/toolbox/operator.hpp>
#include <boost/simd/toolbox/bitwise/function/scalar/rshr.hpp>
#include <boost/simd/toolbox/bitwise/function/simd/all/rshr.hpp> 
