...
NT2_TEST_CASE(hierarchy_of_ints64)
{
  ...
  NT2_TEST( (is_same<target_<scalar_<int_< as_<nt2::int64_t> >         > > , UP(base,3) >::value) );
  NT2_TEST( (is_same<target_<scalar_<signed_< as_<nt2::int64_t> >      > > , UP(base,4) >::value) );
  NT2_TEST( (is_same<target_<scalar_<integer_< as_<nt2::int64_t> >     > > , UP(base,5) >::value) );
  NT2_TEST( (is_same<target_<scalar_<arithmetic_< as_<nt2::int64_t> >  > > , UP(base,6) >::value) );
  NT2_TEST( (is_same<target_<scalar_<fundamental_< as_<nt2::int64_t> > > > , UP(base,7) >::value) );
  NT2_TEST( (is_same<target_<scalar_<unspecified_< as_<nt2::int64_t> > > > , UP(base,8) >::value) );

  NT2_TEST( (is_same<target_<generic_<int64_< as_<nt2::int64_t> >        > > , UP(base,9) >::value) );
  NT2_TEST( (is_same<target_<generic_<ints64_< as_<nt2::int64_t> >       > > , UP(base,10) >::value) );
  NT2_TEST( (is_same<target_<generic_<type64_< as_<nt2::int64_t> >       > > , UP(base,11) >::value) );
  NT2_TEST( (is_same<target_<generic_<int_< as_<nt2::int64_t> >          > > , UP(base,12) >::value) );
  NT2_TEST( (is_same<target_<generic_<signed_< as_<nt2::int64_t> >       > > , UP(base,13) >::value) );
  NT2_TEST( (is_same<target_<generic_<integer_< as_<nt2::int64_t> >      > > , UP(base,14) >::value) );
  NT2_TEST( (is_same<target_<generic_<arithmetic_< as_<nt2::int64_t> >   > > , UP(base,15) >::value) );
  NT2_TEST( (is_same<target_<generic_<fundamental_< as_<nt2::int64_t> >  > > , UP(base,16) >::value) );
  NT2_TEST( (is_same<target_<generic_<unspecified_< as_<nt2::int64_t> >  > > , UP(base,17) >::value) );
  NT2_TEST( (is_same<target_<unspecified_< as_<nt2::int64_t> > >             , UP(base,18) >::value) );
}
...
NT2_TEST_CASE(hierarchy_of_uints64)
{
  ...
  NT2_TEST( (is_same<target_<scalar_<uint_< as_<nt2::uint64_t> >        > > , UP(base,3) >::value) );
  NT2_TEST( (is_same<target_<scalar_<unsigned_< as_<nt2::uint64_t> >    > > , UP(base,4) >::value) );
  NT2_TEST( (is_same<target_<scalar_<integer_< as_<nt2::uint64_t> >     > > , UP(base,5) >::value) );
  NT2_TEST( (is_same<target_<scalar_<arithmetic_< as_<nt2::uint64_t> >  > > , UP(base,6) >::value) );
  NT2_TEST( (is_same<target_<scalar_<fundamental_< as_<nt2::uint64_t> > > > , UP(base,7) >::value) );
  NT2_TEST( (is_same<target_<scalar_<unspecified_< as_<nt2::uint64_t> > > > , UP(base,8) >::value) );

  NT2_TEST( (is_same<target_<generic_<uint64_< as_<nt2::uint64_t> >       > > , UP(base,9) >::value) );
  NT2_TEST( (is_same<target_<generic_<ints64_< as_<nt2::uint64_t> >       > > , UP(base,10) >::value) );
  NT2_TEST( (is_same<target_<generic_<type64_< as_<nt2::uint64_t> >       > > , UP(base,11) >::value) );
  NT2_TEST( (is_same<target_<generic_<uint_< as_<nt2::uint64_t> >         > > , UP(base,12) >::value) );
  NT2_TEST( (is_same<target_<generic_<unsigned_< as_<nt2::uint64_t> >     > > , UP(base,13) >::value) );
  NT2_TEST( (is_same<target_<generic_<integer_< as_<nt2::uint64_t> >      > > , UP(base,14) >::value) );
  NT2_TEST( (is_same<target_<generic_<arithmetic_< as_<nt2::uint64_t> >   > > , UP(base,15) >::value) );
  NT2_TEST( (is_same<target_<generic_<fundamental_< as_<nt2::uint64_t> >  > > , UP(base,16) >::value) );
  NT2_TEST( (is_same<target_<generic_<unspecified_< as_<nt2::uint64_t> >  > > , UP(base,17) >::value) );
  NT2_TEST( (is_same<target_<unspecified_< as_<nt2::uint64_t> > >             , UP(base,18) >::value) );
}
...
NT2_TEST_CASE(hierarchy_of_ints32)
{
  ...
  NT2_TEST( (is_same<target_<scalar_<int_< as_<nt2::int32_t> >         > > , UP(base,3) >::value) );
  NT2_TEST( (is_same<target_<scalar_<signed_< as_<nt2::int32_t> >      > > , UP(base,4) >::value) );
  NT2_TEST( (is_same<target_<scalar_<integer_< as_<nt2::int32_t> >     > > , UP(base,5) >::value) );
  NT2_TEST( (is_same<target_<scalar_<arithmetic_< as_<nt2::int32_t> >  > > , UP(base,6) >::value) );
  NT2_TEST( (is_same<target_<scalar_<fundamental_< as_<nt2::int32_t> > > > , UP(base,7) >::value) );
  NT2_TEST( (is_same<target_<scalar_<unspecified_< as_<nt2::int32_t> > > > , UP(base,8) >::value) );

  NT2_TEST( (is_same<target_<generic_<int32_< as_<nt2::int32_t> >        > > , UP(base,9) >::value) );
  NT2_TEST( (is_same<target_<generic_<ints32_< as_<nt2::int32_t> >       > > , UP(base,10) >::value) );
  NT2_TEST( (is_same<target_<generic_<type32_< as_<nt2::int32_t> >       > > , UP(base,11) >::value) );
  NT2_TEST( (is_same<target_<generic_<int_< as_<nt2::int32_t> >          > > , UP(base,12) >::value) );
  NT2_TEST( (is_same<target_<generic_<signed_< as_<nt2::int32_t> >       > > , UP(base,13) >::value) );
  NT2_TEST( (is_same<target_<generic_<integer_< as_<nt2::int32_t> >      > > , UP(base,14) >::value) );
  NT2_TEST( (is_same<target_<generic_<arithmetic_< as_<nt2::int32_t> >   > > , UP(base,15) >::value) );
  NT2_TEST( (is_same<target_<generic_<fundamental_< as_<nt2::int32_t> >  > > , UP(base,16) >::value) );
  NT2_TEST( (is_same<target_<generic_<unspecified_< as_<nt2::int32_t> >  > > , UP(base,17) >::value) );
  NT2_TEST( (is_same<target_<unspecified_< as_<nt2::int32_t> > >             , UP(base,18) >::value) );
}
...
NT2_TEST_CASE(hierarchy_of_uints32)
{
  ...
  NT2_TEST( (is_same<target_<scalar_<uint_< as_<nt2::uint32_t> >        > > , UP(base,3) >::value) );
  NT2_TEST( (is_same<target_<scalar_<unsigned_< as_<nt2::uint32_t> >    > > , UP(base,4) >::value) );
  NT2_TEST( (is_same<target_<scalar_<integer_< as_<nt2::uint32_t> >     > > , UP(base,5) >::value) );
  NT2_TEST( (is_same<target_<scalar_<arithmetic_< as_<nt2::uint32_t> >  > > , UP(base,6) >::value) );
  NT2_TEST( (is_same<target_<scalar_<fundamental_< as_<nt2::uint32_t> > > > , UP(base,7) >::value) );
  NT2_TEST( (is_same<target_<scalar_<unspecified_< as_<nt2::uint32_t> > > > , UP(base,8) >::value) );

  NT2_TEST( (is_same<target_<generic_<uint32_< as_<nt2::uint32_t> >       > > , UP(base,9) >::value) );
  NT2_TEST( (is_same<target_<generic_<ints32_< as_<nt2::uint32_t> >       > > , UP(base,10) >::value) );
  NT2_TEST( (is_same<target_<generic_<type32_< as_<nt2::uint32_t> >       > > , UP(base,11) >::value) );
  NT2_TEST( (is_same<target_<generic_<uint_< as_<nt2::uint32_t> >         > > , UP(base,12) >::value) );
  NT2_TEST( (is_same<target_<generic_<unsigned_< as_<nt2::uint32_t> >     > > , UP(base,13) >::value) );
  NT2_TEST( (is_same<target_<generic_<integer_< as_<nt2::uint32_t> >      > > , UP(base,14) >::value) );
  NT2_TEST( (is_same<target_<generic_<arithmetic_< as_<nt2::uint32_t> >   > > , UP(base,15) >::value) );
  NT2_TEST( (is_same<target_<generic_<fundamental_< as_<nt2::uint32_t> >  > > , UP(base,16) >::value) );
  NT2_TEST( (is_same<target_<generic_<unspecified_< as_<nt2::uint32_t> >  > > , UP(base,17) >::value) );
  NT2_TEST( (is_same<target_<unspecified_< as_<nt2::uint32_t> > >             , UP(base,18) >::value) );
}
...
NT2_TEST_CASE(hierarchy_of_double)
{
  ...
  NT2_TEST( (is_same<target_<scalar_<real_<as_<double> >        > > , UP(base,2) >::value) );
  ...
  NT2_TEST( (is_same<target_<generic_<real_<as_<double> >        > > , UP(base,9) >::value) );
...
NT2_TEST_CASE(hierarchy_of_float)
{
  ...
  NT2_TEST( (is_same<target_<scalar_<real_<as_<float> >        > > , UP(base,2) >::value) );
  NT2_TEST( (is_same<target_<scalar_<signed_<as_<float> >      > > , UP(base,3) >::value) );
  NT2_TEST( (is_same<target_<scalar_<arithmetic_<as_<float> >  > > , UP(base,4) >::value) );
  NT2_TEST( (is_same<target_<scalar_<fundamental_<as_<float> > > > , UP(base,5) >::value) );
  NT2_TEST( (is_same<target_<scalar_<unspecified_<as_<float> > > > , UP(base,6) >::value) );

  NT2_TEST( (is_same<target_<generic_<float_<as_<float> >       > > , UP(base,7) >::value) );
  NT2_TEST( (is_same<target_<generic_<type32_<as_<float> >      > > , UP(base,8) >::value) );
  NT2_TEST( (is_same<target_<generic_<real_<as_<float> >        > > , UP(base,9) >::value) );
  NT2_TEST( (is_same<target_<generic_<signed_<as_<float> >      > > , UP(base,10) >::value) );
  NT2_TEST( (is_same<target_<generic_<arithmetic_<as_<float> >  > > , UP(base,11) >::value) );
  NT2_TEST( (is_same<target_<generic_<fundamental_<as_<float> > > > , UP(base,12) >::value) );
  NT2_TEST( (is_same<target_<generic_<unspecified_<as_<float> > > > , UP(base,13) >::value) );
  NT2_TEST( (is_same<target_<unspecified_<as_<float> > >            , UP(base,14) >::value) );
}
