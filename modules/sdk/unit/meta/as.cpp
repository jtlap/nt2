...
NT2_TEST_CASE(hierarchy_of_ints64)
{
  ...
  NT2_TEST( (is_same<target_<scalar_<real_sized_< as_<nt2::int64_t> >  > > , UP(base,3) >::value) );
  ...
  NT2_TEST( (is_same<target_<generic_<real_sized_< as_<nt2::int64_t> >   > > , UP(base,13) >::value) );
...
NT2_TEST_CASE(hierarchy_of_uints64)
{
  ...
  NT2_TEST( (is_same<target_<scalar_<real_sized_< as_<nt2::uint64_t> >  > > , UP(base,3) >::value) );
  ...
  NT2_TEST( (is_same<target_<generic_<real_sized_< as_<nt2::uint64_t> >   > > , UP(base,13) >::value) );
...
NT2_TEST_CASE(hierarchy_of_ints32)
{
  ...
  NT2_TEST( (is_same<target_<scalar_<real_sized_< as_<nt2::int32_t> >  > > , UP(base,3) >::value) );
  ...
  NT2_TEST( (is_same<target_<generic_<real_sized_< as_<nt2::int32_t> >   > > , UP(base,13) >::value) );
...
NT2_TEST_CASE(hierarchy_of_uints32)
{
  ...
  NT2_TEST( (is_same<target_<scalar_<real_sized_< as_<nt2::uint32_t> >  > > , UP(base,3) >::value) );
  ...
  NT2_TEST( (is_same<target_<generic_<real_sized_< as_<nt2::uint32_t> >   > > , UP(base,13) >::value) );
