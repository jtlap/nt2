...
NT2_TEST_CASE(hierarchy_of_ints64)
{
  ...
  NT2_TEST( (is_same<scalar_<int_<nt2::int64_t>         > , UP(base,3) >::value) );
  NT2_TEST( (is_same<scalar_<signed_<nt2::int64_t>      > , UP(base,4) >::value) );
  NT2_TEST( (is_same<scalar_<integer_<nt2::int64_t>     > , UP(base,5) >::value) );
  NT2_TEST( (is_same<scalar_<arithmetic_<nt2::int64_t>  > , UP(base,6) >::value) );
  NT2_TEST( (is_same<scalar_<fundamental_<nt2::int64_t> > , UP(base,7) >::value) );
  NT2_TEST( (is_same<scalar_<unspecified_<nt2::int64_t> > , UP(base,8) >::value) );

  NT2_TEST( (is_same<generic_<int64_<nt2::int64_t>        > , UP(base,9) >::value) );
  NT2_TEST( (is_same<generic_<ints64_<nt2::int64_t>       > , UP(base,10) >::value) );
  NT2_TEST( (is_same<generic_<type64_<nt2::int64_t>       > , UP(base,11) >::value) );
  NT2_TEST( (is_same<generic_<int_<nt2::int64_t>          > , UP(base,12) >::value) );
  NT2_TEST( (is_same<generic_<signed_<nt2::int64_t>       > , UP(base,13) >::value) );
  NT2_TEST( (is_same<generic_<integer_<nt2::int64_t>      > , UP(base,14) >::value) );
  NT2_TEST( (is_same<generic_<arithmetic_<nt2::int64_t>   > , UP(base,15) >::value) );
  NT2_TEST( (is_same<generic_<fundamental_<nt2::int64_t>  > , UP(base,16) >::value) );
  NT2_TEST( (is_same<generic_<unspecified_<nt2::int64_t>  > , UP(base,17) >::value) );
  NT2_TEST( (is_same<unspecified_<nt2::int64_t>             , UP(base,18) >::value) );
}
...
NT2_TEST_CASE(hierarchy_of_uints64)
{
  ...
  NT2_TEST( (is_same<scalar_<uint_<nt2::uint64_t>        > , UP(base,3) >::value) );
  NT2_TEST( (is_same<scalar_<unsigned_<nt2::uint64_t>    > , UP(base,4) >::value) );
  NT2_TEST( (is_same<scalar_<integer_<nt2::uint64_t>     > , UP(base,5) >::value) );
  NT2_TEST( (is_same<scalar_<arithmetic_<nt2::uint64_t>  > , UP(base,6) >::value) );
  NT2_TEST( (is_same<scalar_<fundamental_<nt2::uint64_t> > , UP(base,7) >::value) );
  NT2_TEST( (is_same<scalar_<unspecified_<nt2::uint64_t> > , UP(base,8) >::value) );

  NT2_TEST( (is_same<generic_<uint64_<nt2::uint64_t>       > , UP(base,9) >::value) );
  NT2_TEST( (is_same<generic_<ints64_<nt2::uint64_t>       > , UP(base,10) >::value) );
  NT2_TEST( (is_same<generic_<type64_<nt2::uint64_t>       > , UP(base,11) >::value) );
  NT2_TEST( (is_same<generic_<uint_<nt2::uint64_t>         > , UP(base,12) >::value) );
  NT2_TEST( (is_same<generic_<unsigned_<nt2::uint64_t>     > , UP(base,13) >::value) );
  NT2_TEST( (is_same<generic_<integer_<nt2::uint64_t>      > , UP(base,14) >::value) );
  NT2_TEST( (is_same<generic_<arithmetic_<nt2::uint64_t>   > , UP(base,15) >::value) );
  NT2_TEST( (is_same<generic_<fundamental_<nt2::uint64_t>  > , UP(base,16) >::value) );
  NT2_TEST( (is_same<generic_<unspecified_<nt2::uint64_t>  > , UP(base,17) >::value) );
  NT2_TEST( (is_same<unspecified_<nt2::uint64_t>             , UP(base,18) >::value) );
}
...
NT2_TEST_CASE(hierarchy_of_ints32)
{
  ...
  NT2_TEST( (is_same<scalar_<int_<nt2::int32_t>         > , UP(base,3) >::value) );
  NT2_TEST( (is_same<scalar_<signed_<nt2::int32_t>      > , UP(base,4) >::value) );
  NT2_TEST( (is_same<scalar_<integer_<nt2::int32_t>     > , UP(base,5) >::value) );
  NT2_TEST( (is_same<scalar_<arithmetic_<nt2::int32_t>  > , UP(base,6) >::value) );
  NT2_TEST( (is_same<scalar_<fundamental_<nt2::int32_t> > , UP(base,7) >::value) );
  NT2_TEST( (is_same<scalar_<unspecified_<nt2::int32_t> > , UP(base,8) >::value) );

  NT2_TEST( (is_same<generic_<int32_<nt2::int32_t>        > , UP(base,9) >::value) );
  NT2_TEST( (is_same<generic_<ints32_<nt2::int32_t>       > , UP(base,10) >::value) );
  NT2_TEST( (is_same<generic_<type32_<nt2::int32_t>       > , UP(base,11) >::value) );
  NT2_TEST( (is_same<generic_<int_<nt2::int32_t>          > , UP(base,12) >::value) );
  NT2_TEST( (is_same<generic_<signed_<nt2::int32_t>       > , UP(base,13) >::value) );
  NT2_TEST( (is_same<generic_<integer_<nt2::int32_t>      > , UP(base,14) >::value) );
  NT2_TEST( (is_same<generic_<arithmetic_<nt2::int32_t>   > , UP(base,15) >::value) );
  NT2_TEST( (is_same<generic_<fundamental_<nt2::int32_t>  > , UP(base,16) >::value) );
  NT2_TEST( (is_same<generic_<unspecified_<nt2::int32_t>  > , UP(base,17) >::value) );
  NT2_TEST( (is_same<unspecified_<nt2::int32_t>             , UP(base,18) >::value) );
}
...
NT2_TEST_CASE(hierarchy_of_uints32)
{
  ...
  NT2_TEST( (is_same<scalar_<uint_<nt2::uint32_t>        > , UP(base,3) >::value) );
  NT2_TEST( (is_same<scalar_<unsigned_<nt2::uint32_t>    > , UP(base,4) >::value) );
  NT2_TEST( (is_same<scalar_<integer_<nt2::uint32_t>     > , UP(base,5) >::value) );
  NT2_TEST( (is_same<scalar_<arithmetic_<nt2::uint32_t>  > , UP(base,6) >::value) );
  NT2_TEST( (is_same<scalar_<fundamental_<nt2::uint32_t> > , UP(base,7) >::value) );
  NT2_TEST( (is_same<scalar_<unspecified_<nt2::uint32_t> > , UP(base,8) >::value) );

  NT2_TEST( (is_same<generic_<uint32_<nt2::uint32_t>       > , UP(base,9) >::value) );
  NT2_TEST( (is_same<generic_<ints32_<nt2::uint32_t>       > , UP(base,10) >::value) );
  NT2_TEST( (is_same<generic_<type32_<nt2::uint32_t>       > , UP(base,11) >::value) );
  NT2_TEST( (is_same<generic_<uint_<nt2::uint32_t>         > , UP(base,12) >::value) );
  NT2_TEST( (is_same<generic_<unsigned_<nt2::uint32_t>     > , UP(base,13) >::value) );
  NT2_TEST( (is_same<generic_<integer_<nt2::uint32_t>      > , UP(base,14) >::value) );
  NT2_TEST( (is_same<generic_<arithmetic_<nt2::uint32_t>   > , UP(base,15) >::value) );
  NT2_TEST( (is_same<generic_<fundamental_<nt2::uint32_t>  > , UP(base,16) >::value) );
  NT2_TEST( (is_same<generic_<unspecified_<nt2::uint32_t>  > , UP(base,17) >::value) );
  NT2_TEST( (is_same<unspecified_<nt2::uint32_t>             , UP(base,18) >::value) );
}
...
NT2_TEST_CASE(hierarchy_of_double)
{
  ...
  NT2_TEST( (is_same<scalar_<real_<double>        > , UP(base,2) >::value) );
  NT2_TEST( (is_same<scalar_<signed_<double>      > , UP(base,3) >::value) );
  NT2_TEST( (is_same<scalar_<arithmetic_<double>  > , UP(base,4) >::value) );
  NT2_TEST( (is_same<scalar_<fundamental_<double> > , UP(base,5) >::value) );
  NT2_TEST( (is_same<scalar_<unspecified_<double> > , UP(base,6) >::value) );

  NT2_TEST( (is_same<generic_<double_<double>      > , UP(base,7) >::value) );
  NT2_TEST( (is_same<generic_<type64_<double>      > , UP(base,8) >::value) );
  NT2_TEST( (is_same<generic_<real_<double>        > , UP(base,9) >::value) );
  NT2_TEST( (is_same<generic_<signed_<double>      > , UP(base,10) >::value) );
  NT2_TEST( (is_same<generic_<arithmetic_<double>  > , UP(base,11) >::value) );
  NT2_TEST( (is_same<generic_<fundamental_<double> > , UP(base,12) >::value) );
  NT2_TEST( (is_same<generic_<unspecified_<double> > , UP(base,13) >::value) );
  NT2_TEST( (is_same<unspecified_<double>            , UP(base,14) >::value) );
}
...
NT2_TEST_CASE(hierarchy_of_float)
{
  ...
  NT2_TEST( (is_same<scalar_<real_<float>        > , UP(base,2) >::value) );
  NT2_TEST( (is_same<scalar_<signed_<float>      > , UP(base,3) >::value) );
  NT2_TEST( (is_same<scalar_<arithmetic_<float>  > , UP(base,4) >::value) );
  NT2_TEST( (is_same<scalar_<fundamental_<float> > , UP(base,5) >::value) );
  NT2_TEST( (is_same<scalar_<unspecified_<float> > , UP(base,6) >::value) );

  NT2_TEST( (is_same<generic_<float_<float>       > , UP(base,7) >::value) );
  NT2_TEST( (is_same<generic_<type32_<float>      > , UP(base,8) >::value) );
  NT2_TEST( (is_same<generic_<real_<float>        > , UP(base,9) >::value) );
  NT2_TEST( (is_same<generic_<signed_<float>      > , UP(base,10) >::value) );
  NT2_TEST( (is_same<generic_<arithmetic_<float>  > , UP(base,11) >::value) );
  NT2_TEST( (is_same<generic_<fundamental_<float> > , UP(base,12) >::value) );
  NT2_TEST( (is_same<generic_<unspecified_<float> > , UP(base,13) >::value) );
  NT2_TEST( (is_same<unspecified_<float>            , UP(base,14) >::value) );
}
