...
BOOST_DISPATCH_FUNCTOR_IMPLEMENTATION((nt2)(meta),Tag,Site,Types,Seq)

#define NT2_FUNCTOR_IMPLEMENTATION_TPL(Tag,Site,Types,Seq)             \
BOOST_DISPATCH_FUNCTOR_IMPLEMENTATION_TPL((nt2)(meta),Tag,Site,Types,Seq)

#define NT2_FUNCTOR_IMPLEMENTATION_IF(Tag,Site,Types,Cond,Ret,Seq)     \
BOOST_DISPATCH_FUNCTOR_IMPLEMENTATION_IF((nt2)(meta),Tag,Site,Types,Cond,Ret,Seq)
