...
#  endif
#elif defined(NT2_HAS_SSE4A_SUPPORT) && !defined(_MSC_VER)
#  undef NT2_HAS_SSE4A_SUPPORT
#endif

#if defined(NT2_HAS_SSE4A_SUPPORT) && !defined(NT2_HAS_SSE3_SUPPORT)
...
#define NT2_SIMD_STRING_LIST        "SSE2 SSE3 SSE4A"
