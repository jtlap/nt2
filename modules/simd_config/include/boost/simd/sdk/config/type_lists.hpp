...
#define BOOST_SIMD__INT_CONVERT_TYPES  (boost::simd::int32_t)(boost::simd::int64_t) \
/**/

#define BOOST_SIMD__UINT_CONVERT_TYPES  (boost::simd::uint32_t)(boost::simd::uint64_t) \
/**/
