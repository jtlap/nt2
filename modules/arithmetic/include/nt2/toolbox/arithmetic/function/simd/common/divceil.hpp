...
namespace nt2 { namespace ext
{
  ...
  struct call<tag::divceil_(tag::simd_<tag::arithmetic_, X> ,
              ...
              tag::cpu_, Dummy> : callable
  {
    ...
    NT2_FUNCTOR_CALL(2){ return ceil(tofloat(a0)/tofloat(a1)); }
  };
} }
...
{
  template<class X, class Dummy>
  struct call<tag::divceil_(tag::simd_<tag::unsigned_, X> ,
...
{
  template<class X, class Dummy>
  struct call<tag::divceil_(tag::simd_<tag::int16_, X> ,
              ...
              tag::cpu_, Dummy> : callable
  {
    ...
    NT2_FUNCTOR_CALL(2)
    {
      ...
      return simd::native_cast<A0>(group(divceil(a0l, a1l),
					 divceil(a0h, a1h)));
    }
  };
} }
...
{
  template<class X, class Dummy>
  struct call<tag::divceil_(tag::simd_<tag::int8_, X> ,
...
{
  template<class X, class Dummy>
  struct call<tag::divceil_(tag::simd_<tag::real_, X> ,
