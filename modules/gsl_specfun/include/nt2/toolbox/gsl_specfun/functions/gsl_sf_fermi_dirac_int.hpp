 ...
 * \file
**/
#ifndef NT2_TOOLBOX_GSL_SPECFUN_FUNCTIONS_GSL_SF_FERMI_DIRAC_INT_HPP_INCLUDED
#define NT2_TOOLBOX_GSL_SPECFUN_FUNCTIONS_GSL_SF_FERMI_DIRAC_INT_HPP_INCLUDED
#include <nt2/include/simd.hpp>
#include <nt2/include/functor.hpp>

/*!
 * \ingroup gsl_specfun
 * \defgroup gsl_specfun_gsl_sf_fermi_dirac_int gsl_sf_fermi_dirac_int
 *
 * \par Description
 ...
 *   {
 *     template <class A0>
 *       meta::call<tag::gsl_sf_fermi_dirac_int_(A0,A0)>::type
 *       gsl_sf_fermi_dirac_int(const A0 & a0,const A0 & a1);
 *   }
 * }
 * \endcode
 *
...
namespace nt2 { namespace gsl_specfun { namespace tag
  {         
    ...
    **/
    struct gsl_sf_fermi_dirac_int_ : ext::elementwise_<gsl_sf_fermi_dirac_int_> : ext::elementwise_<gsl_sf_fermi_dirac_int_> {};
  }
