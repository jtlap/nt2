 ...
 * \file
**/
#ifndef NT2_TOOLBOX_GSL_SPECFUN_FUNCTIONS_GSL_SF_ETA_HPP_INCLUDED
#define NT2_TOOLBOX_GSL_SPECFUN_FUNCTIONS_GSL_SF_ETA_HPP_INCLUDED
#include <nt2/include/simd.hpp>
#include <nt2/include/functor.hpp>

/*!
 * \ingroup gsl_specfun
 * \defgroup gsl_specfun_gsl_sf_eta gsl_sf_eta
 *
 * \par Description
 ...
 *   {
 *     template <class A0>
 *       meta::call<tag::gsl_sf_eta_(A0)>::type
 *       gsl_sf_eta(const A0 & a0);
 *   }
 * }
 * \endcode
 *
...
namespace nt2 { namespace gsl_specfun { namespace tag
  {         
    ...
    **/
    struct gsl_sf_eta_ : ext::elementwise_<gsl_sf_eta_> : ext::elementwise_<gsl_sf_eta_> {};
  }
  NT2_FUNCTION_IMPLEMENTATION(gsl_specfun::tag::gsl_sf_eta_, gsl_sf_eta, 1)
  } }
