 ...
 * \file
**/
#ifndef NT2_TOOLBOX_GSL_SPECFUN_FUNCTIONS_GSL_SF_HAZARD_HPP_INCLUDED
#define NT2_TOOLBOX_GSL_SPECFUN_FUNCTIONS_GSL_SF_HAZARD_HPP_INCLUDED
#include <nt2/include/simd.hpp>
#include <nt2/include/functor.hpp>

/*!
 * \ingroup gsl_specfun
 * \defgroup gsl_specfun_gsl_sf_hazard gsl_sf_hazard
 *
 * \par Description
 ...
 *   {
 *     template <class A0>
 *       meta::call<tag::gsl_sf_hazard_(A0)>::type
 *       gsl_sf_hazard(const A0 & a0);
 *   }
 * }
 * \endcode
 *
 * \param a0 the unique parameter of gsl_sf_hazard
 * 
...
namespace nt2 { namespace gsl_specfun { namespace tag
  {         
    ...
    **/
    struct gsl_sf_hazard_ : ext::elementwise_<gsl_sf_hazard_> : ext::elementwise_<gsl_sf_hazard_> {};
  }
  NT2_FUNCTION_IMPLEMENTATION(gsl_specfun::tag::gsl_sf_hazard_, gsl_sf_hazard, 1)
  } }

#include <nt2/toolbox/gsl_specfun/functions/scalar/gsl_sf_hazard.hpp>
// #include <nt2/toolbox/gsl_specfun/functions/simd/all/gsl_sf_hazard.hpp> 
