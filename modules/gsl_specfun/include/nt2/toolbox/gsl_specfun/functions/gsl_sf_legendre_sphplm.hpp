 ...
 * \file
**/
#ifndef NT2_TOOLBOX_GSL_SPECFUN_FUNCTIONS_GSL_SF_LEGENDRE_SPHPLM_HPP_INCLUDED
#define NT2_TOOLBOX_GSL_SPECFUN_FUNCTIONS_GSL_SF_LEGENDRE_SPHPLM_HPP_INCLUDED
#include <nt2/include/simd.hpp>
#include <nt2/include/functor.hpp>

/*!
 * \ingroup gsl_specfun
 * \defgroup gsl_specfun_gsl_sf_legendre_sphplm gsl_sf_legendre_sphplm
 *
 * \par Description
 ...
 *   {
 *     template <class A0>
 *       meta::call<tag::gsl_sf_legendre_sphplm_(A0,A0,A0)>::type
 *       gsl_sf_legendre_sphplm(const A0 & a0,const A0 & a1,const A0 & a2);
 *   }
 * }
 * \endcode
 *
...
namespace nt2 { namespace gsl_specfun { namespace tag
  {         
    ...
    **/
    struct gsl_sf_legendre_sphplm_ : ext::elementwise_<gsl_sf_legendre_sphplm_> : ext::elementwise_<gsl_sf_legendre_sphplm_> {};
  }
  NT2_FUNCTION_IMPLEMENTATION(gsl_specfun::tag::gsl_sf_legendre_sphplm_, gsl_sf_legendre_sphplm, 3)
  } }
