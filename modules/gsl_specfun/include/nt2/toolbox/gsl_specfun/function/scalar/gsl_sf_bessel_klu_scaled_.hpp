...
{
  NT2_FUNCTOR_IMPLEMENTATION( gsl_specfun::tag::gsl_sf_bessel_klu_scaled__, tag::cpu_
                            , (A0)(A1)
                            ...
                            )
  {
    ...
    NT2_FUNCTOR_CALL(2)
    {
      return nt2::gsl_specfun::gsl_sf_bessel_klu_scaled_(a0, result_type(a1));
    }
  };
} }
...
namespace nt2 { namespace meta
{
                            ...
                            )
  {
    ...
    NT2_FUNCTOR_CALL(2)
    { return gsl_sf_bessel_Klu_scaled(a0, a1); }
  };
} }
