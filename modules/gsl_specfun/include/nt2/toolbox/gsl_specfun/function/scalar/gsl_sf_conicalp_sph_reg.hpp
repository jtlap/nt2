...
/////////////////////////////////////////////////////////////////////////////
NT2_REGISTER_DISPATCH(gsl_specfun::tag::gsl_sf_conicalp_sph_reg_, tag::cpu_,
                                         (A0)(A1)(A2),
...
namespace nt2 { namespace ext
{
  ...
  struct call<gsl_specfun::tag::gsl_sf_conicalp_sph_reg_(tag::integer_,tag::arithmetic_,tag::arithmetic_),
              tag::cpu_, Dummy> : callable
  {
    template<class Sig> struct result;
    template<class This,class A0, class A1, class A2>
    struct result<This(A0, A1, A2)> : meta::result_of<meta::floating(A1)>{};
...
{
  template<class Dummy>
  struct call<gsl_specfun::tag::gsl_sf_conicalp_sph_reg_(tag::integer_,tag::double_,tag::double_),
              tag::cpu_, Dummy> : callable
  {
    template<class Sig> struct result;
    template<class This,class A0, class A1, class A2>
    ...
    NT2_FUNCTOR_CALL(3){ return gsl_sf_conicalP_sph_reg(a0, a1, a2); }
  };
} }
...
{
  template<class Dummy>
  struct call<gsl_specfun::tag::gsl_sf_conicalp_sph_reg_(tag::integer_,tag::float_,tag::float_),
              tag::cpu_, Dummy> : callable
  {
    template<class Sig> struct result;
    template<class This,class A0, class A1, class A2>
