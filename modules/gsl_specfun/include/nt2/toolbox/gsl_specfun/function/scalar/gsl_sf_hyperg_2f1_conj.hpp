...
/////////////////////////////////////////////////////////////////////////////
NT2_REGISTER_DISPATCH(gsl_specfun::tag::gsl_sf_hyperg_2f1_conj_, tag::cpu_,
                                        (A0)(A1)(A2)(A3),
...
namespace nt2 { namespace ext
{
  ...
  struct call<gsl_specfun::tag::gsl_sf_hyperg_2f1_conj_(tag::arithmetic_,tag::arithmetic_,tag::arithmetic_,tag::arithmetic_),
              tag::cpu_, Dummy> : callable
  {
    template<class Sig> struct result;
    template<class This,class A0, class A1, class A2, class A3>
    struct result<This(A0, A1, A2, A3)> : meta::result_of<meta::floating(A0)>{};
...
{
  template<class Dummy>
  struct call<gsl_specfun::tag::gsl_sf_hyperg_2f1_conj_(tag::double_,tag::double_,tag::double_,tag::double_),
              tag::cpu_, Dummy> : callable
  {
    template<class Sig> struct result;
    template<class This,class A0, class A1, class A2, class A3>
...
{
  template<class Dummy>
  struct call<gsl_specfun::tag::gsl_sf_hyperg_2f1_conj_(tag::float_,tag::float_,tag::float_,tag::float_),
              tag::cpu_, Dummy> : callable
  {
    template<class Sig> struct result;
    template<class This,class A0, class A1, class A2, class A3>
