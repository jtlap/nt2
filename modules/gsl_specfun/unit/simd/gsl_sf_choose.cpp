...
//////////////////////////////////////////////////////////////////////////////
#define NT2_UNIT_MODULE "nt2 gsl_specfun toolbox - gsl_sf_choose - unit/simd Mode"
...
//////////////////////////////////////////////////////////////////////////////
//NT2_TEST_CASE_TPL(gsl_sf_choose, NT2_SIMD_TYPES )
//{
//  using nt2::gsl_sf_choose;
//  using nt2::functors::gsl_sf_choose;
// 
...
//    data[i] = i; // good value here for gsl_sf_choose
//
//    n_t a0 = load<n_t>(&data[0],0);
//    n_t a1 = load<n_t>(&data[0],1);
//    n_t v  = gsl_sf_choose(a0, a1);
//    for(std::size_t j=0;j<cardinal_of<n_t>::value;++j)
//    {
//      NT2_TEST_EQUAL( v[j], gsl_sf_choose(a0[j], a1[j]) );
//    }
//  }
//}
