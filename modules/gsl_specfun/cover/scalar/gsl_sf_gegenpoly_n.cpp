...
//////////////////////////////////////////////////////////////////////////////
#define NT2_UNIT_MODULE "nt2 gsl_specfun toolbox - gsl_sf_gegenpoly_n/scalar Mode"
...
NT2_TEST_CASE_TPL ( gsl_sf_gegenpoly_n_real__3_0,  NT2_REAL_TYPES)
{
  ...
  static const nt2::uint32_t NR = NT2_NB_RANDOM_TEST;
  {
    ...
    NT2_CREATE_BUF(tab_a1,T, NR, T(-0.5), T(10));
    ...
    for(nt2::uint32_t j =0; j < NR; ++j )
      {
        std::cout << "for params "
                  ...
                  << ", a2 = "<< u_t(a2 = tab_a2[j])
                  << std::endl;
        NT2_TEST_ULP_EQUAL( nt2::gsl_specfun::gsl_sf_gegenpoly_n(a0,a1,a2),nt2::gsl_specfun::gsl_sf_gegenpoly_n(a0,a1,a2),1);
