...
//////////////////////////////////////////////////////////////////////////////
#define NT2_UNIT_MODULE "nt2 boost_math toolbox - hermite/scalar Mode"
...
#include <nt2/include/functions/hermite.hpp>
...
NT2_TEST_CASE_TPL ( hermite_real__2_0,  NT2_REAL_TYPES)
{
  ...
  using nt2::boost_math::hermite;
  using nt2::boost_math::tag::hermite_;
    ...
    for(nt2::uint32_t j =0; j < NR; ++j )
      {
        std::cout << "for params "
                  ...
                  << ", a1 = "<< u_t(a1 = tab_a1[j])
                  << std::endl;
        NT2_TEST_ULP_EQUAL( nt2::boost_math::hermite(a0,a1),nt2::hermite(a0,a1),14);
