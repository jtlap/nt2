...
//////////////////////////////////////////////////////////////////////////////
#define NT2_UNIT_MODULE "nt2 boost_math toolbox - log1p/scalar Mode"
...
NT2_TEST_CASE_TPL ( log1p_real__1_0,  NT2_REAL_TYPES)
{
  ...
  using nt2::boost_math::log1p;
  using nt2::boost_math::tag::log1p_;
    ...
    for(nt2::uint32_t j =0; j < NR; ++j )
      {
        std::cout << "for param "
                  << "  a0 = "<< u_t(a0 = tab_a0[j])
                  << std::endl;
        NT2_TEST_ULP_EQUAL( nt2::boost_math::log1p(a0),nt2::log1p(a0),1);
