...
//////////////////////////////////////////////////////////////////////////////
#define NT2_UNIT_MODULE "nt2 boost_math toolbox - sph_neumann/scalar Mode"
...
NT2_TEST_CASE_TPL ( sph_neumann_real__2_0,  NT2_REAL_TYPES)
{
    ...
    for(nt2::uint32_t j =0; j < NR; ++j )
      {
        std::cout << "for params "
                  ...
                  << ", a1 = "<< u_t(a1 = tab_a1[j])
                  << std::endl;
        NT2_TEST_ULP_EQUAL( nt2::boost_math::sph_neumann(a0,a1),nt2::boost_math::sph_neumann(a0,a1),1);
