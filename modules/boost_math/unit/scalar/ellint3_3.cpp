...
//////////////////////////////////////////////////////////////////////////////
#define NT2_UNIT_MODULE "nt2 boost_math toolbox - ellint3_3/scalar Mode"
...
NT2_TEST_CASE_TPL ( ellint3_3_real__3_0,  NT2_REAL_TYPES)
{
  ...
  typedef typename nt2::meta::call<ellint3_3_(T,T,T)>::type r_t;
  ...
  static const uint32_t NR = NT2_NB_RANDOM_TEST;
  {
    ...
    NT2_CREATE_BUF(tab_a2,T, NR, T(0), nt2::Pio_2<T>());
    ...
    for (uint32_t j =0; j < NR; ++j )
      {
        std::cout << "for params "
                  ...
                  << ", a2 = "<< u_t(a2 = tab_a2[j])
                  << std::endl;
        NT2_TEST_ULP_EQUAL( nt2::boost_math::ellint3_3(a0,a1,a2),nt2::boost_math::ellint3_3(a0,a1,a2),1);
