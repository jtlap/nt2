...
/////////////////////////////////////////////////////////////////////////////
NT2_REGISTER_DISPATCH(boost_math::tag::erfc_, tag::cpu_,
                      (A0),
                      (arithmetic_<A0>)
                     )
...
namespace nt2 { namespace ext
{
  ...
  struct call<boost_math::tag::erfc_(tag::arithmetic_),
...
{
  template<class Dummy>
  struct call<boost_math::tag::erfc_(tag::real_),
              tag::cpu_, Dummy> : callable
  {
    template<class Sig> struct result;
    template<class This,class A0>
    ...
    NT2_FUNCTOR_CALL(1){ return boost::math::erfc(a0, nt2_policy()); }
  };
} }
