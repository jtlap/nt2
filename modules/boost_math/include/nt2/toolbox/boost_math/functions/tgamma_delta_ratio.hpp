 ...
 *   {
 *     template <class A0>
 *       meta::call<tag::tgamma_delta_ratio_(A0,A0)>::type
 *       tgamma_delta_ratio(const A0 & a0,const A0 & a1);
 *   }
 * }
 * \endcode
 *
 * \param a0 the first parameter of tgamma_delta_ratio
 * \param a1 the second parameter of tgamma_delta_ratio
 * 
