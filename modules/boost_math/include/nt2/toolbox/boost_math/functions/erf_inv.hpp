 ...
 * \file
**/
#ifndef NT2_TOOLBOX_BOOST_MATH_FUNCTIONS_ERF_INV_HPP_INCLUDED
#define NT2_TOOLBOX_BOOST_MATH_FUNCTIONS_ERF_INV_HPP_INCLUDED
...
/*!
 * \ingroup boost_math
 * \defgroup boost_math_erf_inv erf_inv function
 *
 * \par Description
 ...
 *   {
 *     template <class A0>
 *       meta::call<tag::erf_inv_(A0)>::type
 *       erf_inv(const A0 & a0);
 *   }
 * }
 * \endcode
