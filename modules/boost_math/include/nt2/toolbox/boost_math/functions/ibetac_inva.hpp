 ...
 * \file
**/
#ifndef NT2_TOOLBOX_BOOST_MATH_FUNCTIONS_IBETAC_INVA_HPP_INCLUDED
#define NT2_TOOLBOX_BOOST_MATH_FUNCTIONS_IBETAC_INVA_HPP_INCLUDED
...
/*!
 * \ingroup boost_math
 * \defgroup boost_math_ibetac_inva ibetac_inva
 *
 * \par Description
 ...
 *   {
 *     template <class A0>
 *       meta::call<tag::ibetac_inva_(A0,A0,A0)>::type
 *       ibetac_inva(const A0 & a0,const A0 & a1,const A0 & a2);
 *   }
 * }
 * \endcode
 *
...
namespace nt2 { namespace boost_math { namespace tag
  {         
    ...
    **/
    struct ibetac_inva_ : ext::elementwise_<ibetac_inva_> {};
  }
