...
/*!
 * \ingroup boost_math
 * \defgroup boost_math_expint expint
 *
 * \par Description
 ...
 *   {
 *     template <class A0>
 *       meta::call<tag::expint_(A0)>::type
 *       expint(const A0 & a0);
 *   }
 * }
 * \endcode
 *
 * \param a0 the unique parameter of expint
 * 
...
namespace nt2 { namespace boost_math { namespace tag
  {         
    ...
    **/
    struct expint_ : ext::elementwise_<expint_> { typedef ext::elementwise_<expint_> parent; };
  }
