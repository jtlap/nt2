...
#else
double cephes_pow(), cephes_gamma(), cephes_log(), cephes_exp(), fabs();
#endif
#define EUL 0.57721566490153286060
#define BIG  1.44115188075855872E+17
extern double MAXNUM, MACHEP, MAXLOG;

double cephes_expn( n, x )
int n;
double x;
{
...
if( x < 0 )
	{
domerr:	cephes_mtherr( "expn", DOMAIN );
	return( MAXNUM );
	}
