...
#else
double cephes_pow(), cephes_log(), cephes_exp(), cephes_sin(), cephes_polevl(), cephes_p1evl(), cephes_floor(), fabs();
int isnan(), isfinite();
static double stirf();
double cephes_lgam();
#endif
...
lgsing:
	...
	if( z == 0.0 )
		goto lgsing;
/*	z = cephes_log(PI) - cephes_log( z ) - w;*/
