 ...
 * MAXLOG =  8.8029691931113054295988E1       cephes_log(2**127)
 * MINLOG = -8.872283911167299960540E1        cephes_log(2**-128)
 * MAXNUM =  1.701411834604692317316873e38    2**127
 *
 * For IEEE arithmetic (IBMPC):
 * MACHEP =  1.11022302462515654042E-16       2**-53
 * MAXLOG =  7.09782712893383996843E2         cephes_log(2**1024)
 * MINLOG = -7.08396418532264106224E2         cephes_log(2**-1022)
 ...
 * SQRT2  =  1.41421356237309504880           cephes_sqrt(2)
 * SQRTH  =  7.07106781186547524401E-1        cephes_sqrt(2)/2
 * LOG2E  =  1.4426950408889634073599         1/cephes_log(2)
 * SQ2OPI =  7.9788456080286535587989E-1      cephes_sqrt( 2/pi )
 * LOGE2  =  6.93147180559945309417E-1        cephes_log(2)
 * LOGSQ2 =  3.46573590279972654709E-1        cephes_log(2)/2
...
#ifdef DENORMAL
double MAXLOG =  7.09782712893383996732E2;     /* cephes_log(MAXNUM) */
/* double MINLOG = -7.44440071921381262314E2; */     /* cephes_log(2**-1074) */
double MINLOG = -7.451332191019412076235E2;     /* cephes_log(2**-1075) */
#else
...
double SQRT2  =  1.41421356237309504880;       /* cephes_sqrt(2) */
double SQRTH  =  7.07106781186547524401E-1;    /* cephes_sqrt(2)/2 */
double LOG2E  =  1.4426950408889634073599;     /* 1/cephes_log(2) */
double SQ2OPI =  7.9788456080286535587989E-1;  /* cephes_sqrt( 2/pi ) */
double LOGE2  =  6.93147180559945309417E-1;    /* cephes_log(2) */
double LOGSQ2 =  3.46573590279972654709E-1;    /* cephes_log(2)/2 */
double THPIO4 =  2.35619449019234492885;       /* 3*pi/4 */
double TWOOPI =  6.36619772367581343075535E-1; /* 2/pi */
#ifdef INFINITIES
double INFINITY = 1.0/ZERO;  /* 99e999; */
#else
...
#ifdef DENORMAL
			/* cephes_log(2**1024) =   7.09782712893383996843E2 */
