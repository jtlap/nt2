 ...
 * Otherwise the calculation is cephes_sinh(x) = ( cephes_exp(x) - cephes_exp(-x) )/2.
 *
 *
 *
 * ACCURACY:
...
#else
double fabs(), cephes_exp(), cephes_polevl(), cephes_p1evl();
#endif
