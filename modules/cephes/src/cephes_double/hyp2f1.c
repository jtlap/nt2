 ...
 * SYNOPSIS:
 *
 * double a, b, c, x, y, cephes_hyp2f1();
 *
 * y = cephes_hyp2f1( a, b, c, x );
 *
 *
 * DESCRIPTION:
 *
 *
 *  cephes_hyp2f1( a, b, c, x )  =   F ( a, b; c; x )
 *                           2 1
 *
 *           inf.
...
#else
double fabs(), cephes_pow(), round(), cephes_gamma(), cephes_log(), cephes_exp(), cephes_psi();
