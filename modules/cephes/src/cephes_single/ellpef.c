...
#ifdef ANSIC
float cephes_polevlf(float, float *, int), cephes_logf(float);
float cephes_ellpef( float xx)
#else
float cephes_polevlf(), cephes_logf();
float cephes_ellpef(xx)
double xx;
#endif
{
float x;
