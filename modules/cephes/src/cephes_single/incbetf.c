...
#ifdef ANSIC
float cephes_lgamf(float), cephes_expf(float), cephes_logf(float);
static float incbdf(float, float, float);
static float incbcff(float, float, float);
float cephes_incbpsf(float, float, float);
#else
float cephes_lgamf(), cephes_expf(), cephes_logf();
float cephes_incbpsf();
...
#ifdef ANSIC
float cephes_incbetf( float aaa, float bbb, float xxx )
#else
float cephes_incbetf( aaa, bbb, xxx )
double aaa, bbb, xxx;
#endif
{
...
/* power series */
#ifdef ANSIC
float cephes_incbpsf( float aa, float bb, float xx )
#else
float cephes_incbpsf( aa, bb, xx )
double aa, bb, xx;
#endif
{
float a, b, x, t, u, y, s;
