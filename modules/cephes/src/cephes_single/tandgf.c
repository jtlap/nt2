...
#ifdef ANSIC
float cephes_tandgf( float x )
#else
float cephes_tandgf(x)
double x;
#endif
{
...
#ifdef ANSIC
float cephes_cotdgf( float x )
#else
float cephes_cotdgf(x)
double x;
#endif
{
