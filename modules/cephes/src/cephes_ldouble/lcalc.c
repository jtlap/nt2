...
long double cephes_floorl(), cephes_logl(), cephes_powl(), cephes_sqrtl(), cephes_tanhl(), cephes_expl();
long double cephes_ellpel(), cephes_ellpkl(), cephes_incbetl(), cephes_incbil();
long double cephes_stdtrl(), cephes_stdtril(), zstdtrl(), zstdtril();
long double cephes_sinl(), cephes_cosl(), cephes_tanl(), cephes_asinl(), cephes_acosl(), cephes_atanl(), cephes_atan2l();
long double cephes_tanhl(), cephes_atanhl();
#ifdef NANS
