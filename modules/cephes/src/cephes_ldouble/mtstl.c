...
extern long double cephes_stdtril ( int, long double );
extern long double cephes_ellpel ( long double );
extern long double cephes_ellpkl ( long double );
extern void exit (int);
#else
long double cephes_fabsl(), cephes_sqrtl();
long double cephes_cbrtl(), cephes_expl(), cephes_logl(), cephes_tanl(), cephes_atanl();
long double cephes_sinl(), cephes_asinl(), cephes_cosl(), cephes_acosl(), cephes_powl();
long double cephes_tanhl(), cephes_atanhl(), cephes_sinhl(), cephes_asinhl(), cephes_coshl(), cephes_acoshl();
long double cephes_exp2l(), cephes_log2l(), cephes_exp10l(), cephes_log10l();
long double cephes_gammal(), cephes_lgaml(), cephes_jnl(), cephes_ynl(), cephes_ndtrl(), cephes_ndtril();
long double cephes_stdtrl(), cephes_stdtril(), cephes_ellpel(), cephes_ellpkl();
void exit ();
#endif
extern int merror;
#if GLIBC2
...
rms = 1.0e-16L * cephes_sqrtl( rmsa/m );
da = max;
db = rms;
if(d->ctrl & RELERR)
