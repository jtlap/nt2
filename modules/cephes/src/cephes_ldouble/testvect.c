...
#include <stdio.h>
int cephes_isfinitel (long double);
...
long double cephes_exp2l (long double);
long double cephes_expm1l (long double);
long double cephes_log10l (long double);
long double cephes_log1pl (long double);
long double cephes_log2l (long double);
long double cephes_fabsl (long double);
long double cephes_erfl (long double);
long double cephes_erfcl (long double);
long double cephes_gammal (long double);
long double cephes_lgaml (long double);
long double cephes_floorl (long double);
long double cephes_ceill (long double);
long double cephes_cbrtl (long double);
...
long double cephes_atan2l (long double, long double);
long double cephes_powl (long double, long double);
...
int cephes_isnanl (long double);
int cephes_signbitl (long double);
	  ...
	  if (memcmp(u.c, v.c, 10) != 0)
	    {
	      ...
	      if (cephes_isnanl(v.d) && cephes_isnanl(u.d))
		goto nxttest1;
	      goto wrongone;
	    }
	  else
