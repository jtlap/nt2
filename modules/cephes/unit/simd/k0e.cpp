...
//////////////////////////////////////////////////////////////////////////////
#define NT2_UNIT_MODULE "nt2 cephes toolbox - k0e - unit/simd Mode"
...
//////////////////////////////////////////////////////////////////////////////
//NT2_TEST_CASE_TPL(k0e, NT2_SIMD_TYPES )
//{
//  using nt2::k0e;
//  using nt2::functors::k0e;
// 
...
//    data[i] = i; // good value here for k0e
//
//    n_t a0 = load<n_t>(&data[0],0);
//    n_t v  = k0e(a0);
//    for(std::size_t j=0;j<cardinal_of<n_t>::value;++j)
//    {
//      NT2_TEST_EQUAL( v[j], k0e(a0[j]) );
//    }
//  }
//}
