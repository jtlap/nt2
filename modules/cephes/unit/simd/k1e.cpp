...
//////////////////////////////////////////////////////////////////////////////
#define NT2_UNIT_MODULE "nt2 cephes toolbox - k1e - unit/simd Mode"
...
//////////////////////////////////////////////////////////////////////////////
//NT2_TEST_CASE_TPL(k1e, NT2_SIMD_TYPES )
//{
//  using nt2::k1e;
//  using nt2::functors::k1e;
// 
...
//    data[i] = i; // good value here for k1e
//
//    n_t a0 = load<n_t>(&data[0],0);
//    n_t v  = k1e(a0);
//    for(std::size_t j=0;j<cardinal_of<n_t>::value;++j)
//    {
//      NT2_TEST_EQUAL( v[j], k1e(a0[j]) );
//    }
//  }
//}
