...
//////////////////////////////////////////////////////////////////////////////
#define NT2_UNIT_MODULE "nt2 cephes toolbox - chdtr - unit/simd Mode"
...
//////////////////////////////////////////////////////////////////////////////
//NT2_TEST_CASE_TPL(chdtr, NT2_SIMD_TYPES )
//{
//  using nt2::chdtr;
//  using nt2::functors::chdtr;
// 
...
//    data[i] = i; // good value here for chdtr
//
...
//    {
//      NT2_TEST_EQUAL( v[j], chdtr(a0[j], a1[j]) );
//    }
//  }
//}
