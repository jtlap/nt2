...
//////////////////////////////////////////////////////////////////////////////
#define NT2_UNIT_MODULE "nt2 cephes toolbox - fdtrc - unit/simd Mode"
...
//////////////////////////////////////////////////////////////////////////////
//NT2_TEST_CASE_TPL(fdtrc, NT2_SIMD_TYPES )
//{
//  using nt2::fdtrc;
//  using nt2::functors::fdtrc;
// 
...
//    data[i] = i; // good value here for fdtrc
//
//    n_t a0 = load<n_t>(&data[0],0);
//    n_t a1 = load<n_t>(&data[0],1);
//    n_t a2 = load<n_t>(&data[0],2);
//    n_t v  = fdtrc(a0, a1, a2);
//    for(std::size_t j=0;j<cardinal_of<n_t>::value;++j)
//    {
//      NT2_TEST_EQUAL( v[j], fdtrc(a0[j], a1[j], a2[j]) );
//    }
//  }
//}
