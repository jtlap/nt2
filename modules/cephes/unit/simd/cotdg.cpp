...
//////////////////////////////////////////////////////////////////////////////
#define NT2_UNIT_MODULE "nt2 cephes toolbox - cotdg - unit/simd Mode"
...
//////////////////////////////////////////////////////////////////////////////
//NT2_TEST_CASE_TPL(cotdg, NT2_SIMD_TYPES )
//{
//  using nt2::cotdg;
//  using nt2::functors::cotdg;
// 
...
//    data[i] = i; // good value here for cotdg
//
//    n_t a0 = load<n_t>(&data[0],0);
//    n_t v  = cotdg(a0);
//    for(std::size_t j=0;j<cardinal_of<n_t>::value;++j)
//    {
//      NT2_TEST_EQUAL( v[j], cotdg(a0[j]) );
//    }
//  }
//}
