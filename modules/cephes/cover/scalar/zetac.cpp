...
//////////////////////////////////////////////////////////////////////////////
#define NT2_UNIT_MODULE "nt2 cephes toolbox - zetac/scalar Mode"
...
NT2_TEST_CASE_TPL ( zetac_real__1_0,  NT2_REAL_TYPES)
{
  
  using nt2::cephes::zetac;
  using nt2::cephes::tag::zetac_;
  typedef typename nt2::meta::as_integer<T>::type iT;
  typedef typename nt2::meta::call<zetac_(T)>::type r_t;
    ...
    for(nt2::uint32_t j =0; j < NR; ++j )
      {
        std::cout << "for param "
                  << "  a0 = "<< u_t(a0 = tab_a0[j])
                  << std::endl;
        NT2_TEST_ULP_EQUAL( nt2::cephes::zetac(a0),nt2::cephes::zetac(a0),0.5);
