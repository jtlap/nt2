...
//////////////////////////////////////////////////////////////////////////////
#define NT2_UNIT_MODULE "nt2 cephes toolbox - fdtrc/scalar Mode"
...
NT2_TEST_CASE_TPL ( fdtrc_real__3_0,  NT2_REAL_TYPES)
{
  
  using nt2::cephes::fdtrc;
  using nt2::cephes::tag::fdtrc_;
  typedef typename nt2::meta::as_integer<T>::type iT;
  typedef typename nt2::meta::call<fdtrc_(T,T,T)>::type r_t;
    ...
    for(nt2::uint32_t j =0; j < NR; ++j )
      {
        std::cout << "for params "
                  ...
                  << ", a2 = "<< u_t(a2 = tab_a2[j])
                  << std::endl;
        NT2_TEST_ULP_EQUAL( nt2::cephes::fdtrc(a0,a1,a2),nt2::cephes::fdtrc(a0,a1,a2),0.5);
