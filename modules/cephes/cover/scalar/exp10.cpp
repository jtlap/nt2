...
//////////////////////////////////////////////////////////////////////////////
#define NT2_UNIT_MODULE "nt2 cephes toolbox - exp10/scalar Mode"
...
NT2_TEST_CASE_TPL ( exp10_real__1_0,  NT2_REAL_TYPES)
{
  ...
  {
    NT2_CREATE_BUF(tab_a0,T, NR, T(-30), T(30));
    ...
    for(nt2::uint32_t j =0; j < NR; ++j )
      {
        std::cout << "for param "
                  << "  a0 = "<< u_t(a0 = tab_a0[j])
                  << std::endl;
        NT2_TEST_ULP_EQUAL( nt2::cephes::exp10(a0),nt2::exp10(a0),0.5);
