...
//////////////////////////////////////////////////////////////////////////////
#define NT2_UNIT_MODULE "nt2 cephes toolbox - igam/scalar Mode"
...
NT2_TEST_CASE_TPL ( igam_real__2_0,  NT2_REAL_TYPES)
{
  
  using nt2::cephes::igam;
  using nt2::cephes::tag::igam_;
  typedef typename nt2::meta::as_integer<T>::type iT;
  typedef typename nt2::meta::call<igam_(T,T)>::type r_t;
    ...
    for(nt2::uint32_t j =0; j < NR; ++j )
      {
        std::cout << "for params "
                  ...
                  << ", a1 = "<< u_t(a1 = tab_a1[j])
                  << std::endl;
        NT2_TEST_ULP_EQUAL( nt2::cephes::igam(a0,a1),nt2::cephes::igam(a0,a1),0.5);
