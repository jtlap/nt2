...
//////////////////////////////////////////////////////////////////////////////
#define NT2_UNIT_MODULE "nt2 cephes toolbox - k1e/scalar Mode"
...
NT2_TEST_CASE_TPL ( k1e_real__1_0,  NT2_REAL_TYPES)
{
  
  using nt2::cephes::k1e;
  using nt2::cephes::tag::k1e_;
  typedef typename nt2::meta::as_integer<T>::type iT;
  typedef typename nt2::meta::call<k1e_(T)>::type r_t;
    ...
    for(nt2::uint32_t j =0; j < NR; ++j )
      {
        std::cout << "for param "
                  << "  a0 = "<< u_t(a0 = tab_a0[j])
                  << std::endl;
        NT2_TEST_ULP_EQUAL( nt2::cephes::k1e(a0),nt2::cephes::k1e(a0),0.5);
