 ...
 * \file
**/
#ifndef NT2_TOOLBOX_CEPHES_FUNCTIONS_PDTR_HPP_INCLUDED
#define NT2_TOOLBOX_CEPHES_FUNCTIONS_PDTR_HPP_INCLUDED
#include <nt2/include/simd.hpp>
#include <nt2/include/functor.hpp>

/*!
 * \ingroup cephes
 * \defgroup cephes_pdtr pdtr
 *
 * \par Description
 ...
 *   {
 *     template <class A0>
 *       meta::call<tag::pdtr_(A0,A0)>::type
 *       pdtr(const A0 & a0,const A0 & a1);
 *   }
 * }
 * \endcode
 *
...
namespace nt2 { namespace cephes { namespace tag
  {         
    ...
    **/
    struct pdtr_ : ext::elementwise_<pdtr_> {};
  }
  NT2_FUNCTION_IMPLEMENTATION(cephes::tag::pdtr_, pdtr, 2)
  } }
