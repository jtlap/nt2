 ...
 * \file
**/
#ifndef NT2_TOOLBOX_CEPHES_FUNCTIONS_IV_HPP_INCLUDED
#define NT2_TOOLBOX_CEPHES_FUNCTIONS_IV_HPP_INCLUDED
#include <nt2/include/simd.hpp>
#include <nt2/include/functor.hpp>

/*!
 * \ingroup cephes
 * \defgroup cephes_iv iv
 *
 * \par Description
 ...
 *   {
 *     template <class A0>
 *       meta::call<tag::iv_(A0,A0)>::type
 *       iv(const A0 & a0,const A0 & a1);
 *   }
 * }
 * \endcode
 *
...
namespace nt2 { namespace cephes { namespace tag
  {         
    ...
    **/
    struct iv_ : ext::elementwise_<iv_> {};
  }
  NT2_FUNCTION_IMPLEMENTATION(cephes::tag::iv_, iv, 2)
  } }
