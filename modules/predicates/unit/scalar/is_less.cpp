...
NT2_TEST_CASE_TPL ( is_less_integer__2_0,  NT2_INTEGRAL_TYPES)
{
  ...
  NT2_TEST_EQUAL(is_less(nt2::Mone<T>(), nt2::Mone<T>()), false);
  NT2_TEST_EQUAL(is_less(nt2::One<T>(), nt2::One<T>()), false);
...
NT2_TEST_CASE_TPL ( is_less_real__2_0,  NT2_REAL_TYPES)
{
  ...
  // specific values tests
  NT2_TEST_EQUAL(is_less(nt2::Inf<T>(), nt2::Inf<T>()), false);
  NT2_TEST_EQUAL(is_less(nt2::Minf<T>(), nt2::Minf<T>()), false);
