...
//////////////////////////////////////////////////////////////////////////////
#define NT2_UNIT_MODULE "nt2 predicates toolbox - is_nge/simd Mode"
...
NT2_TEST_CASE_TPL ( is_nge_real__2_0,  NT2_REAL_TYPES)
{
  ...
  typedef typename nt2::meta::call<is_nge_(vT,vT)>::type r_t;
  typedef typename nt2::meta::call<is_nge_(T,T)>::type sr_t;
    ...
    for(uint32_t j = 0; j < NR/cardinal_of<n_t>::value; j++)
      {
        ...
        for(int i = 0; i< cardinal_of<n_t>::value; i++)
        {
          ...
          NT2_TEST_EQUAL( v[i]!=0,ssr_t(nt2::is_nge(tab_a0[k],tab_a1[k])));
        }
      }
