...
namespace nt2 { namespace ext
{
  ...
  struct call<tag::is_nlt_(tag::simd_<tag::arithmetic_, tag::avx_),
...
{
  template<class Dummy>
  struct call<tag::is_nlt_(tag::simd_<tag::double_, tag::avx_),
...
{
  template<class Dummy>
  struct call<tag::is_nlt_(tag::simd_<tag::float_, tag::avx_),
