...
{
  NT2_FUNCTOR_IMPLEMENTATION( tag::is_inf_, tag::cpu_, (A0)(X)
                            , ((simd_<arithmetic_<A0>,X>))
                            )
  {
    typedef A0 result_type;
    NT2_FUNCTOR_CALL(1) { ignore_unused(a0); return False<A0>(); }
  };
  ...
  {
    typedef A0 result_type;
    NT2_FUNCTOR_CALL(1) { return is_equal(abs(a0),Inf<A0>()); }
  };
} }
