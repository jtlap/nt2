...
#include <nt2/toolbox/predicates/function/simd/common/is_nle.hpp>
...
namespace nt2 { namespace ext
{
  ...
  struct call<tag::is_nle_(tag::simd_<tag::double_, tag::sse_> ,
...
{
  template<class Dummy>
  struct call<tag::is_nle_(tag::simd_<tag::float_, tag::sse_> ,
