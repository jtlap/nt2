...
#include <nt2/include/functions/details/simd/sse/sse4_1/is_not_greater.hpp>
...
namespace nt2 { namespace ext
{
  ...
  struct call<tag::is_not_greater_(tag::simd_<tag::arithmetic_, tag::avx_),
...
{
  template<class Dummy>
  struct call<tag::is_not_greater_(tag::simd_<tag::double_, tag::avx_),
...
{
  template<class Dummy>
  struct call<tag::is_not_greater_(tag::simd_<tag::float_, tag::avx_),
