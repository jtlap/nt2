...
NT2_TEST_CASE_TPL ( asinh_real__1_0,  NT2_REAL_TYPES)
{
  ...
  NT2_TEST_ULP_EQUAL(nt2::asinh(cT(nt2::Zero<T>(), nt2::Zero<T>())),  cT(nt2::Zero<T>(), nt2::Pio_2<T>()), 0.75);
  ...
  NT2_TEST_ULP_EQUAL(nt2::asinh(cT(nt2::Nan  <T>(), nt2::Inf<T>())),  cT(nt2::Inf <T>(), nt2::Nan<T>()), 0.75);
...
// casinh(x + i $B!g(B) returns +$B!g(B + i-Fð /2 for positive-signed finite x.-A
// casinh(x + iNaN) returns NaN + iNaN and optionally raises the invalid floating-point exception, for finite x.
// casinh(+$B!g(B + iy) returns +$B!g(B + i0 for positive-signed finite y.
// casinh(+$B!g(B + i $B!g(B) returns +$B!g(B + i-Fð /4.-A
// casinh(+$B!g(B + iNaN) returns +$B!g(B + iNaN.
...
// casinh(NaN + i $B!g(B) returns ±$B!g(B + iNaN (where the sign of the real part of the resultis unspecified).
