...
//   std::cout << boost::math::atanh(cT(1.0, nt2::Inf<T>())) << "   " << boost::math::atanh(cT(1.0, 1.0/nt2::Eps<T>())) << std::endl;
//   std::cout << boost::math::atanh(cT(1.0, nt2::Inf<T>())) - boost::math::atanh(cT(1.0, 1.0/nt2::Eps<T>())) << std::endl;
  
//   std::cout << boost::math::atanh(cT(nt2::Eps<T>()/2, 1.0)) << "   " << boost::math::atanh(cT(nt2::Eps<T>()/2,1.0)) << std::endl;
//   std::cout << boost::math::atanh(cT(0.0, 1.0))   -         boost::math::atanh(cT(nt2::Eps<T>()/2, 1.0)) << std::endl; 
