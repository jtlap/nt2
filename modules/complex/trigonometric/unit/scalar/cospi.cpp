...
NT2_TEST_CASE_TPL ( cospi_real__1_0,  NT2_REAL_TYPES)
{
  ...
  NT2_TEST_ULP_EQUAL(nt2::cospi(cT(0.431, 0.431)),std::cos(nt2::Pi<T>()*cT(0.431, 0.431)), 3);
  NT2_TEST_ULP_EQUAL(nt2::cospi(cT(0.431, 0.628)),std::cos(nt2::Pi<T>()*cT(0.431, 0.628)), 3);
  NT2_TEST_ULP_EQUAL(nt2::cospi(cT(0.628, 0.431)),std::cos(nt2::Pi<T>()*cT(0.628, 0.431)), 3);
  NT2_TEST_ULP_EQUAL(nt2::cospi(cT(0.628, 0.628)),std::cos(nt2::Pi<T>()*cT(0.628, 0.628)), 3);
  NT2_TEST_ULP_EQUAL(nt2::cospi(cT(0, 0.431)),std::cos(nt2::Pi<T>()*cT(0.0, 0.431)), 3);
  NT2_TEST_ULP_EQUAL(nt2::cospi(cT(0, 0.628)),std::cos(nt2::Pi<T>()*cT(0.0, 0.628)), 3);
  NT2_TEST_ULP_EQUAL(nt2::cospi(cT(0.628, 0)),std::cos(nt2::Pi<T>()*cT(0.628, 0.0)), 3);
