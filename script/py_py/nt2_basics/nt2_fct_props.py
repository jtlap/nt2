...
#     def get_tb_name(self)  : return self.__tb_name
    ...
    def get_fct_dict_list(self) :
        s = self.__read_fct_info_dict()
        return s if isinstance(list,s) else [s]
...
##    PrettyPrinter().pprint(read(nfp.get_fct_impl_path('scalar')))
    PrettyPrinter().pprint(Nt2_fct_props("exponential","exp").get_fct_returns())
    PrettyPrinter().pprint(Nt2_fct_props("ieee","mantissa").get_fct_returns())
sys.path.pop(0)
