...
macro(nt2_module_add_library libname)
  ...
  if(${NT2_CURRENT_MODULE} MATCHES "^boost\\.")
    set(macro_name "${NT2_CURRENT_MODULE_U}_SOURCE")
    string(REPLACE "." "_" macro_name ${macro_name})
  else()
    set(macro_name "NT2_${NT2_CURRENT_MODULE_U}_SOURCE")
    string(REPLACE "." "__" macro_name ${macro_name})
  endif()
  set(FLAGS "${NT2_CURRENT_FLAGS} -D${macro_name}")
