...
#
#   topological_sort_u(my_list "MY_" "_EDGES")
#
...
# @verbatim
##############################################################################
# Modified from CMake Utilities to apply uppercase transform as described in
# documentation.
#
...
function(topological_sort_u LIST PREFIX SUFFIX)
  ...
  foreach(VERTEX ${VERTICES})
    ...
    if (NOT FOUND_${VERTEX})
      ...
      string(TOUPPER ${VERTEX} VERTEX_U)
      string(REPLACE ";" " " NEW_ELEMENT
        "${VERTEX};${${PREFIX}${VERTEX_U}${SUFFIX}}")
      ...
      while(STACK_LENGTH GREATER 0)
        ...
        while (OUT_DEGREE GREATER 0)
          ...
          if (NOT FOUND_${TARGET})
            ...
            set(SOURCE ${TARGET})
            string(TOUPPER ${SOURCE} SOURCE_U)
            set(OUT_EDGES
              ${${PREFIX}${SOURCE_U}${SUFFIX}})
...
endfunction(topological_sort_u)
