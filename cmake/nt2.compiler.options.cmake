...
SET( CMAKE_CXX_FLAGS_DEBUG "${CMAKE_CXX_FLAGS_DEBUG} ${NT2_FLAGS}")
...
MESSAGE( STATUS "NT2 compiled in Release mode with ${CMAKE_CXX_FLAGS_RELEASE}" )
SET( NT2_CURRENT_FLAGS ${CMAKE_CXX_FLAGS_RELEASE})
ENDIF()

IF( ${CMAKE_BUILD_TYPE} STREQUAL Debug )
MESSAGE( STATUS "NT2 compiled in Debug mode with ${CMAKE_CXX_FLAGS_DEBUG}" )
SET( NT2_CURRENT_FLAGS ${CMAKE_CXX_FLAGS_DEBUG})
ENDIF()

IF( ${CMAKE_BUILD_TYPE} STREQUAL RelWithDebInfo )
MESSAGE( STATUS "NT2 compiled  in RelWithDebInfo mode with ${CMAKE_CXX_FLAGS_RELWITHDEBINFO}" )
SET( NT2_CURRENT_FLAGS ${CMAKE_CXX_FLAGS_RELWITHDEBINFO})
ENDIF()

IF( ${CMAKE_BUILD_TYPE} STREQUAL MinSizeRel )
MESSAGE( STATUS "NT2 compiled in MinSizeRel mode with ${CMAKE_CXX_FLAGS_MINSIZEREL}" )
