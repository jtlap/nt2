...
function(nt2_find_module COMPONENT)
  ...
  if(NT2_${COMPONENT_U}_ROOT)
    ...
    if(EXISTS ${NT2_${COMPONENT_U}_ROOT}/src/CMakeLists.txt)
  ...
  if(ARGC EQUAL 0)
    if(NT2_SOURCE_ROOT)
      ...
      while(i LESS len)
        ...
        if(${module} MATCHES boostification OR EXISTS ${NT2_SOURCE_ROOT}/modules/${module_path}/experimental)
        ...
        elseif(NOT EXISTS ${NT2_SOURCE_ROOT}/modules/${module_path}/CMakeLists.txt)
          ...
          foreach(NT2_COMPONENT ${NT2_COMPONENTS_})
            string(REPLACE "/" "." NT2_COMPONENT ${NT2_COMPONENT})
            if(NOT ${NT2_COMPONENT} MATCHES "^extern\\.")
