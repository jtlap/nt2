    ...
    if(NT2_${EXTRA_COMPONENT_U}_FOUND)
      ...
      if(NOT NT2_${EXTRA_COMPONENT_U}_DEPENDENCIES_FOUND)
        ...
        if(DEFINED NT2_${EXTRA_COMPONENT_U}_LIBRARIES)
          set(NT2_${EXTRA_COMPONENT_U}_LIBRARIES_)
          foreach(lib ${NT2_${EXTRA_COMPONENT_U}_LIBRARIES})
            list(APPEND NT2_${EXTRA_COMPONENT_U}_LIBRARIES_ optimized ${lib} debug ${lib}_d)
          endforeach()
          set(NT2_${EXTRA_COMPONENT_U}_LIBRARIES ${NT2_${EXTRA_COMPONENT_U}_LIBRARIES_})
          list(APPEND NT2_${COMPONENT_U}_DEPENDENCIES_LIBRARIES ${NT2_${EXTRA_COMPONENT_U}_LIBRARIES})
        endif()
