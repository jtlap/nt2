...
function(nt2_find_module COMPONENT)
  ...
  set(NT2_${COMPONENT_U}_DEPENDENCIES_EXTRA ${COMPONENT})
  set(NT2_${COMPONENT_U}_EXTRA)
  while(NT2_${COMPONENT_U}_DEPENDENCIES_FOUND AND NT2_${COMPONENT_U}_DEPENDENCIES_EXTRA)
    list(GET NT2_${COMPONENT_U}_DEPENDENCIES_EXTRA 0 EXTRA_COMPONENT)
    ...
    if(NT2_${EXTRA_COMPONENT_U}_FOUND)
      ...
      if(NOT NT2_${EXTRA_COMPONENT_U}_DEPENDENCIES_FOUND)
        ...
        nt2_append_if(NT2_${COMPONENT_U}_DEPENDENCIES_INCLUDE_DIR NT2_${EXTRA_COMPONENT_U}_INCLUDE_ROOT NT2_${EXTRA_COMPONENT_U}_DEPENDENCIES_INCLUDE_DIR)
    ...
    list(REMOVE_DUPLICATES NT2_${COMPONENT_U}_DEPENDENCIES_EXTRA)
    list(REMOVE_ITEM NT2_${COMPONENT_U}_DEPENDENCIES_EXTRA ${NT2_${COMPONENT_U}_EXTRA})
  ...
  foreach(EXTRA_COMPONENT ${NT2_${COMPONENT_U}_EXTRA})
    ...
    if(NOT NT2_${EXTRA_COMPONENT_U}_FOUND)
      ...
      set(NT2_${EXTRA_COMPONENT_U}_INCLUDE_DIR ${NT2_${COMPONENT_U}_DEPENDENCIES_INCLUDE_DIR})
      set(NT2_${EXTRA_COMPONENT_U}_LIBRARY_DIR ${NT2_${COMPONENT_U}_DEPENDENCIES_LIBRARY_DIR})
      set(NT2_${EXTRA_COMPONENT_U}_LIBRARIES ${NT2_${COMPONENT_U}_DEPENDENCIES_LIBRARIES})
      set(NT2_${EXTRA_COMPONENT_U}_FLAGS ${NT2_${COMPONENT_U}_DEPENDENCIES_FLAGS})
