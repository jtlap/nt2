...
NT2_TEST_CASE(default_ctor)
{
  ...
  NT2_TEST_EQUAL(empty,"");
  NT2_TEST_EQUAL(empty.size(),0U);
}

////////////////////////////////////////////////////////////////////////////////
// Test sys::string formating constructor
////////////////////////////////////////////////////////////////////////////////
NT2_TEST_CASE(format_ctor)
{
  nt2::sys::string s("%1.1f %d %s",0.1,42,"lol");

  NT2_TEST_EQUAL(s,"0.1 42 lol");
  NT2_TEST_EQUAL(s.size(),10U);
}

////////////////////////////////////////////////////////////////////////////////
// Test sys::string copy constructor
////////////////////////////////////////////////////////////////////////////////
NT2_TEST_CASE(copy_ctor)
{
  nt2::sys::string origin("origin");
  nt2::sys::string copy(origin);

  NT2_TEST_EQUAL(origin,copy);
}
...
////////////////////////////////////////////////////////////////////////////////
NT2_TEST_CASE(compare_string)
{
  nt2::sys::string string1("string1");
  nt2::sys::string string2("string2");
  nt2::sys::string string1b(string1);

  NT2_TEST_EQUAL(string1,string1b);
  NT2_TEST_EQUAL(string1b,string1);
  NT2_TEST_EQUAL(string1,"string1");
  NT2_TEST_EQUAL("string1",string1);

  NT2_TEST_NOT_EQUAL(string1,string2);
  NT2_TEST_NOT_EQUAL(string2,string1);
  NT2_TEST_NOT_EQUAL(string1,"string2");
  NT2_TEST_NOT_EQUAL("string2",string1);
}
...
////////////////////////////////////////////////////////////////////////////////
NT2_TEST_CASE(assign_cstr)
{
  nt2::sys::string copy;
  copy = "origin";

  NT2_TEST_EQUAL(copy,"origin");
}
