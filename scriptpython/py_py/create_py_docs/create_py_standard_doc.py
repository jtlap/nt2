...
class Mk_doc_skeleton_for_standard(Create_py_doc_base) :
    ...
    def get_property_call(self,arity)   :
        ...
        call = "nt2::standard::%s(%s)"% (self.get_fct_name(),call_param)
...
if __name__ == "__main__" :
    ntp = Nt2_tb_props("standard")
    fcts = ntp.get_fcts_list()
##    fcts = ["abs"]
    for fct in  fcts :
        print(fct)
        mds = Mk_doc_skeleton_for_standard(fct)
##//        print(mds)
