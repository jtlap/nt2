...
class Mk_doc_skeleton_for_ast(Create_py_doc_base) :
    def __init__(self, fct_name) :
        Create_py_doc_base.__init__(self, "ast", fct_name)
    ...
    def get_property_call(self,arity)   :
        ...
        call = "nt2::ast::%s(%s)"% (self.get_fct_name(),call_param)
...
##    fcts = ["acosh"]
    for fct in  fcts :
        print(fct)
        mds = Mk_doc_skeleton_for_ast(fct)
