...
from create_py_doc                   import Mk_doc_skeleton
sys.path.pop(0)
sys.path.pop(0)
  

class Mk_doc_skeleton_for_exp(Mk_doc_skeleton) :
    def __init__(self, fct_name) :
        Mk_doc_skeleton.__init__(self, "exponential", fct_name)
