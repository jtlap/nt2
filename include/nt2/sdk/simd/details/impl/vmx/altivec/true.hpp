...
namespace nt2 { namespace ext
{
  ...
  struct  call< tag::true_( tag::target_(tag::simd_(tag::arithmetic_,tag::altivec_)) )
              , tag::cpu_
              , Dummy
              >
        : callable
  {
    ...
    NT2_FUNCTOR_CALL(1)
    {
      ...
      typedef typename type::native_type        native_type;
      type that = { (native_type)(vec_splat_u8(-1)) };
      return that;
    }
  };
} }
