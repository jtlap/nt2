                ...
                , const char* name = NULL )
{
  ...
  // output value
  typedef typename boost::result_of<Func(r_in0,r_in1,r_in2)>::type  out_t;
  typedef typename nt2::meta::scalar_of<out_t>::type                rout_t;
  static out_t                                                      out;

  // Input samples
  static std::vector<t_in0/*, nt2::simd::allocator<t_in0> */>  in0(size);
  static std::vector<t_in1/*, nt2::simd::allocator<t_in1> */>  in1(size);
  static std::vector<t_in2/*, nt2::simd::allocator<t_in1> */>  in2(size);
