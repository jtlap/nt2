...
namespace nt2
{
  ...
  NT2_FUNCTION_IMPLEMENTATION(functors::bitwise_xor_      , bit_xor         , 2 )
  NT2_FUNCTION_IMPLEMENTATION(functors::bitwise_xor_      , b_xor           , 2 )
  NT2_FUNCTION_IMPLEMENTATION(functors::bitwise_or_       , bitwise_or      , 2 )
  NT2_FUNCTION_IMPLEMENTATION(functors::bitwise_or_       , bit_or          , 2 )
  NT2_FUNCTION_IMPLEMENTATION(functors::bitwise_or_       , b_or            , 2 )
  NT2_FUNCTION_IMPLEMENTATION(functors::bitwise_and_      , bitwise_and     , 2 )
  NT2_FUNCTION_IMPLEMENTATION(functors::bitwise_and_      , bit_and         , 2 )
  NT2_FUNCTION_IMPLEMENTATION(functors::bitwise_and_      , b_and           , 2 )
  NT2_FUNCTION_IMPLEMENTATION(functors::is_equal_         , equal_to        , 2 )
  NT2_FUNCTION_IMPLEMENTATION(functors::is_equal_         , eq              , 2 )
  NT2_FUNCTION_IMPLEMENTATION(functors::is_equal_         , is_equal_to     , 2 )
  NT2_FUNCTION_IMPLEMENTATION(functors::is_equal_         , iseq            , 2 )
  NT2_FUNCTION_IMPLEMENTATION(functors::is_equal_         , is_eq           , 2 )
  NT2_FUNCTION_IMPLEMENTATION(functors::is_not_equal_     , not_equal_to    , 2 )
  NT2_FUNCTION_IMPLEMENTATION(functors::is_not_equal_     , neq             , 2 )
  NT2_FUNCTION_IMPLEMENTATION(functors::is_not_equal_     , is_not_equal_to , 2 )
  NT2_FUNCTION_IMPLEMENTATION(functors::is_not_equal_     , isnotequalto    , 2 )
  NT2_FUNCTION_IMPLEMENTATION(functors::is_not_equal_     , isneq           , 2 )
  NT2_FUNCTION_IMPLEMENTATION(functors::is_not_equal_     , is_neq          , 2 )
  NT2_FUNCTION_IMPLEMENTATION(functors::is_less_          , less            , 2 )
  NT2_FUNCTION_IMPLEMENTATION(functors::is_less_          , lt              , 2 )
  NT2_FUNCTION_IMPLEMENTATION(functors::is_less_          , isless          , 2 )
  NT2_FUNCTION_IMPLEMENTATION(functors::is_less_          , islt            , 2 )
  NT2_FUNCTION_IMPLEMENTATION(functors::is_less_          , is_less         , 2 )
  NT2_FUNCTION_IMPLEMENTATION(functors::is_less_          , is_lt           , 2 )
  NT2_FUNCTION_IMPLEMENTATION(functors::is_greater_       , greater         , 2 )
  NT2_FUNCTION_IMPLEMENTATION(functors::is_greater_       , gt              , 2 )
  NT2_FUNCTION_IMPLEMENTATION(functors::is_greater_       , is_greater      , 2 )
  NT2_FUNCTION_IMPLEMENTATION(functors::is_greater_       , is_gt           , 2 )
  NT2_FUNCTION_IMPLEMENTATION(functors::is_greater_       , isgreater       , 2 )
  NT2_FUNCTION_IMPLEMENTATION(functors::is_greater_       , isgt            , 2 )
  NT2_FUNCTION_IMPLEMENTATION(functors::is_less_equal_    , less_equal      , 2 )
  ...
  NT2_FUNCTION_IMPLEMENTATION(functors::is_less_equal_    , is_le           , 2 )
  NT2_FUNCTION_IMPLEMENTATION(functors::is_less_equal_    , islessequal     , 2 )
  NT2_FUNCTION_IMPLEMENTATION(functors::is_less_equal_    , isle            , 2 )
  NT2_FUNCTION_IMPLEMENTATION(functors::is_greater_equal_ , greater_equal   , 2 )
  ...
  NT2_FUNCTION_IMPLEMENTATION(functors::is_greater_equal_ , is_ge           , 2 )
  NT2_FUNCTION_IMPLEMENTATION(functors::is_greater_equal_ , isgreaterequal  , 2 )
  NT2_FUNCTION_IMPLEMENTATION(functors::is_greater_equal_ , isge            , 2 )
