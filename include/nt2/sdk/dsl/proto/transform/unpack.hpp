...
#define N BOOST_PP_ITERATION()
        ...
        : transform_impl<Expr, State, Data>
    {
        typedef typename mpl::if_c<
              ...
              , proto::call<Fun(BOOST_PP_ENUM(N, BOOST_PROTO_CHILD_N, _), proto::_state, proto::_data)>
              , proto::make<Fun(BOOST_PP_ENUM(N, BOOST_PROTO_CHILD_N, _), proto::_state, proto::_data)>
            >::type
            which;
    ...
    template <typename Fun, typename E, typename Expr, typename State, typename Data>
    ...
    template <typename Fun, typename E, typename S, typename Expr, typename State, typename Data>
    ...
    template <typename Fun, typename E, typename S, typename D, typename Expr, typename State, typename Data>
