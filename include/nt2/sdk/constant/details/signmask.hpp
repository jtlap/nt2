...
NT2_REGISTER_DISPATCH(tag::signmask_,tag::cpu_,(A0), (const_< double_<A0>    > ) )
NT2_REGISTER_DISPATCH(tag::signmask_,tag::cpu_,(A0), (const_< float_<A0>     > ) )
NT2_REGISTER_DISPATCH(tag::signmask_,tag::cpu_,(A0), (const_< unsigned_<A0>  > ) )
NT2_REGISTER_DISPATCH(tag::signmask_,tag::cpu_,(A0), (const_< signed_<A0>    > ) )

namespace nt2 { namespace ext
{
  template<class Dummy>
  struct  call< tag::signmask_(tag::const_(tag::double_) )
              , tag::cpu_
              , Dummy
              >
        : callable
  ...
  template<class Dummy>
  struct  call< tag::signmask_(tag::const_(tag::float_) )
              , tag::cpu_
              , Dummy
              >
        : callable
  ...
  template<class Dummy>
  struct  call< tag::signmask_(tag::const_(tag::unsigned_) )
              , tag::cpu_
              , Dummy
              >
        : callable
  ...
  template<class Dummy>
  struct  call< tag::signmask_(tag::const_(tag::signed_) )
              , tag::cpu_
              , Dummy
              >
        : callable
