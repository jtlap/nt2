...
NT2_TEST_CASE_TPL ( nextpow2_real_,  NT2_REAL_TYPES)
{
  using nt2::nextpow2;
...
NT2_TEST_CASE_TPL ( nextpow2_unsigned_int_,  NT2_UNSIGNED_TYPES)
{
  using nt2::nextpow2;
  using nt2::functors::nextpow2_;
  typedef typename nt2::meta::call<nextpow2_(T)>::type r_t;
...
NT2_TEST_CASE_TPL ( nextpow2_signed_int_,  NT2_INTEGRAL_SIGNED_TYPES)
{
  using nt2::nextpow2;
  using nt2::functors::nextpow2_;
  typedef typename nt2::meta::call<nextpow2_(T)>::type r_t;
