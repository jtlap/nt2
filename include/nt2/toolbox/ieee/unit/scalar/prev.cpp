...
NT2_TEST_CASE_TPL ( prev_real_,  NT2_REAL_TYPES)
{
  using nt2::prev;
...
NT2_TEST_CASE_TPL ( prev_unsigned_int_,  NT2_UNSIGNED_TYPES)
{
  using nt2::prev;
  using nt2::functors::prev_;
  typedef typename nt2::meta::call<prev_(T)>::type r_t;
...
NT2_TEST_CASE_TPL ( prev_signed_int_,  NT2_INTEGRAL_SIGNED_TYPES)
{
  using nt2::prev;
  using nt2::functors::prev_;
  typedef typename nt2::meta::call<prev_(T)>::type r_t;
