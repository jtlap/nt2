...
NT2_TEST_CASE_TPL ( round2even_real_,  NT2_REAL_TYPES)
{
...
NT2_TEST_CASE_TPL ( round2even_unsigned_int_,  NT2_UNSIGNED_TYPES)
{
  using nt2::round2even;
  using nt2::functors::round2even_;
  typedef typename nt2::meta::call<round2even_(T)>::type r_t;
...
NT2_TEST_CASE_TPL ( round2even_signed_int_,  NT2_INTEGRAL_SIGNED_TYPES)
{
  using nt2::round2even;
  using nt2::functors::round2even_;
  typedef typename nt2::meta::call<round2even_(T)>::type r_t;
