...
NT2_TEST_CASE_TPL ( maxnummag_real__2_0,  NT2_REAL_TYPES)
{
  ...
  NT2_TEST_EQUAL(maxnummag(nt2::Inf<T>(), nt2::Inf<T>()), nt2::Inf<r_t>());
  NT2_TEST_EQUAL(maxnummag(nt2::Minf<T>(), nt2::Minf<T>()), nt2::Minf<r_t>());
  NT2_TEST_EQUAL(maxnummag(nt2::Mone<T>(), nt2::Mone<T>()), nt2::Mone<r_t>());
  NT2_TEST_EQUAL(maxnummag(nt2::Nan<T>(), nt2::Nan<T>()), nt2::Nan<r_t>());
  NT2_TEST_EQUAL(maxnummag(nt2::Nan<T>(),nt2::One<T>()), nt2::One<r_t>());
    ...
    for (uint32_t j =0; j < NR; ++j )
      {
        std::cout << "for params "
                  ...
                  << ", a1 = "<< u_t(a1 = tab_a1[j])
                  << std::endl;
        NT2_TEST_EQUAL( nt2::maxnummag(a0,a1),(nt2::abs(a0) > nt2::abs(a1)) ? a0 : a1);
     }
     
   }
} // end of test for real_

NT2_TEST_CASE_TPL ( maxnummag_unsigned_int__2_0,  NT2_UNSIGNED_TYPES)
{
...
NT2_TEST_CASE_TPL ( maxnummag_signed_int__2_0,  NT2_INTEGRAL_SIGNED_TYPES)
{
