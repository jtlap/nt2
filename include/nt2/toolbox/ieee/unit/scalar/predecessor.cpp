...
NT2_TEST_CASE_TPL ( predecessor_real_,  NT2_REAL_TYPES)
{
...
NT2_TEST_CASE_TPL ( predecessor_unsigned_int_,  NT2_UNSIGNED_TYPES)
{
  using nt2::predecessor;
  using nt2::functors::predecessor_;
  typedef typename nt2::meta::call<predecessor_(T)>::type r_t;
...
NT2_TEST_CASE_TPL ( predecessor_signed_int_,  NT2_INTEGRAL_SIGNED_TYPES)
{
  using nt2::predecessor;
  using nt2::functors::predecessor_;
  typedef typename nt2::meta::call<predecessor_(T)>::type r_t;
