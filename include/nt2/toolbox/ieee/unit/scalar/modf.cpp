...
NT2_TEST_CASE_TPL ( modf_real_,  NT2_REAL_TYPES)
{
  using nt2::modf;
    ...
    for (int j =0; j < NR; ++j )
      {
        std::cout << "for param "
                  ...
                  << std::endl;
        r_t r = nt2::modf(a0);
        NT2_TEST_TUPLE_ULP_EQUAL( boost::fusion::get<0>(r), nt2::frac(a0),0);
        NT2_TEST_TUPLE_ULP_EQUAL( boost::fusion::get<1>(r), nt2::trunc(a0),0);
     }
   }
} // end of test for real_

NT2_TEST_CASE_TPL ( modf_unsigned_int_,  NT2_UNSIGNED_TYPES)
{
  using nt2::modf;
  using nt2::functors::modf_;
  typedef typename nt2::meta::call<modf_(T)>::type r_t;
...
NT2_TEST_CASE_TPL ( modf_signed_int_,  NT2_INTEGRAL_SIGNED_TYPES)
{
  using nt2::modf;
  using nt2::functors::modf_;
  typedef typename nt2::meta::call<modf_(T)>::type r_t;
