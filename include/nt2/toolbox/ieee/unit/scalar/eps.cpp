...
NT2_TEST_CASE_TPL ( eps_real_,  NT2_REAL_TYPES)
{
  using nt2::eps;
...
NT2_TEST_CASE_TPL ( eps_unsigned_int_,  NT2_UNSIGNED_TYPES)
{
  using nt2::eps;
  using nt2::functors::eps_;
  typedef typename nt2::meta::call<eps_(T)>::type r_t;
...
NT2_TEST_CASE_TPL ( eps_signed_int_,  NT2_INTEGRAL_SIGNED_TYPES)
{
  using nt2::eps;
  using nt2::functors::eps_;
  typedef typename nt2::meta::call<eps_(T)>::type r_t;
