...
NT2_TEST_CASE_TPL ( ulpdist_real_,  NT2_REAL_TYPES)
{
  using nt2::ulpdist;
...
NT2_TEST_CASE_TPL ( ulpdist_unsigned_int_,  NT2_UNSIGNED_TYPES)
{
  using nt2::ulpdist;
  using nt2::functors::ulpdist_;
  typedef typename nt2::meta::call<ulpdist_(T, T)>::type r_t;
...
NT2_TEST_CASE_TPL ( ulpdist_signed_int_,  NT2_INTEGRAL_SIGNED_TYPES)
{
  using nt2::ulpdist;
  using nt2::functors::ulpdist_;
  typedef typename nt2::meta::call<ulpdist_(T, T)>::type r_t;
