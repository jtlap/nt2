...
NT2_TEST_CASE_TPL ( ulp_real_,  NT2_REAL_TYPES)
{
  using nt2::ulp;
  ...
  NT2_TEST_ULP_EQUAL(  ulp(nt2::Inf<T>()), nt2::Inf<r_t>(), 0);
  NT2_TEST_ULP_EQUAL(  ulp(nt2::Minf<T>()), nt2::Inf<r_t>(), 0);
  NT2_TEST_ULP_EQUAL(  ulp(nt2::Mone<T>()), nt2::Eps<r_t>()/2, 0);
...
NT2_TEST_CASE_TPL ( ulp_unsigned_int_,  NT2_UNSIGNED_TYPES)
{
  using nt2::ulp;
  using nt2::functors::ulp_;
  typedef typename nt2::meta::call<ulp_(T)>::type r_t;
...
NT2_TEST_CASE_TPL ( ulp_signed_int_,  NT2_INTEGRAL_SIGNED_TYPES)
{
  using nt2::ulp;
  using nt2::functors::ulp_;
  typedef typename nt2::meta::call<ulp_(T)>::type r_t;
