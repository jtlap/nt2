...
NT2_TEST_CASE_TPL ( sbits_real_,  NT2_REAL_TYPES)
{
  using nt2::sbits;
...
NT2_TEST_CASE_TPL ( sbits_unsigned_int_,  NT2_UNSIGNED_TYPES)
{
  using nt2::sbits;
  using nt2::functors::sbits_;
  typedef typename nt2::meta::call<sbits_(T)>::type r_t;
...
NT2_TEST_CASE_TPL ( sbits_signed_int_,  NT2_INTEGRAL_SIGNED_TYPES)
{
  using nt2::sbits;
  using nt2::functors::sbits_;
  typedef typename nt2::meta::call<sbits_(T)>::type r_t;
