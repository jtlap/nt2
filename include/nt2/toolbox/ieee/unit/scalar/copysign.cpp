...
NT2_TEST_CASE_TPL ( copysign_real__2,  NT2_REAL_TYPES)
{
  ...
  NT2_TEST_EQUAL(copysign(nt2::Inf<T>(), nt2::Inf<T>()), nt2::Inf<r_t>());
  NT2_TEST_EQUAL(copysign(nt2::Minf<T>(), nt2::Minf<T>()), nt2::Minf<r_t>());
  NT2_TEST_EQUAL(copysign(nt2::Mone<T>(), nt2::Mone<T>()), nt2::Mone<r_t>());
  NT2_TEST_EQUAL(copysign(nt2::Nan<T>(), nt2::Nan<T>()), nt2::Nan<r_t>());
