...
NT2_TEST_CASE_TPL ( negate_real_,  NT2_REAL_TYPES)
{
  using nt2::negate;
...
NT2_TEST_CASE_TPL ( negate_unsigned_int_,  NT2_UNSIGNED_TYPES)
{
  using nt2::negate;
  using nt2::functors::negate_;
  typedef typename nt2::meta::call<negate_(T, T)>::type r_t;
...
NT2_TEST_CASE_TPL ( negate_signed_int_,  NT2_INTEGRAL_SIGNED_TYPES)
{
  using nt2::negate;
  using nt2::functors::negate_;
  typedef typename nt2::meta::call<negate_(T, T)>::type r_t;
