...
NT2_TEST_CASE_TPL ( minmag_real_,  NT2_REAL_TYPES)
{
  using nt2::minmag;
    ...
    for (int j =0; j < NR; ++j )
      {
        std::cout << "for params "
                  ...
                  << ", a1 = "<< u_t(a1 = tab_a1[j])
                  << std::endl;
        NT2_TEST_ULP_EQUAL( nt2::minmag(a0,a1), (nt2::abs(a0) < nt2::abs(a1)) ? a0 : a1,0);
     }
   }
} // end of test for real_

NT2_TEST_CASE_TPL ( minmag_unsigned_int_,  NT2_UNSIGNED_TYPES)
{
  using nt2::minmag;
  using nt2::functors::minmag_;
  typedef typename nt2::meta::call<minmag_(T, T)>::type r_t;
...
NT2_TEST_CASE_TPL ( minmag_signed_int_,  NT2_INTEGRAL_SIGNED_TYPES)
{
  using nt2::minmag;
  using nt2::functors::minmag_;
  typedef typename nt2::meta::call<minmag_(T, T)>::type r_t;
