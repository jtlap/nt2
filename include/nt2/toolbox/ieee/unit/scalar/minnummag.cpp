...
NT2_TEST_CASE_TPL ( minnummag,  NT2_INTEGRAL_SIGNED_TYPES
                  )
{
  using nt2::minnummag;
  ...
  NT2_TEST_EQUAL(  minnummag( T(42), T(-13) ), T(-13) );
}
NT2_TEST_CASE_TPL ( real_minnummag,  NT2_REAL_TYPES
                  )
{
  using nt2::minnummag;
  using nt2::tag::minnummag_;
  ...
  NT2_TEST_EQUAL(  minnummag( T(-42), T(-12)), T(-12) );
  NT2_TEST_EQUAL(  minnummag( T(42), T(13) ), T(13) );
  NT2_TEST_EQUAL(  minnummag( T(nt2::Nan<T>()), T(13) ), T(13) );
}
          
NT2_TEST_CASE_TPL ( unsigned_minnummag,  NT2_UNSIGNED_TYPES
                  )
{
  using nt2::minnummag;
  using nt2::tag::minnummag_;
