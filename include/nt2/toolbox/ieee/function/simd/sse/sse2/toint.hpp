...
namespace nt2 { namespace ext
{
  ...
  struct call<tag::toint_(tag::simd_(tag::arithmetic_, tag::see_)),
...
{
  template<class Dummy>
  struct call<tag::toint_(tag::simd_(tag::double_, tag::see_)),
              tag::cpu_, Dummy> : callable
  {
    template<class Sig> struct result;
    template<class This,class A0>
...
{
  template<class Dummy>
  struct call<tag::toint_(tag::simd_(tag::float_, tag::see_)),
              tag::cpu_, Dummy> : callable
  {
    template<class Sig> struct result;
    template<class This,class A0>
