		    ...
		    )
{
  ...
  const int N = 2; 
   ...
   NT2_TEST_EQUAL(  nt2::exp( T(0) )  , 1 );
   NT2_TEST_LESSER_EQUAL(  nt2::ulpdist( nt2::exp( T(1) )  , nt2::Exp_1<T>() ), 0.5  );
   NT2_TEST_EQUAL(  nt2::exp(nt2::Minf<T>() ), T(0.0)); 

   for(int i=0; i < 10; i++)
     {
       T x =  i; 
       NT2_TEST_LESSER(nt2::ulpdist(x, nt2::log(nt2::exp(x))), 1); 
     }
}
