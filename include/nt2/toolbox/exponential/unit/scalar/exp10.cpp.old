		    ...
		    )
{
  ...
  const int N = 2; 
   ...
   NT2_TEST_EQUAL(  nt2::exp10( T(0) )  , 1 );
   NT2_TEST_EQUAL(  nt2::exp10( T(1) )  , T(10) );
   NT2_TEST_EQUAL(  nt2::exp10(nt2::Minf<T>() ), T(0.0)); 

   for(int i=0; i < 10; i++)
     {
       T x =  i; 
       NT2_TEST_LESSER(nt2::ulpdist(x, nt2::log10(nt2::exp10(x))), 2); 
     }
}
