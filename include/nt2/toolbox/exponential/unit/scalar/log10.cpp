...
NT2_TEST_CASE_TPL ( log10_real__1,  NT2_REAL_TYPES)
{
  using nt2::log10;
  ...
  {
    NT2_CREATE_SCALAR_BUFFER(a0,T, NR, T(0.1), T(10));
    ...
    for (int j =0; j < NR; ++j )
      {
        std::cout << "for param "
                  << "  a0 = "<< u_t(a0 = tab_a0[j])
                  << std::endl;
        NT2_TEST_ULP_EQUAL( nt2::log10(a0),cephes_log10l(a0),0.5);
        ulp0=nt2::max(ulpd,ulp0);
        NT2_TEST_ULP_EQUAL( nt2::log10(nt2::exp10(a0)),a0,1.5);
        ulp0=nt2::max(ulpd,ulp0);
        NT2_TEST_ULP_EQUAL( nt2::log10(nt2::sqr(a0)),2*log10(a0),2.5);
        ulp0=nt2::max(ulpd,ulp0);
     }
...
NT2_TEST_CASE_TPL ( log10_unsigned_int__1,  NT2_UNSIGNED_TYPES)
{
  using nt2::log10;
  using nt2::tag::log10_;
  typedef typename nt2::meta::as_integer<T>::type iT;
...
NT2_TEST_CASE_TPL ( log10_signed_int__1,  NT2_INTEGRAL_SIGNED_TYPES)
{
  using nt2::log10;
  using nt2::tag::log10_;
  typedef typename nt2::meta::as_integer<T>::type iT;
