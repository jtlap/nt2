		    ...
		    )
{
  ...
  const int N = 2; 
   ...
   NT2_TEST_EQUAL(  nt2::log10( T(1) )  , 0 );
   NT2_TEST_EQUAL(  nt2::log10( T(0) )  , nt2::Minf<T>() );
   NT2_TEST_EQUAL(  nt2::log10( nt2::Inf<T>() )  , nt2::Inf<T>() );
   NT2_TEST_EQUAL(  nt2::log10(T(10) ), T(1)); 
   NT2_TEST(  nt2::is_nan(log10(nt2::Nan<T>() ))); 
   for(int i=1; i < 100; i++)
     {
       T x =  i; 
       NT2_TEST_LESSER_EQUAL(nt2::ulpdist(x, nt2::exp10(nt2::log10(x))), 2); 
     }
}
