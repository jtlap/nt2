[{'functor': {'arity': '1',
  ...
  'unit': {'global_header': {'first_stamp': 'modified by jt the 08/12/2010',
           ...
           'specific_values': {'default': {},
                               ...
                               'signed_int_': {'nt2::Mone<T>()': 'nt2::One<r_t>()/10',
                                               'nt2::One<T>()': 'nt2::Ten<r_t>()',
                                               'nt2::Zero<T>()': 'nt2::One<r_t>()'},
                               'unsigned_int_': {'nt2::One<T>()': 'nt2::Ten<r_t>()',
                                                 'nt2::Zero<T>()': 'nt2::One<r_t>()'}},
           'verif_test': {'property_call' : {'real_': ['nt2::log10(nt2::exp10(a0))'], 'default' : []},
                          'property_value': {'real_': ['T(a0)'],'default' : []},
