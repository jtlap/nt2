...
//////////////////////////////////////////////////////////////////////////////
#define NT2_UNIT_MODULE "nt2 polynomials toolbox - plevl - unit/simd Mode"
...
NT2_TEST_CASE_TPL(plevl, NT2_REAL_TYPES )
{
 ...
 typedef typename nt2::meta::call<plevl_(n_t, boost::array<rT,4> )>::type call_type;
 ...
 for(int num = 0; num < 10; num++)
   {
     for(std::size_t i=0;i<1*cardinal_of<n_t>::value;++i){
       data[i] = nt2::random(0.0, 100.0); // good value here for plevl
     }
