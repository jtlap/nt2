...
namespace nt2 { namespace functors
{
  ...
  //  no special validate for fast_tanpi
  ...
  /////////////////////////////////////////////////////////////////////////////
  template<class Info>
  struct  call<fast_tanpi_,tag::scalar_(tag::arithmetic_),real_,Info> : callable
  {
    ...
    NT2_FUNCTOR_CALL(1)
    {
      return impl::trig_base<A0,pi_tag, fast_tag, tag::not_simd_type>::tana(a0);
    }
  };
  ...
  /////////////////////////////////////////////////////////////////////////////
  template<class Info>
  struct  call<fast_tanpi_,tag::scalar_(tag::arithmetic_),arithmetic_,Info> : callable
  {
    template<class Sig> struct result;
    template<class This,class A0>
    struct result<This(A0)> : 
