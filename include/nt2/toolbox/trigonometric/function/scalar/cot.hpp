...
namespace nt2 { namespace functors
{
  ...
  /////////////////////////////////////////////////////////////////////////////
  template<class Info>
  struct  call<cot_,tag::scalar_(tag::arithmetic_),fundamental_,Info> : callable
  {
    ...
    NT2_FUNCTOR_CALL(1)
    {
      ...
      return impl::trig_base<type,radian_tag,trig_tag,tag::not_simd_type>::cota(type(a0));
    }
