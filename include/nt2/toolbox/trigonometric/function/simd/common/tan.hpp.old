...
namespace nt2 { namespace functors
{
  ...
  struct validate<tan_,tag::simd_(tag::arithmetic_,Extension),Info>
  {
  ...
  /////////////////////////////////////////////////////////////////////////////
  template<class Extension, class Info>
  struct call<tan_,tag::simd_(tag::arithmetic_,Extension),fundamental_,Info> : callable
  {
    template<class Sig> struct result;
    template<class This,class A0>
    ...
    NT2_FUNCTOR_CALL(1)
    {
      ...
      return impl::trig_base<type,radian_tag, trig_tag, tag::simd_type>::tana(tofloat(a0));
    }
