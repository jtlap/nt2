...
{
    'functor' : {       ## intrinsics values related to functor acscd
    ...
    'unit'    : {       ## informations for creating unit tests
        'global_header' : { ## header of machin.cpp
            ...
            'notes'       : ['asin(1/a0)*Radindeg'],        ## list of strings that will be included in a
                                            ## global comment
            },
        'specific_values' : {
                'real_'       : {
        ...
        'verif_test'      : { ## verification dictionary
            'property_call'   : {'real_' : ['nt2::acscd(a0)'],},  ## dictionary of calls per types
            'property_value'  : {'real_' : ['nt2::crlibm::asin<nt2::rn>(nt2::rec(a0))*nt2::Radindeg<T>()'],}, ## dictionary of alternate calls
