...
{
    'functor' : {       ## intrinsics values related to functor asin
    ...
    'unit'    : {       ## informations for creating unit tests
        ...
        'verif_test'      : { ## verification dictionary
            'property_call'   : {'real_' : ['nt2::asin(a0)'],},  ## dictionary of calls per types
            'property_value'  : {'real_' : ['nt2::crlibm::asin<nt2::rn>(a0)'],}, ## dictionary of alternate calls
