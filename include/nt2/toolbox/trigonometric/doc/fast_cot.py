...
{
    'functor' : {       ## intrinsics values related to functor fast_cot
    ...
    'unit'    : {       ## informations for creating unit tests
        'global_header' : { ## header of machin.cpp
            ...
            'included'    : ['#include <nt2/toolbox/trigonometric/include/constants.hpp>',
                             '#include <nt2/toolbox/cephes/include/cot.hpp>'],     ## list of supplementary include directives
        ...
        'specific_values' : {
                'real_'       : {
                    ...
                    'nt2::Pi<T>()/4':  {'result' : 'nt2::One<r_t>()' ,'ulp_thresh':'0.5'},
                    '-nt2::Pi<T>()/2': {'result' : 'nt2::Nan<r_t>()' ,'ulp_thresh':'0.5'},
                    '-nt2::Pi<T>()/4': {'result' : 'nt2::Mone<r_t>()' ,'ulp_thresh':'0.5'},
        ...
        'verif_test'      : { ## verification dictionary
            'property_call'   : {'real_' : ['nt2::fast_cot(a0)'],},  ## dictionary of calls per types
            'property_value'  : {'real_' : ['nt2::cephes::cot(a0)'],}, ## dictionary of alternate calls
