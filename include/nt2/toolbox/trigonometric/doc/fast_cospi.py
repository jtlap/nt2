...
{
    'functor' : {       ## intrinsics values related to functor fast_cospi
    ...
    'unit'    : {       ## informations for creating unit tests
        ...
        'verif_test'      : { ## verification dictionary
            'property_call'   : {'real_' : ['nt2::fast_cospi(a0)'],},  ## dictionary of calls per types
            'property_value'  : {'real_' : ['nt2::crlibm::cospi<nt2::rn>(a0)'],}, ## dictionary of alternate calls
