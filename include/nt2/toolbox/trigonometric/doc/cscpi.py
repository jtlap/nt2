...
{
    'functor' : {       ## intrinsics values related to functor cscpi
    ...
    'unit'    : {       ## informations for creating unit tests
        'global_header' : { ## header of machin.cpp
            ...
            'included'    : ['#include <nt2/toolbox/trigonometric/include/constants.hpp>',
                             ...
                             '#include <nt2/include/functions/sinpi.hpp>'],     ## list of supplementary include directives
        ...
        'specific_values' : {
                'real_'       : {
                    ...
                    'nt2::Quarter<T>()':  {'result' : 'nt2::Sqrt_2<r_t>()','ulp_thresh':'0.5'},
                    'nt2::Mhalf<T>()':  {'result' : 'nt2::Mone<r_t>()',  'ulp_thresh':'0.5'},
                    '-nt2::Quarter<T>()':  {'result' : '-nt2::Sqrt_2<r_t>()','ulp_thresh':'0.5'},
        ...
        'verif_test'      : { ## verification dictionary
            'property_call'   : {'real_' : ['nt2::cscpi(a0)'],},  ## dictionary of calls per types
            'property_value'  : {'real_' : ['nt2::rec(nt2::sinpi(a0))'],}, ## dictionary of alternate calls
