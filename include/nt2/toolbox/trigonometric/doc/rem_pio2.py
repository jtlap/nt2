...
{
    'functor' : {       ## intrinsics values related to functor rem_pio2
    ...
    'unit'    : {       ## informations for creating unit tests
        'global_header' : { ## header of machin.cpp
            ...
            'included'    : ['#include <nt2/toolbox/trigonometric/include/constants.hpp>','#include <nt2/toolbox/crlibm/include/rem_pio2.hpp>'],     ## list of supplementary include directives
        ...
        'verif_test'      : { ## verification dictionary
            'property_call'   : {'real_' : ['nt2::rem_pio2(a0)'],},  ## dictionary of calls per types
            'property_value'  : {'real_' : ['nt2::crlibm::rem_pio2<nt2::rn>(a0)'],}, ## dictionary of alternate calls
