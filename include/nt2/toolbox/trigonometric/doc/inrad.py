...
{
    'functor' : {       ## intrinsics values related to functor inrad
    ...
    'unit'    : {       ## informations for creating unit tests
        ...
        'verif_test'      : { ## verification dictionary
            'property_call'   : {'real_' : ['nt2::inrad(a0)'],},  ## dictionary of calls per types
            'property_value'  : {'real_' : ['a0*nt2::Pi<T>()/nt2::_180<T>()'],}, ## dictionary of alternate calls
