...
{
    'functor' : {       ## intrinsics values related to functor acot
    ...
    'unit'    : {       ## informations for creating unit tests
        ...
        'verif_test'      : { ## verification dictionary
            'property_call'   : {},  ## dictionary of calls per types
            'property_value'  : {}, ## dictionary of alternate calls
            'ulp_thresh'      : {},     ## validity thresholds(s)
        },  ## end of verif_test
    },  ## end of unit 
},
]
