...
{
    'functor' : {       ## intrinsics values related to functor asind
    ...
    'unit'    : {       ## informations for creating unit tests
        'global_header' : { ## header of machin.cpp
            ...
            'included'    : ['#include <nt2/toolbox/trigonometric/include/constants.hpp>',
                             '#include <nt2/toolbox/crlibm/include/asin.hpp>'],     ## list of supplementary include directives
        ...
        'specific_values' : {
                'real_'       : {
                    ...
                    'nt2::Half<T>()' :  {'result' : '30', 'ulp_thresh':'0.5'},
                    'nt2::Mone<T>()' :  {'result' : '-90', 'ulp_thresh':'0.5'},
                    'nt2::Mhalf<T>()':  {'result' : '-30', 'ulp_thresh':'0.5'},
        ...
        'verif_test'      : { ## verification dictionary
            'property_call'   : {'real_' :["nt2::asind(a0)"]},  ## dictionary of calls per types
            'property_value'  : {'real_' :["nt2::crlibm::asin<nt2::rn>(a0)*nt2::Radindeg<T>()"]}, ## dictionary of alternate calls
