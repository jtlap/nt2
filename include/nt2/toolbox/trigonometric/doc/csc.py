...
{
    'functor' : {       ## intrinsics values related to functor csc
    ...
    'unit'    : {       ## informations for creating unit tests
        ...
        'specific_values' : {
                'real_'       : {
                    ...
                    'nt2::Pi<T>()/4':  {'result' : 'nt2::Sqrt_2<r_t>()' ,'ulp_thresh':'0.5'},
        ...
        'verif_test'      : { ## verification dictionary
            'property_call'   : {'real_' : ['nt2::csc(a0)'],},  ## dictionary of calls per types
            'property_value'  : {'real_' : ['nt2::rec(nt2::crlibm::sin<nt2::rn>(a0))'],}, ## dictionary of alternate calls
