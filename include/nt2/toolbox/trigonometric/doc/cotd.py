...
{
    'functor' : {       ## intrinsics values related to functor cotd
    ...
    'unit'    : {       ## informations for creating unit tests
        'global_header' : { ## header of machin.cpp
            ...
            'included'    : ['#include <nt2/toolbox/trigonometric/include/constants.hpp>',
                             '#include <nt2/toolbox/cephes/include/cotdg.hpp>'],     ## list of supplementary include directives
        ...
        'verif_test'      : { ## verification dictionary
            'property_call'   : {'real_' : ['nt2::cotd(a0)'],},  ## dictionary of calls per types
            'property_value'  : {'real_' : ['nt2::cephes::cotdg(a0)'],}, ## dictionary of alternate calls
