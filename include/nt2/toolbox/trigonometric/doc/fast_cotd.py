...
{
    'functor' : {       ## intrinsics values related to functor fast_cotd
    ...
    'unit'    : {       ## informations for creating unit tests
        'global_header' : { ## header of machin.cpp
            ...
            'included'    : ['#include <nt2/toolbox/trigonometric/include/constants.hpp>',
                             '#include <nt2/include/functions/cotd.hpp>'],     ## list of supplementary include directives
        ...
        'verif_test'      : { ## verification dictionary
            'property_call'   : {'real_' : ['nt2::fast_cotd(a0)'],},  ## dictionary of calls per types
            'property_value'  : {'real_' : ['nt2::cotd(a0)'],}, ## dictionary of alternate calls
