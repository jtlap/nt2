...
{
    'functor' : {       ## intrinsics values related to functor sec
    ...
    'unit'    : {       ## informations for creating unit tests
        ...
        'verif_test'      : { ## verification dictionary
            'property_call'   : {'real_' : ['nt2::sec(a0)'],},  ## dictionary of calls per types
            'property_value'  : {'real_' : ['nt2::rec(nt2::crlibm::cos<nt2::rn>(a0))'],}, ## dictionary of alternate calls
