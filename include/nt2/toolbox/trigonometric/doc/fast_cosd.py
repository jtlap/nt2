...
{
    'functor' : {       ## intrinsics values related to functor fast_cosd
    ...
    'unit'    : {       ## informations for creating unit tests
        ...
        'verif_test'      : { ## verification dictionary
            'property_call'   : {'real_' : ['nt2::fast_cosd(a0)'],},  ## dictionary of calls per types
            'property_value'  : {'real_' : ['nt2::crlibm::cos<nt2::rn>(a0*nt2::Deginrad<T>())'],}, ## dictionary of alternate calls
