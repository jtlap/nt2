...
{
    'functor' : {       ## intrinsics values related to functor fast_sincos
    ...
    'unit'    : {       ## informations for creating unit tests
        ...
        'specific_values' : {
                'real_'       : {
                    ...
                    'nt2::Pi<T>()/2':  {'result' : ['nt2::Nan<r_t0>()','nt2::Nan<r_t0>()'] ,'ulp_thresh':'0.75'},
                    'nt2::Pi<T>()/4':  {'result' : ['nt2::Sqrt_2o_2<r_t0>()']*2 ,'ulp_thresh':'0.75'},
                    '-nt2::Pi<T>()/2': {'result' : ['nt2::Nan<r_t0>()','nt2::Nan<r_t1>()'] ,'ulp_thresh':'0.75'},
        ...
        'verif_test'      : { ## verification dictionary
            'property_call'   : {'real_' : ['nt2::fast_sincos(a0)'],},  ## dictionary of calls per types
            'property_value'  : {'real_' : [['nt2::crlibm::sin<nt2::rn>(a0)','nt2::crlibm::cos<nt2::rn>(a0)']],}, ## dictionary of alternate calls
