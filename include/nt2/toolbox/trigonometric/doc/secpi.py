...
{
    'functor' : {       ## intrinsics values related to functor secpi
    ...
    'unit'    : {       ## informations for creating unit tests
        'global_header' : { ## header of machin.cpp
            ...
            'included'    : ['#include <nt2/toolbox/trigonometric/include/constants.hpp>',
                             '#include <nt2/toolbox/crlibm/include/cospi.hpp>'],     ## list of supplementary include directives
        ...
        'verif_test'      : { ## verification dictionary
            'property_call'   : {'real_' : ['nt2::secpi(a0)'],},  ## dictionary of calls per types
            'property_value'  : {'real_' : ['nt2::rec(nt2::crlibm::cospi<nt2::rn>(a0))'],}, ## dictionary of alternate calls
