[ ##script modified manually
{
    'functor' : {       ## intrinsics values related to functor acosd
    ...
    'unit'    : {       ## informations for creating unit tests
        'global_header' : { ## header of machin.cpp
            ...
            'included'    : ['#include <nt2/toolbox/trigonometric/include/constants.hpp>',
                             '#include <nt2/toolbox/crlibm/include/acos.hpp>'],     ## list of supplementary include directives
        ...
        'verif_test'      : { ## verification dictionary
            'property_call'   : {'real_' :["nt2::acosd(a0)"]},  ## dictionary of calls per types
            'property_value'  : {'real_' :["nt2::crlibm::acos<nt2::rn>(a0)*nt2::Radindeg<T>()"]}, ## dictionary of alternate calls
