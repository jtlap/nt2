...
NT2_TEST_CASE_TPL ( fast_sincosd_real__1,  NT2_REAL_TYPES)
{
  ...
  NT2_TEST_ULP_EQUAL(  fast_sincosd(-nt2::_180<T>()), nt2::Zero<r_t>(), 0.75);
  NT2_TEST_ULP_EQUAL(  fast_sincosd(-nt2::_45<T>()), nt2::Sqrt_2o_2<r_t>(), 0);
  NT2_TEST_ULP_EQUAL(  fast_sincosd(-nt2::_90<T>()), nt2::One<r_t>(), 0);
  NT2_TEST_ULP_EQUAL(  fast_sincosd(nt2::Inf<T>()), nt2::Nan<r_t>(), 0);
  NT2_TEST_ULP_EQUAL(  fast_sincosd(nt2::Minf<T>()), nt2::Nan<r_t>(), 0);
  NT2_TEST_ULP_EQUAL(  fast_sincosd(nt2::Nan<T>()), nt2::Nan<r_t>(), 0);
  NT2_TEST_ULP_EQUAL(  fast_sincosd(nt2::Zero<T>()), nt2::Zero<r_t>(), 0);
  NT2_TEST_ULP_EQUAL(  fast_sincosd(nt2::_180<T>()), nt2::Zero<r_t>(), 0.75);
  NT2_TEST_ULP_EQUAL(  fast_sincosd(nt2::_45<T>()), nt2::Sqrt_2o_2<r_t>(), 0);
  NT2_TEST_ULP_EQUAL(  fast_sincosd(nt2::_90<T>()), nt2::One<r_t>(), 0);
