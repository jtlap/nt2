...
//////////////////////////////////////////////////////////////////////////////
#define NT2_UNIT_MODULE "nt2 trigonometric toolbox - tan/scalar Mode"
...
NT2_TEST_CASE_TPL ( tan_real__1,  NT2_REAL_TYPES)
{
  using nt2::tan;
  using nt2::tag::tan_;
  typedef typename nt2::meta::call<tan_(T)>::type r_t;
    ...
    for (int j =0; j < NR; ++j )
      {
        std::cout << "for param "
                  << "  a0 = "<< u_t(a0 = tab_a0[j])
                  << std::endl;
        NT2_TEST_ULP_EQUAL( nt2::tan(a0),nt2::crlibm::tan<nt2::rn>(a0),1.0);
...
NT2_TEST_CASE_TPL ( tan_unsigned_int__1,  NT2_UNSIGNED_TYPES)
{
  using nt2::tan;
  using nt2::tag::tan_;
  typedef typename nt2::meta::call<tan_(T)>::type r_t;
...
NT2_TEST_CASE_TPL ( tan_signed_int__1,  NT2_INTEGRAL_SIGNED_TYPES)
{
  using nt2::tan;
  using nt2::tag::tan_;
  typedef typename nt2::meta::call<tan_(T)>::type r_t;
