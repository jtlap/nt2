...
//////////////////////////////////////////////////////////////////////////////
#define NT2_UNIT_MODULE "nt2 trigonometric toolbox - tanpi/scalar Mode"
...
NT2_TEST_CASE_TPL ( tanpi_real__1,  NT2_REAL_TYPES)
{
  using nt2::tanpi;
  using nt2::tag::tanpi_;
  typedef typename nt2::meta::as_integer<T>::type iT;
  typedef typename nt2::meta::call<tanpi_(T)>::type r_t;
    ...
    for (int j =0; j < NR; ++j )
      {
        std::cout << "for param "
                  << "  a0 = "<< u_t(a0 = tab_a0[j])
                  << std::endl;
        NT2_TEST_ULP_EQUAL( nt2::tanpi(a0),::cephes_tanl(nt2::long_pi*a0),1.0);
...
NT2_TEST_CASE_TPL ( tanpi_unsigned_int__1,  NT2_UNSIGNED_TYPES)
{
  using nt2::tanpi;
  using nt2::tag::tanpi_;
  typedef typename nt2::meta::as_integer<T>::type iT;
...
NT2_TEST_CASE_TPL ( tanpi_signed_int__1,  NT2_INTEGRAL_SIGNED_TYPES)
{
  using nt2::tanpi;
  using nt2::tag::tanpi_;
  typedef typename nt2::meta::as_integer<T>::type iT;
