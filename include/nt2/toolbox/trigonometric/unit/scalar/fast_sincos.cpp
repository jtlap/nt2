    ...
    for (uint32_t j =0; j < NR; ++j )
      {
        ...
        NT2_TEST_TUPLE_ULP_EQUAL( r0, (r_t0)::cephes_sinl(a0), 0.5);
        NT2_TEST_TUPLE_ULP_EQUAL( r1, (r_t1)::cephes_cosl(a0), 0.5);
     }
     std::cout << "max ulp found is: " << ulp0 << std::endl;
   }
} // end of test for real_

NT2_TEST_CASE_TPL ( fast_sincos_unsigned_int__1_0,  NT2_UNSIGNED_TYPES)
{
...
NT2_TEST_CASE_TPL ( fast_sincos_signed_int__1_0,  NT2_INTEGRAL_SIGNED_TYPES)
{
