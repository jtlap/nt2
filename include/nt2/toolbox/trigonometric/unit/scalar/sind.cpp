...
NT2_TEST_CASE_TPL ( sind_real__1,  NT2_REAL_TYPES)
{
  using nt2::sind;
  using nt2::tag::sind_;
    ...
    for (int j =0; j < NR; ++j )
      {
        std::cout << "for param "
                  << "  a0 = "<< u_t(a0 = tab_a0[j])
                  << std::endl;
        NT2_TEST_ULP_EQUAL( nt2::sind(a0),::sinl(a0*nt2::long_deginrad),1.0);
...
NT2_TEST_CASE_TPL ( sind_unsigned_int__1,  NT2_UNSIGNED_TYPES)
{
  using nt2::sind;
  using nt2::tag::sind_;
  typedef typename nt2::meta::as_integer<T>::type iT;
...
NT2_TEST_CASE_TPL ( sind_signed_int__1,  NT2_INTEGRAL_SIGNED_TYPES)
{
  using nt2::sind;
  using nt2::tag::sind_;
  typedef typename nt2::meta::as_integer<T>::type iT;
