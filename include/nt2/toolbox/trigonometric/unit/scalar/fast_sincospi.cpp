...
NT2_TEST_CASE_TPL ( fast_sincospi_real__1,  NT2_REAL_TYPES)
{
  ...
  NT2_TEST_ULP_EQUAL(  fast_sincospi(-nt2::Quarter<T>()), nt2::Sqrt_2o_2<r_t>(), 0);
  NT2_TEST_ULP_EQUAL(  fast_sincospi(nt2::Half<T>()), nt2::One<r_t>(), 0);
  NT2_TEST_ULP_EQUAL(  fast_sincospi(nt2::Inf<T>()), nt2::Nan<r_t>(), 0);
  NT2_TEST_ULP_EQUAL(  fast_sincospi(nt2::Mhalf<T>()), nt2::One<r_t>(), 0);
  NT2_TEST_ULP_EQUAL(  fast_sincospi(nt2::Minf<T>()), nt2::Nan<r_t>(), 0);
  NT2_TEST_ULP_EQUAL(  fast_sincospi(nt2::Nan<T>()), nt2::Nan<r_t>(), 0);
  NT2_TEST_ULP_EQUAL(  fast_sincospi(nt2::One<T>()), nt2::Zero<r_t>(), 0.75);
  NT2_TEST_ULP_EQUAL(  fast_sincospi(nt2::Quarter<T>()), nt2::Sqrt_2o_2<r_t>(), 0);
  NT2_TEST_ULP_EQUAL(  fast_sincospi(nt2::Zero<T>()), nt2::Zero<r_t>(), 0);
