...
//////////////////////////////////////////////////////////////////////////////
#define NT2_UNIT_MODULE "nt2 trigonometric toolbox - fast_sin/scalar Mode"
...
NT2_TEST_CASE_TPL ( fast_sin_real__1,  NT2_REAL_TYPES)
{
  using nt2::fast_sin;
  ...
  NT2_TEST_ULP_EQUAL(  fast_sin(-nt2::Pi<T>()/2), nt2::Nan<r_t>(), 0.5);
    ...
    for (int j =0; j < NR; ++j )
      {
        std::cout << "for param "
                  << "  a0 = "<< u_t(a0 = tab_a0[j])
                  << std::endl;
        NT2_TEST_ULP_EQUAL( nt2::fast_sin(a0),nt2::crlibm::sin<nt2::rn>(a0),0.5);
