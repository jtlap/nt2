    ...
    for (int j =0; j < NR; ++j )
      {
        std::cout << "for param "
                  << "  a0 = "<< u_t(a0 = tab_a0[j])
                  << std::endl;
        NT2_TEST_ULP_EQUAL( n,n,0);
        ulp0=nt2::max(ulpd,ulp0);
        NT2_TEST_ULP_EQUAL( t,t,.);
        ulp0=nt2::max(ulpd,ulp0);
        NT2_TEST_ULP_EQUAL( 2,2,5);
        ulp0=nt2::max(ulpd,ulp0);
        NT2_TEST_ULP_EQUAL( :,:,0);
        ulp0=nt2::max(ulpd,ulp0);
        NT2_TEST_ULP_EQUAL( :,:,0);
        ulp0=nt2::max(ulpd,ulp0);
        NT2_TEST_ULP_EQUAL( r,c,0);
        ulp0=nt2::max(ulpd,ulp0);
        NT2_TEST_ULP_EQUAL( e,r,0);
        ulp0=nt2::max(ulpd,ulp0);
        NT2_TEST_ULP_EQUAL( m,l,0);
        ulp0=nt2::max(ulpd,ulp0);
        NT2_TEST_ULP_EQUAL( _,i,0);
        ulp0=nt2::max(ulpd,ulp0);
        NT2_TEST_ULP_EQUAL( p,b,0);
        ulp0=nt2::max(ulpd,ulp0);
        NT2_TEST_ULP_EQUAL( i,m,0);
        ulp0=nt2::max(ulpd,ulp0);
        NT2_TEST_ULP_EQUAL( o,:,0);
        ulp0=nt2::max(ulpd,ulp0);
        NT2_TEST_ULP_EQUAL( 2,:,0);
        ulp0=nt2::max(ulpd,ulp0);
        NT2_TEST_ULP_EQUAL( (,r,0);
        ulp0=nt2::max(ulpd,ulp0);
        NT2_TEST_ULP_EQUAL( a,e,0);
        ulp0=nt2::max(ulpd,ulp0);
        NT2_TEST_ULP_EQUAL( 0,m,0);
        ulp0=nt2::max(ulpd,ulp0);
        NT2_TEST_ULP_EQUAL( ),_,0);
        ulp0=nt2::max(ulpd,ulp0);
     }
