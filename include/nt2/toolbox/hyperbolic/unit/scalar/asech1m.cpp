...
//////////////////////////////////////////////////////////////////////////////
#define NT2_UNIT_MODULE "nt2 hyperbolic toolbox - asech1m/scalar Mode"
...
NT2_TEST_CASE_TPL ( asech1m_real__1,  NT2_REAL_TYPES)
{
  ...
  NT2_TEST_ULP_EQUAL(  asech1m(nt2::One<T>()), nt2::Zero<r_t>(), 0.5);
  NT2_TEST_ULP_EQUAL(  asech1m(nt2::Zero<T>()), nt2::Inf<r_t>(), 0.5);
    ...
    for (int j =0; j < NR; ++j )
      {
        std::cout << "for param "
                  << "  a0 = "<< u_t(a0 = tab_a0[j])
                  << std::endl;
        NT2_TEST_ULP_EQUAL( nt2::asech(a0),nt2::asech(nt2::oneminus(a0)),5.0);
