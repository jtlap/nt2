...
//////////////////////////////////////////////////////////////////////////////
#define NT2_UNIT_MODULE "nt2 hyperbolic toolbox - sinhc/scalar Mode"
...
NT2_TEST_CASE_TPL ( sinhc_real__1,  NT2_REAL_TYPES)
{
  using nt2::sinhc;
...
NT2_TEST_CASE_TPL ( sinhc_unsigned_int__1,  NT2_UNSIGNED_TYPES)
{
  using nt2::sinhc;
  using nt2::tag::sinhc_;
  typedef typename nt2::meta::call<sinhc_(T)>::type r_t;
...
NT2_TEST_CASE_TPL ( sinhc_signed_int__1,  NT2_INTEGRAL_SIGNED_TYPES)
{
  using nt2::sinhc;
  using nt2::tag::sinhc_;
  typedef typename nt2::meta::call<sinhc_(T)>::type r_t;
