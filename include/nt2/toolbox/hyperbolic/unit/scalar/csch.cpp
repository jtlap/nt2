...
NT2_TEST_CASE_TPL ( csch_real__1,  NT2_REAL_TYPES)
{
  using nt2::csch;
  using nt2::tag::csch_;
    ...
    for (int j =0; j < NR; ++j )
      {
        std::cout << "for param "
                  << "  a0 = "<< u_t(a0 = tab_a0[j])
                  << std::endl;
        NT2_TEST_ULP_EQUAL( nt2::csch(a0),nt2::rec(nt2::libc::sinh(a0)),1.5);
...
NT2_TEST_CASE_TPL ( csch_unsigned_int__1,  NT2_UNSIGNED_TYPES)
{
  using nt2::csch;
  using nt2::tag::csch_;
  typedef typename nt2::meta::call<csch_(T)>::type r_t;
...
NT2_TEST_CASE_TPL ( csch_signed_int__1,  NT2_INTEGRAL_SIGNED_TYPES)
{
  using nt2::csch;
  using nt2::tag::csch_;
  typedef typename nt2::meta::call<csch_(T)>::type r_t;
