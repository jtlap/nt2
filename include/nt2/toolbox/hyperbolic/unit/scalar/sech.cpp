...
//////////////////////////////////////////////////////////////////////////////
#define NT2_UNIT_MODULE "nt2 hyperbolic toolbox - sech/scalar Mode"
...
NT2_TEST_CASE_TPL ( sech_real__1,  NT2_REAL_TYPES)
{
  using nt2::sech;
  using nt2::tag::sech_;
    ...
    for (int j =0; j < NR; ++j )
      {
        std::cout << "for param "
                  << "  a0 = "<< u_t(a0 = tab_a0[j])
                  << std::endl;
        NT2_TEST_ULP_EQUAL( nt2::sech(a0),nt2::rec(nt2::libc::cosh(a0)),1.0);
...
NT2_TEST_CASE_TPL ( sech_unsigned_int__1,  NT2_UNSIGNED_TYPES)
{
  using nt2::sech;
  using nt2::tag::sech_;
  typedef typename nt2::meta::call<sech_(T)>::type r_t;
...
NT2_TEST_CASE_TPL ( sech_signed_int__1,  NT2_INTEGRAL_SIGNED_TYPES)
{
  using nt2::sech;
  using nt2::tag::sech_;
  typedef typename nt2::meta::call<sech_(T)>::type r_t;
