		    ...
		    )
{
  ...
  const int N = 2; 
   ...
   NT2_TEST(  nt2::is_nan(nt2::acosh( T(0) )));
   NT2_TEST_EQUAL(  nt2::acosh( T(1) )  , 0 );
   NT2_TEST_EQUAL(  nt2::acosh(nt2::Inf<T>() ), nt2::Inf<T>());
   NT2_TEST      (  nt2::is_nan(nt2::acosh(nt2::Nan<T>()) )); 

   for(int i=0; i < 10; i++)
     {
       T x =  i; 
       NT2_TEST_LESSER_EQUAL(nt2::ulpdist(x, nt2::cosh(nt2::acosh(x))), 1); 
     }
}
