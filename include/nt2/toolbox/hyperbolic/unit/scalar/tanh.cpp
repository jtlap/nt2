		    ...
		    )
{
  ...
  const int N = 2; 
   ...
   NT2_TEST_EQUAL(  nt2::tanh( T(0) ), 0);
   NT2_TEST_LESSER_EQUAL(  nt2::ulpdist(nt2::tanh( T(1) )  , T(0.761594155955765)), 1);
   NT2_TEST_EQUAL(  nt2::tanh(nt2::Inf<T>() ), nt2::One<T>());
   NT2_TEST_EQUAL(  nt2::tanh(nt2::Minf<T>() ), nt2::Mone<T>());
   NT2_TEST      (  nt2::is_nan(nt2::tanh(nt2::Nan<T>()) )); 
   ...
   for(int i=1; i < 10; i++) 
     {
       T x =  1.0/i; 
       NT2_TEST_LESSER_EQUAL(nt2::ulpdist(nt2::tanh(x), t[i-1]), 10);
       std::cout << std::setprecision(20) << x << "  " << nt2::tanh(x) << "  " << t[i-1] << std::endl; 
     }
