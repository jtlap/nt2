...
{
    'functor' : {       ## intrinsics values related to functor asech
    ...
    'unit'    : {       ## informations for creating unit tests
        ...
        'verif_test'      : { ## verification dictionary
            'property_call'   : {'real_' : ['nt2::asech(a0)'],},  ## dictionary of calls per types
            'property_value'  : {'real_' : ['nt2::boost_math::acosh(nt2::rec(a0))'],}, ## dictionary of alternate calls
            'ulp_thresh'      : {'real_' : ['5.0'],},     ## validity thresholds(s)
        },  ## end of verif_test
    },  ## end of unit 
},
]
