...
{
    'functor' : {       ## intrinsics values related to functor cosh
    ...
    'unit'    : {       ## informations for creating unit tests
        ...
        'verif_test'      : { ## verification dictionary
            'property_call'   : {'real_' : ['nt2::cosh(a0)'],},  ## dictionary of calls per types
            'property_value'  : {'real_' : ['nt2::libc::cosh(a0)'],}, ## dictionary of alternate calls
