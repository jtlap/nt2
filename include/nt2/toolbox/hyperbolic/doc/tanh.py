...
{
    'functor' : {       ## intrinsics values related to functor tanh
    ...
    'unit'    : {       ## informations for creating unit tests
        ...
        'verif_test'      : { ## verification dictionary
            'property_call'   : {'real_' : ['nt2::tanh(a0)'],},  ## dictionary of calls per types
            'property_value'  : {'real_' : ['nt2::cephes::tanh(a0)'],}, ## dictionary of alternate calls
