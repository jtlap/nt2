...
{
    'functor' : {       ## intrinsics values related to functor coth
    ...
    'unit'    : {       ## informations for creating unit tests
        'global_header' : { ## header of machin.cpp
            ...
            'included'    : ['#include <nt2/toolbox/exponential/include/constants.hpp>',
                             '#include <nt2/toolbox/cephes/include/tanh.hpp>'],     ## list of supplementary include directives
        ...
        'verif_test'      : { ## verification dictionary
            'property_call'   : {'real_' : ['nt2::coth(a0)'],},  ## dictionary of calls per types
            'property_value'  : {'real_' : ['nt2::rec(nt2::cephes::tanh(a0))'],}, ## dictionary of alternate calls
