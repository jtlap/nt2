...
{
    'functor' : {       ## intrinsics values related to functor asinh
    ...
    'unit'    : {       ## informations for creating unit tests
        'global_header' : { ## header of machin.cpp
            ...
            'included'    : ['#include <nt2/toolbox/exponential/include/constants.hpp>',
                             '#include <nt2/toolbox/boost_math/include/asinh.hpp>'],     ## list of supplementary include directives
        ...
        'verif_test'      : { ## verification dictionary
            'property_call'   : {'real_' : ['nt2::asinh(a0)'],},  ## dictionary of calls per types
            'property_value'  : {'real_' : ['nt2::boost_math::asinh(a0)'],}, ## dictionary of alternate calls
