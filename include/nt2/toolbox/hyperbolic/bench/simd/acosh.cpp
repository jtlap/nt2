...
NT2_TIMING(nt2::functors::acosh_,(RS(vfloat,1.0f,10.0f)))
NT2_TIMING(nt2::functors::acosh_,(RS(vdouble,1.0,100.0)))
NT2_TIMING(nt2::functors::acosh_,(RS(vint32_t,1.0,100.0)))
