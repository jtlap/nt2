...
//////////////////////////////////////////////////////////////////////////////
//NT2_TEST_CASE_TPL(hmsb, NT2_SIMD_TYPES )
//{
//  using nt2::hmsb;
//  using nt2::functors::hmsb;
// 
...
//
//  NT2_TEST( (boost::is_same<typename nt2::meta::call<reduction_(n_t)>::type,
//                            typename std::tr1::result_of<nt2::meta::floating<($self.const_n_t_type_list$)>::type
//                            >::value)
//          );
//  NT2_ALIGNED_TYPE(T) data[1*cardinal_of<n_t>::value];
//  for(std::size_t i=0;i<1*cardinal_of<n_t>::value;++i)
//    data[i] = i; // good value here for hmsb
//
//    n_t a0 = load<n_t>(&data[0],0);
//    n_t v  = hmsb(a0);
//    for(std::size_t j=0;j<cardinal_of<n_t>::value;++j)
//    {
//      NT2_TEST_EQUAL( v[j], hmsb(a0[j]) );
//    }
//  }
//}
