...
//////////////////////////////////////////////////////////////////////////////
// Test behavior of nt2::posmin in scalar mode
//////////////////////////////////////////////////////////////////////////////
NT2_TEST_CASE_TPL ( posmin, NT2_SIMD_TYPES )
{
  using nt2::posmin;
  using nt2::load;
  ...
  NT2_TEST( (boost::is_same < typename nt2::meta::call<posmin_(native<T,ext_t>)>::type
  ...
  data[cardinal_of<n_t>::value/2] = 0;
  
  n_t v = load<n_t>(&data[0],0);
  NT2_TEST_EQUAL( nt2::posmin(v),pos);
}
