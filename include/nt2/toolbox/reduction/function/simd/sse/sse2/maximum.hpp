...
namespace nt2 { namespace ext
{
  ...
  struct call<tag::maximum_(tag::simd_(tag::int16_, tag::see_)),
...
{
  template<class Dummy>
  struct call<tag::maximum_(tag::simd_(tag::double_, tag::see_)),
              tag::cpu_, Dummy> : callable
  {
    template<class Sig> struct result;
    template<class This,class A0>
...
{
  template<class Dummy>
  struct call<tag::maximum_(tag::simd_(tag::int64_, tag::see_)),
              tag::cpu_, Dummy> : callable
  {
    template<class Sig> struct result;
    template<class This,class A0>
...
{
  template<class Dummy>
  struct call<tag::maximum_(tag::simd_(tag::float_, tag::see_)),
              tag::cpu_, Dummy> : callable
  {
    template<class Sig> struct result;
    template<class This,class A0>
...
{
  template<class Dummy>
  struct call<tag::maximum_(tag::simd_(tag::int8_, tag::see_)),
              tag::cpu_, Dummy> : callable
  {
    template<class Sig> struct result;
    template<class This,class A0>
...
{
  template<class Dummy>
  struct call<tag::maximum_(tag::simd_(tag::int32_, tag::see_)),
              tag::cpu_, Dummy> : callable
  {
    template<class Sig> struct result;
    template<class This,class A0>
