                ...
                )
{
  ...
  using nt2::libc::tag::pow_;
   ...
   NT2_TEST_EQUAL(  nt2::libc::pow( T(0), T(0))  , 1 );
   NT2_TEST_EQUAL(  nt2::libc::pow( T(1), T(28))  , nt2::One<T>() );
   NT2_TEST_EQUAL(  nt2::libc::pow(T(2), T(3)), nt2::Eight<T>());
   T x =  1.5;
   T y =  nt2::sqrt(x);
   for(int i=1; i < 100; i++)
     {
       T z = nt2::libc::pow(x, T(i+0.5));
       y *=  x; 
