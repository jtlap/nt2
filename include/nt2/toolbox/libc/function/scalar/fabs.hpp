...
/////////////////////////////////////////////////////////////////////////////
NT2_REGISTER_DISPATCH(libc::tag::fabs_, tag::cpu_,
                      (A0),
                      (arithmetic_<A0>)
                     )
...
namespace nt2 { namespace ext
{
  ...
  struct call<libc::tag::fabs_(tag::arithmetic_),
...
{
  template<class Dummy>
  struct call<libc::tag::fabs_(tag::double_),
              tag::cpu_, Dummy> : callable
  {
    template<class Sig> struct result;
    template<class This,class A0>
...
{
  template<class Dummy>
  struct call<libc::tag::fabs_(tag::float_),
              tag::cpu_, Dummy> : callable
  {
    template<class Sig> struct result;
    template<class This,class A0>
...
{
  template<class Dummy>
  struct call<libc::tag::fabs_(tag::long_double_),
              tag::cpu_, Dummy> : callable
  {
    template<class Sig> struct result;
    template<class This,class A0>
