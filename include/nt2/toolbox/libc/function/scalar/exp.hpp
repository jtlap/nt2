...
namespace nt2 { namespace functors
{
  ...
  /////////////////////////////////////////////////////////////////////////////
  template<class Info>
  struct call<libc::exp_,tag::scalar_(tag::arithmetic_),Info>
  {
    ...
    NT2_FUNCTOR_CALL_EVAL_IF(1, long double) { return ::expl(a0);  }
    NT2_FUNCTOR_CALL_EVAL_IF(1, double) { return ::exp(a0);  }
    NT2_FUNCTOR_CALL_EVAL_IF(1, float)  { return ::expf(a0); }
