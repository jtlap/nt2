...
/////////////////////////////////////////////////////////////////////////////
NT2_REGISTER_DISPATCH(libc::tag::fmod_, tag::cpu_,
                      (A0)(A1),
...
namespace nt2 { namespace ext
{
  ...
  struct call<libc::tag::fmod_(tag::arithmetic_,tag::arithmetic_),
...
{
  template<class Dummy>
  struct call<libc::tag::fmod_(tag::double_,tag::double_),
              tag::cpu_, Dummy> : callable
  {
    template<class Sig> struct result;
    template<class This,class A0, class A1>
...
{
  template<class Dummy>
  struct call<libc::tag::fmod_(tag::float_,tag::float_),
              tag::cpu_, Dummy> : callable
  {
    template<class Sig> struct result;
    template<class This,class A0, class A1>
...
{
  template<class Dummy>
  struct call<libc::tag::fmod_(tag::long_double_,tag::long_double_),
              tag::cpu_, Dummy> : callable
  {
    template<class Sig> struct result;
    template<class This,class A0, class A1>
