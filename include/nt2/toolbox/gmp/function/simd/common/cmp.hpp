 ...
 *****************************************************************************/
#ifndef NT2_TOOLBOX_GMP_FUNCTION_SIMD_COMMON_CMP_HPP_INCLUDED
#define NT2_TOOLBOX_GMP_FUNCTION_SIMD_COMMON_CMP_HPP_INCLUDED
#include <nt2/sdk/meta/strip.hpp>

namespace nt2 { namespace functors
{
  template<class Extension,class Dummy>
  struct call<gmp::cmp_,tag::simd_(tag::arithmetic_,Extension),Dummy>
  {
