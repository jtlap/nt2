...
NT2_TEST_CASE_TPL ( max_real_,  NT2_REAL_TYPES)
{
  using nt2::max;
...
NT2_TEST_CASE_TPL ( max_unsigned_int_,  NT2_UNSIGNED_TYPES)
{
  using nt2::max;
  using nt2::functors::max_;
  typedef typename nt2::meta::call<max_(T, T)>::type r_t;
...
NT2_TEST_CASE_TPL ( max_signed_int_,  NT2_INTEGRAL_SIGNED_TYPES)
{
  using nt2::max;
  using nt2::functors::max_;
  typedef typename nt2::meta::call<max_(T, T)>::type r_t;
