...
NT2_TEST_CASE_TPL ( floor_real_,  NT2_REAL_TYPES)
{
  using nt2::floor;
...
NT2_TEST_CASE_TPL ( floor_unsigned_int_,  NT2_UNSIGNED_TYPES)
{
  using nt2::floor;
  using nt2::functors::floor_;
  typedef typename nt2::meta::call<floor_(T)>::type r_t;
...
NT2_TEST_CASE_TPL ( floor_signed_int_,  NT2_INTEGRAL_SIGNED_TYPES)
{
  using nt2::floor;
  using nt2::functors::floor_;
  typedef typename nt2::meta::call<floor_(T)>::type r_t;
