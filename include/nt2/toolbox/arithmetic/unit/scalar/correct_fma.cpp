...
NT2_TEST_CASE_TPL ( correct_fma_real_,  NT2_REAL_TYPES)
{
...
NT2_TEST_CASE_TPL ( correct_fma_signed_int_,  NT2_INTEGRAL_SIGNED_TYPES)
{
  using nt2::correct_fma;
  using nt2::functors::correct_fma_;
  typedef typename nt2::meta::call<correct_fma_(T, T, T)>::type r_t;
...
NT2_TEST_CASE_TPL ( correct_fma_unsigned_int_,  NT2_UNSIGNED_TYPES)
{
  using nt2::correct_fma;
  using nt2::functors::correct_fma_;
  typedef typename nt2::meta::call<correct_fma_(T, T, T)>::type r_t;
