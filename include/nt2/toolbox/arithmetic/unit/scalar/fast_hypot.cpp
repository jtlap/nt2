...
NT2_TEST_CASE_TPL ( fast_hypot_real_,  NT2_REAL_TYPES)
{
...
NT2_TEST_CASE_TPL ( fast_hypot_unsigned_int_,  NT2_UNSIGNED_TYPES)
{
  using nt2::fast_hypot;
  using nt2::functors::fast_hypot_;
  typedef typename nt2::meta::call<fast_hypot_(T, T)>::type r_t;
...
NT2_TEST_CASE_TPL ( fast_hypot_signed_int_,  NT2_INTEGRAL_SIGNED_TYPES)
{
  using nt2::fast_hypot;
  using nt2::functors::fast_hypot_;
  typedef typename nt2::meta::call<fast_hypot_(T, T)>::type r_t;
