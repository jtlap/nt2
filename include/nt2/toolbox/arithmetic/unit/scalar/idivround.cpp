...
NT2_TEST_CASE_TPL ( idivround_real_,  NT2_REAL_TYPES)
{
  using nt2::idivround;
...
NT2_TEST_CASE_TPL ( idivround_unsigned_int_,  NT2_UNSIGNED_TYPES)
{
  using nt2::idivround;
  using nt2::functors::idivround_;
  typedef typename nt2::meta::call<idivround_(T, T)>::type r_t;
...
NT2_TEST_CASE_TPL ( idivround_signed_int_,  NT2_INTEGRAL_SIGNED_TYPES)
{
  using nt2::idivround;
  using nt2::functors::idivround_;
  typedef typename nt2::meta::call<idivround_(T, T)>::type r_t;
