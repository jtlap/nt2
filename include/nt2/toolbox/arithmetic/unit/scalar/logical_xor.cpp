...
NT2_TEST_CASE_TPL ( logical_xor_real_,  NT2_REAL_TYPES)
{
...
NT2_TEST_CASE_TPL ( logical_xor_unsigned_int_,  NT2_UNSIGNED_TYPES)
{
  using nt2::logical_xor;
  using nt2::functors::logical_xor_;
  typedef typename nt2::meta::call<logical_xor_(T, T)>::type r_t;
...
NT2_TEST_CASE_TPL ( logical_xor_signed_int_,  NT2_INTEGRAL_SIGNED_TYPES)
{
  using nt2::logical_xor;
  using nt2::functors::logical_xor_;
  typedef typename nt2::meta::call<logical_xor_(T, T)>::type r_t;
