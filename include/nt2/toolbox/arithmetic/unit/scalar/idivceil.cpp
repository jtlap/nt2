...
NT2_TEST_CASE_TPL ( idivceil_real__2,  NT2_REAL_TYPES)
{
  using nt2::idivceil;
  ...
  NT2_TEST_ULP_EQUAL(  idivceil(nt2::Inf<T>(), nt2::Inf<T>()), nt2::Nan<r_t>(), 0);
  NT2_TEST_ULP_EQUAL(  idivceil(nt2::Minf<T>(), nt2::Minf<T>()), nt2::Nan<r_t>(), 0);
  ...
  NT2_TEST_ULP_EQUAL(  idivceil(nt2::Nan<T>(), nt2::Nan<T>()), nt2::Nan<r_t>(), 0);
  ...
  NT2_TEST_ULP_EQUAL(  idivceil(nt2::Zero<T>(),nt2::Zero<T>()), nt2::Nan<r_t>(), 0);
} // end of test for real_

NT2_TEST_CASE_TPL ( idivceil_unsigned_int__2,  NT2_UNSIGNED_TYPES)
{
  using nt2::idivceil;
  using nt2::tag::idivceil_;
  typedef typename nt2::meta::call<idivceil_(T,T)>::type r_t;
...
NT2_TEST_CASE_TPL ( idivceil_signed_int__2,  NT2_INTEGRAL_SIGNED_TYPES)
{
  using nt2::idivceil;
  using nt2::tag::idivceil_;
  typedef typename nt2::meta::call<idivceil_(T,T)>::type r_t;
