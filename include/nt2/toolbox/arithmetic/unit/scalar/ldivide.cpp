...
NT2_TEST_CASE_TPL ( ldivide_real_,  NT2_REAL_TYPES)
{
  using nt2::ldivide;
...
NT2_TEST_CASE_TPL ( ldivide_unsigned_int_,  NT2_UNSIGNED_TYPES)
{
  using nt2::ldivide;
  using nt2::functors::ldivide_;
  typedef typename nt2::meta::call<ldivide_(T, T)>::type r_t;
...
NT2_TEST_CASE_TPL ( ldivide_signed_int_,  NT2_INTEGRAL_SIGNED_TYPES)
{
  using nt2::ldivide;
  using nt2::functors::ldivide_;
  typedef typename nt2::meta::call<ldivide_(T, T)>::type r_t;
