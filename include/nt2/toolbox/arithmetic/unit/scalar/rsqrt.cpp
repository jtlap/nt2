...
NT2_TEST_CASE_TPL ( rsqrt_real_,  NT2_REAL_TYPES)
{
  using nt2::rsqrt;
...
NT2_TEST_CASE_TPL ( rsqrt_unsigned_int_,  NT2_UNSIGNED_TYPES)
{
  using nt2::rsqrt;
  using nt2::functors::rsqrt_;
  typedef typename nt2::meta::call<rsqrt_(T)>::type r_t;
...
NT2_TEST_CASE_TPL ( rsqrt_signed_int_,  NT2_INTEGRAL_SIGNED_TYPES)
{
  using nt2::rsqrt;
  using nt2::functors::rsqrt_;
  typedef typename nt2::meta::call<rsqrt_(T)>::type r_t;
