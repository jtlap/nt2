...
NT2_TEST_CASE_TPL ( amul_real_,  NT2_REAL_TYPES)
{
  using nt2::amul;
...
NT2_TEST_CASE_TPL ( amul_signed_int_,  NT2_INTEGRAL_SIGNED_TYPES)
{
  using nt2::amul;
  using nt2::functors::amul_;
  typedef typename nt2::meta::call<amul_(T, T, T)>::type r_t;
...
NT2_TEST_CASE_TPL ( amul_unsigned_int_,  NT2_UNSIGNED_TYPES)
{
  using nt2::amul;
  using nt2::functors::amul_;
  typedef typename nt2::meta::call<amul_(T, T, T)>::type r_t;
