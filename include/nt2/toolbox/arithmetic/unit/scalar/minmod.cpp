...
NT2_TEST_CASE_TPL ( minmod_real_,  NT2_REAL_TYPES)
{
  using nt2::minmod;
...
NT2_TEST_CASE_TPL ( minmod_unsigned_int_,  NT2_UNSIGNED_TYPES)
{
  using nt2::minmod;
  using nt2::functors::minmod_;
  typedef typename nt2::meta::call<minmod_(T, T)>::type r_t;
...
NT2_TEST_CASE_TPL ( minmod_signed_int_,  NT2_INTEGRAL_SIGNED_TYPES)
{
  using nt2::minmod;
  using nt2::functors::minmod_;
  typedef typename nt2::meta::call<minmod_(T, T)>::type r_t;
