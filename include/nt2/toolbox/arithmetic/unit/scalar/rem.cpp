...
NT2_TEST_CASE_TPL ( rem_real_,  NT2_REAL_TYPES)
{
  using nt2::rem;
...
NT2_TEST_CASE_TPL ( rem_unsigned_int_,  NT2_UNSIGNED_TYPES)
{
  using nt2::rem;
  using nt2::functors::rem_;
  typedef typename nt2::meta::call<rem_(T, T)>::type r_t;
...
NT2_TEST_CASE_TPL ( rem_signed_int_,  NT2_INTEGRAL_SIGNED_TYPES)
{
  using nt2::rem;
  using nt2::functors::rem_;
  typedef typename nt2::meta::call<rem_(T, T)>::type r_t;
