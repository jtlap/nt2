...
NT2_TEST_CASE_TPL ( oneminus_real_,  NT2_REAL_TYPES)
{
  using nt2::oneminus;
...
NT2_TEST_CASE_TPL ( oneminus_unsigned_int_,  NT2_UNSIGNED_TYPES)
{
  using nt2::oneminus;
  using nt2::functors::oneminus_;
  typedef typename nt2::meta::call<oneminus_(T)>::type r_t;
...
NT2_TEST_CASE_TPL ( oneminus_signed_int_,  NT2_INTEGRAL_SIGNED_TYPES)
{
  using nt2::oneminus;
  using nt2::functors::oneminus_;
  typedef typename nt2::meta::call<oneminus_(T)>::type r_t;
