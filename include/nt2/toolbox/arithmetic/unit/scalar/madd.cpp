...
NT2_TEST_CASE_TPL ( madd_real_,  NT2_REAL_TYPES)
{
  using nt2::madd;
...
NT2_TEST_CASE_TPL ( madd_unsigned_int_,  NT2_UNSIGNED_TYPES)
{
  using nt2::madd;
  using nt2::functors::madd_;
  typedef typename nt2::meta::call<madd_(T, T, T)>::type r_t;
...
NT2_TEST_CASE_TPL ( madd_signed_int_,  NT2_INTEGRAL_SIGNED_TYPES)
{
  using nt2::madd;
  using nt2::functors::madd_;
  typedef typename nt2::meta::call<madd_(T, T, T)>::type r_t;
