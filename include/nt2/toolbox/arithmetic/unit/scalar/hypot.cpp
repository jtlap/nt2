    ...
    for (int j =0; j < NR; ++j )
      {
        std::cout << "for params "
                  ...
                  << ", a1 = "<< u_t(a1 = tab_a1[j])
                  << std::endl;
        NT2_TEST_ULP_EQUAL( nt2::hypot(a0,a1),r_t(::hypot(a0,a1)),0.5);
...
NT2_TEST_CASE_TPL ( hypot_unsigned_int__2,  NT2_UNSIGNED_TYPES)
{
...
NT2_TEST_CASE_TPL ( hypot_signed_int__2,  NT2_INTEGRAL_SIGNED_TYPES)
{
