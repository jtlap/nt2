...
NT2_TEST_CASE_TPL ( sqrt1pm1_real_,  NT2_REAL_TYPES)
{
  using nt2::sqrt1pm1;
  ...
  NT2_TEST_ULP_EQUAL(  sqrt1pm1(nt2::One<T>()), nt2::Sqrt_2<r_t>()-nt2::One<r_t>(), 1);
  NT2_TEST_ULP_EQUAL(  sqrt1pm1(nt2::Zero<T>()), nt2::Zero<r_t>(), 0);
} // end of test for real_

NT2_TEST_CASE_TPL ( sqrt1pm1_unsigned_int_,  NT2_UNSIGNED_TYPES)
{
  using nt2::sqrt1pm1;
  using nt2::functors::sqrt1pm1_;
  typedef typename nt2::meta::call<sqrt1pm1_(T)>::type r_t;
...
NT2_TEST_CASE_TPL ( sqrt1pm1_signed_int_,  NT2_INTEGRAL_SIGNED_TYPES)
{
  using nt2::sqrt1pm1;
  using nt2::functors::sqrt1pm1_;
  typedef typename nt2::meta::call<sqrt1pm1_(T)>::type r_t;
