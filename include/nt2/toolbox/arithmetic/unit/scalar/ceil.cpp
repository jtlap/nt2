...
NT2_TEST_CASE_TPL ( ceil_real__1,  NT2_REAL_TYPES)
{
  ...
  NT2_TEST_ULP_EQUAL(  nt2::ceil(T(-1.1)), r_t(-1), 0);
  NT2_TEST_ULP_EQUAL(  nt2::ceil(T(1.1)), r_t(2), 0);
  NT2_TEST_ULP_EQUAL(  nt2::ceil(nt2::Inf<T>()), nt2::Inf<T>(), 0);
  NT2_TEST_ULP_EQUAL(  nt2::ceil(nt2::Minf<T>()), nt2::Minf<T>(), 0);
  NT2_TEST_ULP_EQUAL(  nt2::ceil(nt2::Mone<T>()), nt2::Mone<T>(), 0);
  NT2_TEST_ULP_EQUAL(  nt2::ceil(nt2::Nan<T>()), nt2::Nan<T>(), 0);
  NT2_TEST_ULP_EQUAL(  nt2::ceil(nt2::One<T>()), nt2::One<T>(), 0);
  NT2_TEST_ULP_EQUAL(  nt2::ceil(nt2::Zero<T>()), nt2::Zero<T>(), 0);
    ...
    for (int j =0; j < NR; ++j )
      {
        std::cout << "for param "
                  << "  a0 = "<< u_t(a0 = tab_a0[j])
                  << std::endl;
	r_t z = nt2::standard::ceil(a0);
	r_t z1= nt2::ceil(a0); 
//         NT2_TEST_ULP_EQUAL( nt2::ceil(a0),
// 			    nt2::standard::ceil(a0),0);
     }
   }
