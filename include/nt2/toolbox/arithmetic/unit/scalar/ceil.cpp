...
NT2_TEST_CASE_TPL ( ceil_real_,  NT2_REAL_TYPES)
{
  using nt2::ceil;
...
NT2_TEST_CASE_TPL ( ceil_signed_int_,  NT2_INTEGRAL_SIGNED_TYPES)
{
  using nt2::ceil;
  using nt2::functors::ceil_;
  typedef typename nt2::meta::call<ceil_(T)>::type r_t;
...
NT2_TEST_CASE_TPL ( ceil_unsigned_int_,  NT2_UNSIGNED_TYPES)
{
  using nt2::ceil;
  using nt2::functors::ceil_;
  typedef typename nt2::meta::call<ceil_(T)>::type r_t;
