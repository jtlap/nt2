...
NT2_TEST_CASE_TPL ( sqr_real_,  NT2_REAL_TYPES)
{
  using nt2::sqr;
...
NT2_TEST_CASE_TPL ( sqr_unsigned_int_,  NT2_UNSIGNED_TYPES)
{
  using nt2::sqr;
  using nt2::functors::sqr_;
  typedef typename nt2::meta::call<sqr_(T)>::type r_t;
...
NT2_TEST_CASE_TPL ( sqr_signed_int_,  NT2_INTEGRAL_SIGNED_TYPES)
{
  using nt2::sqr;
  using nt2::functors::sqr_;
  typedef typename nt2::meta::call<sqr_(T)>::type r_t;
