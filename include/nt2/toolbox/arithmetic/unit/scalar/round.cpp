...
NT2_TEST_CASE_TPL ( round_real_,  NT2_REAL_TYPES)
{
  using nt2::round;
...
NT2_TEST_CASE_TPL ( round_unsigned_int_,  NT2_UNSIGNED_TYPES)
{
  using nt2::round;
  using nt2::functors::round_;
  typedef typename nt2::meta::call<round_(T)>::type r_t;
...
NT2_TEST_CASE_TPL ( round_signed_int_,  NT2_INTEGRAL_SIGNED_TYPES)
{
  using nt2::round;
  using nt2::functors::round_;
  typedef typename nt2::meta::call<round_(T)>::type r_t;
