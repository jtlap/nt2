...
NT2_TEST_CASE_TPL ( iround_real_,  NT2_REAL_TYPES)
{
  using nt2::iround;
...
NT2_TEST_CASE_TPL ( iround_unsigned_int_,  NT2_UNSIGNED_TYPES)
{
  using nt2::iround;
  using nt2::functors::iround_;
  typedef typename nt2::meta::call<iround_(T)>::type r_t;
...
NT2_TEST_CASE_TPL ( iround_signed_int_,  NT2_INTEGRAL_SIGNED_TYPES)
{
  using nt2::iround;
  using nt2::functors::iround_;
  typedef typename nt2::meta::call<iround_(T)>::type r_t;
