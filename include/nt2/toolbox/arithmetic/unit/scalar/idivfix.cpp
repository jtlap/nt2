...
NT2_TEST_CASE_TPL ( idivfix_real_,  NT2_REAL_TYPES)
{
  using nt2::idivfix;
...
NT2_TEST_CASE_TPL ( idivfix_unsigned_int_,  NT2_UNSIGNED_TYPES)
{
  using nt2::idivfix;
  using nt2::functors::idivfix_;
  typedef typename nt2::meta::call<idivfix_(T, T)>::type r_t;
...
NT2_TEST_CASE_TPL ( idivfix_signed_int_,  NT2_INTEGRAL_SIGNED_TYPES)
{
  using nt2::idivfix;
  using nt2::functors::idivfix_;
  typedef typename nt2::meta::call<idivfix_(T, T)>::type r_t;
