...
NT2_TEST_CASE_TPL ( idivfloor_real_,  NT2_REAL_TYPES)
{
  using nt2::idivfloor;
...
NT2_TEST_CASE_TPL ( idivfloor_unsigned_int_,  NT2_UNSIGNED_TYPES)
{
  using nt2::idivfloor;
  using nt2::functors::idivfloor_;
  typedef typename nt2::meta::call<idivfloor_(T, T)>::type r_t;
...
NT2_TEST_CASE_TPL ( idivfloor_signed_int_,  NT2_INTEGRAL_SIGNED_TYPES)
{
  using nt2::idivfloor;
  using nt2::functors::idivfloor_;
  typedef typename nt2::meta::call<idivfloor_(T, T)>::type r_t;
