...
NT2_TEST_CASE_TPL ( idivfloor_real__2,  NT2_REAL_TYPES)
{
  using nt2::idivfloor;
  ...
  NT2_TEST_ULP_EQUAL(  idivfloor(4,3), 1, 0);
  NT2_TEST_ULP_EQUAL(  idivfloor(nt2::Inf<T>(), nt2::Inf<T>()), nt2::Nan<T>(), 0);
  NT2_TEST_ULP_EQUAL(  idivfloor(nt2::Minf<T>(), nt2::Minf<T>()), nt2::Nan<T>(), 0);
  NT2_TEST_ULP_EQUAL(  idivfloor(nt2::Mone<T>(), nt2::Mone<T>()), nt2::One<T>(), 0);
  NT2_TEST_ULP_EQUAL(  idivfloor(nt2::Nan<T>(), nt2::Nan<T>()), nt2::Nan<T>(), 0);
  NT2_TEST_ULP_EQUAL(  idivfloor(nt2::One<T>(), nt2::One<T>()), nt2::One<T>(), 0);
  NT2_TEST_ULP_EQUAL(  idivfloor(nt2::Zero<T>(), nt2::Zero<T>()), nt2::Nan<T>(), 0);
    ...
    for (int j =0; j < NR; ++j )
      {
        std::cout << "for params "
                  ...
                  << ", a1 = "<< u_t(a1 = tab_a1[j])
                  << std::endl;
        NT2_TEST_ULP_EQUAL( nt2::idivfloor(a0,a1),r_t(nt2::floor((1.0*a0)/a1)),0);
     }
   }
} // end of test for real_

NT2_TEST_CASE_TPL ( idivfloor_unsigned_int__2,  NT2_UNSIGNED_TYPES)
{
  using nt2::idivfloor;
  using nt2::tag::idivfloor_;
  typedef typename nt2::meta::call<idivfloor_(T,T)>::type r_t;
  ...
  NT2_TEST_ULP_EQUAL(  idivfloor(4,3), 1, 0);
  NT2_TEST_ULP_EQUAL(  idivfloor(nt2::One<T>(), nt2::One<T>()), nt2::One<T>(), 0);
  NT2_TEST_ULP_EQUAL(  idivfloor(nt2::Zero<T>(), nt2::Zero<T>()), nt2::Zero<T>(), 0);
  // random verifications
  static const uint32_t NR = 100;
  {
...
NT2_TEST_CASE_TPL ( idivfloor_signed_int__2,  NT2_INTEGRAL_SIGNED_TYPES)
{
  using nt2::idivfloor;
  using nt2::tag::idivfloor_;
  typedef typename nt2::meta::call<idivfloor_(T,T)>::type r_t;
