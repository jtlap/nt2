...
NT2_TEST_CASE_TPL ( rdivide_real_,  NT2_REAL_TYPES)
{
  using nt2::rdivide;
...
NT2_TEST_CASE_TPL ( rdivide_unsigned_int_,  NT2_UNSIGNED_TYPES)
{
  using nt2::rdivide;
  using nt2::functors::rdivide_;
  typedef typename nt2::meta::call<rdivide_(T, T)>::type r_t;
...
NT2_TEST_CASE_TPL ( rdivide_signed_int_,  NT2_INTEGRAL_SIGNED_TYPES)
{
  using nt2::rdivide;
  using nt2::functors::rdivide_;
  typedef typename nt2::meta::call<rdivide_(T, T)>::type r_t;
