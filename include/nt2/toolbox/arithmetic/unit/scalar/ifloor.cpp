...
NT2_TEST_CASE_TPL ( ifloor_real_,  NT2_REAL_TYPES)
{
  using nt2::ifloor;
...
NT2_TEST_CASE_TPL ( ifloor_unsigned_int_,  NT2_UNSIGNED_TYPES)
{
  using nt2::ifloor;
  using nt2::functors::ifloor_;
  typedef typename nt2::meta::call<ifloor_(T)>::type r_t;
...
NT2_TEST_CASE_TPL ( ifloor_signed_int_,  NT2_INTEGRAL_SIGNED_TYPES)
{
  using nt2::ifloor;
  using nt2::functors::ifloor_;
  typedef typename nt2::meta::call<ifloor_(T)>::type r_t;
