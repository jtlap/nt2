...
NT2_TEST_CASE_TPL ( minusone_real_,  NT2_REAL_TYPES)
{
  using nt2::minusone;
...
NT2_TEST_CASE_TPL ( minusone_unsigned_int_,  NT2_UNSIGNED_TYPES)
{
  using nt2::minusone;
  using nt2::functors::minusone_;
  typedef typename nt2::meta::call<minusone_(T)>::type r_t;
...
NT2_TEST_CASE_TPL ( minusone_signed_int_,  NT2_INTEGRAL_SIGNED_TYPES)
{
  using nt2::minusone;
  using nt2::functors::minusone_;
  typedef typename nt2::meta::call<minusone_(T)>::type r_t;
