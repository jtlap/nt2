...
<<<<<<< Updated upstream:include/nt2/toolbox/arithmetic/unit/scalar/minusone.cpp
=======
                          (bool)
>>>>>>> Stashed changes:include/nt2/toolbox/arithmetic/unit/scalar/minusone.cpp
                  )
{
  using nt2::minusone;
...
=======
  //NT2_TEST( (boost::is_same < typename nt2::meta::call<minusone_(T)>::type
  //            , bool
  //            >::value)
  //         );
  //NT2_TEST_EQUAL(  minusone( T(42) ), T(42) );
  //NT2_TEST_EQUAL(  minusone( T(-42) ), -T(-42) );
  //NT2_TEST(  minusone(T(1337))  );
  //NT2_TEST( !minusone(T(0))     );
}
