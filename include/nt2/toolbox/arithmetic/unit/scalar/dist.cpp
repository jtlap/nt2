...
NT2_TEST_CASE_TPL ( dist_real_,  NT2_REAL_TYPES)
{
  using nt2::dist;
...
NT2_TEST_CASE_TPL ( dist_signed_int_,  NT2_INTEGRAL_SIGNED_TYPES)
{
  using nt2::dist;
  using nt2::functors::dist_;
  typedef typename nt2::meta::call<dist_(T, T)>::type r_t;
...
NT2_TEST_CASE_TPL ( dist_unsigned_int_,  NT2_UNSIGNED_TYPES)
{
  using nt2::dist;
  using nt2::functors::dist_;
  typedef typename nt2::meta::call<dist_(T, T)>::type r_t;
