...
NT2_TEST_CASE_TPL ( dist_real__2,  NT2_REAL_TYPES)
{
  using nt2::dist;
  using nt2::tag::dist_;
  ...
  {
    NT2_CREATE_SCALAR_BUFFER(a0,T, NR, nt2::Valmin<T>()/2, nt2::Valmax<T>()/2);
    NT2_CREATE_SCALAR_BUFFER(a1,T, NR, nt2::Valmin<T>(), nt2::Valmax<T>());
...
NT2_TEST_CASE_TPL ( dist_signed_int__2,  NT2_INTEGRAL_SIGNED_TYPES)
{
  using nt2::dist;
  using nt2::tag::dist_;
  typedef typename nt2::meta::as_integer<T>::type iT;
...
NT2_TEST_CASE_TPL ( dist_unsigned_int__2,  NT2_UNSIGNED_TYPES)
{
  using nt2::dist;
  using nt2::tag::dist_;
  typedef typename nt2::meta::as_integer<T>::type iT;
