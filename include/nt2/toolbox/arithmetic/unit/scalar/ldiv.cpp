...
NT2_TEST_CASE_TPL ( ldiv_real_,  NT2_REAL_TYPES)
{
  using nt2::ldiv;
...
NT2_TEST_CASE_TPL ( ldiv_unsigned_int_,  NT2_UNSIGNED_TYPES)
{
  using nt2::ldiv;
  using nt2::functors::ldiv_;
  typedef typename nt2::meta::call<ldiv_(T, T)>::type r_t;
...
NT2_TEST_CASE_TPL ( ldiv_signed_int_,  NT2_INTEGRAL_SIGNED_TYPES)
{
  using nt2::ldiv;
  using nt2::functors::ldiv_;
  typedef typename nt2::meta::call<ldiv_(T, T)>::type r_t;
