...
NT2_TEST_CASE_TPL ( arg_real_,  NT2_REAL_TYPES)
{
  using nt2::arg;
...
NT2_TEST_CASE_TPL ( arg_unsigned_int_,  NT2_UNSIGNED_TYPES)
{
  using nt2::arg;
  using nt2::functors::arg_;
  typedef typename nt2::meta::call<arg_(T)>::type r_t;
...
NT2_TEST_CASE_TPL ( arg_signed_int_,  NT2_INTEGRAL_SIGNED_TYPES)
{
  using nt2::arg;
  using nt2::functors::arg_;
  typedef typename nt2::meta::call<arg_(T)>::type r_t;
