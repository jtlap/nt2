...
NT2_TEST_CASE_TPL ( iround2even_real_,  NT2_REAL_TYPES)
{
...
NT2_TEST_CASE_TPL ( iround2even_unsigned_int_,  NT2_UNSIGNED_TYPES)
{
  using nt2::iround2even;
  using nt2::functors::iround2even_;
  typedef typename nt2::meta::call<iround2even_(T)>::type r_t;
...
NT2_TEST_CASE_TPL ( iround2even_signed_int_,  NT2_INTEGRAL_SIGNED_TYPES)
{
  using nt2::iround2even;
  using nt2::functors::iround2even_;
  typedef typename nt2::meta::call<iround2even_(T)>::type r_t;
