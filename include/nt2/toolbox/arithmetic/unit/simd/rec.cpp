...
//////////////////////////////////////////////////////////////////////////////
NT2_TEST_CASE_TPL(rec, (double)(float)(int64_t)(int32_t)(uint64_t)(uint32_t))
{
 using nt2::rec;
 using nt2::tag::rec_;    
 using nt2::load; 
