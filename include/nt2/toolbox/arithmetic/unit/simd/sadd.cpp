...
//////////////////////////////////////////////////////////////////////////////
#define NT2_UNIT_MODULE "nt2 arithmetic toolbox - sadd/simd Mode"
...
NT2_TEST_CASE_TPL ( sadd_signed_int__2_0,  (int64_t))//NT2_INTEGRAL_SIGNED_TYPES)
{
  using nt2::sadd;
  using nt2::tag::sadd_;
  using nt2::load; 
  ...
  typedef typename nt2::meta::call<sadd_(vT,vT)>::type r_t;
  typedef typename nt2::meta::call<sadd_(T,T)>::type sr_t;
    ...
    for(uint32_t j = 0; j < NR/cardinal_of<n_t>::value; j++)
      {
        ...
        for(int i = 0; i< cardinal_of<n_t>::value; i++)
        {
          ...
          NT2_TEST_EQUAL( v[i],ssr_t(nt2::sadd(tab_a0[k],tab_a1[k])));
        }
      }
