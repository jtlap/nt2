...
//////////////////////////////////////////////////////////////////////////////
#ifndef NT2_TOOLBOX_ARITHMETIC_FUNCTION_SIMD_SSE_SSE2_SADD_HPP_INCLUDED
#define NT2_TOOLBOX_ARITHMETIC_FUNCTION_SIMD_SSE_SSE2_SADD_HPP_INCLUDED
...
/////////////////////////////////////////////////////////////////////////////
NT2_REGISTER_DISPATCH(tag::sadd_, tag::cpu_,
                          (A0),
...
namespace nt2 { namespace ext
{
  ...
  struct call<tag::sadd_(tag::simd_<tag::uint64_, tag::sse_>,
...
{
  template<class Dummy>
  struct call<tag::sadd_(tag::simd_<tag::int64_, tag::sse_>,
...
{
  template<class Dummy>
  struct call<tag::sadd_(tag::simd_<tag::uint32_, tag::sse_>,
...
{
  template<class Dummy>
  struct call<tag::sadd_(tag::simd_<tag::int32_, tag::sse_>,
...
{
  template<class Dummy>
  struct call<tag::sadd_(tag::simd_<tag::uint16_, tag::sse_>,
...
{
  template<class Dummy>
  struct call<tag::sadd_(tag::simd_<tag::int16_, tag::sse_>,
...
{
  template<class Dummy>
  struct call<tag::sadd_(tag::simd_<tag::uint8_, tag::sse_>,
...
{
  template<class Dummy>
  struct call<tag::sadd_(tag::simd_<tag::int8_, tag::sse_>,
