...
namespace nt2 { namespace ext
{
  ...
  struct call<tag::max_(tag::simd_(tag::arithmetic_, tag::see_),
...
{
  template<class Dummy>
  struct call<tag::max_(tag::simd_(tag::double_, tag::see_),
...
{
  template<class Dummy>
  struct call<tag::max_(tag::simd_(tag::float_, tag::see_),
...
{
  template<class Dummy>
  struct call<tag::max_(tag::simd_(tag::int16_, tag::see_),
...
{
  template<class Dummy>
  struct call<tag::max_(tag::simd_(tag::uint8_, tag::see_),
