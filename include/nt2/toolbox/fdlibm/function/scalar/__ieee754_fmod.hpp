...
/////////////////////////////////////////////////////////////////////////////
NT2_REGISTER_DISPATCH(tag::__ieee754_fmod_, tag::cpu_,
                                (A0)(A1),
...
namespace nt2 { namespace ext
{
  ...
  struct call<tag::__ieee754_fmod_(tag::arithmetic_,tag::arithmetic_),
...
{
  template<class Dummy>
  struct call<tag::__ieee754_fmod_(tag::double_,tag::double_),
              tag::cpu_, Dummy> : callable
  {
    template<class Sig> struct result;
    template<class This,class A0, class A1>
