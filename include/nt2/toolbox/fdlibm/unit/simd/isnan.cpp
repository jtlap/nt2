...
//////////////////////////////////////////////////////////////////////////////
#define NT2_UNIT_MODULE "nt2 fdlibm toolbox - isnan - unit/simd Mode"
...
//////////////////////////////////////////////////////////////////////////////
//NT2_TEST_CASE_TPL(isnan, NT2_SIMD_TYPES )
//{
//  using nt2::isnan;
//  using nt2::functors::isnan;
// 
...
//    data[i] = i; // good value here for isnan
//
//    n_t a0 = load<n_t>(&data[0],0);
//    n_t v  = isnan(a0);
//    for(std::size_t j=0;j<cardinal_of<n_t>::value;++j)
//    {
//      NT2_TEST_EQUAL( v[j], isnan(a0[j]) );
//    }
//  }
//}
