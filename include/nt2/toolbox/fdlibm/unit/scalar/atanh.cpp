...
#include <nt2/toolbox/fdlibm/include/atanh.hpp> 
                ...
                )
{
  ...
  const int N = 2; 
   ...
   NT2_TEST_EQUAL(  nt2::fdlibm::atanh( T(0) )  , 0 );
   NT2_TEST_EQUAL(  nt2::fdlibm::atanh( T(1) )  , nt2::Inf<T>());
   NT2_TEST      (  nt2::is_nan(nt2::fdlibm::atanh(nt2::Nan<T>()) )); 
   NT2_TEST_LESSER_EQUAL(  nt2::ulpdist(nt2::fdlibm::atanh( T(0.5) )  , T(0.549306144334055)), 1);
...
T v[] ={  9.990009990009990e-04,     4.997501249375312e-04,     3.332222592469177e-04, 
   ...
   for(int i=0; i < 9; i++) 
     {
       NT2_TEST_LESSER_EQUAL(nt2::ulpdist(nt2::fdlibm::atanh(v[i]), t[i]), 3);
       std::cout << std::setprecision(16) << v[i] << "  " << nt2::fdlibm::atanh(v[i]) << "  " << t[i] << std::endl; 
     }
}
