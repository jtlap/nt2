...
{
  using nt2::fdlibm::asinh; 
  using nt2::fdlibm::tag::asinh_;
  const int N = 2; 
   ...
   NT2_TEST_EQUAL(  nt2::fdlibm::asinh( T(0) )  , 0 );
   NT2_TEST_LESSER_EQUAL(  nt2::ulpdist(asinh( T(1) )  , T(0.881373587019543)), 1);
   NT2_TEST_EQUAL(  nt2::fdlibm::asinh(nt2::Inf<T>() ), nt2::Inf<T>());
   NT2_TEST      (  nt2::is_nan(nt2::fdlibm::asinh(nt2::Nan<T>()) )); 

   for(int i=0; i < 10; i++)
     {
       T x =  i; 
       NT2_TEST_LESSER_EQUAL(nt2::ulpdist(x, nt2::sinh(nt2::fdlibm::asinh(x))), 1); 
     }
}
