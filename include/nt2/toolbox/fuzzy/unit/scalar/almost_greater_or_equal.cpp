...
NT2_TEST_CASE_TPL ( almost_greater_or_equal_real__3,  NT2_REAL_TYPES)
{
  ...
  NT2_TEST_EQUAL(almost_greater_or_equal(0,0,1), nt2::True<r_t>());
  NT2_TEST_EQUAL(almost_greater_or_equal(0,1,1), nt2::True<r_t>());
    ...
    for (int j =0; j < NR; ++j )
      {
        std::cout << "for params "
                  ...
                  << ", a2 = "<< u_t(a2 = tab_a2[j])
                  << std::endl;
        NT2_TEST_EQUAL( nt2::almost_greater_or_equal(a0,a1,a2),nt2::almost_greater_or_equal(a0,a1,a2));
     }
     
   }
} // end of test for real_

NT2_TEST_CASE_TPL ( almost_greater_or_equal_signed_int__3,  NT2_INTEGRAL_SIGNED_TYPES)
{
...
NT2_TEST_CASE_TPL ( almost_greater_or_equal_unsigned_int__3,  NT2_UNSIGNED_TYPES)
{
