...
//////////////////////////////////////////////////////////////////////////////
#define NT2_UNIT_MODULE "nt2 fuzzy toolbox - fuzzy_equal/scalar Mode"
...
NT2_TEST_CASE_TPL ( fuzzy_equal_real__3,  NT2_REAL_TYPES)
{
  
  using nt2::fuzzy_equal;
  using nt2::tag::fuzzy_equal_;
  typedef typename nt2::meta::as_integer<T>::type iT;
  typedef typename nt2::meta::call<fuzzy_equal_(T,T,T)>::type r_t;
    ...
    for (int j =0; j < NR; ++j )
      {
        std::cout << "for params "
                  ...
                  << ", a2 = "<< u_t(a2 = tab_a2[j])
                  << std::endl;
        NT2_TEST_EQUAL( nt2::fuzzy_equal(a0,a1,a2),nt2::fuzzy_equal(a0,a1,a2));
     }
