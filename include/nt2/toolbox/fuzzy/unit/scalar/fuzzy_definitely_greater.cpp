...
NT2_TEST_CASE_TPL ( fuzzy_definitely_greater_real__3,  NT2_REAL_TYPES)
{
  ...
  NT2_TEST_EQUAL(fuzzy_definitely_greater(0,0,1), nt2::False<r_t>());
  NT2_TEST_EQUAL(fuzzy_definitely_greater(0,1,1), nt2::False<r_t>());
    ...
    for (int j =0; j < NR; ++j )
      {
        std::cout << "for params "
                  ...
                  << ", a2 = "<< u_t(a2 = tab_a2[j])
                  << std::endl;
        NT2_TEST_EQUAL( nt2::fuzzy_definitely_greater(a0,a1,a2),nt2::fuzzy_definitely_greater(a0,a1,a2));
     }
     
   }
} // end of test for real_

NT2_TEST_CASE_TPL ( fuzzy_definitely_greater_signed_int__3,  NT2_INTEGRAL_SIGNED_TYPES)
{
...
NT2_TEST_CASE_TPL ( fuzzy_definitely_greater_unsigned_int__3,  NT2_UNSIGNED_TYPES)
{
