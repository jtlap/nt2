...
NT2_TEST_CASE_TPL ( fuzzy_definitely_less_real__3,  NT2_REAL_TYPES)
{
  ...
  NT2_TEST_EQUAL(fuzzy_definitely_less(0,0,1), nt2::False<r_t>());
  NT2_TEST_EQUAL(fuzzy_definitely_less(0,1,1), nt2::False<r_t>());
...
NT2_TEST_CASE_TPL ( fuzzy_definitely_less_signed_int__3,  NT2_INTEGRAL_SIGNED_TYPES)
{
...
NT2_TEST_CASE_TPL ( fuzzy_definitely_less_unsigned_int__3,  NT2_UNSIGNED_TYPES)
{
