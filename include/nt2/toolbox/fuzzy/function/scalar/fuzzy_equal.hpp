...
namespace nt2 { namespace functors
{
  ...
  //  no special validate for fuzzy_equal

  /////////////////////////////////////////////////////////////////////////////
  // Compute fuzzy_equal(const A0& a0, const A1& a1, const A2& a2)
  /////////////////////////////////////////////////////////////////////////////
  ...
  /////////////////////////////////////////////////////////////////////////////
  template<class Info>
  struct  call<fuzzy_equal_,tag::scalar_(tag::arithmetic_),fundamental_,Info> : callable
  {
