...
namespace nt2 { namespace functors
{
  ...
  //  no special validate for fuzzy_greater_or_equal

  /////////////////////////////////////////////////////////////////////////////
  // Compute fuzzy_greater_or_equal(const A0& a0, const A1& a1, const A2& a2)
  /////////////////////////////////////////////////////////////////////////////
  ...
  /////////////////////////////////////////////////////////////////////////////
  template<class Info>
  struct  call<fuzzy_greater_or_equal_,tag::scalar_(tag::arithmetic_),fundamental_,Info> : callable
  {
