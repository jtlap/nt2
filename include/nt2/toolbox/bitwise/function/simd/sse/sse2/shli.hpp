...
namespace nt2 { namespace ext
{
  ...
  struct call<tag::shli_(tag::simd_(tag::types8_, tag::see_),
...
{
  template<class Dummy>
  struct call<tag::shli_(tag::simd_(tag::types32_, tag::see_),
...
{
  template<class Dummy>
  struct call<tag::shli_(tag::simd_(tag::types64_, tag::see_),
...
{
  template<class Dummy>
  struct call<tag::shli_(tag::simd_(tag::types16_, tag::see_),
