...
namespace nt2 { namespace ext
{
  ...
  struct call<tag::bitwise_andnot_(tag::simd_(tag::arithmetic_, tag::see_),
...
{
  template<class Dummy>
  struct call<tag::bitwise_andnot_(tag::simd_(tag::double_, tag::see_),
...
{
  template<class Dummy>
  struct call<tag::bitwise_andnot_(tag::simd_(tag::float_, tag::see_),
