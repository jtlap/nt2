...
NT2_TIMING(nt2::tag::firstbitunset_,(RS(vfloat,-10000.0f,10000.0f)))
NT2_TIMING(nt2::tag::firstbitunset_,(RS(vdouble,-10000.0,10000.0)))
NT2_TIMING(nt2::tag::firstbitunset_,(RS(vint64_t,-10000,10000)))
NT2_TIMING(nt2::tag::firstbitunset_,(RS(vint32_t,-10000,10000)))
NT2_TIMING(nt2::tag::firstbitunset_,(RS(vint16_t,-32768,32767)))
NT2_TIMING(nt2::tag::firstbitunset_,(RS(vint8_t,-128,127)))
NT2_TIMING(nt2::tag::firstbitunset_,(RS(vuint64_t,0,65535)))
NT2_TIMING(nt2::tag::firstbitunset_,(RS(vuint32_t,0,65535)))
NT2_TIMING(nt2::tag::firstbitunset_,(RS(vuint16_t,0,65535)))
NT2_TIMING(nt2::tag::firstbitunset_,(RS(vuint8_t,0,255)))
