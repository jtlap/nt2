...
//////////////////////////////////////////////////////////////////////////////
#define NT2_UNIT_MODULE "nt2 bitwise toolbox - rror/scalar Mode"
...
NT2_TEST_CASE_TPL ( rror_integer__2,  NT2_INTEGRAL_TYPES)
{
  using nt2::rror;
  using nt2::tag::rror_;
  ...
  NT2_TEST_ULP_EQUAL(  rror(nt2::Zero<T>(), nt2::Zero<T>()), nt2::Zero<r_t>(), 0.5);
    ...
    for (int j =0; j < NR; ++j )
      {
        std::cout << "for params "
                  ...
                  << ", a1 = "<< u_t(a1 = tab_a1[j])
                  << std::endl;
        NT2_TEST_ULP_EQUAL( nt2::rror(a0,a1),nt2::rror(a0,a1),0);
