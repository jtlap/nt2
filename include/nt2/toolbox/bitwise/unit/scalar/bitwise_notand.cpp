...
NT2_TEST_CASE_TPL ( bitwise_notand_real__2,  NT2_REAL_TYPES)
{
  ...
  NT2_TEST_ULP_EQUAL(  bitwise_notand(nt2::Inf<T>(), nt2::Inf<T>()), nt2::Zero<r_t>(), 0.5);
  NT2_TEST_ULP_EQUAL(  bitwise_notand(nt2::Minf<T>(), nt2::Minf<T>()), nt2::Zero<r_t>(), 0.5);
  NT2_TEST_ULP_EQUAL(  bitwise_notand(nt2::Nan<T>(), nt2::Nan<T>()), nt2::Zero<r_t>(), 0.5);
  NT2_TEST_ULP_EQUAL(  bitwise_notand(nt2::One<T>(),nt2::Zero<T>()), nt2::Zero<r_t>(), 0.5);
...
NT2_TEST_CASE_TPL ( bitwise_notand_integer__2,  NT2_INTEGRAL_TYPES)
{
  ...
  // specific values tests
  NT2_TEST_ULP_EQUAL(  bitwise_notand(nt2::One<T>(), nt2::One<T>()), nt2::Zero<r_t>(), 0.5);
  NT2_TEST_ULP_EQUAL(  bitwise_notand(nt2::One<T>(),nt2::Zero<T>()), nt2::Zero<r_t>(), 0.5);
  NT2_TEST_ULP_EQUAL(  bitwise_notand(nt2::Zero<T>(), nt2::Zero<T>()), nt2::Zero<r_t>(), 0.5);
