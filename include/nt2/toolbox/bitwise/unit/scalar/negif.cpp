...
NT2_TEST_CASE_TPL ( negif_real__2,  NT2_REAL_TYPES)
{
  ...
  NT2_TEST_ULP_EQUAL(  negif(0,1), 1, 0.5);
  NT2_TEST_ULP_EQUAL(  negif(1,1), -1, 0.5);
  NT2_TEST_ULP_EQUAL(  negif(nt2::Inf<T>(),1), -1, 0.5);
  NT2_TEST_ULP_EQUAL(  negif(nt2::Minf<T>(),1), -1, 0.5);
  NT2_TEST_ULP_EQUAL(  negif(nt2::Nan<T>(),1), -1, 0.5);
  NT2_TEST_ULP_EQUAL(  negif(nt2::Zero<T>(),1), 1, 0.5);
