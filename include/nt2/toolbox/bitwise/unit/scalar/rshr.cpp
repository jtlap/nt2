...
//////////////////////////////////////////////////////////////////////////////
#define NT2_UNIT_MODULE "nt2 bitwise toolbox - rshr/scalar Mode"
...
NT2_TEST_CASE_TPL ( rshr_integer__2,  NT2_INTEGRAL_TYPES)
{
  using nt2::rshr;
  using nt2::tag::rshr_;
  ...
  NT2_TEST_ULP_EQUAL(  rshr(nt2::Zero<T>(), nt2::Zero<T>()), nt2::Zero<r_t>(), 0.5);
    ...
    for (int j =0; j < NR; ++j )
      {
        std::cout << "for params "
                  ...
                  << ", a1 = "<< u_t(a1 = tab_a1[j])
                  << std::endl;
        NT2_TEST_ULP_EQUAL( nt2::rshr(a0,a1),nt2::rshr(a0,a1),0);
