...
NT2_TEST_CASE_TPL ( bitwise_ornot_real_convert__2,  NT2_REAL_CONVERTIBLE_TYPES)
{
    ...
    for(int j = 0; j < NR/cardinal_of<n_t>::value; j++)
      {
        ...
        r_t v = bitwise_ornot(a0,a1);
        for(int i = 0; i< cardinal_of<n_t>::value; i++)
        {
          int k = i+j*cardinal_of<n_t>::value;
          NT2_TEST_ULP_EQUAL( v[i],nt2::bitwise_ornot(tab_a0[k],tab_a1[k]),1.5);
