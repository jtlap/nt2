...
{
    'functor' : {       ## intrinsics values related to functor rrol
    ...
    'unit'    : {       ## informations for creating unit tests
        ...
        'verif_test'      : { ## verification dictionary
            ...
            'property_call'   : {'integer_' : ['nt2::rrol(a0,a1)'],},  ## dictionary of calls per types
            'property_value'  : {'integer_' : ['nt2::rrol(a0,a1)'],}, ## dictionary of alternate calls
