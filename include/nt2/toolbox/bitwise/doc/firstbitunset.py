...
{
    'functor' : {       ## intrinsics values related to functor firstbitunset
    ...
    'unit'    : {       ## informations for creating unit tests
        ...
        'verif_test'      : { ## verification dictionary
            ...
            'property_call'   : {},   ##'integer_' : ['nt2::firstbitunset(a0)'],},  ## dictionary of calls per types
            'property_value'  : {},   ##'integer_' : ['nt2::firstbitunset(a0)'],}, ## dictionary of alternate calls
