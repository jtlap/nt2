...
{
    'functor' : {       ## intrinsics values related to functor rol
...
#                    'nt2::One<T>()<<(sizeof(T)*8-1),1': {'result' : 'nt2::One<r_t>()','ulp_thresh':'0.5'},
        ...
        'verif_test'      : { ## verification dictionary
            ...
            'property_call'   : {},   ##'integer_' : ['nt2::rol(a0,a1)'],},  ## dictionary of calls per types
            'property_value'  : {},   ##'integer_' : ['nt2::rol(a0,a1)'],}, ## dictionary of alternate calls
