...
{
    'functor' : {       ## intrinsics values related to functor genmask
    ...
    'unit'    : {       ## informations for creating unit tests
        ...
        'verif_test'      : { ## verification dictionary
            ...
            'property_call'   : {'integer_' : ['nt2::genmask(a0)'],},
                                ## 'real_' : ['nt2::genmask(a0)']},  ## dictionary of calls per types
            'property_value'  : {'integer_' : ['a0?nt2::Mone<r_t>():nt2::Zero<r_t>()'],},
                                ## 'real' : ['a0?nt2::Nan<r_t>():nt2::Zero<r_t>()'],}, ## dictionary of alternate calls
