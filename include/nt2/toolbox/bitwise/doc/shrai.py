...
{
    'functor' : {       ## intrinsics values related to functor shrai
    ...
    'unit'    : {       ## informations for creating unit tests
        ...
        'specific_values' : {
                ...
                'signed_int_': {
                    ...
                    'nt2::One<T>(),1': {'result' : 'nt2::Zero<r_t>()','ulp_thresh':'0.5'},
                    'nt2::Two<T>(),1': {'result' : 'nt2::One<T>()','ulp_thresh':'0.5'},
                    'nt2::Mone<T>(),(sizeof(T)*8-1)': {'result' : 'nt2::Mone<r_t>()','ulp_thresh':'0.5'},
                    'nt2::Mone<T>(),(sizeof(T)*8-2)': {'result' : 'nt2::Mone<r_t>()','ulp_thresh':'0.5'},
                    '-nt2::Two<T>(),1': {'result' : 'nt2::Mone<r_t>()','ulp_thresh':'0.5'},
                    '-nt2::Three<T>(),1': {'result' : '-nt2::Two<r_t>()','ulp_thresh':'0.5'},
        ...
        'verif_test'      : { ## verification dictionary
            ...
            'property_call'   : {'unsigned_int_' : ['nt2::shrai(a0,a1)'],},  ## dictionary of calls per types
