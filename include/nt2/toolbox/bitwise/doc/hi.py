...
{
    'functor' : {       ## intrinsics values related to functor hi
        ...
        'rturn'         : { 'default' : 'typename nt2::meta::downgrade<ir_t>::type' },     ## dictionary of return types
        'call_types'    : [],## types used in call ['T']*arity if omitted 
        'type_defs'     : ['typedef typename nt2::meta::as_integer<T,unsigned>::type ir_t;'],  ## supplementary typedefs
 ##       'type_defs_aft' : ['typedef typename nt2::meta::downgrade<r_t>::type dr_t;'],  ## supplementary typedefs     
    ...
    'unit'    : {       ## informations for creating unit tests
        ...
        'verif_test'      : { ## verification dictionary
            ...
            'property_call'   : {},   ##'integer_' : ['nt2::hi(a0)'],},  ## dictionary of calls per types
            'property_value'  : {},   ##'integer_' : ['nt2::hi(a0)'],}, ## dictionary of alternate calls
