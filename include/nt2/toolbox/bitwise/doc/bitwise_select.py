...
{
    'functor' : {       ## intrinsics values related to functor bitwise_select
    ...
    'unit'    : {       ## informations for creating unit tests
        ...
        'verif_test'      : { ## verification dictionary
            ...
            'property_call'   : {'integer_' : ['nt2::bitwise_select(a0,a1,a2)'],},  ## dictionary of calls per types
            'property_value'  : {'integer_' : ['(a1&a0)|(a2&(~a0))'],}, ## dictionary of alternate calls
