...
{
    'functor' : {       ## intrinsics values related to functor select
    ...
    'unit'    : {       ## informations for creating unit tests
        ...
        'verif_test'      : { ## verification dictionary
            ...
            'property_call'   : {'integer_' : ['nt2::select(a0,a1,a2)'],},  ## dictionary of calls per types
            'property_value'  : {'integer_' : ['nt2::select(a0,a1,a2)'],}, ## dictionary of alternate calls
