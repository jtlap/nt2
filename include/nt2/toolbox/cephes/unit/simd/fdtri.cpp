...
//////////////////////////////////////////////////////////////////////////////
#define NT2_UNIT_MODULE "nt2 cephes toolbox - fdtri - unit/simd Mode"
...
//////////////////////////////////////////////////////////////////////////////
//NT2_TEST_CASE_TPL(fdtri, NT2_SIMD_TYPES )
//{
//  using nt2::fdtri;
//  using nt2::functors::fdtri;
// 
...
//    data[i] = i; // good value here for fdtri
//
//    n_t a0 = load<n_t>(&data[0],0);
//    n_t a1 = load<n_t>(&data[0],1);
//    n_t a2 = load<n_t>(&data[0],2);
//    n_t v  = fdtri(a0, a1, a2);
//    for(std::size_t j=0;j<cardinal_of<n_t>::value;++j)
//    {
//      NT2_TEST_EQUAL( v[j], fdtri(a0[j], a1[j], a2[j]) );
//    }
//  }
//}
