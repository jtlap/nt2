...
//////////////////////////////////////////////////////////////////////////////
#define NT2_UNIT_MODULE "nt2 cephes toolbox - i0e - unit/simd Mode"
...
//////////////////////////////////////////////////////////////////////////////
//NT2_TEST_CASE_TPL(i0e, NT2_SIMD_TYPES )
//{
//  using nt2::i0e;
//  using nt2::functors::i0e;
// 
...
//    data[i] = i; // good value here for i0e
//
//    n_t a0 = load<n_t>(&data[0],0);
//    n_t v  = i0e(a0);
//    for(std::size_t j=0;j<cardinal_of<n_t>::value;++j)
//    {
//      NT2_TEST_EQUAL( v[j], i0e(a0[j]) );
//    }
//  }
//}
