...
//////////////////////////////////////////////////////////////////////////////
#define NT2_UNIT_MODULE "nt2 cephes toolbox - hyperg - unit/simd Mode"
...
//////////////////////////////////////////////////////////////////////////////
//NT2_TEST_CASE_TPL(hyperg, NT2_SIMD_TYPES )
//{
//  using nt2::hyperg;
//  using nt2::functors::hyperg;
// 
...
//    data[i] = i; // good value here for hyperg
//
//    n_t a0 = load<n_t>(&data[0],0);
//    n_t a1 = load<n_t>(&data[0],1);
//    n_t a2 = load<n_t>(&data[0],2);
//    n_t v  = hyperg(a0, a1, a2);
//    for(std::size_t j=0;j<cardinal_of<n_t>::value;++j)
//    {
//      NT2_TEST_EQUAL( v[j], hyperg(a0[j], a1[j], a2[j]) );
//    }
//  }
//}
