...
//////////////////////////////////////////////////////////////////////////////
#define NT2_UNIT_MODULE "nt2 cephes toolbox - rgamma - unit/simd Mode"
...
//////////////////////////////////////////////////////////////////////////////
//NT2_TEST_CASE_TPL(rgamma, NT2_SIMD_TYPES )
//{
//  using nt2::rgamma;
//  using nt2::functors::rgamma;
// 
...
//    data[i] = i; // good value here for rgamma
//
//    n_t a0 = load<n_t>(&data[0],0);
//    n_t v  = rgamma(a0);
//    for(std::size_t j=0;j<cardinal_of<n_t>::value;++j)
//    {
//      NT2_TEST_EQUAL( v[j], rgamma(a0[j]) );
//    }
//  }
//}
