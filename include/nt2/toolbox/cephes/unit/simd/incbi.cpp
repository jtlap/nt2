...
//////////////////////////////////////////////////////////////////////////////
#define NT2_UNIT_MODULE "nt2 cephes toolbox - incbi - unit/simd Mode"
...
//////////////////////////////////////////////////////////////////////////////
//NT2_TEST_CASE_TPL(incbi, NT2_SIMD_TYPES )
//{
//  using nt2::incbi;
//  using nt2::functors::incbi;
// 
...
//    data[i] = i; // good value here for incbi
//
//    n_t a0 = load<n_t>(&data[0],0);
//    n_t a1 = load<n_t>(&data[0],1);
//    n_t a2 = load<n_t>(&data[0],2);
//    n_t v  = incbi(a0, a1, a2);
//    for(std::size_t j=0;j<cardinal_of<n_t>::value;++j)
//    {
//      NT2_TEST_EQUAL( v[j], incbi(a0[j], a1[j], a2[j]) );
//    }
//  }
//}
