...
//////////////////////////////////////////////////////////////////////////////
#define NT2_UNIT_MODULE "nt2 cephes toolbox - zetac - unit/simd Mode"
...
//////////////////////////////////////////////////////////////////////////////
//NT2_TEST_CASE_TPL(zetac, NT2_SIMD_TYPES )
//{
//  using nt2::zetac;
//  using nt2::functors::zetac;
// 
...
//    data[i] = i; // good value here for zetac
//
//    n_t a0 = load<n_t>(&data[0],0);
//    n_t v  = zetac(a0);
//    for(std::size_t j=0;j<cardinal_of<n_t>::value;++j)
//    {
//      NT2_TEST_EQUAL( v[j], zetac(a0[j]) );
//    }
//  }
//}
