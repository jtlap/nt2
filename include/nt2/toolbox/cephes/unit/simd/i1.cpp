...
//////////////////////////////////////////////////////////////////////////////
#define NT2_UNIT_MODULE "nt2 cephes toolbox - i1 - unit/simd Mode"
...
//////////////////////////////////////////////////////////////////////////////
//NT2_TEST_CASE_TPL(i1, NT2_SIMD_TYPES )
//{
//  using nt2::i1;
//  using nt2::functors::i1;
// 
...
//    data[i] = i; // good value here for i1
//
//    n_t a0 = load<n_t>(&data[0],0);
//    n_t v  = i1(a0);
//    for(std::size_t j=0;j<cardinal_of<n_t>::value;++j)
//    {
//      NT2_TEST_EQUAL( v[j], i1(a0[j]) );
//    }
//  }
//}
