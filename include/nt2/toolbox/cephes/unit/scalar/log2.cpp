                ...
                )
{
  ...
  const int N = 2; 
   ...
   NT2_TEST_EQUAL(  nt2::cephes::log2( nt2::Inf<T>() )  , nt2::Inf<T>() );
   NT2_TEST_EQUAL(  nt2::cephes::log2(T(2) ), T(1)); 
   NT2_TEST_EQUAL(  nt2::cephes::log2(T(8) ), T(3)); 
   NT2_TEST(  nt2::is_nan(log2(nt2::Nan<T>() ))); 
   for(int i=1; i < 100; i++)
     {
       T x =  i; 
       NT2_TEST_LESSER_EQUAL(nt2::ulpdist(x, nt2::exp2(nt2::cephes::log2(x))), 2); 
     }
}
