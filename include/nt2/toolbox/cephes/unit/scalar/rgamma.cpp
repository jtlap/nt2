...
//////////////////////////////////////////////////////////////////////////////
#define NT2_UNIT_MODULE "nt2 cephes toolbox - rgamma/scalar Mode"
...
NT2_TEST_CASE_TPL ( rgamma_real__1,  NT2_REAL_TYPES)
{
  using nt2::cephes::rgamma;
  using nt2::cephes::tag::rgamma_;
  typedef typename nt2::meta::as_integer<T>::type iT;
  typedef typename nt2::meta::call<rgamma_(T)>::type r_t;
    ...
    for (int j =0; j < NR; ++j )
      {
        std::cout << "for param "
                  << "  a0 = "<< u_t(a0 = tab_a0[j])
                  << std::endl;
        NT2_TEST_ULP_EQUAL( nt2::cephes::rgamma(a0),nt2::cephes::rgamma(a0),0.5);
