...
//////////////////////////////////////////////////////////////////////////////
#define NT2_UNIT_MODULE "nt2 cephes toolbox - ellpk/scalar Mode"
...
NT2_TEST_CASE_TPL ( ellpk_real__1,  NT2_REAL_TYPES)
{
  
  using nt2::cephes::ellpk;
  using nt2::cephes::tag::ellpk_;
    ...
    for (uint32_t j =0; j < NR; ++j )
      {
        std::cout << "for param "
                  << "  a0 = "<< u_t(a0 = tab_a0[j])
                  << std::endl;
        NT2_TEST_ULP_EQUAL( nt2::cephes::ellpk(a0),nt2::ellpk(a0),0.5);
