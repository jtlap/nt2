...
//////////////////////////////////////////////////////////////////////////////
#define NT2_UNIT_MODULE "nt2 cephes toolbox - incbet/scalar Mode"
...
NT2_TEST_CASE_TPL ( incbet_real__3,  NT2_REAL_TYPES)
{
  using nt2::cephes::incbet;
  using nt2::cephes::tag::incbet_;
  typedef typename nt2::meta::as_integer<T>::type iT;
  typedef typename nt2::meta::call<incbet_(T,T,T)>::type r_t;
    ...
    for (int j =0; j < NR; ++j )
      {
        std::cout << "for params "
                  ...
                  << ", a2 = "<< u_t(a2 = tab_a2[j])
                  << std::endl;
        NT2_TEST_ULP_EQUAL( nt2::cephes::incbet(a0,a1,a2),nt2::cephes::incbet(a0,a1,a2),0.5);
