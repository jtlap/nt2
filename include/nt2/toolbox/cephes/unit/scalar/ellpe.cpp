...
//////////////////////////////////////////////////////////////////////////////
#define NT2_UNIT_MODULE "nt2 cephes toolbox - ellpe/scalar Mode"
...
{
  using nt2::cephes::ellpe;
  using nt2::cephes::tag::ellpe_;
    ...
    for (int j =0; j < NR; ++j )
      {
        std::cout << "for param "
                  << "  a0 = "<< u_t(a0 = tab_a0[j])
                  << std::endl;
        NT2_TEST_ULP_EQUAL( nt2::cephes::ellpe(a0),nt2::ellpe(a0),0.5);
