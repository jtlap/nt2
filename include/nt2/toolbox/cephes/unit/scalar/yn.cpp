...
//////////////////////////////////////////////////////////////////////////////
#define NT2_UNIT_MODULE "nt2 cephes toolbox - yn/scalar Mode"
...
NT2_TEST_CASE_TPL ( yn_real__2,  NT2_REAL_TYPES)
{
  ...
  typedef typename nt2::meta::call<yn_(T,iT)>::type r_t;
    ...
    for (int j =0; j < NR; ++j )
      {
        std::cout << "for params "
                  ...
                  << ", a1 = "<< u_t(a1 = tab_a1[j])
                  << std::endl;
        NT2_TEST_ULP_EQUAL( nt2::cephes::yn(a0,a1),nt2::yni(a0,a1),0.5);
