...
//////////////////////////////////////////////////////////////////////////////
#define NT2_UNIT_MODULE "nt2 cephes toolbox - erfc/scalar Mode"
...
NT2_TEST_CASE_TPL ( erfc_real__1,  NT2_REAL_TYPES)
{
    ...
    for (int j =0; j < NR; ++j )
      {
        std::cout << "for param "
                  << "  a0 = "<< u_t(a0 = tab_a0[j])
                  << std::endl;
        NT2_TEST_ULP_EQUAL( nt2::cephes::erfc(a0),nt2::cephes::erfc(a0),0.5);
