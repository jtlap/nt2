...
//////////////////////////////////////////////////////////////////////////////
#define NT2_UNIT_MODULE "nt2 cephes toolbox - i0/scalar Mode"
...
extern "C" {float cephes_i0f(float); }
NT2_TEST_CASE_TPL ( i0_real__1,  (float))
{
  using nt2::cephes::i0;
  using nt2::cephes::tag::i0_;
    ...
    for (int j =0; j < NR; ++j )
      {
        std::cout << "for param "
                  << "  a0 = "<< u_t(a0 = tab_a0[j])
                  << std::endl;
        NT2_TEST_ULP_EQUAL( nt2::cephes::i0(a0),nt2::i0(a0),0.5);
