...
namespace nt2 { namespace functors
{
  ...
  /////////////////////////////////////////////////////////////////////////////
  template<class Info>
  struct call<cephes::chdtri_,tag::scalar_(tag::arithmetic_),Info>
  {
    ...
    NT2_FUNCTOR_CALL_EVAL_IF(2,  float){ return cephes_chdtri(a0, a1);}
    NT2_FUNCTOR_CALL_EVAL_IF(2,  double){ return cephes_chdtri(a0, a1);}
    NT2_FUNCTOR_CALL_EVAL_IF(2,  long double){ return cephes_chdtri(a0, a1);}
