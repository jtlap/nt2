...
namespace nt2 { namespace functors
{
  ...
  /////////////////////////////////////////////////////////////////////////////
  template<class Info>
  struct call<cephes::fdtri_,tag::scalar_(tag::arithmetic_),Info>
  {
    template<class Sig> struct result;
    template<class This,class A0, class A1, class A2>
    ...
    NT2_FUNCTOR_CALL_EVAL_IF(3,  float){ return cephes_fdtri(a0, a1, a2);}
    NT2_FUNCTOR_CALL_EVAL_IF(3,  double){ return cephes_fdtri(a0, a1, a2);}
    NT2_FUNCTOR_CALL_EVAL_IF(3,  long double){ return cephes_fdtri(a0, a1, a2);}
