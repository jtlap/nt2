...
namespace nt2 { namespace functors
{
  ...
  /////////////////////////////////////////////////////////////////////////////
  template<class Info>
  struct call<cephes::expn_,tag::scalar_(tag::arithmetic_),Info>
  {
    template<class Sig> struct result;
    template<class This,class A0, class A1>
    ...
    NT2_FUNCTOR_CALL_EVAL_IF(2,  float){ return cephes_expn(a0, a1);}
    NT2_FUNCTOR_CALL_EVAL_IF(2,  double){ return cephes_expn(a0, a1);}
    NT2_FUNCTOR_CALL_EVAL_IF(2,  long double){ return cephes_expn(a0, a1);}
    NT2_FUNCTOR_CALL_EVAL_IF(2, arithmetic_)
    {
      typedef typename NT2_CALL_RETURN_TYPE(2)::type type;
      return nt2::cephes::expn(type(a0), type(a1));
    }
  };
} }
