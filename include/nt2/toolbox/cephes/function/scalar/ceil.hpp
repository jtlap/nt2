...
/////////////////////////////////////////////////////////////////////////////
NT2_REGISTER_DISPATCH(cephes::tag::ceil_, tag::cpu_,
                      (A0),
                      (arithmetic_<A0>)
                     )
...
namespace nt2 { namespace ext
{
  ...
  struct call<cephes::tag::ceil_(tag::arithmetic_),
...
{
  template<class Dummy>
  struct call<cephes::tag::ceil_(tag::double_),
              tag::cpu_, Dummy> : callable
  {
    template<class Sig> struct result;
    template<class This,class A0>
...
{
  template<class Dummy>
  struct call<cephes::tag::ceil_(tag::float_),
              tag::cpu_, Dummy> : callable
  {
    template<class Sig> struct result;
    template<class This,class A0>
...
{
  template<class Dummy>
  struct call<cephes::tag::ceil_(tag::long_double_),
              tag::cpu_, Dummy> : callable
  {
    template<class Sig> struct result;
    template<class This,class A0>
