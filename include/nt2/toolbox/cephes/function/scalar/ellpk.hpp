...
namespace nt2 { namespace functors
{
  ...
  /////////////////////////////////////////////////////////////////////////////
  template<class Info>
  struct call<cephes::ellpk_,tag::scalar_(tag::arithmetic_),Info>
  {
    ...
    NT2_FUNCTOR_CALL_EVAL_IF(1,  float){ return cephes_ellpk(a0);}
    NT2_FUNCTOR_CALL_EVAL_IF(1,  double){ return cephes_ellpk(a0);}
    NT2_FUNCTOR_CALL_EVAL_IF(1,  long double){ return cephes_ellpk(a0);}
