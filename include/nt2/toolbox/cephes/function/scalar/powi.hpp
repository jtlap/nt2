...
namespace nt2 { namespace ext
{
  ...
  struct call<tag::powi_(tag::arithmetic_,tag::arithmetic_),
...
{
  template<class Dummy>
  struct call<tag::powi_(tag::double_,tag::double_),
              tag::cpu_, Dummy> : callable
  {
    template<class Sig> struct result;
    template<class This,class A0, class A1>
...
{
  template<class Dummy>
  struct call<tag::powi_(tag::float_,tag::float_),
              tag::cpu_, Dummy> : callable
  {
    template<class Sig> struct result;
    template<class This,class A0, class A1>
...
{
  template<class Dummy>
  struct call<tag::powi_(tag::long double_,tag::long double_),
              tag::cpu_, Dummy> : callable
  {
    template<class Sig> struct result;
    template<class This,class A0, class A1>
