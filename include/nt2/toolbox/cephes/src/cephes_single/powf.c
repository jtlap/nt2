...
#else
float cephes_floorf(), cephes_frexpf(), cephes_ldexpf(), cephes_powif();
#endif
...
z = cephes_ldexpf( z, i );  /* multiply by integer power of 2 */
