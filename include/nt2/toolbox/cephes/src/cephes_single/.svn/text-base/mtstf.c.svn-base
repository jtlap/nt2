...
#ifndef ANSIC
float cephes_sqrtf(), cephes_cbrtf(), cephes_expf(), cephes_logf();
float cephes_exp10f(), cephes_log10f(), cephes_tanf(), cephes_atanf();
float cephes_sinf(), cephes_asinf(), cephes_cosf(), cephes_acosf(), cephes_powf();
float cephes_tanhf(), cephes_atanhf(), cephes_sinhf(), cephes_asinhf(), cephes_coshf(), cephes_acoshf();
#endif
...
#if SETPREC
cephes_sprec();  /* set coprocessor precision */
#endif
ntr = NTRIALS;
...
rms = 1.0e-7F * cephes_sqrtf( rmsa/m );
if(ctrl & RELERR)
