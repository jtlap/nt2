...
double cephes_atan (double);
double cephes_sin (double);
double cephes_cos (double);
double cephes_tan (double);
double cephes_acos (double);
double cephes_asin (double);
double cephes_acosh (double);
double cephes_asinh (double);
double cephes_atanh (double);
double cephes_sinh (double);
double cephes_cosh (double);
double cephes_tanh (double);
double cephes_exp2 (double);
double expm1 (double);
double cephes_log10 (double);
double log1p (double);
double cephes_log2 (double);
double fabs (double);
double cephes_erf (double);
double cephes_erfc (double);
double cephes_gamma (double);
double cephes_floor (double);
double cephes_ceil (double);
double cephes_cbrt (double);
#if GLIBC2
