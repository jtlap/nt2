...
#else
double cephes_floor(), cephes_ldexp(), cephes_sin();
#endif
...
/* cephes_floor() returns the largest integer less than its argument.
 ...
 *
 * If you do not have cephes_ldexp(), then you may multiply or
...
a = z - cephes_ldexp(n, 2);	/* 4n */
a -= cephes_ldexp( n, 1);	/* 2n */
a -= cephes_ldexp( n, -2 );	/* n/4 */
a -= cephes_ldexp( n, -5 );	/* n/32 */
a -= cephes_ldexp( n, -9 );	/* n/512 */
a += cephes_ldexp( n, -15 );	/* add n/32768 */
a -= cephes_ldexp( n, -17 );	/* n/131072 */
a -= cephes_ldexp( n, -18 );
a -= cephes_ldexp( n, -20 );
a -= cephes_ldexp( n, -22 );
a -= cephes_ldexp( n, -24 );
