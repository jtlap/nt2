...
#else
int drand();
int cephes_dprec(), cephes_ldprec();
double cephes_exp(), cephes_sqrt(), fabs(), cephes_floor();
...
merror = 0;
cephes_ldprec();   /* set up coprocessor.  */
...
/*cephes_ldprec();*/	/* set up floating point coprocessor */
...
/*
a = 0.5*cephes_floor(2.0*a+1.0);
b = 0.5*cephes_floor(2.0*b+1.0);
*/
v = a;
qy4 = v;
/*x = (a / (a+b));*/
