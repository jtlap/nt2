...
double ifrac(), xcmpl();
double cephes_floor(), cephes_log(), cephes_pow(), cephes_sqrt(), cephes_tanh(), cephes_exp(), fabs(), hypot();
double cephes_frexp(), zfrexp(), cephes_ldexp(), zldexp(), makenan(), makeinfinity();
double cephes_incbet(), cephes_incbi(), cephes_sin(), cephes_cos(), cephes_atan(), cephes_atan2(), cephes_gamma(), cephes_lgam();
#define GLIBC2 0
#if GLIBC2
double lgamma();
#endif
