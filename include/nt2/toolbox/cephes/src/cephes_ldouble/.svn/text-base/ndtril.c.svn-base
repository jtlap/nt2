...
#else
long double cephes_polevll(), cephes_p1evll(), cephes_logl(), cephes_sqrtl();
#endif

long double cephes_ndtril(y0)
long double y0;
{
...
x = cephes_sqrtl( -2.0L * cephes_logl(y) );
