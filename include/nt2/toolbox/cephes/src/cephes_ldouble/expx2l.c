 ...
 * SYNOPSIS:
 *
 * long double x, y, cephes_expx2l();
 * int sign;
 *
 * y = cephes_expx2l( x, sign );
 *
 *
 *
 * DESCRIPTION:
...
long double cephes_expx2l (x, sign)
     long double x;
     int sign;
{
  ...
  u = cephes_expl(u) * cephes_expl(u1);
  return(u);
}
