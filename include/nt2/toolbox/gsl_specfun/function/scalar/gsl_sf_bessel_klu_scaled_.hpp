...
namespace nt2 { namespace functors
{
  ...
  /////////////////////////////////////////////////////////////////////////////
  template<class Info>
  struct call<gsl_specfun::gsl_sf_bessel_Klu_scaled__,tag::scalar_(tag::arithmetic_),Info>
  {
    template<class Sig> struct result;
    template<class This,class A0, class A1>
    ...
    NT2_FUNCTOR_CALL_EVAL_IF(2,  float){ return gsl_sf_bessel_Klu_scaled(a0, a1);}
    NT2_FUNCTOR_CALL_EVAL_IF(2,  double){ return gsl_sf_bessel_Klu_scaled(a0, a1);}
