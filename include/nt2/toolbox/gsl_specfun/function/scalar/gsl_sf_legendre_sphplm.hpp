...
/////////////////////////////////////////////////////////////////////////////
NT2_REGISTER_DISPATCH(tag::gsl_sf_legendre_sphplm_, tag::cpu_,
                                        (A0)(A1)(A2),
...
namespace nt2 { namespace ext
{
  ...
  struct call<tag::gsl_sf_legendre_sphplm_(tag::arithmetic_,tag::arithmetic_,tag::arithmetic_),
...
{
  template<class Dummy>
  struct call<tag::gsl_sf_legendre_sphplm_(tag::double_,tag::double_,tag::double_),
              tag::cpu_, Dummy> : callable
  {
    template<class Sig> struct result;
    template<class This,class A0, class A1, class A2>
...
{
  template<class Dummy>
  struct call<tag::gsl_sf_legendre_sphplm_(tag::float_,tag::float_,tag::float_),
              tag::cpu_, Dummy> : callable
  {
    template<class Sig> struct result;
    template<class This,class A0, class A1, class A2>
