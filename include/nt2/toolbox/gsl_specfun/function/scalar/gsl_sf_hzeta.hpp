...
/////////////////////////////////////////////////////////////////////////////
NT2_REGISTER_DISPATCH(tag::gsl_sf_hzeta_, tag::cpu_,
                              (A0),
                              (arithmetic_<A0>)
                             )
...
namespace nt2 { namespace ext
{
  ...
  struct call<tag::gsl_sf_hzeta_(tag::arithmetic_),
...
{
  template<class Dummy>
  struct call<tag::gsl_sf_hzeta_(tag::double_),
              tag::cpu_, Dummy> : callable
  {
    template<class Sig> struct result;
    template<class This,class A0>
...
{
  template<class Dummy>
  struct call<tag::gsl_sf_hzeta_(tag::float_),
              tag::cpu_, Dummy> : callable
  {
    template<class Sig> struct result;
    template<class This,class A0>
