...
/////////////////////////////////////////////////////////////////////////////
NT2_REGISTER_DISPATCH(gsl_specfun::tag::gsl_sf_bessel_klu_scaled_, tag::cpu_,
                                           (A0)(A1),
...
namespace nt2 { namespace ext
{
  ...
  struct call<gsl_specfun::tag::gsl_sf_bessel_klu_scaled_(tag::integer_,tag::arithmetic_),
              tag::cpu_, Dummy> : callable
  {
    ...
    NT2_FUNCTOR_CALL(2)
    {
      ...
      return nt2::gsl_specfun::gsl_sf_bessel_klu_scaled(a0, type(a1));
    }
  };
} }
...
{
  template<class Dummy>
  struct call<gsl_specfun::tag::gsl_sf_bessel_klu_scaled_(tag::integer_,tag::double_),
              tag::cpu_, Dummy> : callable
  {
    template<class Sig> struct result;
    template<class This,class A0, class A1>
...
{
  template<class Dummy>
  struct call<gsl_specfun::tag::gsl_sf_bessel_klu_scaled_(tag::integer_,tag::float_),
              tag::cpu_, Dummy> : callable
  {
    template<class Sig> struct result;
    template<class This,class A0, class A1>
