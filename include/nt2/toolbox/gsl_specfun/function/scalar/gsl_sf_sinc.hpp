...
namespace nt2 { namespace functors
{
  ...
  /////////////////////////////////////////////////////////////////////////////
  template<class Info>
  struct call<gsl_specfun::gsl_sf_sinc_,tag::scalar_(tag::arithmetic_),Info>
  {
    template<class Sig> struct result;
    template<class This,class A0>
    ...
    NT2_FUNCTOR_CALL_EVAL_IF(1,  float){ return gsl_sf_sinc(a0);}
    NT2_FUNCTOR_CALL_EVAL_IF(1,  double){ return gsl_sf_sinc(a0);}
