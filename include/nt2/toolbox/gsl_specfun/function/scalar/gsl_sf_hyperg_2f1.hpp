...
namespace nt2 { namespace functors
{
  ...
  /////////////////////////////////////////////////////////////////////////////
  template<class Info>
  struct call<gsl_specfun::gsl_sf_hyperg_2F1_,tag::scalar_(tag::arithmetic_),Info>
  {
    template<class Sig> struct result;
    template<class This,class A0, class A1, class A2, class A3>
    ...
    NT2_FUNCTOR_CALL_EVAL_IF(4,  float){ return gsl_sf_hyperg_2F1(a0, a1, a2, a3);}
    NT2_FUNCTOR_CALL_EVAL_IF(4,  double){ return gsl_sf_hyperg_2F1(a0, a1, a2, a3);}
