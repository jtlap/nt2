...
namespace nt2 { namespace functors
{
  ...
  /////////////////////////////////////////////////////////////////////////////
  template<class Info>
  struct call<gsl_specfun::gsl_sf_beta_inc_,tag::scalar_(tag::arithmetic_),Info>
  {
    template<class Sig> struct result;
    template<class This,class A0, class A1, class A2>
    ...
    NT2_FUNCTOR_CALL_EVAL_IF(3,  float){ return gsl_sf_beta_inc(a0, a1, a2);}
    NT2_FUNCTOR_CALL_EVAL_IF(3,  double){ return gsl_sf_beta_inc(a0, a1, a2);}
