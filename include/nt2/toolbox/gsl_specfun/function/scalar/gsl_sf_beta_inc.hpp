...
/////////////////////////////////////////////////////////////////////////////
NT2_REGISTER_DISPATCH(gsl_specfun::tag::gsl_sf_beta_inc_, tag::cpu_,
                                 (A0)(A1)(A2),
...
namespace nt2 { namespace ext
{
  ...
  struct call<gsl_specfun::tag::gsl_sf_beta_inc_(tag::arithmetic_,tag::arithmetic_,tag::arithmetic_),
...
{
  template<class Dummy>
  struct call<gsl_specfun::tag::gsl_sf_beta_inc_(tag::double_,tag::double_,tag::double_),
              tag::cpu_, Dummy> : callable
  {
    template<class Sig> struct result;
    template<class This,class A0, class A1, class A2>
...
{
  template<class Dummy>
  struct call<gsl_specfun::tag::gsl_sf_beta_inc_(tag::float_,tag::float_,tag::float_),
              tag::cpu_, Dummy> : callable
  {
    template<class Sig> struct result;
    template<class This,class A0, class A1, class A2>
