...
//////////////////////////////////////////////////////////////////////////////
#define NT2_UNIT_MODULE "nt2 gsl_specfun toolbox - gsl_sf_bessel_kn_scaled/scalar Mode"
...
NT2_TEST_CASE_TPL ( gsl_sf_bessel_kn_scaled_real__2,  NT2_REAL_TYPES)
{
  
  using nt2::gsl_specfun::gsl_sf_bessel_kn_scaled;
  using nt2::gsl_specfun::tag::gsl_sf_bessel_kn_scaled_;
  typedef typename nt2::meta::as_integer<T>::type iT;
  typedef typename nt2::meta::call<gsl_sf_bessel_kn_scaled_(iT,T)>::type r_t;
