...
NT2_TEST_CASE_TPL ( gsl_sf_legendre_sphplm_real__3,  NT2_REAL_TYPES)
{
  
  using nt2::gsl_specfun::gsl_sf_legendre_sphplm;
  using nt2::gsl_specfun::tag::gsl_sf_legendre_sphplm_;
  typedef typename nt2::meta::as_integer<T>::type iT;
  typedef typename nt2::meta::call<gsl_sf_legendre_sphplm_(T,T,T)>::type r_t;
    ...
    for (int j =0; j < NR; ++j )
      {
        std::cout << "for params "
                  ...
                  << ", a2 = "<< u_t(a2 = tab_a2[j])
                  << std::endl;
        NT2_TEST_ULP_EQUAL( nt2::gsl_specfun::gsl_sf_legendre_sphplm(a0,a1,a2),nt2::gsl_specfun::gsl_sf_legendre_sphplm(a0,a1,a2),1);
