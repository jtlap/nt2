...
//////////////////////////////////////////////////////////////////////////////
#define NT2_UNIT_MODULE "nt2 gsl_specfun toolbox - gsl_sf_gammastar/scalar Mode"
...
NT2_TEST_CASE_TPL ( gsl_sf_gammastar_real__1,  NT2_REAL_TYPES)
{
  
  using nt2::gsl_specfun::gsl_sf_gammastar;
  using nt2::gsl_specfun::tag::gsl_sf_gammastar_;
  typedef typename nt2::meta::as_integer<T>::type iT;
  typedef typename nt2::meta::call<gsl_sf_gammastar_(T)>::type r_t;
