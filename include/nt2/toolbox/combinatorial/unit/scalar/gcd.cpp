...
NT2_TEST_CASE_TPL ( gcd_real_,  NT2_REAL_TYPES)
{
  using nt2::gcd;
...
NT2_TEST_CASE_TPL ( gcd_unsigned_int_,  NT2_UNSIGNED_TYPES)
{
  using nt2::gcd;
  using nt2::functors::gcd_;
  typedef typename nt2::meta::call<gcd_(T, T)>::type r_t;
...
NT2_TEST_CASE_TPL ( gcd_signed_int_,  NT2_INTEGRAL_SIGNED_TYPES)
{
  using nt2::gcd;
  using nt2::functors::gcd_;
  typedef typename nt2::meta::call<gcd_(T, T)>::type r_t;
