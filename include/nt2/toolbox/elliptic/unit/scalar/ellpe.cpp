...
//////////////////////////////////////////////////////////////////////////////
#define NT2_UNIT_MODULE "nt2 elliptic toolbox - ellpe/scalar Mode"
...
NT2_TEST_CASE_TPL ( ellpe_real__1,  NT2_REAL_TYPES)
{
  using nt2::ellpe;
  ...
  NT2_TEST_ULP_EQUAL(ellpe(nt2::One<T>()), nt2::Pio_2<r_t>(), 0);
  NT2_TEST_ULP_EQUAL(ellpe(nt2::Pio_2<T>()), nt2::Nan<r_t>(), 0);
  NT2_TEST_ULP_EQUAL(ellpe(nt2::Zero<T>()), nt2::One<r_t>(), 0);
    ...
    for (int j =0; j < NR; ++j )
      {
        std::cout << "for param "
                  << "  a0 = "<< u_t(a0 = tab_a0[j])
                  << std::endl;
        NT2_TEST_ULP_EQUAL( nt2::ellpe(a0),::cephes_ellpel(a0),0.5);
