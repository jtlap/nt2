...
//////////////////////////////////////////////////////////////////////////////
#define NT2_UNIT_MODULE "nt2 boost_math toolbox - gamma_p_derivative - unit/simd Mode"
...
//////////////////////////////////////////////////////////////////////////////
//NT2_TEST_CASE_TPL(gamma_p_derivative, NT2_SIMD_TYPES )
//{
//  using nt2::gamma_p_derivative;
//  using nt2::functors::gamma_p_derivative;
// 
...
//    data[i] = i; // good value here for gamma_p_derivative
//
//    n_t a0 = load<n_t>(&data[0],0);
//    n_t a1 = load<n_t>(&data[0],1);
//    n_t v  = gamma_p_derivative(a0, a1);
//    for(std::size_t j=0;j<cardinal_of<n_t>::value;++j)
//    {
//      NT2_TEST_EQUAL( v[j], gamma_p_derivative(a0[j], a1[j]) );
//    }
//  }
//}
