...
//////////////////////////////////////////////////////////////////////////////
#define NT2_UNIT_MODULE "nt2 boost_math toolbox - cyl_neumann - unit/simd Mode"
...
//////////////////////////////////////////////////////////////////////////////
//NT2_TEST_CASE_TPL(cyl_neumann, NT2_SIMD_TYPES )
//{
//  using nt2::cyl_neumann;
//  using nt2::functors::cyl_neumann;
// 
...
//    data[i] = i; // good value here for cyl_neumann
//
//    n_t a0 = load<n_t>(&data[0],0);
//    n_t a1 = load<n_t>(&data[0],1);
//    n_t v  = cyl_neumann(a0, a1);
//    for(std::size_t j=0;j<cardinal_of<n_t>::value;++j)
//    {
//      NT2_TEST_EQUAL( v[j], cyl_neumann(a0[j], a1[j]) );
//    }
//  }
//}
