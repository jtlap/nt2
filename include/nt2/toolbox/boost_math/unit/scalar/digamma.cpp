...
//////////////////////////////////////////////////////////////////////////////
#define NT2_UNIT_MODULE "nt2 boost_math toolbox - digamma/scalar Mode"
...
NT2_TEST_CASE_TPL ( digamma_real__1,  NT2_REAL_TYPES)
{
  
  using nt2::boost_math::digamma;
  using nt2::boost_math::tag::digamma_;
    ...
    for (int j =0; j < NR; ++j )
      {
        std::cout << "for param "
                  << "  a0 = "<< u_t(a0 = tab_a0[j])
                  << std::endl;
        NT2_TEST_ULP_EQUAL( nt2::boost_math::digamma(a0),nt2::digamma(a0),1);
