...
//////////////////////////////////////////////////////////////////////////////
#define NT2_UNIT_MODULE "nt2 boost_math toolbox - factorial/scalar Mode"
...
NT2_TEST_CASE_TPL ( factorial_integer__1,  NT2_INTEGRAL_TYPES)
{
    ...
    for (uint32_t j =0; j < NR; ++j )
      {
        std::cout << "for param "
                  << "  a0 = "<< u_t(a0 = tab_a0[j])
                  << std::endl;
        NT2_TEST_ULP_EQUAL( nt2::boost_math::factorial<double>(a0),nt2::boost_math::factorial<double>(a0),1);
