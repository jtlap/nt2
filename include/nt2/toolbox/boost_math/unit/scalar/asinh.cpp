...
//////////////////////////////////////////////////////////////////////////////
#define NT2_UNIT_MODULE "nt2 boost_math toolbox - asinh/scalar Mode"
...
NT2_TEST_CASE_TPL ( asinh_real__1_0,  NT2_REAL_TYPES)
{
  ...
  using nt2::boost_math::asinh;
  using nt2::boost_math::tag::asinh_;
    ...
    for (uint32_t j =0; j < NR; ++j )
      {
        std::cout << "for param "
                  << "  a0 = "<< u_t(a0 = tab_a0[j])
                  << std::endl;
        NT2_TEST_ULP_EQUAL( nt2::boost_math::asinh(a0),nt2::asinh(a0),1);
