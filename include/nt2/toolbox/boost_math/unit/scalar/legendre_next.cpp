...
// NT2_TEST_CASE_TPL ( legendre_next_real__5,  NT2_REAL_TYPES)
// {
...
//                   << ", a4 = "<< u_t(a4 = tab_a4[j])
//                   << std::endl;
//         NT2_TEST_EQUAL( nt2::boost_math::legendre_next(a0,a1,a2,a3,a4),nt2::boost_math::legendre_next(a0,a1,a2,a3,a4));
//      }
