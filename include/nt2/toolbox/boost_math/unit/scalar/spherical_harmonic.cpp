...
NT2_TEST_CASE_TPL ( spherical_harmonic_real__4,  NT2_REAL_TYPES)
{
    ...
    for (int j =0; j < NR; ++j )
      {
        std::cout << "for params "
                  ...
                  << ", a3 = "<< u_t(a3 = tab_a3[j])
                  << std::endl;
        NT2_TEST_EQUAL( nt2::boost_math::spherical_harmonic(a0,a1,a2,a3),nt2::boost_math::spherical_harmonic(a0,a1,a2,a3));
     }
