...
//////////////////////////////////////////////////////////////////////////////
#define NT2_UNIT_MODULE "nt2 boost_math toolbox - atanh/scalar Mode"
...
NT2_TEST_CASE_TPL ( atanh_real__1,  NT2_REAL_TYPES)
{
  ...
  using nt2::boost_math::atanh;
  using nt2::boost_math::tag::atanh_;
    ...
    for (int j =0; j < NR; ++j )
      {
        std::cout << "for param "
                  << "  a0 = "<< u_t(a0 = tab_a0[j])
                  << std::endl;
        NT2_TEST_ULP_EQUAL( nt2::boost_math::atanh(a0),nt2::atanh(a0),1);
