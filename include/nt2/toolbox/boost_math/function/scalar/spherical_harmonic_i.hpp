...
/////////////////////////////////////////////////////////////////////////////
NT2_REGISTER_DISPATCH(tag::spherical_harmonic_i_, tag::cpu_,
                                      (A0)(A1)(A2)(A3),
...
namespace nt2 { namespace ext
{
  ...
  struct call<tag::spherical_harmonic_i_(tag::arithmetic_,tag::arithmetic_,tag::arithmetic_,tag::arithmetic_),
...
{
  template<class Dummy>
  struct call<tag::spherical_harmonic_i_(tag::real_,tag::real_,tag::real_,tag::real_),
              tag::cpu_, Dummy> : callable
  {
    template<class Sig> struct result;
    template<class This,class A0, class A1, class A2, class A3>
