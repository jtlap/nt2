...
namespace nt2 { namespace ext
{
  ...
  struct call<boost_math::tag::spherical_harmonic_i_(tag::arithmetic_,tag::arithmetic_,tag::arithmetic_,tag::arithmetic_),
...
{
  template<class Dummy>
  struct call<boost_math::tag::spherical_harmonic_i_(tag::real_,tag::real_,tag::real_,tag::real_),
              tag::cpu_, Dummy> : callable
  {
    template<class Sig> struct result;
    template<class This,class A0, class A1, class A2, class A3>
