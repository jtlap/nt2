...
/////////////////////////////////////////////////////////////////////////////
NT2_REGISTER_DISPATCH(tag::tgamma_delta_ratio_, tag::cpu_,
                                    (A0)(A1),
...
namespace nt2 { namespace ext
{
  ...
  struct call<tag::tgamma_delta_ratio_(tag::arithmetic_,tag::arithmetic_),
...
{
  template<class Dummy>
  struct call<tag::tgamma_delta_ratio_(tag::real_,tag::real_),
              tag::cpu_, Dummy> : callable
  {
    template<class Sig> struct result;
    template<class This,class A0, class A1>
