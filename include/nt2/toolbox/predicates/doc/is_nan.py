...
{
    'functor' : {       ## intrinsics values related to functor is_nan
    ...
    'unit'    : {       ## informations for creating unit tests
        ...
        'verif_test'      : { ## verification dictionary
            ...
            'property_call'   : {'default' : ['nt2::is_nan(a0)'],},  ## dictionary of calls per types
            'property_value'  : {'default' : ['a0!=a0'],}, ## dictionary of alternate calls
