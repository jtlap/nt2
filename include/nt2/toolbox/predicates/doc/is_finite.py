...
{
    'functor' : {       ## intrinsics values related to functor is_finite
    ...
    'unit'    : {       ## informations for creating unit tests
        ...
        'verif_test'      : { ## verification dictionary
            ...
            'property_call'   : {'default' : ['nt2::is_finite(a0)'],},  ## dictionary of calls per types
            'property_value'  : {'default' : ['nt2::abs(a0)<nt2::Inf<T>()'],}, ## dictionary of alternate calls
