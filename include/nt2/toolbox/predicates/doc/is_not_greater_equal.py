...
{
    'functor' : {       ## intrinsics values related to functor is_not_greater_equal
    ...
    'unit'    : {       ## informations for creating unit tests
        ...
        'verif_test'      : { ## verification dictionary
            ...
            'property_call'   : {'default' : ['nt2::is_not_greater_equal(a0,a1)'],},  ## dictionary of calls per types
            'property_value'  : {'default' : ['nt2::is_not_greater_equal(a0,a1)'],}, ## dictionary of alternate calls
