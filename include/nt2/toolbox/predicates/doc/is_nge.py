...
{
    'functor' : {       ## intrinsics values related to functor is_nge
    ...
    'unit'    : {       ## informations for creating unit tests
        ...
        'specific_values' : {
                'real_'       : {
                    ...
                    '-nt2::Zero<T>()':  {'result' : 'nt2::False<r_t>()', 'ulp_thresh':'0.5'},
                    '1,2'            :  {'result' : 'nt2::True<r_t>()', 'ulp_thresh':'0.5'},
                    '2,1'            :  {'result' : 'nt2::False<r_t>()', 'ulp_thresh':'0.5'}, 
                },
                'signed_int_': {
                    'nt2::Zero<T>()':  {'result' : 'nt2::False<r_t>()','ulp_thresh':'0.5'},
                    'nt2::Two<T>()' :  {'result' : 'nt2::False<r_t>()', 'ulp_thresh':'0.5'},
        ...
        'verif_test'      : { ## verification dictionary
            ...
            'property_call'   : {'default' : ['nt2::is_nge(a0,a1)'],},  ## dictionary of calls per types
            'property_value'  : {'default' : ['a0<a1'],}, ## dictionary of alternate calls
