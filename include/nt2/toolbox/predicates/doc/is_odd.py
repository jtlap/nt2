...
{
    'functor' : {       ## intrinsics values related to functor is_odd
    ...
    'unit'    : {       ## informations for creating unit tests
        ...
        'verif_test'      : { ## verification dictionary
            ...
            'property_call'   : {'default' : ['nt2::is_odd(a0)'],},  ## dictionary of calls per types
            'property_value'  : {'default' : ['int(nt2::abs(a0)/2.0)*2+nt2::One<T>()==nt2::abs(a0)'],}, ## dictionary of alternate calls
