...
{
    'functor' : {       ## intrinsics values related to functor is_nlez
    ...
    'unit'    : {       ## informations for creating unit tests
        ...
        'verif_test'      : { ## verification dictionary
            ...
            'property_call'   : {'default' : ['nt2::is_nlez(a0)'],},  ## dictionary of calls per types
            'property_value'  : {'default' : ['nt2::is_nlez(a0)'],}, ## dictionary of alternate calls
