...
{
    'functor' : {       ## intrinsics values related to functor is_nle
    ...
    'unit'    : {       ## informations for creating unit tests
        ...
        'verif_test'      : { ## verification dictionary
            ...
            'property_call'   : {'default' : ['nt2::is_nle(a0,a1)'],},  ## dictionary of calls per types
            'property_value'  : {'default' : ['nt2::is_nle(a0,a1)'],}, ## dictionary of alternate calls
