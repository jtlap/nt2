...
{
    'functor' : {       ## intrinsics values related to functor majority
    ...
    'unit'    : {       ## informations for creating unit tests
        ...
        'verif_test'      : { ## verification dictionary
            ...
            'property_call'   : {'default' : ['nt2::majority(a0,a1,a2)'],},  ## dictionary of calls per types
            'property_value'  : {'default' : ['nt2::majority(a0,a1,a2)'],}, ## dictionary of alternate calls
