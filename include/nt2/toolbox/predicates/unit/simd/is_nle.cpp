...
//////////////////////////////////////////////////////////////////////////////
#define NT2_UNIT_MODULE "nt2 predicates toolbox - is_nle/simd Mode"
...
NT2_TEST_CASE_TPL ( is_nle_real__2,  NT2_REAL_TYPES)
{
  ...
  typedef typename nt2::meta::call<is_nle_(vT,vT)>::type r_t;
    ...
    for(int j = 0; j < NR/cardinal_of<n_t>::value; j++)
      {
        ...
        for(int i = 0; i< cardinal_of<n_t>::value; i++)
        {
          ...
          NT2_TEST_ULP_EQUAL( v[i]!=0,nt2::is_nle(tab_a0[k],tab_a1[k]),0);
