...
//////////////////////////////////////////////////////////////////////////////
#define NT2_UNIT_MODULE "nt2 predicates toolbox - is_invalid/scalar Mode"
...
NT2_TEST_CASE_TPL ( is_invalid_real__1,  NT2_REAL_TYPES)
{
  using nt2::is_invalid;
  using nt2::tag::is_invalid_;
  typedef typename nt2::meta::as_integer<T>::type iT;
  typedef typename nt2::meta::call<is_invalid_(T)>::type r_t;
  ...
  NT2_TEST_ULP_EQUAL(  is_invalid(nt2::Nan<T>()), nt2::False<r_t>(), 0.5);
    ...
    for (int j =0; j < NR; ++j )
      {
        std::cout << "for param "
                  << "  a0 = "<< u_t(a0 = tab_a0[j])
                  << std::endl;
        NT2_TEST_ULP_EQUAL( nt2::is_invalid(a0),nt2::abs(a0)==nt2::Inf<r_t>() || a0!=a0,0);
...
NT2_TEST_CASE_TPL ( is_invalid_signed_int__1,  NT2_INTEGRAL_SIGNED_TYPES)
{
  using nt2::is_invalid;
  using nt2::tag::is_invalid_;
  typedef typename nt2::meta::as_integer<T>::type iT;
...
NT2_TEST_CASE_TPL ( is_invalid_unsigned_int__1,  NT2_UNSIGNED_TYPES)
{
  using nt2::is_invalid;
  using nt2::tag::is_invalid_;
  typedef typename nt2::meta::as_integer<T>::type iT;
