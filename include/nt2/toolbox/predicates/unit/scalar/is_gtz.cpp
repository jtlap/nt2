...
NT2_TEST_CASE_TPL ( is_gtz_real__1,  NT2_REAL_TYPES)
{
  ...
  NT2_TEST_ULP_EQUAL(  is_gtz(-nt2::Zero<T>()), nt2::False<r_t>(), 0.5);
  NT2_TEST_ULP_EQUAL(  is_gtz(nt2::Half<T>()), nt2::True<r_t>(), 0.5);
  NT2_TEST_ULP_EQUAL(  is_gtz(nt2::Inf<T>()), nt2::True<r_t>(), 0.5);
  NT2_TEST_ULP_EQUAL(  is_gtz(nt2::Minf<T>()), nt2::False<r_t>(), 0.5);
  NT2_TEST_ULP_EQUAL(  is_gtz(nt2::Mone<T>()), nt2::False<r_t>(), 0.5);
  NT2_TEST_ULP_EQUAL(  is_gtz(nt2::Nan<T>()), nt2::False<r_t>(), 0.5);
  NT2_TEST_ULP_EQUAL(  is_gtz(nt2::One<T>()), nt2::True<r_t>(), 0.5);
  NT2_TEST_ULP_EQUAL(  is_gtz(nt2::Quarter<T>()), nt2::True<r_t>(), 0.5);
  NT2_TEST_ULP_EQUAL(  is_gtz(nt2::Two<T>()), nt2::True<r_t>(), 0.5);
  NT2_TEST_ULP_EQUAL(  is_gtz(nt2::Zero<T>()), nt2::False<r_t>(), 0.5);
    ...
    for (int j =0; j < NR; ++j )
      {
        std::cout << "for param "
                  << "  a0 = "<< u_t(a0 = tab_a0[j])
                  << std::endl;
        NT2_TEST_ULP_EQUAL( nt2::is_gtz(a0),a0>0,0);
