...
NT2_TEST_CASE_TPL ( is_flint_real__1,  NT2_REAL_TYPES)
{
  ...
  NT2_TEST_EQUAL(is_flint(nt2::Half<T>()), nt2::False<r_t>());
  NT2_TEST_EQUAL(is_flint(nt2::Inf<T>()), nt2::False<r_t>());
  NT2_TEST_EQUAL(is_flint(nt2::Minf<T>()), nt2::False<r_t>());
  NT2_TEST_EQUAL(is_flint(nt2::Mone<T>()), nt2::True<r_t>());
  NT2_TEST_EQUAL(is_flint(nt2::Nan<T>()), nt2::False<r_t>());
  NT2_TEST_EQUAL(is_flint(nt2::One<T>()), nt2::True<r_t>());
  NT2_TEST_EQUAL(is_flint(nt2::Quarter<T>()), nt2::False<r_t>());
  NT2_TEST_EQUAL(is_flint(nt2::Two<T>()), nt2::True<r_t>());
  NT2_TEST_EQUAL(is_flint(nt2::Zero<T>()), nt2::True<r_t>());
    ...
    for (int j =0; j < NR; ++j )
      {
        std::cout << "for param "
                  << "  a0 = "<< u_t(a0 = tab_a0[j])
                  << std::endl;
        NT2_TEST_EQUAL( nt2::is_flint(a0),nt2::frac(a0)==nt2::Zero<T>());
     }
    ...
    for (int j =0; j < NR; ++j )
      {
        std::cout << "for param "
                  << "  a0 = "<< u_t(a0 = tab_a0[j])
                  << std::endl;
        NT2_TEST_EQUAL( nt2::is_flint(a0),nt2::True<T>());
     }
