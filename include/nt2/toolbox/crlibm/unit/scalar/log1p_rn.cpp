                ...
                )
{
  ...
  const int N = 2; 
   ...
   NT2_TEST_EQUAL(  nt2::crlibm::log1p_rn( nt2::Inf<T>() )  , nt2::Inf<T>() );
   NT2_TEST_LESSER_EQUAL(nt2::ulpdist( nt2::crlibm::log1p_rn(nt2::Exp_1<T>()-1 ), T(1)), 1); 
   NT2_TEST_LESSER_EQUAL(  nt2::ulpdist(nt2::crlibm::log1p_rn(nt2::Eps<T>()), nt2::Eps<T>()), 1); 
   ...
   for(int i=0; i < 10; i++)  
     {
       NT2_TEST_LESSER_EQUAL(nt2::ulpdist(nt2::crlibm::log1p_rn(v[i]), t[i]), 3);
       std::cout << std::setprecision(20) << v[i] << "  " << nt2::crlibm::log1p_rn(v[i]) << "  " << t[i] << std::endl; 
     } }
