...
//////////////////////////////////////////////////////////////////////////////
#define NT2_UNIT_MODULE "nt2 crlibm toolbox - asinpi_rd - unit/simd Mode"
...
//////////////////////////////////////////////////////////////////////////////
//NT2_TEST_CASE_TPL(asinpi_rd, NT2_SIMD_TYPES )
//{
//  using nt2::asinpi_rd;
//  using nt2::functors::asinpi_rd;
// 
...
//    data[i] = i; // good value here for asinpi_rd
//
//    n_t a0 = load<n_t>(&data[0],0);
//    n_t v  = asinpi_rd(a0);
//    for(std::size_t j=0;j<cardinal_of<n_t>::value;++j)
//    {
//      NT2_TEST_EQUAL( v[j], asinpi_rd(a0[j]) );
//    }
//  }
//}
