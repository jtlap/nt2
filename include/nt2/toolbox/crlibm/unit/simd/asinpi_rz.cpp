...
//////////////////////////////////////////////////////////////////////////////
#define NT2_UNIT_MODULE "nt2 crlibm toolbox - asinpi_rz - unit/simd Mode"
...
//////////////////////////////////////////////////////////////////////////////
//NT2_TEST_CASE_TPL(asinpi_rz, NT2_SIMD_TYPES )
//{
//  using nt2::asinpi_rz;
//  using nt2::functors::asinpi_rz;
// 
...
//    data[i] = i; // good value here for asinpi_rz
//
//    n_t a0 = load<n_t>(&data[0],0);
//    n_t v  = asinpi_rz(a0);
//    for(std::size_t j=0;j<cardinal_of<n_t>::value;++j)
//    {
//      NT2_TEST_EQUAL( v[j], asinpi_rz(a0[j]) );
//    }
//  }
//}
