...
//////////////////////////////////////////////////////////////////////////////
#define NT2_UNIT_MODULE "nt2 crlibm toolbox - exp_rd_ - unit/simd Mode"
...
//////////////////////////////////////////////////////////////////////////////
//NT2_TEST_CASE_TPL(exp_rd_, NT2_SIMD_TYPES )
//{
//  using nt2::exp_rd_;
//  using nt2::functors::exp_rd_;
// 
...
//    data[i] = i; // good value here for exp_rd_
//
//    n_t a0 = load<n_t>(&data[0],0);
//    n_t v  = exp_rd_(a0);
//    for(std::size_t j=0;j<cardinal_of<n_t>::value;++j)
//    {
//      NT2_TEST_EQUAL( v[j], exp_rd_(a0[j]) );
//    }
//  }
//}
